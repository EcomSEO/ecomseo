...
export const metadata: Metadata = {
  title: "WooCommerce SEO Agency | EcomSEO",
  description:
    "WooCommerce SEO that actually moves revenue. Most agencies don\u2019t understand WooCommerce. We run stores on it. Big difference.",
  openGraph: {
    title: "WooCommerce SEO That Actually Moves Revenue | EcomSEO",
    description:
