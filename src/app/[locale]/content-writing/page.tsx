    ...
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          name: "SEO Content That Converts Browsers Into Buyers",
          description: "We write content that ranks and converts for ecommerce stores. From product descriptions to buying guides \u2014 every word is optimized for search and sales.",
      ...
      <JsonLd
        data={breadcrumbJsonLd(locale as Locale, [
          { name: "Home", path: "/" },
          { name: "SEO Content That Converts Browsers Into Buyers", path: "/content-writing" },
        ])}
      />
      <ServicePageTemplate
      hero={{
