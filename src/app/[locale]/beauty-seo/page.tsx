    ...
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          name: "Beauty SEO That Makes Brands Shine",
          description: "We help beauty and skincare brands rank for the searches that drive revenue \u2014 from ingredient queries to routine guides and product comparisons.",
          path: "/beauty-seo",
        })}
      />
      <JsonLd
        data={breadcrumbJsonLd(locale as Locale, [
          { name: "Home", path: "/" },
          { name: "Beauty SEO That Makes Brands Shine", path: "/beauty-seo" },
        ])}
      />
      <ServicePageTemplate
      hero={{
