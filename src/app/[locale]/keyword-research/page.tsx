    ...
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          name: "Revenue-First Keyword Research for Ecommerce Brands",
          description: "Stop chasing vanity rankings. We find the exact search terms your buyers use \u2014 and build a keyword strategy that turns organic traffic into predictable, compounding revenue.",
      ...
      <JsonLd
        data={breadcrumbJsonLd(locale as Locale, [
          { name: "Home", path: "/" },
          { name: "Revenue-First Keyword Research for Ecommerce Brands", path: "/keyword-research" },
        ])}
      />
      <ServicePageTemplate
      hero={{
