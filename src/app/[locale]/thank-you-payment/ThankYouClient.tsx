...
export default function ThankYouPaymentPage() {
  ...
  const t = thankYouPaymentT[locale];
        ...
        <div className="mx-auto max-w-[1200px] px-5 md:px-10 pt-[120px] md:pt-[160px] pb-20">
          ...
          <div className="max-w-[600px] mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-body text-sm mb-1.5">{t.email}</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-body text-sm mb-1.5">{t.phone}</label>
                <input
                  type="tel"
