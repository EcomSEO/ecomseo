    ...
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          name: "Ecommerce SEO Services That Grow Revenue \u2014 Not Just Traffic",
          description: "Most agencies chase vanity metrics. We chase sales. If your store gets visitors but not buyers, you don\u2019t have an SEO problem \u2014 you have a growth strategy problem.",
          path: "/ecommerce-seo",
        })}
      />
      <JsonLd
        data={breadcrumbJsonLd(locale as Locale, [
          { name: "Home", path: "/" },
          { name: "Ecommerce SEO Services That Grow Revenue \u2014 Not Just Traffic", path: "/ecommerce-seo" },
        ])}
      />
      <ServicePageTemplate
      hero={{
