...
import HreflangValidatorClient from "@/components/tools/HreflangValidatorClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { hreflangValidatorT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/hreflang-validator");
}

export default async function HreflangValidatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = hreflangValidatorT[locale as Locale];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bg">
        ...
        <ToolPreviewSection
          src="/images/tools/hreflang-validator-preview.png"
          imgWidth={1920}
          imgHeight={644}
          url="ecomseo.co/tools/hreflang-validator"
          ...
          <div className="max-w-[900px] mx-auto text-center space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">Canonical Tag Checker</div>
                  <div className="text-xs text-body mt-0.5">Validate canonical URLs and find conflicts</div>
                </div>
              </LocaleLink>
              <LocaleLink
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-body mt-0.5">Analyze title tags, meta descriptions and more</div>
                </div>
              </LocaleLink>
            </div>
          </div>
