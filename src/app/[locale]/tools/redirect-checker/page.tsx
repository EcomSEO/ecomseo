...
import RedirectCheckerClient from "@/components/tools/RedirectCheckerClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { redirectCheckerT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/redirect-checker");
}
...
export default async function RedirectCheckerPage({
  ...
  const { locale } = await params;
  const t = redirectCheckerT[locale as Locale];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bg">
        ...
        <ToolPreviewSection
          src="/images/tools/redirect-checker-preview.png"
          imgWidth={1800}
          imgHeight={434}
          url="ecomseo.co/tools/redirect-checker"
          ...
          <div className="max-w-[900px] mx-auto text-center space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">Canonical Checker</div>
                  <div className="text-xs text-body mt-0.5">Verify canonical tags across your pages</div>
                </div>
              </LocaleLink>
              <LocaleLink
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">Indexability Checker</div>
                  <div className="text-xs text-body mt-0.5">Check if your pages are indexable by search engines</div>
                </div>
              </LocaleLink>
            </div>
          </div>
