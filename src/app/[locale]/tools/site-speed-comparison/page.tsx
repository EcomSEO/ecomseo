...
import SiteSpeedComparisonClient from "@/components/tools/SiteSpeedComparisonClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { siteSpeedComparisonT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/site-speed-comparison");
}

export default async function SiteSpeedComparisonPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = siteSpeedComparisonT[locale as Locale];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bg">
        ...
        <ToolPreviewSection
          src="/images/tools/site-speed-comparison-preview.png"
          imgWidth={1920}
          imgHeight={2408}
          url="ecomseo.co/tools/site-speed-comparison"
          ...
          <div className="max-w-[900px] mx-auto text-center space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">Core Web Vitals Checker</div>
                  <div className="text-xs text-body mt-0.5">Check LCP, CLS, and INP for your pages</div>
                </div>
              </LocaleLink>
              <LocaleLink
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">Meta Tags Checker</div>
                  <div className="text-xs text-body mt-0.5">Validate meta tags across your pages</div>
                </div>
              </LocaleLink>
            </div>
          </div>
