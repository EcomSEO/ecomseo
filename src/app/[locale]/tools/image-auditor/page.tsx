...
import ImageAuditorClient from "@/components/tools/ImageAuditorClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { imageAuditorT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/image-auditor");
}

export default async function ImageAuditorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = imageAuditorT[locale as Locale];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bg">
        ...
        <ToolPreviewSection
          src="/images/tools/image-auditor-preview.png"
          imgWidth={1920}
          imgHeight={922}
          url="ecomseo.co/tools/image-auditor"
          ...
          <div className="max-w-[900px] mx-auto text-center space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">OG Tag Checker</div>
                  <div className="text-xs text-body mt-0.5">Preview how your pages appear on social media</div>
                </div>
              </LocaleLink>
              <LocaleLink
