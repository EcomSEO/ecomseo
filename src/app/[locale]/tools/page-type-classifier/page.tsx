...
import PageTypeClassifierClient from "@/components/tools/PageTypeClassifierClient";
...
export default async function PageTypeClassifierPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = pageTypeClassifierT[locale as Locale];
