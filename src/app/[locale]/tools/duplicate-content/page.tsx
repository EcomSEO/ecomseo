...
import DuplicateContentClient from "@/components/tools/DuplicateContentClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { duplicateContentT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/duplicate-content");
}
...
export default async function DuplicateContentPage({
  ...
  const { locale } = await params;
  const t = duplicateContentT[locale as Locale];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bg">
        ...
        <ToolPreviewSection
          src="/images/tools/duplicate-content-preview.png"
          imgWidth={2560}
          imgHeight={8966}
          url="ecomseo.co/tools/duplicate-content"
          ...
          <div className="max-w-[900px] mx-auto text-center space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">Thin Content Checker</div>
                  <div className="text-xs text-body mt-0.5">Detect pages with too little content</div>
                </div>
              </LocaleLink>
              <LocaleLink
