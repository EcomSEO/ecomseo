...
import InternalLinkAnalyzerClient from "@/components/tools/InternalLinkAnalyzerClient";
...
export default async function InternalLinkAnalyzerPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = internalLinkAnalyzerT[locale as Locale];
      ...
      <main className="min-h-screen bg-bg">
        ...
        <section className="relative overflow-hidden px-5 md:px-16 pt-[120px] md:pt-[160px] pb-20">
          <div className="relative z-10 max-w-[1300px] mx-auto">
            ...
            <InternalLinkAnalyzerClient t={t} />
          </div>
          ...
          <div className="max-w-[900px] mx-auto text-center space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-heading">Heading Checker</div>
                  <div className="text-xs text-body mt-0.5">Analyze heading hierarchy and structure</div>
                </div>
              </LocaleLink>
              <LocaleLink
