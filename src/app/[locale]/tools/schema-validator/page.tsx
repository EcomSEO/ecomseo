...
import SchemaValidatorClient from "@/components/tools/SchemaValidatorClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { schemaValidatorT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/schema-validator");
}
...
export default async function SchemaValidatorPage({
  ...
  const { locale } = await params;
  const t = schemaValidatorT[locale as Locale];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bg">
        ...
        <ToolPreviewSection
          src="/images/tools/schema-validator-preview.png"
          imgWidth={1800}
          imgHeight={1212}
          url="ecomseo.co/tools/schema-validator"
