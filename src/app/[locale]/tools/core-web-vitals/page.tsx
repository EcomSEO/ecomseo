...
import CoreWebVitalsClient from "@/components/tools/CoreWebVitalsClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { coreWebVitalsT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/core-web-vitals");
}
...
export default async function CoreWebVitalsPage({
  ...
  const { locale } = await params;
  const t = coreWebVitalsT[locale as Locale];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bg">
        ...
        <ToolPreviewSection
          src="/images/tools/core-web-vitals-preview.png"
          imgWidth={2120}
          imgHeight={902}
          url="ecomseo.co/tools/core-web-vitals"
