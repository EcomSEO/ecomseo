        ...
        <section className="relative overflow-hidden px-5 md:px-16 pt-[120px] md:pt-[160px] pb-20">
          <div className="relative z-10 max-w-[1200px] mx-auto">
            ...
            <div className="max-w-[1100px] mx-auto space-y-14">
              ...
              {/* ── On-Page & Content ── */}
              <CategorySection
                title={t.categories.onPageContent}
                icon={
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* ── Technical SEO ── */}
              <CategorySection
                title={t.categories.technicalSeo}
                icon={
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <CategorySection
                title={t.categories.structuredData}
                icon={
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* ── Sitemaps & Crawling ── */}
              <CategorySection
                title={t.categories.sitemapsCrawling}
                icon={
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              >
                ...
                />
                <ToolCard
                  title={t.sitemapExtractor.title}
                  desc={t.sitemapExtractor.desc}
                  href="/tools/sitemap-extractor"
                  icon={
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" />
                      <path d="M14 2v6h6" />
                      <path d="M8 13h3M8 17h3M13 13l2 2-2 2" />
                    </svg>
                  }
                />
              </CategorySection>
              ...
              <CategorySection
                title={t.categories.ecommerceInternational}
                icon={
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="12" cy="12" r="10" />
