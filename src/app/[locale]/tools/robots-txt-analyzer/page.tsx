...
import RobotsAnalyzerClient from "@/components/tools/RobotsAnalyzerClient";
...
export default async function RobotsAnalyzerPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = robotsAnalyzerT[locale as Locale];
