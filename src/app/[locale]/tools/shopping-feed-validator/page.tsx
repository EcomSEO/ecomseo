...
import ShoppingFeedValidatorClient from "@/components/tools/ShoppingFeedValidatorClient";
import { buildPageMetadata } from "@/lib/i18n/metadata";
import type { Locale } from "@/lib/i18n/config";
import { shoppingFeedValidatorT } from "@/lib/i18n/translations/seoTools";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildPageMetadata(locale as Locale, "/tools/shopping-feed-validator");
}

export default async function ShoppingFeedValidatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  const { locale } = await params;
  const t = shoppingFeedValidatorT[locale as Locale];
      ...
      <main className="min-h-screen bg-bg">
        ...
        <section className="relative overflow-hidden px-5 md:px-16 pt-[120px] md:pt-[160px] pb-20">
          <div className="relative z-10 max-w-[1300px] mx-auto">
            ...
            <ShoppingFeedValidatorClient t={t} />
          </div>
        ...
        <ToolPreviewSection
          src="/images/tools/shopping-feed-validator-preview.png"
          imgWidth={1920}
          imgHeight={434}
          url="ecomseo.co/tools/shopping-feed-validator"
