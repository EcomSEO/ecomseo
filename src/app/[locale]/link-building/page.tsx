    ...
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          name: "Profit-Focused Link Building Services for Ecommerce Brands",
          description: "You don\u2019t need more random backlinks. You need link building that compounds revenue, grows valuation and turns SEO into a predictable profit lever.",
          path: "/link-building",
        })}
      />
      <JsonLd
        data={breadcrumbJsonLd(locale as Locale, [
          { name: "Home", path: "/" },
          { name: "Profit-Focused Link Building Services for Ecommerce Brands", path: "/link-building" },
        ])}
      />
      <ServicePageTemplate
      hero={{
