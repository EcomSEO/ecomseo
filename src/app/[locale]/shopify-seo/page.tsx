    ...
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          name: "Shopify SEO That Actually Drives Revenue",
          description: "Our Chef\u2019s Special. We audit, fix, and scale organic traffic for Shopify and Shopify Plus stores \u2014 so you can stop bleeding revenue to competitors.",
          path: "/shopify-seo",
        })}
      />
      <JsonLd
        data={breadcrumbJsonLd(locale as Locale, [
          { name: "Home", path: "/" },
          { name: "Shopify SEO That Actually Drives Revenue", path: "/shopify-seo" },
        ])}
      />
      <ServicePageTemplate
      hero={{
