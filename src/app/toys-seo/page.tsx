...
export const metadata: Metadata = {
  title: "Toys SEO Agency | EcomSEO",
  description:
    "Toys SEO that makes sales soar. We help toy and game ecommerce stores rank for seasonal, age-based, and gift-driven search queries.",
  openGraph: {
    title: "Toys SEO That Makes Sales Soar | EcomSEO",
    description:
      "We help toy and game ecommerce stores rank for high-intent queries.",
  },
};

export default function ToysSeoPage() {
  return (
    <ServicePageTemplate
      hero={{
        badge: "Toys SEO",
