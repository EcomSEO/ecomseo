...
export const metadata: Metadata = {
  title: "Resources & Learning Centre | EcomSEO",
  description:
    "Industry's best resources about SEO for ecommerce brands. Guides, templates, tools, and articles to help you scale organic revenue.",
  openGraph: {
    title: "Resources & Learning Centre | EcomSEO",
    description:
