...
export const metadata: Metadata = {
  title: "ABC Template | EcomSEO Resource Library",
  description:
    "Unlock new superpowers with effortless copy & paste code overrides — no coding required.",
  openGraph: {
    title: "ABC Template | EcomSEO Resource Library",
    description:
      "Unlock new superpowers with effortless copy & paste code overrides.",
  },
};
