...
export const metadata: Metadata = {
  title: "Amazon SEO Agency | EcomSEO",
  description:
    "Get on top of Amazon with your brand. We optimize listings, backend keywords, and A+ content to boost your organic visibility on Amazon.",
  openGraph: {
    title: "Amazon SEO — Get on Top of Amazon With Your Brand | EcomSEO",
    description:
      "We optimize Amazon listings, backend keywords, and A+ content for organic growth.",
  },
};
