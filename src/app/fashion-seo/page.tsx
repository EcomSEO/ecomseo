...
export const metadata: Metadata = {
  title: "Fashion SEO Agency | EcomSEO",
  description:
    "Fashion SEO that turns browsers into buyers. We help fashion and apparel brands rank for seasonal, style-based, and trend-driven search queries.",
  openGraph: {
    title: "Fashion SEO That Turns Browsers Into Buyers | EcomSEO",
    description:
      "We help fashion and apparel brands rank for high-intent queries.",
  },
};
