...
export const metadata: Metadata = {
  title: "Consumables SEO Agency | EcomSEO",
  description:
    "Consumables SEO that fuels repeat revenue. We help food, supplement, and consumable brands rank for high-intent ingredient, comparison, and subscription queries.",
  openGraph: {
    title: "Consumables SEO That Fuels Repeat Revenue | EcomSEO",
    description:
      "We help food, supplement, and consumable brands rank for high-intent queries.",
  },
};

export default function ConsumablesSeoPage() {
  return (
    <ServicePageTemplate
      hero={{
