          ...
          <div className="mx-auto max-w-[1200px] flex items-center justify-between px-3 py-3">
            ...
            <div className="hidden lg:flex items-center gap-4">
              <a
                ...
                className="group flex items-center gap-2.5 px-3 py-1.5 rounded-full border border-white/[0.08] hover:border-white/[0.16] bg-white/[0.03] hover:bg-white/[0.06] transition-all duration-200"
              >
                ...
                <span className="text-[13px] font-medium text-white/70 group-hover:text-white transition-colors whitespace-nowrap">
                  Chat with Fabian
                </span>
