...
export const seoAnalyticsWithGa4: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "Le rapport Pages d'arrivee sous Engagement montre sur quelles pages arrivent les visiteurs organiques et comment ils performent. Ajoutez une comparaison pour votre segment de trafic organique, puis triez par sessions pour trouver vos principaux points d'entree SEO. Les metriques cles a surveiller sont le taux d'engagement, le temps d'engagement moyen et les conversions.\n\nLe rapport Achats e-commerce sous Monetisation montre le revenu au niveau article, la quantite vendue et le nombre d'achats. Filtre sur le trafic organique, ce rapport revele quels produits generent le plus de revenus grace au SEO. Vous pourriez decouvrir que vos produits les plus vendus globalement ne sont pas les memes que vos meilleurs generateurs de revenus organiques.\n\nLe rapport Chemin de conversion sous Publicite montre le role de la recherche organique dans l'ensemble du parcours client. Les achats e-commerce se font rarement en une seule session. Un client peut decouvrir votre boutique via une recherche organique, revenir via une recherche de marque et finalement acheter via une visite directe.\n\nUtilisez le rapport Acquisition d'utilisateurs pour suivre la croissance de nouveaux utilisateurs issus de la recherche organique au fil du temps. Cette metrique est un indicateur avance puissant de la sante SEO.",
        },
        {
          title: "Explorations personnalisees pour l'analyse SEO",
          content:
            "L'espace de travail Explorations de GA4 est l'endroit ou se fait l'analyse SEO serieuse. Les rapports standard fournissent des metriques d'ensemble, mais les explorations permettent de construire des analyses sur mesure qui repondent a des questions commerciales specifiques.\n\nCreez une exploration en forme libre avec ces dimensions : Page d'arrivee, Session source/medium, Categorie d'appareil et Pays. Ajoutez des metriques pour les Sessions, Sessions engagees, Achats e-commerce et Revenus d'achat. Appliquez votre segment organique et vous obtenez un tableau de bord complet de performance SEO.\n\nCreez une exploration en entonnoir pour visualiser le parcours du visiteur organique. Definissez les etapes comme : session_start sur une page produit ou categorie, puis view_item, add_to_cart, begin_checkout et purchase. Cet entonnoir montre exactement ou les visiteurs organiques abandonnent.\n\nUne exploration de chemin revele les pages que les visiteurs organiques consultent apres l'arrivee. C'est precieux pour comprendre les schemas de navigation interne. Vous pourriez decouvrir que les visiteurs organiques arrivant sur des articles de blog naviguent frequemment vers des categories de produits specifiques.",
          tip: "Sauvegardez vos explorations les plus utilisees comme modeles. GA4 permet de dupliquer les explorations, donc creez une version maitre avec vos dimensions, metriques et segments standards, puis clonez-la pour chaque nouvelle periode d'analyse.",
        },
        {
          title: "Suivre le revenu et les conversions organiques",
          content:
            "L'attribution du revenu a la recherche organique necessite de comprendre les modeles d'attribution de GA4. Par defaut, GA4 utilise l'attribution basee sur les donnees, qui distribue le credit de conversion sur tous les points de contact grace au machine learning. Pour la plupart des boutiques e-commerce, cela donne une image plus precise de la contribution du SEO que l'attribution au dernier clic.\n\nPour voir le revenu de la recherche organique, naviguez vers la section Publicite et utilisez le rapport Comparaison de modeles. Comparez l'attribution basee sur les donnees avec le dernier clic pour comprendre combien de revenus la recherche organique influence versus genere directement.\n\nConfigurez des evenements personnalises pour suivre les micro-conversions qui indiquent un engagement genere par le SEO. Les ajouts a la liste de souhaits, les formulaires d'inscription par email completes depuis des pages d'arrivee organiques et l'utilisation d'outils de comparaison de produits sont autant de signaux.\n\nCreez un rapport mensuel de revenus organiques qui suit le revenu total organique, le taux de conversion organique, la valeur moyenne de commande du trafic organique et le revenu par session organique. Comparez ces metriques d'un mois a l'autre et d'une annee a l'autre.",
          items: [
            "Comparez l'attribution basee sur les donnees avec le dernier clic pour voir l'influence complete du SEO sur le revenu",
        ...
        },
        {
          ...
          content:
            "Le seuil de donnees est le probleme GA4 le plus frustrant pour les equipes SEO e-commerce. Lorsque vos segments ont de petits echantillons, GA4 applique des seuils et masque des lignes de donnees pour proteger la vie privee des utilisateurs. Cela arrive souvent lorsque vous filtrez le trafic organique par pages d'arrivee specifiques. La solution est d'utiliser des periodes plus longues, des segments plus larges ou des exports BigQuery.\n\nUn autre probleme courant est le spam de referral et le trafic de bots qui gonflent les chiffres organiques. GA4 a un filtrage de bots integre, mais il manque de nombreux visiteurs automatises. Verifiez votre trafic organique pour des comptes de sessions suspectement eleves depuis des pages individuelles avec 0% de taux d'engagement.\n\nLe balisage UTM negligent sur les liens internes corrompt egalement l'attribution organique. Si vos liens d'email marketing ou liens de bannieres internes utilisent des parametres UTM, ils ecrasent la source de trafic d'origine. Auditez votre site pour les liens internes contenant des parametres UTM et supprimez-les.\n\nEnfin, surveillez les ecarts de donnees entre GA4 et Search Console. GSC compte les clics vers votre site tandis que GA4 compte les sessions. Ces chiffres ne correspondront jamais exactement. Un ecart de 10-15% entre les clics GSC et les sessions organiques GA4 est normal. Au-dela de 20%, verifiez si votre code de suivi GA4 se declenche correctement sur tous les modeles de pages.",
        },
      ],
      navLabels: {
        previous: "Precedent",
      ...
      sections: [
        {
          ...
          content:
            "Antes de poder medir el rendimiento SEO en GA4, necesitas que los eventos de ecommerce correctos se activen adecuadamente. GA4 depende de nombres de eventos especificos: view_item, add_to_cart, begin_checkout y purchase. Cada evento debe incluir parametros a nivel de articulo como item_id, item_name, item_category, price y quantity. Sin estos parametros, tus informes de ecommerce estaran vacios o seran poco fiables.\n\nPara tiendas Shopify, la integracion nativa de GA4 maneja los eventos de compra automaticamente, pero frecuentemente omite los eventos view_item y add_to_cart. Necesitaras un data layer personalizado o una configuracion a traves de Google Tag Manager para capturar el embudo completo. WooCommerce y Magento tienen brechas similares.\n\nUna vez que tus eventos esten activos, verificalos en el DebugView de GA4. Recorre tu tienda como lo haria un cliente: aterriza en una pagina de producto, agrega al carrito y completa la compra. Confirma que cada evento aparece en DebugView con todos los parametros requeridos.\n\nFinalmente, conecta Google Search Console a tu propiedad de GA4. Esta integracion muestra las consultas de busqueda organica junto con tus datos de engagement de GA4. Navega a Admin, luego Enlaces de productos, luego Enlaces de Search Console para configurarlo.",
          items: [
            "Verifica que todos los eventos de ecommerce se activen con parametros completos a nivel de articulo",
        ...
        },
        {
          ...
          content:
            "El umbral de datos es el problema de GA4 mas frustrante para los equipos de SEO de ecommerce. Cuando tus segmentos tienen muestras pequenas, GA4 aplica umbrales y oculta filas de datos para proteger la privacidad del usuario. Esto sucede frecuentemente cuando filtras trafico organico por paginas de destino especificas. La solucion es usar periodos mas largos, segmentos mas amplios o exportaciones a BigQuery.\n\nOtro problema comun es el spam de referral y el trafico de bots que inflan los numeros organicos. GA4 tiene filtrado de bots integrado, pero no detecta muchos visitantes automatizados. Revisa tu trafico organico en busca de conteos de sesiones sospechosamente altos desde paginas individuales con 0% de tasa de engagement.\n\nEl etiquetado UTM descuidado en enlaces internos tambien corrompe la atribucion organica. Si tus enlaces de email marketing o enlaces de banners internos usan parametros UTM, sobreescriben la fuente de trafico original. Audita tu sitio en busca de enlaces internos que contengan parametros UTM y eliminalos.\n\nFinalmente, vigila las discrepancias de datos entre GA4 y Search Console. GSC cuenta clics a tu sitio mientras GA4 cuenta sesiones. Estos numeros nunca coincidiran exactamente. Una brecha del 10-15% entre clics de GSC y sesiones organicas de GA4 es normal. Si supera el 20%, investiga si tu codigo de seguimiento de GA4 se activa correctamente en todas las plantillas de pagina.",
        },
      ],
      navLabels: {
        previous: "Anterior",
    ...
    it: {
      ...
      intro:
        "Google Analytics 4 ha cambiato il modo in cui gli store e-commerce misurano le performance della ricerca organica. Il modello di dati basato sugli eventi offre una visibilita granulare su come i visitatori organici interagiscono con le pagine prodotto, aggiungono articoli al carrello e completano gli acquisti. Padroneggiare i report e-commerce e gli strumenti di esplorazione di GA4 ti permette di collegare ogni azione SEO direttamente al fatturato.",
