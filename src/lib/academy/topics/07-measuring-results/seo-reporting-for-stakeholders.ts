...
export const seoReportingForStakeholders: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro:
        "La plupart des rapports SEO echouent parce qu'ils parlent le langage des specialistes du search marketing plutot que celui des dirigeants. Les cadres s'interessent au chiffre d'affaires, aux parts de marche et au positionnement concurrentiel, pas aux nombres de mots-cles ou aux erreurs de crawl. Creer des rapports SEO adaptes aux parties prenantes signifie traduire les donnees techniques de recherche en resultats commerciaux qui favorisent l'investissement continu dans la croissance organique.",
      readTime: "11 min de lecture",
      sections: [
        {
          title: "Comprendre ce dont les parties prenantes ont reellement besoin",
          content:
            "La premiere erreur des professionnels SEO est de presenter des rapports remplis de metriques qui n'interessent que d'autres praticiens SEO. Les classements, impressions et statistiques de crawl sont des metriques operationnelles. Ils montrent si votre moteur SEO fonctionne, mais ne disent pas a un directeur financier si ce moteur genere du profit. Les parties prenantes doivent comprendre trois choses : combien de revenus le SEO genere, comment cela se compare aux autres canaux, et si la tendance est a la hausse ou a la baisse.\n\nDifferentes parties prenantes ont besoin de vues differentes des memes donnees. Un PDG veut un resume d'une page montrant la croissance du chiffre d'affaires organique, les gains de parts de marche et le positionnement concurrentiel. Un VP Marketing veut voir comment la recherche organique se compare aux canaux payants en termes de cout d'acquisition client et de valeur vie client.\n\nAvant de construire un rapport, interrogez vos parties prenantes. Demandez-leur quelles decisions elles prennent sur la base des donnees marketing. Demandez quelles questions elles apportent aux revues trimestrielles. Leurs reponses faconneront la structure de votre rapport bien plus efficacement que n'importe quel modele trouve en ligne.\n\nLes meilleurs rapports SEO e-commerce connectent la visibilite de recherche au catalogue produits. Au lieu de rapporter que vous vous classez pour 500 mots-cles supplementaires ce trimestre, rapportez que 85% de votre catalogue produits actif apparait desormais dans le top 20 de Google, contre 72% au trimestre precedent.",
          items: [
            ...
            "Interrogez les parties prenantes pour savoir quelles decisions elles tirent des donnees marketing",
            "Formulez les progres SEO en termes de visibilite du catalogue et de couverture de marche",
          ],
        },
        {
        ...
        },
        {
          ...
          content:
            "La visualisation des donnees separe les rapports efficaces des oubliables. Le cerveau humain traite les informations visuelles 60 000 fois plus vite que le texte, donc la facon dont vous presentez les donnees compte autant que les donnees elles-memes. Pour le reporting SEO e-commerce, choisissez des types de graphiques qui mettent en valeur les tendances, proportions et comparaisons.\n\nUtilisez des graphiques en courbes pour toute metrique suivie dans le temps, y compris le chiffre d'affaires organique, le trafic et les taux de conversion. Montrez toujours au moins douze mois de donnees et ajoutez une ligne de tendance.\n\nUtilisez des graphiques a barres empilees pour montrer la contribution du chiffre d'affaires organique par categorie de produits. Cette visualisation communique instantanement quelles categories generent le plus de revenus organiques et comment ce mix evolue dans le temps.\n\nLes camemberts fonctionnent pour montrer le mix de canaux a un moment donne. Cependant, ne les utilisez jamais pour des comparaisons sur plusieurs periodes. Utilisez plutot des graphiques a barres groupees.\n\nLes nuages de points sont excellents pour montrer la relation entre l'investissement SEO et les resultats au niveau de la page ou de la categorie. Tracez chaque categorie de produits avec les heures d'optimisation sur l'axe X et le changement de chiffre d'affaires organique sur l'axe Y.",
    ...
    es: {
      ...
      intro:
        "La mayoria de los reportes SEO fallan porque hablan el lenguaje de los especialistas en marketing de busqueda en lugar del lenguaje de los lideres empresariales. Los ejecutivos se preocupan por los ingresos, la cuota de mercado y el posicionamiento competitivo, no por conteos de palabras clave o errores de rastreo. Crear reportes SEO listos para stakeholders significa traducir datos tecnicos de busqueda en resultados de negocio que impulsen la inversion continua en crecimiento organico.",
      readTime: "11 min de lectura",
      sections: [
        {
          title: "Entender lo que los stakeholders realmente necesitan",
          content:
            "El primer error que cometen los profesionales SEO es presentar reportes llenos de metricas que solo importan a otros practicantes de SEO. Rankings, impresiones y estadisticas de rastreo son metricas operativas. Indican si tu motor SEO esta funcionando, pero no le dicen a un director financiero si ese motor esta generando ganancias. Los stakeholders necesitan entender tres cosas: cuantos ingresos genera el SEO, como se compara con otros canales, y si la tendencia va al alza o a la baja.\n\nDiferentes stakeholders necesitan diferentes vistas de los mismos datos. Un CEO quiere un resumen de una pagina mostrando crecimiento de ingresos organicos, ganancias de cuota de mercado y posicionamiento competitivo. Un VP de Marketing quiere ver como la busqueda organica se compara con canales pagados en terminos de costo de adquisicion de clientes y valor de vida del cliente.\n\nAntes de construir cualquier reporte, entrevista a tus stakeholders. Preguntales que decisiones toman basandose en datos de marketing. Pregunta que preguntas llevan a las revisiones trimestriales de negocio. Sus respuestas moldaran la estructura de tu reporte mucho mas efectivamente que cualquier plantilla que encuentres en linea.\n\nLos mejores reportes SEO de ecommerce conectan la visibilidad de busqueda con el catalogo de productos. En lugar de reportar que rankeas para 500 palabras clave mas este trimestre, reporta que el 85% de tu catalogo de productos activo ahora aparece en el top 20 de Google, subiendo del 72% del trimestre anterior.",
          items: [
            "Lidera con ingresos y resultados de negocio, no con metricas tecnicas de SEO",
            ...
            "Enmarca el progreso SEO en terminos de visibilidad del catalogo y cobertura de mercado",
          ],
        },
        {
        ...
        },
        {
          ...
          content:
            "Los ingresos organicos son la metrica mas importante para el reporting SEO de ecommerce. Extraelos de GA4 usando un segmento de trafico organico correctamente configurado con atribucion basada en datos. Reportalo como total, como porcentaje de los ingresos generales y con tasa de crecimiento interanual. Estas tres vistas dan a los stakeholders volumen, participacion y trayectoria.\n\nLa tasa de conversion organica muestra la calidad del trafico. Si el trafico organico crece pero la tasa de conversion cae, puedes estar atrayendo visitantes equivocados o tus paginas de destino necesitan optimizacion. Reporta esta metrica junto a la tasa de conversion general del sitio.\n\nEl trafico organico sin marca aisla el verdadero crecimiento SEO de las busquedas impulsadas por la marca. Un aumento del 30% en trafico organico significa poco si el 25% de ese aumento proviene de consultas de marca impulsadas por una nueva campana de TV.\n\nLa tasa de indexacion de paginas de producto muestra que porcentaje de tu catalogo de productos ha indexado Google y esta sirviendo en resultados de busqueda. Para grandes tiendas ecommerce con miles de SKUs, lograr que cada pagina de producto sea indexada es un desafio fundamental.\n\nEl valor promedio de pedido del trafico organico comparado con otros canales revela si el SEO esta generando compras de alto o bajo valor.",
          items: [
            "Total de ingresos organicos, porcentaje de ingresos generales y crecimiento interanual",
            "Crecimiento del trafico organico sin marca como la medida mas pura de expansion SEO",
            "Tasa de indexacion de paginas de producto relativa al tamano total del catalogo activo",
        ...
        },
        {
          ...
          content:
            "La visualizacion de datos separa los reportes efectivos de los olvidables. El cerebro humano procesa informacion visual 60,000 veces mas rapido que texto, asi que como presentas los datos importa tanto como que datos presentas. Para reporting SEO de ecommerce, elige tipos de graficos que enfaticen tendencias, proporciones y comparaciones.\n\nUsa graficos de lineas para cualquier metrica rastreada en el tiempo, incluyendo ingresos organicos, trafico y tasas de conversion. Siempre muestra al menos doce meses de datos y agrega una linea de tendencia.\n\nUsa graficos de barras apiladas para mostrar la contribucion de ingresos organicos por categoria de producto. Esta visualizacion comunica instantaneamente cuales categorias generan mas ingresos organicos y como esa mezcla esta cambiando.\n\nLos graficos circulares funcionan para mostrar la mezcla de canales en un punto unico en el tiempo. Sin embargo, nunca uses graficos circulares para comparaciones entre periodos de tiempo. Usa graficos de barras agrupadas en su lugar.\n\nLos diagramas de dispersion son excelentes para mostrar la relacion entre inversion SEO y resultados a nivel de pagina o categoria. Grafica cada categoria de producto con horas de optimizacion en el eje X y cambio de ingresos organicos en el eje Y.",
          tip: "Usa colores consistentes en todos los reportes. Asigna a la busqueda organica un unico color, como verde, y usalo en cada grafico y cada reporte. Con el tiempo, los stakeholders asociaran instantaneamente ese color con el rendimiento organico sin leer la leyenda.",
        },
        {
          title: "Cadencia de reportes y automatizacion",
          content:
            "Los reportes mensuales son la cadencia estandar para SEO de ecommerce. El reporting semanal crea ruido porque la busqueda organica cambia gradualmente y las fluctuaciones diarias en rankings y trafico no son accionables a nivel estrategico. Los reportes trimestrales funcionan para resumenes ejecutivos pero son demasiado infrecuentes para equipos operativos.\n\nAutomatiza tanto de la recoleccion de datos como sea posible. Usa Looker Studio para construir dashboards en vivo que extraigan de GA4, Google Search Console y herramientas SEO de terceros via conectores API.\n\nSin embargo, no dependas solo de dashboards automatizados. La parte mas valiosa de un reporte SEO es el analisis e interpretacion que un humano proporciona. Un dashboard puede mostrar que el trafico organico cayo 15% el mes pasado, pero solo un analista puede explicar que la caida fue causada por una actualizacion del algoritmo de Google.\n\nCrea una plantilla de reporte que incluya secciones de datos automatizadas y secciones de analisis manual. Las secciones de datos extraen directamente de tus dashboards. Las secciones de analisis contienen tu interpretacion de lo que paso, por que importa y que acciones deben seguir.\n\nConfigura alertas automatizadas para cambios significativos. Configura insights personalizados de GA4 para notificarte cuando el trafico organico baje o suba mas alla de un umbral que definas.",
          items: [
            ...
            "Siempre incluye analisis escrito por humanos junto a visualizaciones de datos automatizadas",
            "Configura alertas de GA4 Custom Insights para anomalias significativas de trafico organico",
          ],
        },
        {
          title: "Manejar resultados negativos y establecer expectativas",
          content:
            "Todo programa SEO experimentara periodos de declive. Actualizaciones de algoritmos, competencia incrementada, patrones estacionales y problemas tecnicos pueden causar que el trafico y los ingresos organicos caigan. Como reportas estos declives determina si los stakeholders mantienen confianza en tu programa SEO o empiezan a cuestionar su valor.\n\nNunca ocultes resultados negativos. Los stakeholders que descubren malas noticias por si mismos pierden confianza en el proceso de reporting. En su lugar, lidera con la mala noticia, explica la causa y presenta tu plan de respuesta.\n\nEstablece expectativas proactivamente educando a los stakeholders sobre la naturaleza de la busqueda organica. El SEO no es un canal de crecimiento lineal. Los resultados se componen con el tiempo pero estan sujetos a disrupciones periodicas por cambios de algoritmo. Explica el cronograma tipico de inversion SEO: trabajo de fundacion tecnica en meses uno a tres, construccion de contenido y autoridad en meses tres a seis, e impacto medible en ingresos desde el mes seis en adelante.\n\nProporciona contexto competitivo al reportar declives. Si tu trafico organico cayo 10% pero tus tres competidores mas cercanos cayeron 15-20%, tu posicion relativa realmente mejoro.\n\nFinalmente, mantén un registro de todas las acciones SEO tomadas, actualizaciones de algoritmos observadas y cambios de negocio. Este registro historico es invaluable cuando los stakeholders preguntan por que el rendimiento cambio durante un periodo especifico.",
          tip: "Crea un documento de linea temporal simple que registre cada actualizacion de algoritmo, cada cambio SEO importante que implementes y cada evento de negocio significativo. Cuando un stakeholder pregunte por que el trafico cambio hace seis meses, este registro te permite responder con precision en lugar de suposiciones.",
        },
      ],
      navLabels: {
        previous: "Anterior",
