...
export const categoryPageSeo: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro: "Les pages cat\u00c3\u00a9gories sont les piliers du SEO ecommerce. Elles ciblent les requetes de recherche en milieu de tunnel ou les acheteurs savent quel type de produit ils veulent mais n'ont pas encore choisi un article sp\u00c3\u00a9cifique. Une recherche pour \"chaussures de course femme\" ou \"croquettes bio pour chien\" atterrit sur une page cat\u00e9gorie, pas sur une page produit. Bien optimiser les pages cat\u00e9gories signifie capter des milliers de recherches a forte intention qui alimentent directement votre catalogue produit. R\u00c3\u00a9ussir l'[optimisation des pages cat\u00c3\u00a9gories](/blog/ecommerce-category-page-seo) signifie capturer des milliers de recherches \u00c3\u00a0 forte intention qui alimentent directement votre catalogue produit.",
      readTime: "10 min de lecture",
      sections: [
        {
          title: "Pourquoi les pages catégories comptent plus que vous ne le pensez",
          content:
            "La plupart des proprietaires de boutiques concentrent leur energie SEO sur les pages produits et ignorent compl\u00e8tement les pages cat\u00e9gories. C'est une erreur. Les pages cat\u00e9gories ciblent des mots-cl\u00e9s plus larges avec un volume de recherche plus eleve que n'importe quelle page produit individuelle. Une seule page cat\u00e9gorie bien optimisee pour \"portefeuilles en cuir\" peut generer plus de trafic organique que cinquante pages produits individuelles combinees, car le mot-cl\u00e9 de cat\u00e9gorie capture l'ensemble de l'audience de navigation.\n\nLes pages cat\u00e9gories servent egalement de hub principal dans l'architecture de votre site. Elles transmettent l'equite de lien a chaque produit liste en dessous, et elles recoivent des [liens internes](/academy/internal-linking-for-stores) de votre navigation, du pied de page et des fils d'Ariane. Une page cat\u00e9gorie faible cree un goulot d'etranglement qui limite le potentiel de classement de chaque produit en dessous. Renforcer vos pages cat\u00e9gories a un effet multiplicateur sur l'ensemble de votre catalogue.\n\nDu point de vue de l'exp\u00e9rience utilisateur, les pages cat\u00e9gories definissent les attentes. Un acheteur arrivant de Google s'attend a voir une s\u00e9lection organisee de produits pertinents avec des options de filtrage claires. S'il atterrit sur une page mince sans contexte, avec un tri mediocre ou des produits non pertinents melanges, il retournera aux resultats de recherche en quelques secondes.",
        },
        {
          title: "Créer du contenu de page catégorie qui se positionne",
          content:
            "Le plus grand defi du SEO des pages cat\u00e9gories est d'ajouter suffisamment de contenu textuel pour se positionner sans enterrer la grille de produits que les acheteurs sont venus parcourir. La solution est le placement strategique : mettez un paragraphe d'introduction concis (80-150 mots) au-dessus de la grille de produits et un bloc de contenu plus detaille (300-500 mots) en dessous. Cette disposition satisfait le besoin de pertinence thematique de Google tout en gardant l'exp\u00e9rience d'achat au premier plan.\n\nLe paragraphe d'introduction au-dessus de la grille de produits doit repondre a la question implicite du chercheur : \"Suis-je au bon endroit ?\" Pour une cat\u00e9gorie ciblant \"chaussures de randonnee homme\", l'introduction pourrait couvrir ce qui fait une bonne chaussure de randonnee, les types disponibles dans cette collection et les marques ou caracteristiques remarquables.\n\nLe bloc de contenu sous la grille de produits est l'endroit ou vous pouvez developper les guides d'achat, les points de comparaison et les mots-cl\u00e9s secondaires. Couvrez des sujets comme les conseils de taille, les comparaisons de materiaux, les instructions d'entretien ou les recommandations saisonni\u00e8res.\n\nEvitez le piege d'ecrire le meme style de contenu sur toutes les cat\u00e9gories. Votre cat\u00e9gorie \"manteaux d'hiver\" devrait se lire diff\u00e9remment de votre cat\u00e9gorie \"robes d'ete\". Adaptez les conseils, le langage et les r\u00e9f\u00e9rences saisonni\u00e8res a chaque type de produit sp\u00e9cifique. Vous pouvez \u00c3\u00a9galement ajouter une [section FAQ](/academy/faq-pages-for-ecommerce) pour r\u00c3\u00a9pondre aux questions courantes des acheteurs directement sur la page cat\u00c3\u00a9gorie.",
          items: [
            ...
            "Adapter le contenu a chaque cat\u00e9gorie sp\u00e9cifique au lieu d'utiliser du remplissage generique",
            "Inclure des guides d'achat, des comparaisons et des conseils de taille ou pertinents",
            "Incorporer naturellement les mots-cl\u00e9s primaires et secondaires dans tout le texte",
          ],
          tip: "V\u00e9rifiez les pages cat\u00e9gories de vos concurrents pour les mots-cl\u00e9s que vous ciblez. S'ils ont 400 mots de contenu utile et vous zero, cet ecart de contenu seul peut expliquer la difference de classement. Egalez ou depassez leur profondeur tout en rendant votre contenu plus pratique et sp\u00e9cifique.",
          image: {
        ...
        },
        {
          ...
          content:
            "Les balises title des pages cat\u00e9gories suivent une formule differente de celles des pages produits. La structure la plus efficace est : Nom de la Cat\u00e9gorie + Qualificatif + Nom de la Boutique. Des qualificatifs comme \"Acheter\", \"Top\", \"Meilleurs\" ou l'ann\u00e9e en cours aident a correspondre a l'intention de recherche commerciale.\n\nPour les pages de sous-categories, incluez la cat\u00e9gorie parente pour fournir du contexte : \"Chaussures Trail - Running Homme | SportHub\" indique a Google exactement ou cette page se situe dans votre hierarchie. Cette approche previent aussi la cannibalisation entre votre cat\u00e9gorie principale et les pages de sous-categories.\n\nLes meta descriptions des pages cat\u00e9gories devraient se concentrer sur l'etendue et la qualit\u00e9 de votre s\u00e9lection. Mentionnez le nombre de produits disponibles, les marques cl\u00e9s, les fourchettes de prix ou les arguments de vente uniques comme la livraison gratuite ou les avis d'experts.\n\nEvitez d'utiliser le meme mod\u00e8le de meta description sur toutes les cat\u00e9gories en changeant simplement le nom de la cat\u00e9gorie. Google peut detecter les mod\u00e8les paresseux et peut choisir d'ignorer compl\u00e8tement votre meta description, generant son propre extrait a partir du contenu de la page.",
        },
        {
          title: "Navigation a facettes et structure d'URL",
          content:
            "La navigation a facettes, ces options de filtre pour la taille, la couleur, la gamme de prix et la marque sur vos pages cat\u00e9gories, cree l'un des defis SEO techniques les plus delicats du ecommerce. Chaque combinaison de filtres peut generer une URL unique, ce qui signifie qu'une seule cat\u00e9gorie avec 5 tailles, 8 couleurs et 10 marques pourrait produire des milliers de pages indexables. Sans traitement adequat, cette inflation de crawl gaspille votre budget de crawl et dilue l'autorite de votre page cat\u00e9gorie.\n\nL'approche standard consiste a garder vos URLs de cat\u00e9gories principales et de sous-categories cl\u00e9s indexables tout en empechant les variations filtrees d'etre crawlees et indexees. Utilisez des balises canoniques sur les pages filtrees pointant vers l'URL de la cat\u00e9gorie principale.\n\nCertaines combinaisons de filtres meritent leurs propres pages indexables si elles correspondent a des requetes de recherche a haut volume. Si \"bottes cuir noir\" obtient un volume de recherche significatif, cr\u00e9er une page de sous-categorie dediee a \"/bottes/cuir-noir\" vaut plus qu'une URL filtree.\n\nGardez votre structure d'URL de cat\u00e9gorie peu profonde et lisible. \"/femme/chaussures/course\" est meilleur que \"/catalogue/cat\u00e9gorie/sous-categorie/12345.\"\" Recherchez quelles combinaisons de filtres les gens recherchent r\u00c3\u00a9ellement en utilisant une approche solide de [mapping de mots-cl\u00c3\u00a9s](/academy/keyword-mapping-for-stores), puis cr\u00c3\u00a9ez des pages de sous-cat\u00c3\u00a9gories permanentes pour ces termes.",
          items: [
            "Canoniser les URLs filtrees vers la page cat\u00e9gorie principale",
            "Bloquer le crawl des combinaisons de filtres a faible valeur via robots.txt ou nofollow",
            "Cr\u00e9er des pages de sous-categories dediees pour les combinaisons de filtres avec un vrai volume de recherche",
        ...
        },
        {
          ...
          content:
            "La grille de produits elle-meme porte un poids SEO que beaucoup de proprietaires de boutiques negligent. Chaque vignette de produit, nom de produit et prix affiche dans la grille est du contenu que Google lit et utilise pour comprendre la page. Si votre grille montre 12 produits avec des noms comme \"SKU-8842\", vous gaspillez une opportunite de renforcer la pertinence des mots-cl\u00e9s.\n\nLa strat\u00e9gie de pagination est importante pour le SEO. Si votre cat\u00e9gorie a 200 produits repartis sur 10 pages, Google a besoin d'un chemin clair pour les decouvrir tous. Implementez une pagination correcte avec des liens rel=\"next\" et rel=\"prev\", ou utilisez un bouton \"Charger plus\".\n\nLe nombre de produits par page affecte a la fois le SEO et la conversion. Trop peu de produits (8-12) forcent une pagination excessive qui dilue l'autorite de la page. Trop (100+) ralentissent les temps de chargement. Nous avons constate que 24-48 produits par page est le point ideal pour la plupart des cat\u00e9gories.\n\nL'ordre de tri par defaut influence quels produits Google voit en premier lors du crawl. Si votre tri par defaut est \"les plus recents\" mais que vos produits les plus vendus sont enterres en page 5, Google pourrait associer votre cat\u00e9gorie a des produits plus recents et moins eprouves.",
          tip: "Ajoutez un petit extrait de texte unique a chaque carte produit dans la grille, meme juste la premi\u00e8re ligne de la description du produit. Cela donne a Google plus de contenu a indexer depuis chaque vue de page cat\u00e9gorie.",
        },
        {
          title: "Liens internes depuis les pages catégories",
          content:
            "Les pages cat\u00e9gories sont des hubs naturels de liens internes. Chaque produit liste dans la grille est un lien interne, mais le veritable levier SEO vient des liens contextuels supplementaires dans le contenu de la cat\u00e9gorie. Liez depuis votre introduction ou le contenu en bas de page vers des cat\u00e9gories associees, des guides d'achat ou des produits mis en avant.\n\nLa navigation par fil d'Ariane sur les pages cat\u00e9gories sert un double objectif : elle aide les acheteurs a remonter dans la hierarchie, et elle transmet l'equite de lien de la page cat\u00e9gorie aux cat\u00e9gories parentes et a la page d'accueil. Assurez-vous que vos fils d'Ariane utilisent le balisage schema.\n\nLes liens croises entre cat\u00e9gories associees sont sous-utilises par la plupart des boutiques. Si quelqu'un parcourt \"moulins a cafe\", il pourrait aussi etre int\u00e9ress\u00e9 par \"cafetieres\" ou \"cafe en grains\". Ajouter une section \"Cat\u00e9gories associees\" cree des chemins de liaison horizontaux.\n\nNe liez pas vers toutes les cat\u00e9gories associees depuis chaque page. Soyez selectif et pertinent. Trop de liens internes sur une seule page diluent la valeur de chaque lien. Concentrez-vous sur les 3-5 cat\u00e9gories les plus etroitement liees.",
        },
      ],
      navLabels: {
    ...
    es: {
      ...
      intro: "Las p\u00c3\u00a1ginas de categor\u00c3\u00ada son los caballos de batalla del SEO para ecommerce. Apuntan a consultas de busqueda de mitad de embudo donde los compradores saben que tipo de producto quieren pero aun no se han decidido por un art\u00c3\u00adculo especifico. Una busqueda de \"zapatillas de running mujer\" o \"comida organica para perros\" llega a una p\u00e1gina de categor\u00eda, no a una p\u00e1gina de producto. Optimizar correctamente las p\u00e1ginas de categor\u00eda significa capturar miles de busquedas con alta intenci\u00f3n que alimentan directamente tu cat\u00e1logo de productos. Lograr una correcta [optimizaci\u00f3n de p\u00e1ginas de categor\u00eda](/blog/ecommerce-category-page-seo) significa capturar miles de busquedas de alta intenci\u00f3n que canalizan directamente hacia tu cat\u00e1logo de productos.",
      readTime: "10 min de lectura",
      sections: [
        {
          title: "Por qué las páginas de categoría importan más de lo que piensas",
          content:
            "La mayoria de los duenos de tiendas concentran su energ\u00eda SEO en las p\u00e1ginas de producto e ignoran completamente las p\u00e1ginas de categor\u00eda. Eso es un error. Las p\u00e1ginas de categor\u00eda apuntan a palabras clave m\u00e1s amplias con mayor volumen de busqueda que cualquier p\u00e1gina de producto individual. Una sola p\u00e1gina de categor\u00eda bien optimizada para \"carteras de cuero\" puede generar m\u00e1s tr\u00e1fico organico que cincuenta p\u00e1ginas de producto individuales combinadas, porque la palabra clave de categor\u00eda captura toda la audiencia de navegaci\u00f3n.\n\nLas p\u00e1ginas de categor\u00eda tambi\u00e9n sirven como el hub principal en la arquitectura de tu sitio. Pasan autoridad de enlace hacia cada producto listado debajo, y reciben [enlaces internos](/academy/internal-linking-for-stores) desde tu navegaci\u00f3n, pie de p\u00e1gina y rutas de migas de pan. Una p\u00e1gina de categor\u00eda debil crea un cuello de botella que limita el potencial de ranking de cada producto debajo. Fortalecer tus p\u00e1ginas de categor\u00eda tiene un efecto multiplicador en todo tu cat\u00e1logo.\n\nDesde el punto de vista de la experiencia del usuario, las p\u00e1ginas de categor\u00eda establecen expectativas. Un comprador que llega desde Google espera ver una selecci\u00f3n curada de productos relevantes con opciones de filtrado claras. Si aterriza en una p\u00e1gina delgada sin contexto, mala clasificacion o productos irrelevantes mezclados, rebotara de vuelta a los resultados de busqueda en segundos.",
        },
        {
          title: "Crear contenido de página de categoría que posicione",
          content:
            "El mayor desafio con el SEO de p\u00e1ginas de categor\u00eda es agregar suficiente contenido de texto para posicionar sin enterrar la cuadricula de productos que los compradores vinieron a explorar. La solucion es la colocacion estrategica: pon un parrafo introductorio conciso (80-150 palabras) sobre la cuadricula de productos y un bloque de contenido m\u00e1s detallado (300-500 palabras) debajo. Este diseno satisface la necesidad de relevancia tem\u00e1tica de Google mientras mantiene la experiencia de compra en primer plano.\n\nEl parrafo introductorio sobre la cuadricula de productos debe responder la pregunta implicita del buscador: \"Estoy en el lugar correcto?\" Para una categor\u00eda que apunta a \"botas de senderismo para hombre\", la introducci\u00f3n podria cubrir que hace una buena bota de senderismo, los tipos disponibles en esta coleccion y las marcas o caracteristicas destacadas.\n\nEl bloque de contenido debajo de la cuadricula de productos es donde puedes expandir sobre guias de compra, puntos de comparacion y palabras clave secundarias. Cubre temas como consejos de talla, comparaciones de materiales, instrucciones de cuidado o recomendaciones estacionales.\n\nEvita la trampa de escribir el mismo estilo de contenido en todas las categor\u00edas. Tu categor\u00eda \"abrigos de invierno\" debe leerse diferente a tu categor\u00eda \"vestidos de verano\". Adapta los consejos, el lenguaje y las referencias estacionales a cada tipo de producto especifico. Tambi\u00e9n puedes agregar una [seccion de FAQ](/academy/faq-pages-for-ecommerce) para abordar preguntas comunes de compradores directamente en la p\u00e1gina de categor\u00eda.",
          items: [
            ...
            "Adaptar el contenido a cada categor\u00eda especifica en lugar de usar relleno generico",
        ...
        },
        {
          ...
          content:
            "Las etiquetas de t\u00edtulo de p\u00e1ginas de categor\u00eda siguen una formula diferente a las p\u00e1ginas de producto. La estructura m\u00e1s efectiva es: Nombre de la Categor\u00eda + Calificador + Nombre de la Tienda. Calificadores como \"Comprar\", \"Mejores\" o el a\u00c3\u00b1o actual ayudan a coincidir con la intenci\u00f3n de busqueda comercial.\n\nPara p\u00e1ginas de subcategoria, incluye la categor\u00eda padre para proporcionar contexto: \"Zapatillas Trail Running - Running Hombre | SportHub\" le dice a Google exactamente donde esta esta p\u00e1gina en tu jerarquia. Este enfoque tambi\u00e9n previene la canibalizaci\u00f3n entre tu categor\u00eda principal y las p\u00e1ginas de subcategoria.\n\nLas meta descripciones para p\u00e1ginas de categor\u00eda deben enfocarse en la amplitud y calidad de tu selecci\u00f3n. Menciona el n\u00famero de productos disponibles, marcas clave, rangos de precio o puntos de venta unicos como env\u00edo gratuito o resenas de expertos.\n\nEvita usar la misma plantilla de meta descripcion en todas las categor\u00edas solo cambiando el nombre de la categor\u00eda. Google puede detectar plantillas perezosas y puede elegir ignorar tu meta descripcion por completo, generando su propio fragmento del contenido de la p\u00e1gina.",
        },
        {
          title: "Navegación facetada y estructura de URL",
          content:
            "La navegaci\u00f3n facetada, esas opciones de filtro por talla, color, rango de precio y marca en tus p\u00e1ginas de categor\u00eda, crea uno de los desafios t\u00e9cnicos SEO m\u00e1s complicados en ecommerce. Cada combinacion de filtros puede generar una URL unica, lo que significa que una sola categor\u00eda con 5 tallas, 8 colores y 10 marcas podria producir miles de p\u00e1ginas indexables. Sin un manejo adecuado, esta inflaci\u00f3n de crawl desperdicia tu presupuesto de rastreo y diluye la autoridad de tu p\u00e1gina de categor\u00eda.\n\nEl enfoque est\u00e1ndar es mantener tus URLs de categor\u00edas principales y subcategorias clave indexables mientras bloqueas las variaciones filtradas de ser rastreadas e indexadas. Usa etiquetas canonicas en las p\u00e1ginas filtradas apuntando a la URL de la categor\u00eda principal.\n\nAlgunas combinaciones de filtros merecen sus propias p\u00e1ginas indexables si coinciden con consultas de busqueda de alto volumen. Si \"botas cuero negro\" tiene un volumen de busqueda significativo, crear una p\u00e1gina de subcategoria dedicada vale m\u00e1s que una URL filtrada.\n\nManten tu estructura de URL de categor\u00eda poco profunda y legible. \"/mujer/zapatos/running\" es mejor que \"/cat\u00e1logo/categor\u00eda/subcategoria/12345.\" Investiga que combinaciones de filtros la gente realmente busca usando un solido enfoque de [mapeo de palabras clave](/academy/keyword-mapping-for-stores), luego construye p\u00e1ginas de subcategoria permanentes para esos terminos.",
          items: [
            "Canonizar URLs filtradas hacia la p\u00e1gina de categor\u00eda principal",
            "Bloquear el rastreo de combinaciones de filtros de bajo valor via robots.txt o nofollow",
            "Crear p\u00e1ginas de subcategoria dedicadas para combinaciones de filtros con volumen de busqueda real",
        ...
        },
        {
          ...
          content:
            "La cuadricula de productos en si tiene peso SEO que muchos duenos de tiendas pasan por alto. Cada miniatura de producto, nombre de producto y precio mostrado en la cuadricula es contenido que Google lee y usa para entender la p\u00e1gina. Si tu cuadricula muestra 12 productos con nombres como \"SKU-8842\", estas desperdiciando una oportunidad de reforzar la relevancia de palabras clave.\n\nLa estrategia de paginacion importa para el SEO. Si tu categor\u00eda tiene 200 productos distribuidos en 10 p\u00e1ginas, Google necesita un camino claro para descubrirlos todos. Implementa una paginacion adecuada con enlaces rel=\"next\" y rel=\"prev\", o usa un bot\u00f3n \"Cargar m\u00e1s\".\n\nLa cantidad de productos por p\u00e1gina afecta tanto el SEO como la conversion. Muy pocos productos (8-12) fuerzan una paginacion excesiva que diluye la autoridad de la p\u00e1gina. Demasiados (100+) ralentizan los tiempos de carga. Hemos encontrado que 24-48 productos por p\u00e1gina alcanza el punto optimo para la mayoria de las categor\u00edas.\n\nEl orden de clasificacion predeterminado influye en que productos ve Google primero al rastrear. Si tu clasificacion predeterminada es \"m\u00e1s recientes\" pero tus productos m\u00e1s vendidos estan enterrados en la p\u00e1gina 5, Google podria asociar tu categor\u00eda con productos m\u00e1s nuevos y menos probados.",
          tip: "Agrega un pequeno fragmento de texto unico a cada tarjeta de producto en la cuadricula, incluso solo la primera l\u00ednea de la descripcion del producto. Esto le da a Google m\u00e1s contenido para indexar desde cada vista de p\u00e1gina de categor\u00eda.",
        },
        {
          title: "Enlaces internos desde páginas de categoría",
          content:
            "Las p\u00e1ginas de categor\u00eda son hubs naturales de enlaces internos. Cada producto listado en la cuadricula es un enlace interno, pero el verdadero apalancamiento SEO viene de enlaces contextuales adicionales dentro del contenido de la categor\u00eda. Enlaza desde tu introducci\u00f3n o contenido al final de la p\u00e1gina hacia categor\u00edas relacionadas, guias de compra o productos destacados.\n\nLa navegaci\u00f3n de migas de pan en p\u00e1ginas de categor\u00eda sirve un doble proposito: ayuda a los compradores a navegar hacia arriba en la jerarquia, y pasa autoridad de enlace de la p\u00e1gina de categor\u00eda a las categor\u00edas padre y la p\u00e1gina de inicio. Asegurate de que tus migas de pan usen marcado schema.\n\nLos enlaces cruzados entre categor\u00edas relacionadas son subutilizados por la mayoria de las tiendas. Si alguien esta navegando \"molinos de cafe\", tambi\u00e9n podria estar interesado en \"cafeteras\" o \"cafe en grano\". Agregar una seccion de \"Categor\u00edas Relacionadas\" crea rutas de enlaces horizontales.\n\nNo enlaces hacia todas las categor\u00edas relacionadas desde cada p\u00e1gina. Se selectivo y relevante. Demasiados enlaces internos en una sola p\u00e1gina diluyen el valor de cada enlace. Enfocate en las 3-5 categor\u00edas m\u00e1s estrechamente relacionadas.",
        },
      ],
      navLabels: {
        previous: "SEO de p\u00e1ginas de producto",
        next: "SEO de p\u00e1gina de inicio para ecommerce",
      },
    },
    it: {
      badge: "SEO On-Page",
