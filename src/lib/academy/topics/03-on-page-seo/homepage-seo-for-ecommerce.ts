...
export const homepageSeoForEcommerce: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "Votre menu de navigation principal est sans doute l'\u00e9l\u00e9ment de liens internes le plus puissant de votre site car il apparait sur chaque page. Les cat\u00e9gories que vous incluez dans la navigation principale recoivent l'equite de liens de chaque page indexee de votre domaine. Choisissez-les soigneusement, votre navigation principale devrait presenter vos cat\u00e9gories les plus precieuses, pas des pages utilitaires comme \"A propos\" ou \"Contact.\"\n\nLimitez votre navigation principale a 7-10 \u00e9l\u00e9ments de premier niveau. Les mega-menus avec des dizaines de liens diluent l'equite transmise a chaque page liee et peuvent submerger utilisateurs et moteurs de recherche.\n\nLes liens internes sp\u00e9cifiques a la page d'accueil, ceux en dehors de la navigation principale, sont l'endroit ou vous pouvez etre strategique dans la direction de l'autorite. Liez vers des collections saisonni\u00e8res, les nouveautes ou les cat\u00e9gories pour lesquelles vous essayez activement de vous positionner.\n\nN'oubliez pas les liens du pied de page. Bien qu'ils portent moins de poids que les liens de navigation principale, les liens du footer sont un bon endroit pour votre liste complete de cat\u00e9gories et les pages de politique importantes.",
          tip: "Revoyez vos liens internes de page d'accueil tous les trimestres. Les changements saisonniers, les lancements de nouveaux produits et les cat\u00e9gories abandonnees justifient tous des mises a jour sur les pages qui recoivent l'equite de liens au niveau de la page d'accueil.",
        },
        {
          title: "Balise title, meta description et schema",
          content:
            "La balise title de la page d'accueil est le seul endroit ou commencer par votre nom de marque a du sens, car la plupart des recherches de page d'accueil sont des requetes de marque. La formule optimale est : Nom de Marque + Mot-cl\u00e9 Principal + Differenciant.\n\nVotre meta description de page d'accueil devrait servir de mini-publicite pour l'ensemble de votre boutique. Incluez vos principales cat\u00e9gories de produits, un signal de confiance et un appel a l'action.\n\nImplementez le schema Organization sur votre page d'accueil pour informer Google de votre entite commerciale. Incluez votre nom d'entreprise, logo, coordonnees, profils de reseaux sociaux et date de cr\u00e9ation. Ce schema aide Google a connecter votre marque avec son Knowledge Graph.\n\nNe negligez pas le schema SiteNavigationElement pour votre menu principal. Bien que ce ne soit pas un facteur de classement direct, il aide les moteurs de recherche a comprendre la structure de votre site et peut influencer l'apparition des sitelinks sous votre page d'accueil dans les resultats de recherche.",
        },
        {
          title: "Erreurs courantes de SEO de page d'accueil",
          content:
            "L'erreur la plus frequente que nous voyons est la page d'accueil \"toutes images, pas de texte\". Une banniere hero plein ecran, une grille d'images de produits et rien d'autre. Google peut lire le texte alternatif des images, mais ce n'est pas un substitut au contenu textuel reel qui etablit la pertinence thematique.\n\nUne autre erreur courante est d'utiliser le H1 de la page d'accueil pour un message promotionnel saisonnier qui change chaque semaine. \"Soldes d'Ete - Jusqu'a 50% de Reduction\" ne dit rien a Google sur ce que vous vendez. Votre H1 devrait etre stable et descriptif.\n\nLes carrousels de diaporamas nuisent a la fois au SEO et a la conversion. Seul le contenu de la premi\u00e8re diapositive recoit l'attention complete des utilisateurs, et le contenu rotatif cree un signal confus pour les moteurs de recherche.\n\nEnfin, beaucoup de boutiques commettent l'erreur de bourrer leur page d'accueil de liens vers des produits individuels au lieu de cat\u00e9gories. Votre page d'accueil devrait lier vers des cat\u00e9gories, qui ensuite lient vers des produits. Cela s'aligne avec une [architecture de site](/academy/site-architecture-for-ecommerce) solide qui garde chaque page \u00c3\u00a0 quelques clics de la page d'accueil.",
          items: [
            ...
            "Lier vers les cat\u00e9gories depuis la page d'accueil, pas vers des centaines de produits individuels",
      ...
      navLabels: {
        previous: "SEO des pages cat\u00e9gories",
    ...
    es: {
      ...
      intro: "Tu p\u00c3\u00a1gina de inicio es la p\u00c3\u00a1gina m\u00e1s autoritativa de todo tu dominio. Recibe la mayor parte de los backlinks, lleva la mayor equidad de enlaces internos y establece el tono de como los motores de busqueda entienden tu tienda. Sin embargo, muchos sitios de ecommerce desperdician esta autoridad con banners hero llamativos sin contenido de texto, dejando a Google adivinando que venden realmente. Una p\u00c3\u00a1gina de inicio estrat\u00c3\u00a9gicamente optimizada canaliza la autoridad hacia tus categor\u00c3\u00adas m\u00e1s importantes y establece tu tienda como la autoridad tem\u00c3\u00a1tica en tu nicho. Para profundizar, lee nuestra guia de [SEO de homepage para ecommerce](/blog/ecommerce-homepage-seo).",
      readTime: "10 min de lectura",
      sections: [
        {
          title: "El rol de tu página de inicio en el SEO de ecommerce",
          content:
            "Tu p\u00e1gina de inicio sirve un proposito SEO fundamentalmente diferente al de cualquier otra p\u00e1gina de tu sitio. Mientras que las p\u00e1ginas de producto y categor\u00eda apuntan a palabras clave transaccionales especificas, la p\u00e1gina de inicio apunta a tu nombre de marca y la descripcion m\u00e1s amplia de lo que ofrece tu tienda. Una tienda que vende equipamiento outdoor deberia tener una p\u00e1gina de inicio que comunique claramente \"vendemos equipamiento outdoor y de camping\" tanto a humanos como a rastreadores.\n\nLa p\u00e1gina de inicio tambi\u00e9n actua como el hub principal de distribucion de equidad de enlaces en todo tu sitio. Los enlaces externos de cobertura de prensa, asociaciones y directorios casi siempre apuntan a la p\u00e1gina de inicio. Cada enlace interno desde la p\u00e1gina de inicio pasa una porcion de esa autoridad acumulada a la p\u00e1gina enlazada.\n\nLas busquedas de marca a menudo activan la p\u00e1gina de inicio como el resultado principal, y Google usa la p\u00e1gina de inicio para construir su comprensi\u00f3n del tema general de tu sitio. Si Google no puede descifrar que vendes desde tu p\u00e1gina de inicio, tendra dificultades para posicionar tus p\u00e1ginas m\u00e1s profundas para consultas relevantes.",
        },
        {
          title: "Estructura de contenido de página de inicio que funciona",
          content:
            "La p\u00e1gina de inicio de ecommerce ideal sigue una jerarquia de contenido que sirve tanto a objetivos de SEO como de conversion. Comienza con un H1 claro que incluya tu frase de palabra clave principal, algo como \"Equipamiento Outdoor Premium y Material de Camping\" en lugar de un eslogan vago como \"La Aventura Te Espera.\"\n\nDebajo del H1 y el area hero, incluye un parrafo introductorio corto (100-200 palabras) que describa tu tienda, lo que vendes y por que los compradores deberian comprarte. Este parrafo le da a Google el contexto semantico necesario para categorizar tu sitio.\n\nPresenta tus categor\u00edas de nivel superior con tarjetas visuales y enlaces de texto. Cada bloque de categor\u00eda deberia incluir el nombre de la categor\u00eda como H2 o H3, una breve descripcion (2-3 oraciones) y un enlace a la p\u00e1gina de la categor\u00eda.\n\nTermina la p\u00e1gina de inicio con una seccion de contenido m\u00e1s larga (200-400 palabras) que ampl\u00c3\u00ade tu historia de marca, experiencia o propuesta de valor unica.",
          items: [
            ...
            "Presentar las categor\u00edas principales con nombres, descripciones y enlaces",
        ...
        },
        {
          ...
          content:
            "Tu menu de navegaci\u00f3n principal es posiblemente el elemento de [enlaces internos](/academy/internal-linking-for-stores) m\u00e1s poderoso de tu sitio porque aparece en cada p\u00e1gina. Las categor\u00edas que incluyes en la navegaci\u00f3n principal reciben equidad de enlaces de cada p\u00e1gina indexada de tu dominio. Eligelas cuidadosamente, tu navegaci\u00f3n superior deberia presentar tus categor\u00edas de mayor valor, no p\u00e1ginas utilitarias como \"Sobre Nosotros\" o \"Contacto.\"\n\nLimita tu navegaci\u00f3n principal a 7-10 elementos de nivel superior. Los mega menus con docenas de enlaces diluyen la equidad pasada a cada p\u00e1gina enlazada y pueden abrumar tanto a usuarios como a motores de busqueda.\n\nLos enlaces internos especificos de la p\u00e1gina de inicio, aquellos fuera de la navegaci\u00f3n principal, son donde puedes ser estrategico sobre dirigir autoridad. Enlaza a colecciones estacionales, novedades o categor\u00edas para las que estas tratando activamente de posicionarte.\n\nNo olvides los enlaces del pie de p\u00e1gina. Aunque llevan menos peso que los enlaces de navegaci\u00f3n principal, los enlaces del footer son un buen lugar para tu lista completa de categor\u00edas y p\u00e1ginas de politicas importantes.",
          tip: "Revisa tus enlaces internos de la p\u00e1gina de inicio trimestralmente. Los cambios estacionales, los lanzamientos de nuevos productos y las categor\u00edas descontinuadas justifican actualizaciones sobre que p\u00e1ginas reciben equidad de enlaces a nivel de p\u00e1gina de inicio.",
        },
        {
          title: "Etiqueta de título, meta descripcion y schema",
          content:
            "La etiqueta de t\u00edtulo de la p\u00e1gina de inicio es el unico lugar donde liderar con tu nombre de marca tiene sentido, porque la mayoria de las busquedas de p\u00e1gina de inicio son consultas de marca. La formula optima es: Nombre de Marca + Palabra Clave Principal + Diferenciador.\n\nTu meta descripcion de la p\u00e1gina de inicio deberia servir como un mini-anuncio para toda tu tienda. Incluye tus principales categor\u00edas de productos, una senal de confianza y un llamado a la acci\u00f3n.\n\nImplementa el schema Organization en tu p\u00e1gina de inicio para decirle a Google sobre tu entidad comercial. Incluye tu nombre de empresa, logo, informaci\u00f3n de contacto, perfiles de redes sociales y fecha de fundacion.\n\nNo pases por alto el schema SiteNavigationElement para tu menu principal. Aunque no es un factor de ranking directo, ayuda a los motores de busqueda a entender la estructura de tu sitio y puede influir en como aparecen los sitelinks debajo de tu p\u00e1gina de inicio en los resultados de busqueda.",
        },
        {
          title: "Errores comunes de SEO de página de inicio",
          content:
            "El error m\u00e1s frecuente que vemos es la p\u00e1gina de inicio \"todas imagenes, sin texto\". Un banner hero de pantalla completa, una cuadricula de imagenes de productos y nada m\u00e1s. Google puede leer el texto alternativo de las imagenes, pero no es sustituto del contenido de texto real que establece relevancia tem\u00e1tica.\n\nOtro error comun es usar el H1 de la p\u00e1gina de inicio para un mensaje promocional estacional que cambia cada semana. \"Rebajas de Verano - Hasta 50% de Descuento\" no le dice nada a Google sobre lo que vendes. Tu H1 deberia ser estable y descriptivo.\n\nLos carruseles de diapositivas danan tanto el SEO como la conversion. Solo el contenido de la primera diapositiva recibe atenci\u00f3n completa de los usuarios, y el contenido rotativo crea una senal confusa para los motores de busqueda.\n\nFinalmente, muchas tiendas cometen el error de llenar su p\u00e1gina de inicio con enlaces a productos individuales en lugar de categor\u00edas. Tu p\u00e1gina de inicio deberia enlazar a categor\u00edas, que luego enlazan a productos. Esto se alinea con una solida [arquitectura de sitio](/academy/site-architecture-for-ecommerce) que mantiene cada p\u00e1gina a pocos clics de la homepage.",
          items: [
            "Asegurar al menos 200-300 palabras de contenido de texto visible en la p\u00e1gina de inicio",
            ...
            "Enlazar a categor\u00edas desde la p\u00e1gina de inicio, no a cientos de productos individuales",
            "Evitar huerfanar p\u00e1ginas importantes excluyendolas completamente de la navegaci\u00f3n",
          ],
          callout: {
            title: "Slider vs. statischer Hero",
            text: "Studien zeigen konsistent, dass statische Hero-Bilder Karussell-Slider in der Conversion-Rate übertreffen. Slider erzeugen auch verwirrende SEO-Signale.",
      ...
      navLabels: {
        previous: "SEO de p\u00e1ginas de categor\u00eda",
        next: "Etiquetas de t\u00edtulo y meta descripciones",
      },
    },
    it: {
      badge: "SEO On-Page",
