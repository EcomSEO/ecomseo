...
export const ecommerceBlogSeo: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro:
        "La plupart des boutiques e-commerce s'appuient entierement sur les pages produit et categorie pour generer du trafic organique, passant a cote de l'enorme opportunite qu'un blog bien optimise offre. Un blog e-commerce strategique capture les requetes de recherche informationnelles que les pages produit ne peuvent pas cibler, construit une autorite thematique qui renforce l'ensemble de votre domaine, et cree des chemins naturels du contenu educatif vers les decisions d'achat, transformant les lecteurs en clients a chaque etape du parcours d'achat.",
