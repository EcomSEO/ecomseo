      ...
      sections: [
        {
          ...
          items: [
            ...
            "Tous ceux qui en ont assez des conseils SEO fragmentes qui ne forment jamais un syst\u00e8me",
          ],
          callout: {
            title: "Wichtige Voraussetzung",
        ...
        },
        {
          ...
          content:
            "L'\u00e9tape 1 consiste a comprendre comment Google fonctionne reellement pour l'ecommerce. Pas la version simplifiee, mais comment Googlebot decouvre les pages produits, pourquoi le budget de crawl compte quand vous avez 50 000 URLs, et ce que la file d'attente de rendu signifie pour les vitrines lourdes en JavaScript. Vous ne pouvez pas prendre de bonnes d\u00e9cisions SEO sans comprendre la mecanique. La plupart des boutiques que nous auditons ont des problemes techniques enracines dans une incomprehension fondamentale de la fa\u00e7on dont les moteurs de recherche traitent leurs pages.\n\nL'\u00e9tape 2 est la mise en place de votre infrastructure de mesure. Cela signifie Google Search Console v\u00e9rifi\u00e9 et connecte, Google Analytics 4 configure avec le suivi ecommerce, et un audit de site complet avec un crawler comme Screaming Frog ou Sitebulb. Nous sommes entres dans des boutiques qui fonctionnaient depuis trois ans sans acces a la Search Console. Elles n'avaient aucune idee des pages indexees, des requetes generant du trafic ou de la capacite de Google a trouver la moitie de leur catalogue.\n\nL'\u00e9tape 3 est votre premier audit technique. Vous lancez le crawler, exportez les donn\u00e9es et identifiez les problemes principaux : pages cassees, titres manquants, meta descriptions dupliquees, pages orphelines sans liens internes et problemes de profondeur de crawl ou les produits sont a cinq clics ou plus de la page d'accueil. Cet audit devient votre backlog de projet pour les mois suivants.",
          items: [
            "Apprenez comment Googlebot decouvre, crawle, rend et indexe les pages de boutique",
            "Configurez et v\u00e9rifiez Google Search Console pour votre domaine",
          ...
          tip: "Ne sautez pas l'audit. Nous avons vu des equipes passer directement a la [recherche de mots-cl\u00e9s](/academy/keyword-research-for-ecommerce) et passer des mois a optimiser des pages que Google n'indexait meme pas. Reparez la plomberie avant de redecorer.",
          image: {
        ...
        },
        {
          ...
          content:
            "L'\u00e9tape 4 est la recherche de mots-cl\u00e9s, et elle fonctionne diff\u00e9remment pour l'ecommerce que pour les blogs. Vous ne cherchez pas des requetes informationnelles a fort volume. Vous devez trouver les termes que les gens utilisent juste avant d'acheter. Cela signifie des mots-cl\u00e9s au niveau produit comme les noms de mod\u00e8les sp\u00e9cifiques et les recherches par SKU, des mots-cl\u00e9s de cat\u00e9gorie qui correspondent a la fa\u00e7on dont les acheteurs naviguent, et des mots-cl\u00e9s modificateurs comme meilleur, moins cher ou avis qui signalent une intention commerciale.\n\nLe processus commence avec vos propres donn\u00e9es. Extrayez les requetes de la Search Console qui generent d\u00e9j\u00e0 du trafic. V\u00e9rifiez quelles pages produits et cat\u00e9gories sont positionnees pour quoi. Puis elargissez avec des outils de mots-cl\u00e9s pour trouver les lacunes, surtout les mots-cl\u00e9s de cat\u00e9gorie pour lesquels vos concurrents se positionnent mais pas vous. Triez tout par potentiel de chiffre d'affaires, pas seulement par volume de recherche. Un mot-cl\u00e9 avec 200 recherches mensuelles et un CPC de 4 EUR vaut souvent plus qu'un mot-cl\u00e9 avec 5 000 recherches et un CPC de 0,10 EUR.\n\nL'\u00e9tape 5 est l'application de ces mots-cl\u00e9s a vos pages. L'optimisation des pages produits signifie des title tags uniques, des descriptions structurees allant au-dela du texte du fabricant, une hierarchie de titres correcte et des textes alternatifs d'images incluant des termes de recherche pertinents sans bourrage de mots-cl\u00e9s. [L'optimisation des pages cat\u00e9gories](/academy/category-page-seo) signifie rediger un texte d'introduction authentique ciblant votre mot-cl\u00e9 principal, ajouter des liens internes contextuels et s'assurer que vos titres de cat\u00e9gories correspondent a ce que les gens recherchent reellement.",
          items: [
            "Exploitez la Search Console pour les requetes existantes generant impressions et clics",
            "Construisez une carte de mots-cl\u00e9s assignant des termes primaires et secondaires a chaque page",
            "Redigez des descriptions produits uniques allant au-dela du texte fabricant",
            "Optimisez les titres, introductions et structures de titres des pages cat\u00e9gories",
            "Auditez les title tags et meta descriptions de vos 50 pages a plus fort revenu",
          ],
          tip: "Assignez un mot-cl\u00e9 principal par page. Quand deux pages ciblent le meme terme, Google doit choisir laquelle positionner, et il ne choisit souvent aucune des deux. La cannibalisation est l'un des problemes les plus courants que nous voyons dans les audits de boutiques.",
          callout: {
            title: "Umsatz vor Volumen",
        ...
        },
        {
          ...
          content:
            "L'\u00e9tape 6 approfondit le cote technique. L'architecture du site est le point majeur pour l'ecommerce. Votre hierarchie de cat\u00e9gories devrait refeter la fa\u00e7on dont les clients achevent et dont Google comprend la pertinence thematique. Les architectures plates ou chaque produit est a un clic de la page d'accueil semblent geniales en theorie, mais elles creent des pages avec des centaines de liens qui diluent l'autorite. Les architectures profondes ou les produits se trouvent derriere quatre couches de sous-categories enterrent les pages importantes. Le point ideal est generalement de deux a trois clics de la page d'accueil au produit.\n\nLa vitesse de chargement n'est pas negociable a cette \u00e9tape. Les sites ecommerce tendent a etre charges d'images et bourres de scripts tiers pour les avis, widgets de chat et pixels de suivi. Lancez des verifications Core Web Vitals sur vos templates cl\u00e9s : page d'accueil, page cat\u00e9gorie, page produit et panier. Corrigez les plus gros problemes en premier, generalement les images non optimisees et le JavaScript bloquant le rendu. Les donn\u00e9es structurees appartiennent aussi a cette \u00e9tape. Le schema Produit, le schema Breadcrumb et le schema FAQ aident Google a comprendre vos pages et peuvent vous obtenir des resultats enrichis qui ameliorent les taux de clics.\n\nL'\u00e9tape 7 passe au contenu. Chaque boutique a besoin de contenu qui n'est pas directement transactionnel. Les guides d'achat, les comparatifs, les articles pratiques et le contenu pedagogique servent deux objectifs : ils captent les acheteurs plus tot dans la phase de recherche, et ils attirent des backlinks d'autres sites d'une maniere que les pages produits ne peuvent tout simplement pas. Une boutique de chaussures de course devrait avoir du contenu sur le choix du bon type de chaussure, les plans d'entrainement et la prevention des blessures. Ce contenu cree des liens internes vers les pages produits et cat\u00e9gories, transmettant l'autorite la ou elle compte.",
          items: [
            "Auditez et restructurez votre hierarchie de cat\u00e9gories pour une profondeur de crawl optimale",
            "Optimisez les Core Web Vitals sur vos quatre templates de pages cl\u00e9s",
            "Implementez les donn\u00e9es structurees Produit, Breadcrumb et FAQ",
        ...
        },
        {
          ...
          content:
            "L'\u00e9tape 8 est celle ou la plupart des equipes ecommerce sont bloquees. Le link building pour les boutiques en ligne est difficile parce que les pages produits attirent rarement des liens naturels. Vous avez besoin de strat\u00e9gies construites autour de votre contenu et de votre marque. Les RP digitales fonctionnent bien : des recherches originales, des \u00e9tudes de donn\u00e9es sur votre industrie ou des lancements de produits mediatiques peuvent obtenir une couverture de journalistes et blogueurs. Les relations avec les fournisseurs et fabricants peuvent mener a des liens depuis des pages de marque. Les contributions en tant qu'invite dans des publications sectorielles construisent autorite et trafic referent simultanement.\n\nL'approche qui fonctionne le mieux a long terme est de cr\u00e9er des ressources genuinement utiles vers lesquelles les gens font des liens parce qu'elles resolvent un probleme. Un magasin de meubles qui publie un guide detaille de mesure de pieces obtiendra des liens de blogs de design d'interieur, de forums de renovation et d'etudiants en architecture. Ces liens transmettent de l'autorite a l'ensemble du domaine, elevant les pages produits au passage. Evitez d'acheter des liens, de participer a des schemas de liens ou de soumettre en masse a des annuaires. La detection de spam de Google est devenue extremement performante, et le risque de penalite depasse largement les gains a court terme.\n\nL'\u00e9tape 9 est la construction d'un syst\u00e8me de mesure et de reporting qui vous tient responsable. Suivez le chiffre d'affaires organique comme KPI principal, pas seulement les positions ou le trafic. Mettez en place un rythme de reporting mensuel couvrant les sessions organiques, le revenu de la recherche organique, les changements de positions des mots-cl\u00e9s, les nouvelles pages indexees et les backlinks acquis. L'objectif est de transformer le SEO d'un projet ponctuel en un processus mensuel reproductible avec des entrees claires et des resultats mesurables. Pour une vue d'ensemble compl\u00c3\u00a8te de ces principes, commencez par notre guide pilier sur le [SEO e-commerce](/blog/ecommerce-seo).",
          items: [
          ...
          tip: "Mesurez le succ\u00e8s SEO en chiffre d'affaires, pas en positions. Un classement numero un pour un mot-cl\u00e9 sur lequel personne n'achete ne vaut rien. Reliez chaque action SEO a des pages qui convertissent.",
        },
        {
          title: "Faire fonctionner cette feuille de route en pratique",
          content:
            "La plus grande erreur des equipes avec une feuille de route comme celle-ci est d'essayer de tout faire en meme temps. Les \u00e9tapes 1 a 3 devraient prendre quatre a six semaines. Les \u00e9tapes 4 et 5 necessitent quatre a six semaines supplementaires. Les \u00e9tapes 6 et 7 se deroulent en parallele sur deux a trois mois. Les \u00e9tapes 8 et 9 sont continues et ne finissent jamais vraiment. Si vous essayez de tout compresser en un seul mois, vous couperez les coins sur les fondations et passerez l'ann\u00e9e suivante a corriger les consequences.\n\nPriorisez selon l'impact. Si votre audit de site revele que 40 % de vos pages produits retournent des erreurs 404, corriger cela passe avant la recherche de mots-cl\u00e9s. Si vos pages cat\u00e9gories se positionnent d\u00e9j\u00e0 en page deux pour des termes precieux, l'optimisation on-page fera bouger les choses plus vite que de lancer un blog. Laissez les donn\u00e9es guider la sequence, pas une checklist generique.\n\nEnfin, acceptez que les resultats SEO prennent du temps. Vous ne verrez pas de croissance significative du chiffre d'affaires organique avant trois a six mois apr\u00e8s le d\u00e9marrage. C'est normal. Les boutiques qui reussissent sont celles qui s'engagent dans le processus, executent de maniere constante et resistent a la tentation d'abandonner le plan quand les resultats ne sont pas immediats. Apr\u00e8s douze mois d'execution disciplinee, la recherche organique devient typiquement le canal au meilleur ROI du mix marketing.",
          image: {
      ...
      sections: [
        {
          ...
          content:
            "Hemos creado esta hoja de ruta para tres grupos de personas. Propietarios de tiendas que gestionan su propio marketing y quieren dejar de adivinar en SEO. Marketeros internos en empresas de ecommerce que necesitan un marco adecuado en lugar de t\u00e1cticas dispersas. Y SEOs junior que se mueven al ecommerce por primera vez y necesitan entender como este sector difiere de los sitios de contenido o negocios locales.\n\nNo necesitas conocimiento previo de SEO para seguir este camino. Si has gestionado una tienda online durante algunos meses, ya entiendes las p\u00e1ginas de producto, categor\u00edas y flujos de compra. Ese conocimiento operativo es m\u00e1s util de lo que la mayoria piensa, porque el [SEO para ecommerce](/blog/ecommerce-seo) consiste en hacer que esas mismas p\u00e1ginas rindan en los resultados de busqueda.\n\nLo que si asumimos es que tienes acceso al backend de tu tienda, puedes instalar herramientas de seguimiento y estas dispuesto a dedicar al menos unas horas por semana a la implementaci\u00f3n. Leer sobre SEO sin hacer el trabajo no produce nada. Cada etapa de esta hoja de ruta termina con acciones concretas que debes completar antes de avanzar.",
          items: [
            ...
            "SEOs junior en transici\u00f3n al sector ecommerce",
        ...
        },
        {
          ...
          content:
            "La etapa 1 es entender como funciona realmente Google para ecommerce. No la versi\u00f3n simplificada, sino como Googlebot descubre p\u00e1ginas de producto, por que el presupuesto de rastreo importa cuando tienes 50.000 URLs, y que significa la cola de renderizado para storefronts con mucho JavaScript. No puedes tomar buenas decisiones de SEO sin entender la mecanica. La mayoria de las tiendas que auditamos tienen problemas t\u00e9cnicos arraigados en una incomprension fundamental de como los motores de busqueda procesan sus p\u00e1ginas.\n\nLa etapa 2 es configurar tu infraestructura de medicion. Eso significa Google Search Console verificada y conectada, Google Analytics 4 configurado con seguimiento de ecommerce, y una auditoria de sitio adecuada usando un crawler como Screaming Frog o Sitebulb. Hemos encontrado tiendas que llevaban tres a\u00c3\u00b1os funcionando sin acceso a Search Console. No tenian idea de que p\u00e1ginas estaban indexadas, que consultas generaban tr\u00e1fico o si Google estaba encontrando siquiera la mitad de su cat\u00e1logo.\n\nLa etapa 3 es tu primera auditoria t\u00e9cnica. Ejecutas el crawler, exportas los datos e identificas los problemas principales: p\u00e1ginas rotas, t\u00edtulos faltantes, meta descripciones duplicadas, p\u00e1ginas huerfanas sin enlaces internos y problemas de profundidad de rastreo donde los productos estan a cinco o m\u00e1s clics de la p\u00e1gina de inicio. Esta auditoria se convierte en tu backlog de proyecto para los proximos meses.",
          items: [
            "Aprende como Googlebot descubre, rastrea, renderiza e indexa p\u00e1ginas de tienda",
            ...
            "Identifica y prioriza los 20 problemas t\u00e9cnicos principales de la auditoria",
          ],
          tip: "No te saltes la auditoria. Hemos visto equipos saltar directamente a la investigaci\u00f3n de palabras clave y pasar meses optimizando p\u00e1ginas que Google ni siquiera estaba indexando. Arregla las tuberias antes de redecorar.",
          image: {
        ...
        },
        {
          ...
          content:
            "La etapa 4 es la [investigaci\u00f3n de palabras clave](/academy/keyword-research-for-ecommerce), y funciona de forma diferente para ecommerce que para blogs. No buscas consultas informativas con alto volumen. Necesitas encontrar los terminos que la gente usa justo antes de comprar. Eso significa palabras clave a nivel de producto como nombres de modelos especificos y busquedas por SKU, palabras clave de categor\u00eda que coincidan con como navegan los compradores, y palabras clave modificadoras como mejor, m\u00e1s barato o opiniones que senalan intenci\u00f3n comercial.\n\nEl proceso empieza con tus propios datos. Extrae las consultas de Search Console que ya generan tr\u00e1fico. Revisa que p\u00e1ginas de producto y categor\u00eda se posicionan para que. Luego expande hacia afuera con herramientas de palabras clave para encontrar vacios, especialmente palabras clave de categor\u00eda para las que tus competidores se posicionan pero tu no. Ordena todo por potencial de ingresos, no solo por volumen de busqueda. Una palabra clave con 200 busquedas mensuales y un CPC de 4 EUR a menudo vale m\u00e1s que una con 5.000 busquedas y 0,10 EUR de CPC.\n\nLa etapa 5 es aplicar esas palabras clave a tus p\u00e1ginas. La optimizaci\u00f3n de p\u00e1ginas de producto significa title tags unicos, descripciones estructuradas que van m\u00e1s alla del texto del fabricante, jerarquia de encabezados correcta y texto alternativo de imagenes que incluya terminos de busqueda relevantes sin relleno de palabras clave. La [optimizaci\u00f3n de p\u00e1ginas de categor\u00eda](/academy/category-page-seo) significa escribir un texto introductorio genuino que apunte a tu palabra clave principal, anadir enlaces internos contextuales y asegurarte de que tus t\u00edtulos de categor\u00eda coincidan con lo que la gente realmente busca.",
          items: [
            "Explora Search Console buscando consultas existentes que generan impresiones y clics",
            "Construye un mapa de palabras clave asignando terminos primarios y secundarios a cada p\u00e1gina",
            "Escribe descripciones de producto unicas que vayan m\u00e1s alla del texto del fabricante",
            "Optimiza t\u00edtulos, introducciones y estructuras de encabezados de p\u00e1ginas de categor\u00eda",
            "Audita title tags y meta descripciones en tus 50 p\u00e1ginas de mayor ingreso",
          ],
          tip: "Asigna una palabra clave principal por p\u00e1gina. Cuando dos p\u00e1ginas apuntan al mismo termino, Google tiene que elegir cual posicionar, y a menudo no elige ninguna. La canibalizaci\u00f3n es uno de los problemas m\u00e1s comunes que vemos en auditorias de tiendas.",
          callout: {
            title: "Umsatz vor Volumen",
        ...
        },
        {
          ...
          content:
            "La etapa 6 profundiza en el lado t\u00e9cnico. La arquitectura del sitio es el punto grande para ecommerce. Tu jerarquia de categor\u00edas deberia reflejar como compran los clientes y como Google entiende la relevancia tem\u00e1tica. Las arquitecturas planas donde cada producto esta a un clic de la p\u00e1gina de inicio suenan genial en teoria, pero crean p\u00e1ginas con cientos de enlaces que diluyen la autoridad. Las arquitecturas profundas donde los productos estan detras de cuatro capas de subcategorias entierran p\u00e1ginas importantes. El punto ideal suele ser de dos a tres clics desde la p\u00e1gina de inicio hasta el producto.\n\nLa velocidad de p\u00e1gina no es negociable en esta etapa. Los sitios de ecommerce tienden a estar cargados de imagenes y llenos de scripts de terceros para resenas, widgets de chat y pixeles de seguimiento. Ejecuta comprobaciones de Core Web Vitals en tus templates clave: p\u00e1gina de inicio, p\u00e1gina de categor\u00eda, p\u00e1gina de producto y carrito. Corrige los mayores problemas primero, normalmente imagenes sin optimizar y JavaScript que bloquea el renderizado. Los datos estructurados tambi\u00e9n pertenecen aqui. El schema de Producto, el schema de Breadcrumb y el schema de FAQ ayudan a Google a entender tus p\u00e1ginas y pueden conseguirte resultados enriquecidos que mejoran las tasas de clics.\n\nLa etapa 7 pasa al contenido. Toda tienda necesita contenido que no sea directamente transaccional. Guias de compra, comparativas, art\u00edculos practicos y contenido educativo sirven dos propositos: captan compradores antes en la fase de investigaci\u00f3n, y atraen backlinks de otros sitios de formas que las p\u00e1ginas de producto simplemente no pueden. Una tienda de zapatillas de running deberia tener contenido sobre elegir el tipo correcto de zapatilla, planes de entrenamiento y prevencion de lesiones. Este contenido enlaza internamente a p\u00e1ginas de producto y categor\u00eda, pasando autoridad donde importa.",
          items: [
            "Audita y reestructura tu jerarquia de categor\u00edas para una profundidad de rastreo optima",
            "Optimiza Core Web Vitals en tus cuatro templates de p\u00e1gina clave",
            "Implementa datos estructurados de Producto, Breadcrumb y FAQ",
            "Planifica un calendario de contenido con 2 a 4 art\u00edculos de apoyo al mes",
            "Construye rutas de enlaces internos desde p\u00e1ginas de contenido a p\u00e1ginas comerciales",
          ],
        },
        {
          title: "Etapas 8 y 9: Link building y medicion de resultados",
          content:
            "La etapa 8 es donde la mayoria de los equipos de ecommerce se atascan. El link building para tiendas online es dif\u00edcil porque las p\u00e1ginas de producto rara vez atraen enlaces naturales. Necesitas estrategias construidas alrededor de tu contenido y tu marca. Las relaciones publicas digitales funcionan bien: investigaciones originales, estudios de datos sobre tu industria o lanzamientos de productos noticiables pueden conseguir cobertura de periodistas y bloggers. Las relaciones con proveedores y fabricantes pueden llevar a enlaces desde p\u00e1ginas de marca. Las contribuciones como invitado en publicaciones del sector construyen autoridad y tr\u00e1fico referido simultaneamente.\n\nEl enfoque que mejor funciona a largo plazo es crear recursos genuinamente utiles hacia los que la gente enlaza porque resuelven un problema. Una tienda de muebles que p\u00fablica una guia detallada de medicion de habitaciones conseguira enlaces de blogs de diseno de interiores, foros de renovacion y estudiantes de arquitectura. Esos enlaces pasan autoridad a todo el dominio, elevando las p\u00e1ginas de producto en el proceso. Evita comprar enlaces, participar en esquemas de enlaces o enviar masivamente a directorios. La deteccion de spam de Google se ha vuelto extremadamente buena, y el riesgo de penalizacion supera con creces las ganancias a corto plazo.\n\nLa etapa 9 es construir un sistema de medicion y reporting que te mantenga responsable. Rastrea los ingresos organicos como tu KPI principal, no solo rankings o tr\u00e1fico. Establece una cadencia de reporting mensual que cubra sesiones organicas, ingresos de busqueda organica, cambios de posicion de palabras clave, nuevas p\u00e1ginas indexadas y backlinks adquiridos. El objetivo es convertir el SEO de un proyecto puntual en un proceso mensual repetible con entradas claras y resultados medibles.",
          items: [
            ...
            "Configura reporting SEO mensual cubriendo ingresos, tr\u00e1fico y rankings",
