    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "Le leak Content Warehouse a revele un module appele CompressedQualitySignals qui agit comme une \"fiche\" par document. Il regroupe siteAuthority, unauthoritativeScore, lowQuality, anchorMismatchDemotion, exactMatchDomainDemotion et pandaDemotion. Les documents qui echouent au prefiltre sont ecartes avant que le travail de ranking plus couteux ne s'execute.\n\nPour les pages produits, cela change la priorisation. Les PDP minces avec descriptions templatisees peuvent declencher le flag lowQuality a grande \u00e9chelle et faire chuter la position de tout le site. Une boutique avec 10 000 produits, dont 8 000 n'ont que des paragraphes fournis par le fabricant, enseigne a Google que le catalogue est majoritairement peu travaille. Le correctif est rarement \"ecrire plus de texte riche en mots-cl\u00e9s\" - c'est l'elagage, la consolidation des variantes sous un seul canonical, et la concentration de l'effort editorial sur les PDP qui generent reellement du revenu.\n\nLes d\u00e9cisions d'indexation en decoulent. Google refuse souvent d'indexer les PDP qui semblent de basse qualit\u00e9, meme quand elles sont crawlees. Si votre nombre GSC \"Explorees - actuellement non indexees\" est eleve, les signaux lowQuality et pandaDemotion sont une explication plus probable que le crawl budget.",
          items: [
            ...
            "\"Explorees - actuellement non indexees\" pointe generalement vers des signaux de qualit\u00e9, pas le crawl budget",
    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "El leak Content Warehouse revelo un modulo llamado CompressedQualitySignals que actua como una \"ficha\" por documento. Agrupa siteAuthority, unauthoritativeScore, lowQuality, anchorMismatchDemotion, exactMatchDomainDemotion y pandaDemotion. Los documentos que fallan el prefiltro son descartados antes de que se ejecute trabajo de ranking m\u00e1s costoso.\n\nPara p\u00e1ginas de producto, esto cambia la priorizacion. Las PDPs delgadas con descripciones de plantilla pueden disparar el flag lowQuality a escala y arrastrar todo el standing del sitio. Una tienda con 10.000 productos, 8.000 de los cuales solo tienen parrafos proporcionados por el fabricante, le ensena a Google que el cat\u00e1logo es mayormente de bajo esfuerzo. El fix raramente es \"escribir m\u00e1s copy rico en keywords\" - es podar, consolidar variantes bajo un canonical unico, y concentrar esfuerzo editorial en las PDPs que realmente generan ingresos.\n\nLas decisiones de indexaci\u00f3n siguen de esto. Google a menudo se niega a indexar PDPs que parecen de baja calidad, incluso cuando son crawleadas. Si tu n\u00famero GSC \"Rastreadas - actualmente no indexadas\" es alto, las senales lowQuality y pandaDemotion son una explicaci\u00f3n m\u00e1s probable que el crawl budget.",
          items: [
            ...
            "PDPs delgadas masivas degradan el standing de todo el cat\u00e1logo - poda o consolida antes de anadir",
