    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "Le leak Content Warehouse 2024 a nomme les syst\u00e8mes qui transferent votre boutique de l'URL au resultat classe. Trawler crawle et recupere les pages. Alexandria les indexe. Mustang execute ensuite le scoring initial (l'Ascorer) avec des centaines de features, avant que les twiddlers reclassent les resultats. Chaque page produit de votre boutique passe par chaque \u00e9tape.\n\nPour les boutiques, l'implication de la pipeline est que les signaux de priorite de crawl (link equity, fraicheur, profondeur de liens internes) decident a quelle fr\u00e9quence Trawler revisite une URL. Les pages enterrees a 4+ clics, sans liens internes entrants et avec des dates lastmod obsoletes, sont rarement crawlees - et les changements que vous y apportez prennent beaucoup plus longtemps a apparaitre dans les rankings. L'attribut hostAge du leak confirme aussi le \"sandbox\" longtemps soupconne : les nouveaux domaines de moins de ~12 mois voient une visibilite plafonnee independamment de l'optimisation.\n\nL'indexation n'est pas non plus binaire. Alexandria peut indexer une URL sans l'afficher (Google Search Console marque celles-ci \"Explorees - actuellement non indexees\"), et le choix est influence par des signaux de qualit\u00e9 d\u00e9j\u00e0 calcules au moment de l'indexation. La conclusion pour l'ecommerce : traitez l'architecture de crawl et la base technique comme porteuses - elles decident quelles de vos pages atteignent meme l'\u00e9tape de scoring.",
          items: [
            "Trawler -> Alexandria -> Mustang -> twiddlers est la vraie chaine de ranking divulguee dans le leak",
            "La fr\u00e9quence de revisite Trawler depend du link equity, de la fraicheur et de la profondeur des liens internes - une PDP enterree, les mises a jour atterrissent en semaines",
            "Alexandria peut indexer sans servir ; les signaux de qualit\u00e9 calcules a l'indexation decident ce qui peut s'afficher",
