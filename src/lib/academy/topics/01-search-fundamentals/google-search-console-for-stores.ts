      ...
      sections: [
        {
          ...
          callout: {
            title: "Indexation Benchmark",
            text: "A healthy ecommerce site should see 85-95% of submitted product URLs indexed. If your rate is below 70%, you have a significant technical or content quality issue to investigate.",
          },
        },
        {
        ...
        },
        {
          ...
          callout: {
            title: "Traffic Math",
            text: "Moving from position 7 (3% CTR) to position 3 (12% CTR) for a keyword with 8,000 monthly impressions means going from 240 to 960 clicks/month. We have seen stores boost organic traffic by 30-40% by systematically improving page-two rankings.",
          },
        },
        {
          title: "Monitoring Indexation Health",
          image: {
            src: "/images/academy/gsc-indexation-dashboard.svg",
            alt: "Dashboard visualization showing GSC page indexing status breakdown: indexed, crawled but not indexed, discovered but not indexed, and other exclusions with recommended fixes",
            caption: "Track your indexation health monthly. A healthy store should have 85-95% of submitted product URLs indexed.",
          },
          content:
            "For ecommerce sites, indexation monitoring is critical because unindexed pages generate zero organic traffic. The Page indexing report in GSC shows exactly how many of your pages are in Google's index and why others are excluded.\n\nCheck this report at least monthly and track your indexed page count over time. A sudden drop in indexed pages could mean Google encountered crawl errors, your robots.txt was accidentally updated, or a site migration went wrong. We've seen stores lose 40% of their organic traffic overnight because a developer accidentally added a noindex tag to a template that rendered across thousands of product pages.\n\nPay close attention to the \"Discovered - currently not indexed\" and \"Crawled - currently not indexed\" statuses. The first means Google knows about the page but hasn't crawled it yet, often due to [crawl budget](/academy/crawl-budget-management) limitations. The second means Google crawled the page but chose not to index it, usually because the content was too thin or too similar to other pages. For ecommerce, the second status often affects product variants or filtered category pages.\n\nUse the Sitemaps report alongside Page indexing to compare submitted URLs versus indexed URLs. If you submitted 10,000 product URLs but only 6,500 are indexed, you have 3,500 pages that need investigation. Group these by pattern to find systematic issues rather than fixing pages one by one.",
    ...
    de: {
      ...
      sections: [
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/de/gsc-quick-wins.svg",
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/de/gsc-indexation-dashboard.svg",
      ...
      sections: [
        {
          ...
          content:
            "Configurer correctement Google Search Console pour un site e-commerce n\u00e9cessite quelques \u00e9tapes supplementaires au-dela de la v\u00e9rification de base. Commencez par v\u00e9rifier votre domaine au niveau de la propriete en utilisant la v\u00e9rification DNS plutot qu'un prefixe d'URL. La v\u00e9rification au niveau du domaine capture tous les sous-domaines et variations de protocole, ce qui est important quand votre boutique peut avoir des sous-domaines separes pour les blogs, centres d'aide ou versions internationales.\n\nUne fois v\u00e9rifi\u00e9, soumettez immediatement votre sitemap XML. Pour la plupart des sites e-commerce, vous voudrez des sitemaps separes pour les pages produits, les pages de cat\u00e9gories et le contenu du blog. GSC vous montre combien d'URLs de chaque sitemap ont ete indexees par rapport a celles soumises, vous donnant une image claire de votre taux d'indexation. Une boutique en bonne sante devrait voir 85 a 95% des URLs de produits soumises indexees.\n\nConnectez egalement GSC a Google Analytics 4. L'integration vous permet de combiner les donn\u00e9es de performance de recherche avec les metriques de comportement sur site, pour voir non seulement quelles requetes amenent du trafic mais ce que ces visiteurs font apr\u00e8s leur arrivee. Cette connexion est particulierement precieuse pour l'e-commerce car elle relie directement les requetes de recherche aux revenus.",
          items: [
            "Utilisez la v\u00e9rification au niveau du domaine via DNS pour capturer tous les sous-domaines",
            "Soumettez des sitemaps XML separes pour les produits, cat\u00e9gories et contenu blog",
            "Connectez GSC a GA4 pour des donn\u00e9es combinees de recherche et de comportement",
        ...
        },
        {
          ...
          content:
            "Le rapport de Performance est l'endroit ou vous passerez le plus de temps. Il montre le total des clics, impressions, le taux de clics moyen et la position moyenne pour chaque requete et page de votre site. Pour l'e-commerce, filtrez ce rapport par type de page pour comprendre comment vos pages produits se comportent par rapport a vos pages de cat\u00e9gories et votre contenu blog.\n\nLe rapport Pages au sein de la Performance est particulierement precieux. Triez par impressions pour trouver les pages que Google affiche fr\u00e9quemment mais qui obtiennent peu de clics. Ce sont vos opportunites de gains rapides. Une page produit avec 5 000 impressions mensuelles mais un CTR de 1,2% a probablement un title tag ou une meta description faible. Am\u00e9liorer ces seuls \u00e9l\u00e9ments peut doubler ou tripler vos clics sans changement de classement.\n\nLe rapport de Couverture (maintenant appele Indexation des pages) vous dit exactement combien de pages sont indexees, exclues et en erreur. Pour les sites e-commerce avec des milliers de produits, ce rapport revele souvent que Google exclut des portions significatives de votre catalogue. Les raisons d'exclusion courantes incluent \"Exploree - actuellement non indexee\" et \"Doublon sans URL canonique selectionnee par l'utilisateur\", toutes deux corrigeables avec une optimisation ciblee.",
          tip: "Etablissez une routine hebdomadaire : chaque lundi matin, v\u00e9rifiez votre rapport de Performance des 28 derniers jours compare a la periode precedente. Cherchez les requetes ou les impressions ont chute de plus de 20%, ce qui pourrait signaler des pertes de classement necessitant une attention immediate.",
        },
        {
          title: "Trouver des gains rapides dans les performances de recherche",
          content:
            "Les donn\u00e9es GSC revelent des opportunites de gains rapides qui peuvent stimuler le trafic sans cr\u00e9er de nouveau contenu ni construire de liens. L'endroit le plus productif est votre rapport de requetes, filtre pour montrer les mots-cl\u00e9s ou votre position moyenne se situe entre 5 et 20.\n\nLes mots-cl\u00e9s en positions 5-10 sont en premi\u00e8re page mais obtiennent des clics minimaux car ils sont sous la ligne de flottaison. Une petite am\u00e9lioration des signaux de pertinence ou du title tag de votre page pourrait vous pousser dans le top 3-4, ou les taux de clics passent de 3-5% a 10-15%. Pour un mot-cl\u00e9 produit avec 8 000 impressions mensuelles, passer de la position 7 a la position 3 pourrait signifier passer de 240 a 1 200 clics par mois.\n\nLes mots-cl\u00e9s en positions 11-20 representent des pages en deuxieme page de Google. Ces pages sont d\u00e9j\u00e0 assez pertinentes pour se classer mais ont besoin d'un boost de contenu. Ajouter des descriptions produits plus detaillees, elargir la section FAQ ou construire quelques backlinks de qualit\u00e9 peut les pousser en premi\u00e8re page. Nous avons vu des boutiques augmenter leur trafic organique de 30 a 40% simplement en ameliorant systematiquement les pages classees en deuxieme page.\n\nRegardez aussi les mots-cl\u00e9s ou vous etes bien classe mais votre CTR est en dessous de la moyenne pour cette position. La position 1 obtient typiquement un CTR de 25-30%, la position 2 obtient 15-18%, et la position 3 obtient 10-12%. Si votre page est 2eme mais n'obtient que 8% de CTR, votre title tag et meta description ont probablement besoin d'am\u00e9lioration. Notre sujet sur le [suivi des classements pour l'e-commerce](/academy/rank-tracking-for-ecommerce) explique comment surveiller ces positions de mani\u00c3\u00a8re syst\u00c3\u00a9matique.",
          items: [
            "Filtrez les mots-cl\u00e9s en positions 5-10 pour trouver des am\u00e9liorations en premi\u00e8re page",
            "Ciblez les mots-cl\u00e9s en positions 11-20 qui necessitent un boost pour atteindre la premi\u00e8re page",
        ...
        },
        {
          ...
          content:
            "L'outil d'inspection d'URL vous permet de v\u00e9rifier exactement comment Google voit une page sp\u00e9cifique de votre site. Entrez une URL et vous verrez si la page est indexee, quand elle a ete exploree pour la derniere fois, l'URL canonique selectionnee par Google et si elle est eligible aux resultats enrichis.\n\nPour l'e-commerce, utilisez cet outil chaque fois que vous publiez de nouveaux produits, mettez a jour des pages importantes ou resolvez des problemes d'indexation. Apr\u00e8s le lancement d'une nouvelle collection de produits, inspectez la page principale de la collection pour confirmer qu'elle a ete exploree et indexee. Si ce n'est pas le cas, utilisez le bouton \"Demander l'indexation\" pour demander a Google de l'explorer plus tot. Cela ne garantit pas une indexation immediate, mais place l'URL dans une file d'attente de crawl prioritaire.\n\nLa vue HTML rendu dans l'Inspection d'URL est particulierement utile pour les boutiques utilisant des frontends JavaScript lourds. Elle vous montre exactement ce que Google voit apr\u00e8s le rendu, ce qui peut etre tr\u00e8s diff\u00e9rent de votre HTML source. Si les prix des produits, les avis ou les donn\u00e9es structurees n'apparaissent pas dans la vue rendue, Google ne peut pas utiliser ces informations pour les classements ou les resultats enrichis.\n\nUn pattern courant que nous observons est les conflits de balises canoniques. Vous definissez peut-etre un canonical pointant vers l'URL A, mais Google s\u00e9lectionn\u00e9 l'URL B comme canonique. L'outil d'Inspection d'URL revele ces conflits pour que vous puissiez les corriger. Cela arrive fr\u00e9quemment avec les pages produits accessibles via plusieurs chemins de cat\u00e9gories ou avec des parametres d'URL qui creent des versions en double.",
          items: [
            "Inspectez les nouvelles pages produits pour v\u00e9rifier leur crawl et indexation corrects",
            "V\u00e9rifiez le HTML rendu pour vous assurer que le contenu JavaScript est visible par Google",
            "V\u00e9rifiez que le canonical s\u00e9lectionn\u00e9 par Google correspond a votre canonical prevu",
        ...
        },
        {
          ...
          content:
            "La valeur de GSC vient de la transformation des donn\u00e9es en plans d'action. Les donn\u00e9es brutes dans les rapports n'ameliorent pas les classements. Vous avez besoin d'un processus systematique pour extraire des insights et implementer des changements.\n\nCommencez par un cycle mensuel d'optimisation de contenu. Exportez vos 200 premi\u00e8res requetes du rapport de Performance et triez-les par impressions. Pour chaque requete, v\u00e9rifiez la page d'atterrissage et demandez-vous : cette page satisfait-elle compl\u00e8tement l'intention de recherche ? Le title tag inclut-il la requete ? Le contenu est-il assez complet ? Ce processus revele typiquement 15 a 25 pages par mois qui beneficient d'optimisation.\n\nConstruisez un tableau de bord de sante technique utilisant les donn\u00e9es GSC. Suivez vos pages indexees totales, erreurs de crawl, problemes d'utilisabilite mobile et scores Core Web Vitals dans le temps. Quand une metrique tend dans la mauvaise direction, investigez immediatement plutot que d'attendre des baisses de trafic. La prevention est significativement moins couteuse que la recuperation en SEO.\n\nPour les entreprises e-commerce saisonni\u00e8res, utilisez la fonction de comparaison de dates de GSC pour comprendre vos patterns de trafic d'une ann\u00e9e sur l'autre. Comparez ce decembre au decembre dernier, cette semaine de Black Friday a celle de l'ann\u00e9e derniere. Cela vous aide a d\u00e9finir des attentes realistes et a identifier si les changements de trafic sont dus a vos efforts SEO ou simplement a des patterns saisonniers. Cela vous aide aussi a preparer du contenu avant les pics saisonniers en regardant quand des requetes sp\u00e9cifiques commencent a monter chaque ann\u00e9e. Un processus structur\u00c3\u00a9 d'[audit SEO e-commerce](/blog/how-to-make-ecommerce-seo-audit) vous aide \u00c3\u00a0 d\u00c3\u00a9tecter ces probl\u00c3\u00a8mes avant qu'ils n'impactent le trafic.",
        },
      ],
      navLabels: {
        previous: "L'intention de recherche en e-commerce",
        next: "Recherche de mots-cl\u00e9s pour l'e-commerce",
      },
    },
    es: {
      ...
      sections: [
        {
          ...
          content:
            "Configurar correctamente Google Search Console para un sitio de e-commerce requiere algunos pasos adicionales m\u00e1s alla de la verificaci\u00f3n basica. Comienza verificando tu dominio a nivel de propiedad usando verificaci\u00f3n DNS en lugar de un prefijo de URL. La verificaci\u00f3n a nivel de dominio captura todos los subdominios y variaciones de protocolo, lo cual importa cuando tu tienda puede tener subdominios separados para blogs, centros de ayuda o versiones internacionales.\n\nUna vez verificado, envia tu sitemap XML inmediatamente. Para la mayoria de los sitios e-commerce, querras sitemaps separados para p\u00e1ginas de producto, p\u00e1ginas de categor\u00eda y contenido de blog. GSC te muestra cuantas URLs de cada sitemap han sido indexadas versus enviadas, dandote una imagen clara de tu tasa de indexaci\u00f3n. Una tienda saludable deberia ver el 85-95% de las URLs de producto enviadas indexadas.\n\nConecta GSC con Google Analytics 4 tambi\u00e9n. La integracion te permite combinar datos de rendimiento de busqueda con m\u00e9tricas de comportamiento en el sitio, para que puedas ver no solo que consultas traen tr\u00e1fico sino que hacen esos visitantes despues de llegar. Esta conexi\u00f3n es especialmente valiosa para e-commerce porque vincula directamente las consultas de busqueda con los ingresos.",
          items: [
            "Usa verificaci\u00f3n a nivel de dominio via DNS para capturar todos los subdominios",
            "Envia sitemaps XML separados para productos, categor\u00edas y contenido de blog",
        ...
        },
        {
          ...
          content:
            "El informe de Rendimiento es donde pasaras la mayor parte de tu tiempo. Muestra clics totales, impresiones, tasa de clics promedio y posicion promedio para cada consulta y p\u00e1gina de tu sitio. Para e-commerce, filtra este informe por tipo de p\u00e1gina para entender como rinden tus p\u00e1ginas de producto versus tus p\u00e1ginas de categor\u00eda versus tu contenido de blog.\n\nEl informe de P\u00e1ginas dentro de Rendimiento es particularmente valioso. Ordena por impresiones para encontrar p\u00e1ginas que Google muestra frecuentemente pero que obtienen pocos clics. Estas son tus oportunidades de victoria r\u00e1pida. Una p\u00e1gina de producto con 5.000 impresiones mensuales pero un CTR de 1,2% probablemente tiene un title tag o meta description debil. Mejorar solo estos elementos puede duplicar o triplicar tus clics sin cambios de posicionamiento.\n\nEl informe de Cobertura (ahora llamado Indexaci\u00f3n de p\u00e1ginas) te dice exactamente cuantas p\u00e1ginas estan indexadas, excluidas y con errores. Para sitios e-commerce con miles de productos, este informe a menudo revela que Google esta excluyendo porciones significativas de tu cat\u00e1logo. Las razones de exclusion comunes incluyen \"Rastreada - actualmente no indexada\" y \"Duplicada sin canonical seleccionada por el usuario\", ambas solucionables con optimizaci\u00f3n especifica.",
          tip: "Establece una rutina semanal: cada lunes por la manana, revisa tu informe de Rendimiento de los \u00faltimos 28 dias comparado con el periodo anterior. Busca consultas donde las impresiones cayeron m\u00e1s del 20%, lo que podria senalar p\u00e9rdidas de posicionamiento que necesitan atenci\u00f3n inmediata.",
        },
        {
          title: "Encontrar victorias rapidas en el rendimiento de busqueda",
          content:
            "Los datos de GSC revelan oportunidades de victoria r\u00e1pida que pueden aumentar el tr\u00e1fico sin crear nuevo contenido o construir enlaces. El lugar m\u00e1s productivo es tu informe de consultas, filtrado para mostrar palabras clave donde tu posicion promedio esta entre 5 y 20.\n\nLas palabras clave en posiciones 5-10 estan en la primera p\u00e1gina pero reciben clics minimos porque estan por debajo del pliegue visible. Una pequena mejora en las senales de relevancia o el title tag de tu p\u00e1gina podria empujarte al top 3-4, donde las tasas de clics saltan del 3-5% al 10-15%. Para una palabra clave de producto con 8.000 impresiones mensuales, moverse de la posicion 7 a la posicion 3 podria significar pasar de 240 clics a 1.200 clics por mes.\n\nLas palabras clave en posiciones 11-20 representan p\u00e1ginas en la segunda p\u00e1gina de Google. Estas p\u00e1ginas ya son suficientemente relevantes para posicionar pero necesitan un impulso de contenido. Agregar descripciones de producto m\u00e1s detalladas, expandir la seccion de FAQ o construir algunos backlinks de calidad puede empujarlas a la primera p\u00e1gina. Hemos visto tiendas aumentar el tr\u00e1fico organico un 30-40% solo mejorando sistematicamente p\u00e1ginas que posicionan en la segunda p\u00e1gina.\n\nTambi\u00e9n busca palabras clave donde posicionas bien pero tu CTR esta por debajo del promedio para esa posicion. La posicion 1 tipicamente obtiene un CTR de 25-30%, la posicion 2 obtiene 15-18%, y la posicion 3 obtiene 10-12%. Si tu p\u00e1gina posiciona 2da pero solo obtiene un 8% de CTR, tu title tag y meta description probablemente necesitan trabajo. Nuestro tema de [seguimiento de posiciones para ecommerce](/academy/rank-tracking-for-ecommerce) cubre como monitorizar estas posiciones sistematicamente.",
          items: [
            "Filtra palabras clave en posiciones 5-10 para encontrar oportunidades de mejora en primera p\u00e1gina",
            "Apunta a palabras clave en posiciones 11-20 que necesitan impulso de contenido o enlaces",
            "Identifica p\u00e1ginas con muchas impresiones y bajo CTR que necesitan mejores titles",
        ...
        },
        {
          ...
          content:
            "Para sitios e-commerce, el monitoreo de indexaci\u00f3n es critico porque las p\u00e1ginas no indexadas generan cero tr\u00e1fico organico. El informe de Indexaci\u00f3n de p\u00e1ginas en GSC muestra exactamente cuantas de tus p\u00e1ginas estan en el indice de Google y por que otras estan excluidas.\n\nRevisa este informe al menos mensualmente y rastrea tu conteo de p\u00e1ginas indexadas a lo largo del tiempo. Una caida repentina en p\u00e1ginas indexadas podria significar que Google encontro errores de rastreo, tu robots.txt se actualizo accidentalmente, o una migracion de sitio salio mal. Hemos visto tiendas perder el 40% de su tr\u00e1fico organico de la noche a la manana porque un desarrollador agrego accidentalmente una etiqueta noindex a una plantilla que se renderizaba en miles de p\u00e1ginas de producto.\n\nPresta atenci\u00f3n especial a los estados \"Descubierta - actualmente no indexada\" y \"Rastreada - actualmente no indexada\". El primero significa que Google conoce la p\u00e1gina pero no la ha rastreado aun, a menudo debido a limitaciones del [presupuesto de rastreo](/academy/crawl-budget-management). El segundo significa que Google rastro la p\u00e1gina pero eligio no indexarla, usualmente porque el contenido era demasiado delgado o demasiado similar a otras p\u00e1ginas. Para e-commerce, el segundo estado a menudo afecta variantes de producto o p\u00e1ginas de categor\u00edas filtradas.\n\nUsa el informe de Sitemaps junto con la Indexaci\u00f3n de p\u00e1ginas para comparar URLs enviadas versus URLs indexadas. Si enviaste 10.000 URLs de producto pero solo 6.500 estan indexadas, tienes 3.500 p\u00e1ginas que necesitan investigaci\u00f3n. Agrupalas por patr\u00f3n para encontrar problemas sistematicos en lugar de arreglar p\u00e1ginas una por una.",
          tip: "Crea una hoja de c\u00e1lculo mensual de seguimiento de indexaci\u00f3n. Registra el total de p\u00e1ginas indexadas, total de p\u00e1ginas excluidas y el desglose de razones de exclusion. En tres a seis meses, detectaras tendencias que revelan si la salud de tu sitio esta mejorando o empeorando.",
          image: {
        ...
        },
        {
          ...
          content:
            "La herramienta de Inspeccion de URL te permite verificar exactamente como Google ve cualquier p\u00e1gina especifica de tu sitio. Ingresa una URL y veras si la p\u00e1gina esta indexada, cuando fue rastreada por \u00faltima vez, la URL canonical que Google selecciono y si es elegible para resultados enriquecidos.\n\nPara e-commerce, usa esta herramienta cada vez que publiques nuevos productos, actualices p\u00e1ginas importantes o soluciones problemas de indexaci\u00f3n. Despues de lanzar una nueva coleccion de productos, inspecciona la p\u00e1gina principal de la coleccion para confirmar que fue rastreada e indexada. Si no lo fue, usa el bot\u00f3n \"Solicitar indexaci\u00f3n\" para pedir a Google que la rastree antes. Esto no garantiza indexaci\u00f3n inmediata, pero coloca la URL en una cola de rastreo prioritaria.\n\nLa vista de HTML renderizado dentro de la Inspeccion de URL es especialmente util para tiendas que usan frontends con mucho JavaScript. Te muestra exactamente lo que Google ve despues del renderizado, lo cual puede ser muy diferente de tu HTML fuente. Si los precios de productos, resenas o datos estructurados no aparecen en la vista renderizada, Google no puede usar esa informaci\u00f3n para posicionamiento o resultados enriquecidos.\n\nUn patr\u00f3n comun que vemos son conflictos de etiquetas canonical. Podrias establecer un canonical apuntando a la URL A, pero Google selecciona la URL B como canonical. La herramienta de Inspeccion de URL revela estos conflictos para que puedas corregirlos. Esto sucede frecuentemente con p\u00e1ginas de producto accesibles a traves de multiples rutas de categor\u00edas o con parametros de URL que crean versiones duplicadas.",
          items: [
            "Inspecciona nuevas p\u00e1ginas de producto para verificar rastreo e indexaci\u00f3n correctos",
            ...
            "Usa Solicitar indexaci\u00f3n para lanzamientos de productos urgentes y actualizaciones",
          ],
        },
        {
          title: "Convertir datos de GSC en acciones",
          content:
            "El valor de GSC viene de convertir datos en planes de acci\u00f3n. Los datos crudos en informes no mejoran posicionamientos. Necesitas un proceso sistematico para extraer insights e implementar cambios.\n\nComienza con un ciclo mensual de optimizaci\u00f3n de contenido. Exporta tus 200 consultas principales del informe de Rendimiento y ordenalas por impresiones. Para cada consulta, revisa la p\u00e1gina de destino y pregunta: esta p\u00e1gina satisface completamente la intenci\u00f3n de busqueda? El title tag incluye la consulta? El contenido es suficientemente completo? Este proceso tipicamente revela 15-25 p\u00e1ginas por mes que se benefician de optimizaci\u00f3n.\n\nConstruye un dashboard de salud t\u00e9cnica usando datos de GSC. Rastrea tus p\u00e1ginas indexadas totales, errores de rastreo, problemas de usabilidad movil y puntuaciones de Core Web Vitals a lo largo del tiempo. Cuando cualquier m\u00e9trica tienda en la direccion equivocada, investiga inmediatamente en lugar de esperar caidas de tr\u00e1fico. La prevencion es significativamente m\u00e1s barata que la recuperacion en SEO.\n\nPara negocios e-commerce estacionales, usa la funcion de comparacion de fechas de GSC para entender tus patrones de tr\u00e1fico interanuales. Compara este diciembre con el diciembre pasado, esta semana de Black Friday con la del a\u00c3\u00b1o pasado. Esto te ayuda a establecer expectativas realistas e identificar si los cambios en el tr\u00e1fico se deben a tus esfuerzos de SEO o simplemente a patrones estacionales. Tambi\u00e9n te ayuda a preparar contenido antes de los picos estacionales observando cuando las consultas especificas comienzan a subir cada a\u00c3\u00b1o. Un proceso estructurado de [auditoria SEO para ecommerce](/blog/how-to-make-ecommerce-seo-audit) te ayuda a detectar estos problemas antes de que impacten el tr\u00e1fico.",
        },
      ],
      navLabels: {
        previous: "Intenci\u00f3n de busqueda en e-commerce",
        next: "Investigaci\u00f3n de palabras clave para e-commerce",
      },
    },
    it: {
