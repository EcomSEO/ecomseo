...
export const searchIntentForEcommerce: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro: "Chaque requete de recherche a un objectif, et Google est exceptionnellement doue pour le determiner. Quand vos pages correspondent au bon type d'intention, vous obtenez de meilleurs classements et plus de conversions. Quand vous vous trompez, meme un SEO on-page parfait ne vous sauvera pas.",
      readTime: "10 min de lecture",
      sections: [
        {
          title: "Ce que l'intention de recherche signifie pour les boutiques en ligne",
          content:
            "L'intention de recherche est la raison pour laquelle quelqu'un tape une requete dans Google. Cherche-t-il une marque sp\u00e9cifique ? Fait-il des recherches sur une cat\u00e9gorie de produits ? Compare-t-il des options ? Est-il pret a acheter ? Google classe chaque requete dans une cat\u00e9gorie d'intention et propose des resultats correspondant a cette classification.\n\nPour l'e-commerce, l'intention est primordiale. Une page qui correspond a l'intention de l'utilisateur obtient des taux de clics plus eleves, un temps passe sur le site plus long et de meilleurs taux de conversion. Google suit ces signaux d'engagement et recompense les pages qui satisfont reellement les attentes des chercheurs. Une page produit classee pour une requete informationnelle sera ignoree, et un article de blog classe pour une requete transactionnelle ne convertira pas.\n\nL'impact pratique est considerable. Les boutiques qui alignent leurs pages sur la bonne intention voient des taux de clics organiques 40 a 60% plus eleves par rapport a celles qui ne le font pas. Comprendre l'intention evite aussi de gaspiller des efforts. Il est inutile d'optimiser une page produit pour une requete ou Google affiche exclusivement des articles de blog et des guides. Ce concept est \u00c3\u00a9troitement li\u00c3\u00a9 \u00c3\u00a0 la [recherche de mots-cl\u00c3\u00a9s pour l'e-commerce](/academy/keyword-research-for-ecommerce), o\u00c3\u00b9 l'analyse de l'intention fa\u00c3\u00a7onne toute votre strat\u00c3\u00a9gie.",
          callout: {
            title: "CTR-Wirkung",
            text: "Les magasins qui font correspondre correctement les types de pages aux intentions de recherche enregistrent des taux de clics organiques 40 à 60 % plus élevés. Les intentions incompatibles sont l’une des raisons les plus courantes pour lesquelles les pages de commerce électronique sont sous-performantes dans les recherches.",
          },
        },
        {
          title: "Les quatre types d'intention de recherche",
          content:
            "Les directives de Google pour les evaluateurs de qualit\u00e9 identifient quatre types d'intention principaux, et chacun correspond directement a des types de pages sp\u00e9cifiques dans votre boutique.\n\nL'intention de navigation correspond aux recherches d'une marque ou d'un site web sp\u00e9cifique. Des requetes comme \"chaussures de course Nike\" ou \"soins de peau Glossier\" signalent que l'utilisateur sait d\u00e9j\u00e0 ce qu'il veut et cherche cette marque en particulier. Ces requetes ont generalement des taux de conversion eleves car l'utilisateur a d\u00e9j\u00e0 decide de la marque.\n\nL'intention informationnelle couvre les requetes ou l'utilisateur veut apprendre quelque chose. \"Comment choisir des chaussures de course\" ou \"meilleure routine de soins pour peau grasse\" sont des requetes informationnelles. Ces utilisateurs ne sont pas encore prets a acheter, mais ils representent le haut de votre entonnoir. Les articles de blog, les guides d'achat et le contenu educatif repondent a cette intention.\n\nL'intention d'investigation commerciale se situe entre l'informationnelle et la transactionnelle. L'utilisateur fait des recherches avant d'acheter. \"Meilleures chaussures de course 2025\" ou \"Cerave vs Cetaphil creme hydratante\" montrent que quelqu'un compare des options. Les pages de cat\u00e9gories, le contenu comparatif et les syntheses d'avis correspondent a cette intention.\n\nL'intention transactionnelle signifie que l'utilisateur est pret a acheter. \"Acheter Nike Air Max 90\" ou \"prix creme hydratante Cerave\" signalent une disposition a l'achat. Les pages produits, les pages de cat\u00e9gories avec boutons d'achat et les pages de promotions repondent a l'intention transactionnelle.",
          items: [
          ...
          image: {
            ...
            alt: "Diagramme en entonnoir montrant les quatre types d'intention de recherche, de l'information en haut à la navigation en bas, avec les taux de conversion et les types de pages correspondants",
            caption: "Chaque type d'intention correspond à des types de pages spécifiques. L’intention d’achat augmente de haut en bas.",
          },
        },
        {
          title: "Associer les types de pages a l'intention",
          content:
            "La cl\u00e9 de l'optimisation de l'intention est de proposer le bon type de page pour chaque requete. L'algorithme de Google a des opinions bien arretees a ce sujet, et aller a contre-courant est une bataille perdue d'avance.\n\nPour les requetes transactionnelles, les pages produits et les pages de cat\u00e9gories bien structurees fonctionnent le mieux. Ces pages doivent avoir des prix clairs, un statut de disponibilite, des boutons d'ajout au panier et des specifications produit. Quand quelqu'un cherche \"acheter t-shirt coton bio\", il veut atterrir sur une page ou il peut reellement acheter, pas lire un article de 2 000 mots sur le coton biologique.\n\nPour les requetes d'investigation commerciale, vous avez besoin de contenu qui aide les utilisateurs a comparer et \u00e9valuer. Les pages de cat\u00e9gories avec des options de filtrage, des tableaux comparatifs et des selections de produits curees fonctionnent bien. Une requete comme \"meilleurs ecouteurs sans fil moins de 100 euros\" fonctionne mieux avec une page qui liste et compare plusieurs options avec avantages et inconvenients.\n\nPour les requetes informationnelles, les articles de blog, les guides d'achat et le contenu FAQ sont vos meilleurs atouts. Ces pages doivent etre approfondies et sincerement utiles. Une requete comme \"comment mesurer sa taille de bague a la maison\" n\u00e9cessite un guide detaille, pas une page de listing de produits.",
          items: [
            "Pages produits : repondent a l'intention transactionnelle avec des prix clairs et des parcours d'achat",
            "Pages de cat\u00e9gories : repondent aux intentions transactionnelle et commerciale avec filtres et tri",
          ...
          tip: "V\u00e9rifiez les 10 premiers resultats actuels pour votre mot-cl\u00e9 cible avant de cr\u00e9er du contenu. Si Google affiche 8 articles de blog et 2 pages de cat\u00e9gories, cr\u00e9er une page produit pour cette requete a peu de chances de se classer. Adaptez-vous au type de page dominant dans les resultats.",
        },
        {
          title: "Comment identifier l'intention a partir des SERPs",
          content:
            "La methode la plus fiable pour determiner l'intention de recherche est de regarder ce que Google classe d\u00e9j\u00e0 pour une requete. Google dispose de milliards de points de donn\u00e9es sur le comportement des utilisateurs, et les resultats affiches refletent ce qui satisfait les chercheurs.\n\nRecherchez votre mot-cl\u00e9 cible et examinez les 10 premiers resultats. Regardez les types de pages classees : s'agit-il de pages produits, de pages de cat\u00e9gories, d'articles de blog ou d'articles comparatifs ? Si 7 resultats sur 10 sont des articles de blog, Google a classe cette requete comme principalement informationnelle. Si tous les resultats sont des pages produits et de cat\u00e9gories, c'est transactionnel.\n\nFaites aussi attention aux fonctionnalit\u00e9s SERP. Les annonces Shopping et les carrousels de produits indiquent une intention transactionnelle. Les extraits en vedette et les encadres \"Autres questions posees\" suggerent une intention informationnelle. Les packs locaux indiquent une intention locale, ce qui compte pour les boutiques ayant des emplacements physiques.\n\nSurveillez les requetes a intention mixte ou Google affiche diff\u00e9rents types de contenu. \"Chaussures de course\" pourrait montrer un melange de pages de cat\u00e9gories, d'avis et de pages de marques car l'intention est ambigue. Pour ces requetes, vous pouvez vous classer avec plusieurs types de pages ciblant diff\u00e9rents aspects.",
          tip: "Creez un simple tableau avec trois colonnes : mot-cl\u00e9, intention dominante et type de page recommande. Classifiez vos 50 a 100 mots-cl\u00e9s cibles principaux de cette maniere avant de construire votre plan de contenu. Cela prend un apres-midi et evite des mois de cr\u00e9ation de contenu mal orientee.",
        },
        {
          title: "Mapping de l'intention tout au long du parcours d'achat",
          content:
            "L'intention de recherche correspond directement au parcours d'achat, et comprendre cette connexion vous aide a capter des clients a chaque \u00e9tape.\n\nA l'\u00e9tape de la prise de conscience, les utilisateurs font des recherches informationnelles. Quelqu'un qui tape \"que signifie le nombre de fils pour les draps\" ne sait pas encore quels draps il veut. Votre contenu blog capture ces utilisateurs et leur presente votre marque. Ces requetes convertissent rarement directement, mais elles construisent la familiarite et la confiance.\n\nA l'\u00e9tape de la consideration, les utilisateurs passent aux requetes d'investigation commerciale. \"Meilleurs draps en coton egyptien\" ou \"Marque A vs Marque B draps\" montre qu'ils restreignent leurs options. Votre contenu comparatif et vos pages de cat\u00e9gories bien organisees captent ce trafic. Les taux de conversion a cette \u00e9tape sont generalement de 2 a 4%, et ces utilisateurs reviennent souvent plus tard pour acheter.\n\nA l'\u00e9tape de la d\u00e9cision, les utilisateurs font des recherches transactionnelles. \"Acheter set de draps luxe Marque X king\" est un utilisateur pret a acheter maintenant. Vos pages produits doivent etre optimisees pour capter et convertir ce trafic a haute valeur. Les taux de conversion pour les requetes transactionnelles atteignent souvent 5 a 10% pour des pages produits bien optimisees.\n\nLa strat\u00e9gie intelligente est de construire des liens internes entre ces types de contenu, creant un chemin du contenu de sensibilisation au contenu comparatif puis aux pages produits. Cela garde les utilisateurs dans votre ecosysteme pendant leur parcours d'achat. Comprendre l'\u00c3\u00a9quilibre entre [intention d'achat et volume de recherche](/academy/buyer-intent-vs-search-volume) vous aide \u00c3\u00a0 d\u00c3\u00a9cider quelle \u00c3\u00a9tape prioriser.",
          items: [
            "\u00c9tape de sensibilisation : le contenu informationnel capture les chercheurs au stade initial",
            "\u00c9tape de consideration : le contenu comparatif et d'avis guide l'\u00e9valuation",
            "\u00c9tape de d\u00e9cision : les pages produits convertissent les acheteurs prets a l'achat",
            "Construisez des liens internes entre les \u00e9tapes pour garder les utilisateurs dans votre ecosysteme",
          ],
          image: {
            src: "/images/academy/fr/buyer-journey-intent-map.svg",
            alt: "Diagramme cartographiant les trois étapes du parcours de l'acheteur (conscience, considération, décision) pour les types d'intention de recherche, les types de pages et les taux de conversion",
            caption: "Les liens internes relient les étapes : le contenu du blog alimente les pages de catégories, qui mènent aux pages de produits.",
          },
        },
        {
          title: "Erreurs d'intention courantes en e-commerce",
          content:
            "L'erreur la plus frequente que nous observons est d'essayer de classer une page produit pour une requete informationnelle. Si quelqu'un cherche \"comment choisir un matelas\", il ne veut pas atterrir sur une page produit d'un seul matelas. Il veut un guide qui explique les niveaux de fermete, les materiaux et les positions de sommeil. Votre page produit ne surpassera jamais un guide complet pour cette requete.\n\nLa deuxieme erreur courante est d'ignorer compl\u00e8tement l'intention commerciale. De nombreuses boutiques ont des pages produits et des articles de blog mais rien entre les deux. Elles manquent toutes les requetes \"meilleur\", \"top\", \"avis\" et \"vs\" qui representent des utilisateurs presque prets a acheter. Ajouter du contenu comparatif et des pages de cat\u00e9gories curees comble cette lacune.\n\nUne autre erreur est la cannibalisation de mots-cl\u00e9s par inadequation d'intention. Si vous avez a la fois une page de cat\u00e9gorie et un article de blog ciblant \"vetements bebe bio\", Google doit choisir lequel classer. Si l'intention est principalement transactionnelle, l'article de blog peut cannibaliser votre page de cat\u00e9gorie. Auditez votre contenu pour vous assurer qu'une seule page cible chaque intention principale pour un mot-cl\u00e9 donne.\n\nEnfin, ne supposez pas que l'intention est statique. Les changements saisonniers modifient l'intention de maniere dramatique. \"Cadeaux Saint-Valentin\" est informationnel en novembre mais devient de plus en plus transactionnel a l'approche de fevrier. Ajustez votre strat\u00e9gie de contenu pour correspondre a ces patterns changeants. Notre guide sur les [mots-cl\u00c3\u00a9s SEO e-commerce](/blog/ecommerce-seo-keywords) explique comment identifier et prioriser les bons termes pour chaque type d'intention.",
        },
      ],
      navLabels: {
    ...
    es: {
      ...
      heading: "Intención de busqueda en e-commerce",
      intro: "Cada consulta de busqueda tiene un proposito detras, y Google es excepcionalmente bueno identificandolo. Cuando alineas tus p\u00c3\u00a1ginas con el tipo correcto de intenci\u00c3\u00b3n, posicionas mejor y conviertes m\u00e1s. Cuando fallas, ni siquiera un SEO on-page perfecto te salvara.",
      readTime: "10 min de lectura",
      sections: [
        {
          title: "Qué significa la intención de busqueda para las tiendas online",
          content:
            "La intenci\u00f3n de busqueda es la raz\u00f3n por la que alguien escribe una consulta en Google. Busca una marca especifica? Investiga una categor\u00eda de producto? Compara opciones? Esta listo para comprar? Google clasifica cada consulta en una categor\u00eda de intenci\u00f3n y muestra resultados que coinciden con esa clasificacion.\n\nPara el e-commerce, la intenci\u00f3n lo es todo. Una p\u00e1gina que coincide con la intenci\u00f3n del usuario obtiene tasas de clics m\u00e1s altas, mayor tiempo en el sitio y mejores tasas de conversion. Google rastrea estas senales de engagement y recompensa las p\u00e1ginas que satisfacen lo que los buscadores realmente quieren. Una p\u00e1gina de producto posicionada para una consulta informativa sera ignorada, y un art\u00edculo de blog posicionado para una consulta transaccional no convertira.\n\nEl impacto practico es significativo. Las tiendas que mapean sus p\u00e1ginas a la intenci\u00f3n correcta ven tasas de clics organicos 40-60% m\u00e1s altas comparadas con las que no lo hacen. Entender la intenci\u00f3n tambi\u00e9n evita desperdiciar esfuerzos. No tiene sentido optimizar una p\u00e1gina de producto para una consulta donde Google muestra exclusivamente art\u00edculos de blog y guias. Este concepto esta estrechamente ligado a la [investigaci\u00f3n de palabras clave para ecommerce](/academy/keyword-research-for-ecommerce), donde el an\u00e1lisis de intenci\u00f3n moldea toda tu estrategia.",
          callout: {
            title: "CTR-Wirkung",
            text: "Las tiendas que relacionan correctamente los tipos de páginas con la intención de búsqueda obtienen tasas de clics orgánicos entre un 40% y un 60% más altas. La intención no coincidente es una de las razones más comunes por las que las páginas de comercio electrónico tienen un rendimiento inferior en las búsquedas.",
          },
        },
        {
          title: "Los cuatro tipos de intención de busqueda",
          content:
            "Las directrices de evaluadores de calidad de Google identifican cuatro tipos principales de intenci\u00f3n, y cada uno se mapea directamente a tipos especificos de p\u00e1ginas en tu tienda.\n\nLa intenci\u00f3n de navegaci\u00f3n ocurre cuando alguien busca una marca o sitio web especifico. Consultas como \"zapatillas running Nike\" o \"skincare Glossier\" senalan que el usuario ya sabe lo que quiere y busca esa marca en particular. Estas consultas tipicamente tienen altas tasas de conversion porque el usuario ya ha decidido la marca.\n\nLa intenci\u00f3n informativa cubre consultas donde el usuario quiere aprender algo. \"Como elegir zapatillas de running\" o \"mejor rutina skincare para piel grasa\" son consultas informativas. Estos usuarios no estan listos para comprar, pero representan la parte superior de tu embudo. Art\u00edculos de blog, guias de compra y contenido educativo sirven esta intenci\u00f3n.\n\nLa intenci\u00f3n de investigaci\u00f3n comercial se situa entre informativa y transaccional. El usuario investiga antes de comprar. \"Mejores zapatillas running 2025\" o \"Cerave vs Cetaphil crema hidratante\" muestran que alguien esta comparando opciones. P\u00e1ginas de categor\u00edas, contenido comparativo y resumenes de resenas se ajustan a esta intenci\u00f3n.\n\nLa intenci\u00f3n transaccional significa que el usuario esta listo para comprar. \"Comprar Nike Air Max 90\" o \"precio crema hidratante Cerave\" senalan disposicion de compra. P\u00e1ginas de producto, p\u00e1ginas de categor\u00edas con botones de compra y p\u00e1ginas de ofertas sirven la intenci\u00f3n transaccional.",
          items: [
            "Navegacional: busquedas de marca, consultas directas de nombres de producto",
            "Informativa: consultas como-hacer, preguntas que-es, investigaci\u00f3n educativa",
          ...
          image: {
            ...
            alt: "Diagrama de embudo que muestra los cuatro tipos de intención de búsqueda, desde informativo en la parte superior hasta de navegación en la parte inferior, con tasas de conversión y tipos de páginas coincidentes.",
            caption: "Cada tipo de intención se asigna a tipos de páginas específicos. La intención de compra aumenta de arriba a abajo.",
          },
        },
        {
          title: "Asignar tipos de página a la intención",
          content:
            "La clave de la optimizaci\u00f3n de intenci\u00f3n es servir el tipo de p\u00e1gina correcto para cada consulta. El algoritmo de Google tiene opiniones fuertes al respecto, y luchar contra ellas es una batalla p\u00e9rdida.\n\nPara consultas transaccionales, las p\u00e1ginas de producto y las p\u00e1ginas de categor\u00edas bien estructuradas funcionan mejor. Estas p\u00e1ginas deben tener precios claros, estado de disponibilidad, botones de anadir al carrito y especificaciones del producto. Cuando alguien busca \"comprar camiseta algodon organico\", quiere llegar a una p\u00e1gina donde pueda realmente comprar una, no leer un art\u00edculo de 2.000 palabras sobre el algodon organico.\n\nPara consultas de investigaci\u00f3n comercial, necesitas contenido que ayude a los usuarios a comparar y evaluar. P\u00e1ginas de categor\u00edas con opciones de filtrado, tablas comparativas y selecciones curadas de productos funcionan bien. Una consulta como \"mejores auriculares inalambricos menos de 100 euros\" funciona mejor con una p\u00e1gina que lista y compara multiples opciones con pros y contras.\n\nPara consultas informativas, los art\u00edculos de blog, guias de compra y contenido FAQ son tus mejores activos. Estas p\u00e1ginas deben ser exhaustivas y genuinamente utiles. Una consulta como \"como medir talla de anillo en casa\" necesita una guia detallada, no una p\u00e1gina de listado de productos.",
          items: [
            "P\u00e1ginas de producto: sirven intenci\u00f3n transaccional con precios claros y rutas de compra",
            "P\u00e1ginas de categor\u00eda: sirven intenci\u00f3n transaccional y comercial con filtros y ordenacion",
            "Art\u00edculos de blog y guias: sirven intenci\u00f3n informativa con profundidad educativa",
            "P\u00e1ginas de comparacion: sirven intenci\u00f3n comercial con evaluaciones lado a lado",
            "Landing pages: sirven intenci\u00f3n de navegaci\u00f3n para campa\u00f1as de marca",
          ],
          tip: "Revisa los 10 primeros resultados actuales para tu palabra clave objetivo antes de crear contenido. Si Google muestra 8 art\u00edculos de blog y 2 p\u00e1ginas de categor\u00edas, crear una p\u00e1gina de producto para esa consulta es improbable que posicione. Adapta al tipo de p\u00e1gina dominante en los resultados.",
        },
        {
          title: "Cómo identificar la intención desde los SERPs",
          content:
            "La forma m\u00e1s fiable de determinar la intenci\u00f3n de busqueda es mirar lo que Google ya posiciona para una consulta. Google tiene miles de millones de puntos de datos sobre el comportamiento de los usuarios, y los resultados que muestra reflejan lo que satisface a los buscadores.\n\nBusca tu palabra clave objetivo y examina los 10 primeros resultados. Mira los tipos de p\u00e1ginas que posicionan: son p\u00e1ginas de producto, p\u00e1ginas de categor\u00edas, art\u00edculos de blog o art\u00edculos comparativos? Si 7 de 10 resultados son art\u00edculos de blog, Google ha clasificado esa consulta como principalmente informativa. Si todos los resultados son p\u00e1ginas de producto y categor\u00edas, es transaccional.\n\nTambi\u00e9n presta atenci\u00f3n a las funciones SERP. Los anuncios de Shopping y carruseles de productos indican intenci\u00f3n transaccional. Los fragmentos destacados y las cajas de \"La gente tambi\u00e9n pregunta\" sugieren intenci\u00f3n informativa. Los packs locales indican intenci\u00f3n local, relevante para tiendas con ubicaciones fisicas.\n\nObserva las consultas con intenci\u00f3n mixta donde Google muestra diferentes tipos de contenido. \"Zapatillas running\" podria mostrar una mezcla de p\u00e1ginas de categor\u00edas, resenas y p\u00e1ginas de marca porque la intenci\u00f3n es ambigua. Para estas consultas, puedes posicionar con multiples tipos de p\u00e1gina apuntando a diferentes aspectos.",
          tip: "Crea una hoja de c\u00e1lculo sencilla con tres columnas: palabra clave, intenci\u00f3n dominante y tipo de p\u00e1gina recomendado. Clasifica tus 50-100 palabras clave objetivo principales de esta manera antes de construir tu plan de contenido. Toma una tarde y previene meses de creaci\u00f3n de contenido desalineada.",
        },
        {
          title: "Mapeo de intención a traves del recorrido del comprador",
          content:
            "La intenci\u00f3n de busqueda se mapea directamente al recorrido del comprador, y entender esta conexi\u00f3n te ayuda a captar clientes en cada etapa.\n\nEn la etapa de conciencia, los usuarios buscan consultas informativas. Alguien que escribe \"que significa el n\u00famero de hilos en sabanas\" no sabe aun que sabanas quiere. Tu contenido de blog captura a estos usuarios y les presenta tu marca. Aunque estas consultas raramente convierten directamente, construyen familiaridad y confianza.\n\nEn la etapa de consideraci\u00f3n, los usuarios cambian a consultas de investigaci\u00f3n comercial. \"Mejores sabanas de algodon egipcio\" o \"Marca A vs Marca B sabanas\" muestra que estan reduciendo opciones. Tu contenido comparativo y p\u00e1ginas de categor\u00edas bien organizadas capturan este tr\u00e1fico. Las tasas de conversion en esta etapa tipicamente van del 2 al 4%, y estos usuarios a menudo vuelven despues para comprar.\n\nEn la etapa de decisi\u00f3n, los usuarios buscan consultas transaccionales. \"Comprar set de sabanas de lujo Marca X king\" es un usuario listo para comprar ahora mismo. Tus p\u00e1ginas de producto deben estar optimizadas para captar y convertir este tr\u00e1fico de alto valor. Las tasas de conversion para consultas transaccionales a menudo alcanzan el 5-10% en p\u00e1ginas de producto bien optimizadas.\n\nLa estrategia inteligente es construir enlaces internos entre estos tipos de contenido, creando un camino desde contenido de conciencia pasando por contenido comparativo hasta p\u00e1ginas de producto. Esto mantiene a los usuarios en tu ecosistema mientras avanzan en su recorrido de compra. Comprender el equilibrio entre [intenci\u00f3n de compra vs volumen de busqueda](/academy/buyer-intent-vs-search-volume) te ayuda a decidir que etapa priorizar.",
          items: [
            "Etapa de conciencia: contenido informativo captura investigadores en fase temprana",
            "Etapa de consideraci\u00f3n: contenido comparativo y de resenas guia la evaluaci\u00f3n",
            "Etapa de decisi\u00f3n: p\u00e1ginas de producto convierten compradores listos para comprar",
          ...
          image: {
            ...
            alt: "Diagrama que mapea las tres etapas del recorrido del comprador (conciencia, consideración, decisión) para buscar tipos de intención, tipos de páginas y tasas de conversión.",
            caption: "Los enlaces internos conectan etapas: el contenido del blog se alimenta de páginas de categorías, que conducen a páginas de productos.",
          },
        },
        {
          title: "Errores comunes de intención en e-commerce",
          content:
            "El error m\u00e1s frecuente que vemos es intentar posicionar una p\u00e1gina de producto para una consulta informativa. Si alguien busca \"como elegir un colchon\", no quiere llegar a una p\u00e1gina de producto de un solo colchon. Quiere una guia que explique niveles de firmeza, materiales y posiciones para dormir. Tu p\u00e1gina de producto nunca superara a una guia completa para esa consulta.\n\nEl segundo error comun es ignorar la intenci\u00f3n comercial por completo. Muchas tiendas tienen p\u00e1ginas de producto y art\u00edculos de blog pero nada entre medio. Pierden todas las consultas \"mejor\", \"top\", \"resena\" y \"vs\" que representan usuarios casi listos para comprar. Anadir contenido comparativo y p\u00e1ginas de categor\u00edas curadas llena este vacio.\n\nOtro error es la canibalizaci\u00f3n de palabras clave por desajuste de intenci\u00f3n. Si tienes tanto una p\u00e1gina de categor\u00eda como un art\u00edculo de blog apuntando a \"ropa de bebe organica\", Google tiene que elegir cual posicionar. Si la intenci\u00f3n es principalmente transaccional, el art\u00edculo de blog puede estar canibalizando tu p\u00e1gina de categor\u00eda. Audita tu contenido para asegurar que solo una p\u00e1gina apunta a cada intenci\u00f3n principal para una palabra clave dada.\n\nFinalmente, no asumas que la intenci\u00f3n es estatica. Los cambios estacionales alteran la intenci\u00f3n dramaticamente. \"Regalos San Valentin\" es informativa en noviembre pero se vuelve cada vez m\u00e1s transaccional conforme se acerca febrero. Ajusta tu estrategia de contenido para coincidir con estos patrones cambiantes. Nuestra guia de [palabras clave SEO para ecommerce](/blog/ecommerce-seo-keywords) cubre como identificar y priorizar los terminos correctos para cada tipo de intenci\u00f3n.",
        },
      ],
      navLabels: {
      ...
      sections: [
        {
          ...
          callout: {
            title: "CTR-Wirkung",
            text: "I negozi che abbinano correttamente i tipi di pagina all'intento di ricerca registrano percentuali di clic organiche più elevate del 40-60%. L'intento non corrispondente è uno dei motivi più comuni per cui le pagine di e-commerce hanno un rendimento inferiore nella ricerca.",
          },
        },
        {
          ...
          image: {
            ...
            alt: "Diagramma a imbuto che mostra i quattro tipi di intenti di ricerca, da quello informativo in alto a quello di navigazione in basso, con tassi di conversione e tipi di pagina corrispondenti",
            caption: "Ogni tipo di intento è mappato a tipi di pagina specifici. L’intenzione di acquisto aumenta dall’alto verso il basso.",
          },
        },
        {
      ...
      sections: [
        {
          ...
          callout: {
            title: "CTR-Wirkung",
            text: "Winkels die de paginatypen correct afstemmen op de zoekintentie, zien 40-60% hogere organische klikfrequenties. Niet-overeenkomende intentie is een van de meest voorkomende redenen waarom e-commercepagina's slecht presteren in de zoekresultaten.",
          },
        },
        {
          ...
          image: {
            ...
            alt: "Trechterdiagram met de vier typen zoekintentie, van informatief bovenaan tot navigatie onderaan, met conversiepercentages en overeenkomende paginatypen",
            caption: "Elk intentietype verwijst naar specifieke paginatypen. De koopintentie neemt van boven naar beneden toe.",
          },
        },
        {
        ...
        },
        {
          ...
          image: {
            ...
            alt: "Diagram waarin de drie fases van het koperstraject (bewustzijn, overweging, beslissing) in kaart worden gebracht voor typen zoekintenties, paginatypen en conversiepercentages",
            caption: "Interne links verbinden fasen: bloginhoud wordt ingevoerd in categoriepagina's, die naar productpagina's leiden.",
          },
        },
        {
