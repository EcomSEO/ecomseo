...
export const emailOutreachForLinks: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro:
        "L'outreach par email reste la methode la plus fiable pour obtenir des backlinks de haute qualite vers les sites e-commerce. Contrairement aux strategies passives qui dependent de la decouverte organique du contenu, l'outreach place vos meilleures pages directement devant les proprietaires de sites, redacteurs et blogueurs qui peuvent y creer des liens. Bien execute, une seule campagne d'outreach peut generer des dizaines de backlinks pertinents et autoritaires qui font evoluer les classements.",
