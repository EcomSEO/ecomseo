...
export const competitorBacklinkAnalysis: AcademyTopic = {
  ...
  content: {
    en: {
      ...
      intro:
        "Your competitors have already done the hard work of finding sites willing to link to ecommerce content. Analyzing their backlink profiles reveals exactly which websites, journalists, and bloggers are open to linking in your niche, giving you a proven roadmap instead of guessing where to focus your outreach efforts. Before starting, make sure you understand the [backlink fundamentals for ecommerce](/academy/backlink-fundamentals-for-ecommerce) that determine which links are worth pursuing.",
      ...
      sections: [
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/competitor-link-gap-analysis.svg",
            alt: "Diagram showing how link gap analysis identifies domains linking to competitors but not to your store",
            caption: "Domains linking to multiple competitors are the highest-priority outreach targets. Each gap is a pre-qualified prospect.",
          },
          callout: {
            title: "Pre-Qualified Leads",
            text: "Link gap domains have already proven they link to ecommerce content in your niche. Sites linking to 3+ competitors convert at the highest outreach rates because they actively cover your product category.",
          },
        },
        {
    ...
    de: {
      ...
      intro:
        "Ihre Konkurrenten haben bereits die schwere Arbeit geleistet, Websites zu finden, die bereit sind, auf E-Commerce-Inhalte zu verlinken. Die Analyse ihrer Backlink-Profile zeigt genau, welche Websites, Journalisten und Blogger offen fuer Verlinkungen in Ihrer Nische sind, und gibt Ihnen eine bewaehrte Roadmap, anstatt zu raten, worauf Sie Ihre Outreach-Bemuehungen konzentrieren sollten. Stellen Sie sicher, dass Sie die [Backlink-Grundlagen f\u00fcr Ecommerce](/academy/backlink-fundamentals-for-ecommerce) verstehen, die bestimmen, welche Links es wert sind, verfolgt zu werden.",
      ...
      sections: [
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/de/competitor-link-gap-analysis.svg",
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/de/competitor-link-tactics.svg",
      ...
      sections: [
        {
          ...
          content:
            "Vos concurrents en matiere de liens ne sont pas toujours les memes que vos concurrents commerciaux. Un grand detaillant vendant les memes produits peut dominer en chiffre d'affaires, mais un blog de niche plus petit ou une boutique specialisee peut en fait detenir le profil de backlinks que vous devez \u00e9tudier. Les concurrents en liens sont les sites qui se classent pour vos mots-cl\u00e9s cibles et ont des profils de backlinks solides qui alimentent ces classements.\n\nPour trouver vos concurrents en liens, commencez par vos 20 principaux mots-cl\u00e9s cibles et notez quels domaines apparaissent r\u00e9guli\u00e8rement dans les positions un a cinq. Les domaines qui reviennent de maniere repetee sur plusieurs mots-cl\u00e9s sont vos concurrents principaux. Des outils comme Ahrefs, Semrush ou Moz vous permettent d'entrer votre domaine et de faire apparaitre automatiquement les domaines concurrents bases sur le chevauchement de mots-cl\u00e9s.\n\nConcentrez-vous d'abord sur les concurrents de taille et de mod\u00e8le commercial similaires. Analyser le profil de backlinks d'Amazon ou de grandes surfaces produira principalement des donn\u00e9es non exploitables, leurs liens proviennent d'une \u00e9chelle et d'une notoriete de marque qu'une boutique de taille moyenne ne peut pas repliquer. Etudiez plutot les boutiques et sites de contenu qui sont une ou deux \u00e9tapes devant vous.",
          tip: "Creez un tableur de cinq a huit vrais concurrents en liens. Incluez leur note de domaine, le total des domaines referents et le nombre de mots-cl\u00e9s pour lesquels ils se classent. Mettez-le a jour trimestriellement pour suivre comment votre profil de backlinks se compare.",
        },
        {
          title: "Extraire et organiser les backlinks concurrentiels",
          content:
            "Une fois vos concurrents identifies, extrayez leurs profils de backlinks complets avec Ahrefs, Semrush ou Majestic. Exportez les donn\u00e9es dans un tableur et concentrez-vous sur les colonnes les plus importantes : domaine referent, note de domaine, texte d'ancrage, URL cible, type de lien (dofollow ou nofollow), et date de premi\u00e8re decouverte.\n\nTriez l'export par note de domaine decroissante pour faire apparaitre les liens les plus autoritaires en premier. Ces liens a haute autorite representent vos cibles de plus haute valeur. Un lien d'un site DR 70+ qui lie d\u00e9j\u00e0 un concurrent est un candidat solide pour votre liste de prospection car le site a demontre sa volonte de lier du contenu e-commerce dans votre niche.\n\nFiltrez les liens de faible qualit\u00e9, domaines avec des notes inferieures a 20, sites en langues etrangeres non pertinents pour votre march\u00e9, et fermes de liens ou repertoires evidents. Ce filtrage supprime generalement 40-60% des backlinks d'un concurrent, vous laissant avec une liste curatee d'opportunites de liens genuines. Groupez les liens restants par type : mentions editoriales, avis produits, pages de ressources, articles invites, repertoires et mentions de marque.\n\nPortez attention aux URLs cibles. Si un concurrent a obtenu la majorite de ses liens vers un guide d'achat ou une \u00e9tude de donn\u00e9es sp\u00e9cifique, cela vous indique quel type de contenu attire les liens dans votre niche.",
          items: [
            "Exportez les backlinks concurrentiels et triez par note de domaine pour prioriser les cibles a haute autorite",
            "Filtrez les domaines sous DR 20, les sites de langues non pertinentes et le spam \u00e9vident pour vous concentrer sur les vraies opportunites",
        ...
        },
        {
          ...
          content:
            "Une analyse d'ecart de liens revele les domaines qui lient vos concurrents mais pas vous. C'est l'un des moyens les plus efficaces de construire une liste de prospects car ces sites ont d\u00e9j\u00e0 demontre un int\u00e9r\u00eat pour votre cat\u00e9gorie de produits.\n\nDans Ahrefs, l'outil Link Intersect vous permet d'entrer votre domaine aux cotes de dix concurrents maximum. L'outil retourne une liste de domaines qui lient un ou plusieurs concurrents mais pas votre site. Semrush propose une fonctionnalit\u00e9 similaire appelee Backlink Gap. La liste resultante est essentiellement une liste de prospection pre-qualifiee, chaque domaine a d\u00e9j\u00e0 lie du contenu similaire.\n\nPriorisez les opportunites d'ecart de liens ou un domaine lie plusieurs concurrents. Si un site lie trois de vos cinq concurrents, il a un schema fort de couverture de votre cat\u00e9gorie de produits et est tr\u00e8s susceptible de considerer un lien vers votre contenu egalement.\n\nRecherchez aussi les ecarts au niveau des pages. Si un concurrent a un guide d'achat qui a obtenu 50 domaines referents et que vous n'avez pas de page equivalente, cet ecart represente a la fois une opportunite de contenu et une opportunite de link building.",
          image: {
        ...
        },
        {
          ...
          content:
            "Comprendre a quelle vitesse les concurrents acquierent de nouveaux liens, et quel contenu les obtient actuellement, revele des opportunites tactiques. Un concurrent avec une croissance reguliere de 20-30 nouveaux domaines referents par mois execute un programme de link building actif dont vous pouvez apprendre. Un concurrent dont la croissance de liens stagne presente une opportunite de le depasser.\n\nLa plupart des outils de backlinks permettent de filtrer les liens par date de premi\u00e8re decouverte. Examinez les liens que vos principaux concurrents ont acquis au cours des 90 derniers jours. Cette activite recente montre leur strat\u00e9gie actuelle, obtiennent-ils des liens par des lancements de produits, des campagnes RP, du content marketing ou des articles invites ?\n\nSuivez les schemas saisonniers dans l'acquisition de liens de la concurrence. De nombreuses niches e-commerce voient des pics de liens autour d'evenements sp\u00e9cifiques : guides cadeaux de Noel en novembre, roundups de rentree en aout, ou salons professionnels. En notant quand les concurrents obtiennent le plus de liens, vous pouvez chronometrer votre propre cr\u00e9ation de contenu et prospection pour coincider avec ces fenetres d'opportunite.\n\nComparez la velocite de liens entre concurrents pour calibrer des objectifs realistes. Si les trois premi\u00e8res boutiques de votre niche font en moyenne 15 nouveaux domaines referents par mois, viser 50 par mois est irrealiste.",
        ...
        },
        {
          ...
          content:
            "\u00c9tudier les schemas dans le profil de backlinks d'un concurrent revele l'integralite de leur playbook de link building. Recherchez des clusters de liens partageant des caracteristiques communes, ces clusters indiquent des tactiques sp\u00e9cifiques utilisees par le concurrent.\n\nUn cluster de liens de blogs avec des biographies d'auteur renvoyant au site concurrent indique une strat\u00e9gie active d'articles invites. Notez les blogs acceptant des articles invites, les sujets couverts et les standards de qualit\u00e9. Ces memes blogs sont des cibles potentielles pour votre propre prospection d'articles invites.\n\nPlusieurs liens de sites d'actualites et magazines en ligne, surtout avec des mentions de marque dans le texte d'ancrage, suggerent une strat\u00e9gie de RP numerique. Examinez quelles histoires le concurrent a propose pour obtenir ces liens, lancements de produits, recherche originale, commentaires d'experts ou partenariats caritatifs.\n\nDes liens de pages de ressources (URLs contenant des termes comme /ressources/, /liens/, /outils/) indiquent que le concurrent a poursuivi le link building via des pages de ressources. Visitez chaque page pour comprendre quel type de contenu y est liste et si votre site a du contenu equivalent a soumettre.\n\nDe multiples liens provenant de sites d'actualit\u00c3\u00a9s et de magazines en ligne, surtout avec des mentions de marque dans le texte d'ancrage, sugg\u00c3\u00a8rent une strat\u00c3\u00a9gie de [RP num\u00c3\u00a9riques pour l'e-commerce](/academy/digital-pr-for-ecommerce). Notre guide sur le [SEO off-page pour l'e-commerce](/blog/off-page-seo-for-ecommerce) fournit un cadre complet pour ex\u00c3\u00a9cuter ces strat\u00c3\u00a9gies.",
          items: [
        ...
        },
        {
          ...
          content:
            "Les donn\u00e9es brutes de backlinks concurrentiels sont inutiles sans un plan structure pour agir. Convertissez votre analyse en une liste de prospection priorisee avec des prochaines \u00e9tapes claires pour chaque prospect.\n\nCreez un tableur maitre de prospection avec des colonnes pour : domaine, personne de contact, adresse email, type de lien (article invite, page de ressources, mention editoriale), concurrent actuellement lie, note de domaine, et votre statut de prospection. Remplissez ce tableur a partir de votre analyse d'ecart de liens et de votre revue de backlinks concurrentiels. La plupart des analyses produisent 100-300 prospects viables a partir de cinq profils concurrentiels.\n\nPriorisez les prospects avec un syst\u00e8me de notation. Attribuez des points pour l'autorite de domaine, la pertinence par rapport a votre niche, le nombre de concurrents lies, et le type d'opportunite de lien. Triez par score total et travaillez de haut en bas.\n\nGroupez les prospects par type de prospection. Les prospects de pages de ressources necessitent un email diff\u00e9rent de ceux pour les articles invites ou les journalistes. Regroupez votre prospection par type pour pouvoir personnaliser les mod\u00e8les efficacement. Un tableur de prospection bien organise transforme des mois de link building potentiel en un workflow systematique executable semaine apr\u00e8s semaine.",
          image: {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "Agrupa los enlaces restantes por tipo, menciones editoriales, resenas, p\u00e1ginas de recursos, posts invitados, para identificar patrones",
            "Analiza que URLs objetivo obtuvieron m\u00e1s enlaces para entender que tipos de contenido atraen enlaces en tu nicho",
          ],
        },
        {
          title: "Encontrar brechas de enlaces entre tu y los competidores",
          content:
            "Un an\u00e1lisis de brecha de enlaces revela dominios que enlazan a tus competidores pero no a ti. Esta es una de las formas m\u00e1s eficientes de construir una lista de prospectos porque estos sitios ya han demostrado inter\u00e9s en tu categor\u00eda de producto.\n\nEn Ahrefs, la herramienta Link Intersect te permite introducir tu dominio junto con hasta diez competidores. La herramienta devuelve una lista de dominios que enlazan a uno o m\u00e1s competidores pero no a tu sitio. Semrush ofrece una funcionalidad similar llamada Backlink Gap. La lista resultante es esencialmente una lista de outreach precalificada, cada dominio en ella ha enlazado contenido similar previamente.\n\nPrioriza las oportunidades de brecha de enlaces donde un dominio enlaza a multiples competidores. Si un sitio enlaza a tres de tus cinco competidores, tiene un patr\u00f3n fuerte de cubrir tu categor\u00eda de producto y es muy probable que considere enlazar tu contenido tambi\u00e9n.\n\nTambi\u00e9n busca brechas a nivel de p\u00e1gina. Si un competidor tiene una guia de compra que obtuvo 50 dominios referentes y tu no tienes una p\u00e1gina equivalente, esa brecha representa tanto una oportunidad de contenido como una de link building.",
          image: {
        ...
        },
        {
          ...
          content:
            "Entender que tan r\u00e1pido los competidores adquieren nuevos enlaces, y que contenido los esta obteniendo actualmente, revela oportunidades t\u00e1cticas. Un competidor con crecimiento constante de 20-30 nuevos dominios referentes por mes esta ejecutando un programa activo de link building del que puedes aprender. Un competidor cuyo crecimiento de enlaces se ha estancado presenta una oportunidad para superarlo.\n\nLa mayoria de herramientas de backlinks permiten filtrar enlaces por la fecha en que fueron descubiertos. Revisa los enlaces que tus principales competidores adquirieron en los \u00faltimos 90 dias. Esta actividad reciente muestra su estrategia actual, estan obteniendo enlaces a traves de lanzamientos de productos, campa\u00f1as de PR, marketing de contenidos o guest posting?\n\nRastrea patrones estacionales en la adquisicion de enlaces de la competencia. Muchos nichos ecommerce ven picos de enlaces alrededor de eventos especificos: guias de regalos navidenos en noviembre, roundups de vuelta al cole en agosto, o ferias comerciales de la industria.\n\nCompara la velocidad de enlaces entre competidores para calibrar objetivos realistas. Si las tres principales tiendas en tu nicho promedian 15 nuevos dominios referentes por mes, establecer un objetivo de 50 por mes es irrealista.",
          tip: "Configura alertas semanales en Ahrefs para tus tres principales competidores. Cada vez que obtengan un nuevo backlink de un dominio DR 40+, recibiras una notificacion. Esto te permite reaccionar r\u00e1pidamente, si un competidor aparece en un art\u00edculo roundup, puedes contactar al mismo autor antes de que el art\u00edculo se vuelva obsoleto.",
        },
        {
          title: "Replicar las t\u00e1cticas de link building de la competencia",
          content:
            "Estudiar los patrones en el perfil de backlinks de un competidor revela todo su libro de jugadas de link building. Busca clusters de enlaces que compartan caracteristicas comunes, estos clusters indican t\u00e1cticas especificas que el competidor esta usando.\n\nUn cluster de enlaces de blogs con biografias de autor que enlazan de vuelta al sitio del competidor indica una estrategia activa de guest posting. Anota los blogs que aceptan posts invitados, los temas cubiertos y los est\u00e1ndares de calidad. Estos mismos blogs son objetivos potenciales para tu propio outreach de guest posting.\n\nMultiples enlaces de sitios de noticias y revistas online, especialmente con menciones de marca en el texto ancla, sugieren una estrategia de [PR digital](/academy/digital-pr-for-ecommerce). Examina que historias el competidor presento para obtener esos enlaces, lanzamientos de productos, investigaci\u00f3n original, comentarios de expertos o asociaciones beneficas.\n\nEnlaces de p\u00e1ginas de recursos (URLs que contienen terminos como /recursos/, /enlaces/, /herramientas/) indican que el competidor ha perseguido link building de p\u00e1ginas de recursos. Visita cada p\u00e1gina de recursos para entender que tipo de contenido se lista y si tu sitio tiene contenido equivalente que valga la pena enviar. Nuestra guia de [SEO off-page para ecommerce](/blog/off-page-seo-for-ecommerce) proporciona un marco completo para ejecutar estas estrategias.",
          items: [
            ...
            "Los enlaces de p\u00e1ginas de recursos son identificables por patrones de URL como /recursos/ o /enlaces-utiles/",
            "Multiples enlaces de las mismas p\u00e1ginas que tambi\u00e9n contienen enlaces muertos pueden indicar actividad de broken link building",
          ],
        },
        {
          title: "Convertir el análisis en un plan de outreach accionable",
          content:
            "Los datos brutos de backlinks de la competencia son inutiles sin un plan estructurado para actuar. Convierte tu an\u00e1lisis en una lista de outreach priorizada con proximos pasos claros para cada prospecto.\n\nCrea una hoja de c\u00e1lculo maestra de prospeccion con columnas para: dominio, persona de contacto, direccion de email, tipo de enlace (guest post, p\u00e1gina de recursos, mencion editorial), competidor al que actualmente enlazan, su calificacion de dominio y tu estado de outreach. Rellena esta hoja con tu an\u00e1lisis de brecha de enlaces y revision de backlinks de la competencia. La mayoria de an\u00e1lisis producen 100-300 prospectos viables de cinco perfiles de competidores.\n\nPrioriza prospectos usando un sistema de puntuacion. Asigna puntos por autoridad de dominio, relevancia para tu nicho, n\u00famero de competidores a los que enlazan y el tipo de oportunidad de enlace. Ordena por puntuacion total y trabaja de arriba abajo.\n\nAgrupa prospectos por tipo de outreach. Los prospectos de p\u00e1ginas de recursos necesitan un email diferente que los de guest posts o los periodistas que cubren tu categor\u00eda de producto. Agrupa tu outreach por tipo para personalizar plantillas eficientemente. Una hoja de prospeccion bien organizada transforma meses de link building potencial en un flujo de trabajo sistematico ejecutable semana a semana.",
          image: {
    ...
    it: {
      ...
      intro:
        "I tuoi concorrenti hanno gia fatto il lavoro duro di trovare siti disposti a linkare contenuti ecommerce. Analizzare i loro profili di backlink rivela esattamente quali siti web, giornalisti e blogger sono aperti ai link nella tua nicchia, dandoti una roadmap collaudata invece di indovinare dove concentrare i tuoi sforzi di outreach. Approfondisci con la nostra guida sui [fondamentali dei backlink per l'ecommerce](/academy/backlink-fundamentals-for-ecommerce).",
