...
export const backlinkFundamentalsForEcommerce: AcademyTopic = {
  ...
  content: {
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/backlink-value-factors.svg",
            alt: "Diagram showing the four factors that determine backlink value: relevance, authority, placement, and dofollow status",
            caption: "Google evaluates every backlink on four factors. A link that scores well on all four is worth ten links that only meet one criterion.",
          },
        ...
        },
        {
          ...
          callout: {
            title: "Easy Win",
            text: "Check every manufacturer and supplier you stock for dealer directories or authorized retailer pages. These links are highly relevant, often DR 50+, and require only a listing request to secure.",
          },
        },
        {
        ...
        {
          title: "anchorMismatchDemotion and sourceType: Hidden Link-Quality Signals From the Leak",
          content:
            "The leak (catalogued for searchability at sites like seo-datawarehouse.com) confirmed Google's link evaluation goes well beyond raw PageRank. Two attributes matter for ecommerce link strategy.\n\nanchorMismatchDemotion: when an inbound link's anchor text is topically mismatched with the target page, the link can be devalued or actively demoted, not just ignored. A link from a tech blog with anchor \"running shoes\" pointing to your hiking-boots page is worse than no link at all. The historic SEO advice to \"diversify anchor text aggressively\" backfires when the mismatched anchors look manipulative.\n\nsourceType: links are categorised by the type of source. Editorial links from established, high-traffic sites carry materially more weight than directory links, footer links, or links from low-traffic auto-generated pages. The leak's classification suggests Google explicitly distinguishes between an editorial mention in a relevant publication and a sidebar link on a generic blogroll \u2014 and only the first counts for serious authority transfer.\n\nThe practical strategy: pursue fewer, more topically aligned links from genuinely trafficked editorial publications. Audit your existing link profile for mismatched anchors and disavow or request removal where the anchor undermines target relevance.",
          items: [
            "anchorMismatchDemotion can devalue or actively demote links whose anchors don't match the target page topic",
            "sourceType distinguishes editorial in-content links from footer/directory/sidebar \u2014 only editorial in-content carries serious weight",
            "Aggressive anchor-text diversification with mismatched anchors backfires under the leaked signal",
            "Audit and prune mismatched anchors; pursue fewer, more topically aligned editorial links",
          ],
          callout: {
            title: "The leaked attribute names are publicly indexed",
            text: "Researchers have catalogued the disclosed signals (siteAuthority, NavBoost, anchorMismatchDemotion, sourceType, hostAge, contentEffort, etc.) at sites like seo-datawarehouse.com. Use them as a vocabulary when explaining link strategy to teams or clients \u2014 \"this link will trigger anchorMismatchDemotion\" lands harder than generic \"this link looks unnatural.\"",
          },
        },
      ],
      navLabels: {
    ...
    de: {
      ...
      intro:
        "Backlinks bleiben eines der staerksten Ranking-Signale, die Google zur Bewertung von Online-Shops nutzt. Jeder Link von einer anderen Website fungiert als Vertrauensbeweis und signalisiert Suchmaschinen, dass Ihr Shop etwas Referenzwuerdiges bietet. Zu verstehen, wie Backlinks funktionieren, und welche tatsaechlich etwas fuer E-Commerce bewegen, bildet das Fundament fuer jede [Linkaufbau](/link-building)-Strategie in diesem Cluster.",
      ...
      sections: [
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/de/backlink-value-factors.svg",
        ...
        },
        {
          ...
          image: {
            src: "/images/academy/de/ecommerce-backlink-types.svg",
        ...
        {
          title: "anchorMismatchDemotion und sourceType: Versteckte Link-Qualitaets-Signale aus dem Leak",
          content:
            "Das Leak (zur Durchsuchbarkeit auf Seiten wie seo-datawarehouse.com katalogisiert) bestaetigte, dass Googles Link-Bewertung weit ueber rohes PageRank hinausgeht. Zwei Attribute zaehlen fuer E-Commerce-Link-Strategie.\n\nanchorMismatchDemotion: Wenn der Ankertext eines eingehenden Links topisch nicht zur Zielseite passt, kann der Link entwertet oder aktiv herabgestuft werden, nicht nur ignoriert. Ein Link von einem Tech-Blog mit Anker \"Laufschuhe\" der auf Ihre Wanderschuhe-Seite zeigt, ist schlechter als gar kein Link. Der historische SEO-Rat, \"Ankertext aggressiv zu diversifizieren\", schlaegt fehl, wenn die nicht passenden Anker manipulativ aussehen.\n\nsourceType: Links werden nach Quellentyp kategorisiert. Redaktionelle Links von etablierten, traffic-starken Seiten tragen materiell mehr Gewicht als Verzeichnis-Links, Footer-Links oder Links von traffic-armen auto-generierten Seiten. Die Klassifizierung des Leaks deutet an, dass Google explizit zwischen einer redaktionellen Erwaehnung in einer relevanten Publikation und einem Sidebar-Link auf einem generischen Blogroll unterscheidet - und nur die erste zaehlt fuer ernsthaften Autoritaets-Transfer.\n\nDie praktische Strategie: Verfolgen Sie weniger, topisch besser ausgerichtete Links von genuin getrafften redaktionellen Publikationen. Auditieren Sie Ihr existierendes Link-Profil auf nicht passende Anker und disavowen oder fordern Sie Entfernung an, wo der Anker die Ziel-Relevanz untergraebt.",
          items: [
            "anchorMismatchDemotion kann Links entwerten oder aktiv herabstufen, deren Anker nicht zum Ziel-Seitenthema passen",
            "sourceType unterscheidet redaktionelle In-Content-Links von Footer/Verzeichnis/Sidebar - nur redaktionelle In-Content-Links tragen ernsthaftes Gewicht",
            "Aggressive Ankertext-Diversifikation mit nicht passenden Ankern schlaegt unter dem geleakten Signal fehl",
            "Auditieren und prunen Sie nicht passende Anker; verfolgen Sie weniger, topisch besser ausgerichtete redaktionelle Links",
          ],
          callout: {
            title: "Die geleakten Attributnamen sind oeffentlich indexiert",
            text: "Forscher haben die offengelegten Signale (siteAuthority, NavBoost, anchorMismatchDemotion, sourceType, hostAge, contentEffort, etc.) auf Seiten wie seo-datawarehouse.com katalogisiert. Nutzen Sie sie als Vokabular bei der Erklaerung von Link-Strategie an Teams oder Kunden - \"dieser Link wird anchorMismatchDemotion ausloesen\" landet haerter als generisches \"dieser Link sieht unnatuerlich aus\".",
          },
        },
      ],
      navLabels: {
      ...
      sections: [
        {
          ...
          content:
            "Google traite les backlinks comme des recommandations de tiers. Quand un site web repute pointe vers votre page produit, page cat\u00e9gorie ou article de blog, Google interprete cela comme un signal que votre contenu est fiable et utile. Pour les boutiques e-commerce en competition sur des march\u00e9s satures, les backlinks determinent souvent qui se classe en premi\u00e8re page et qui reste en troisieme page.\n\nLe lien entre backlinks et classements est bien documente. Les pages dans les trois premi\u00e8res positions organiques ont, en moyenne, trois a cinq fois plus de domaines referents que les pages classees aux positions sept a dix. Pour les pages produit et cat\u00e9gorie, pour lesquelles il est intrinsequement plus difficile d'obtenir des liens, meme une poignee de backlinks de qualit\u00e9 peut cr\u00e9er un avantage significatif par rapport aux concurrents sans liens externes.\n\nLes backlinks accelerent egalement le crawl et l'indexation. Google decouvre de nouvelles pages en suivant les liens a travers le web. Si votre nouvelle page produit obtient un lien d'un blog ou site d'actualites bien crawle, Googlebot trouvera et indexera cette page plus rapidement que s'il se fiait uniquement a votre sitemap XML. Pour les boutiques qui lancent de nouveaux produits ou des collections saisonni\u00e8res, cet avantage de vitesse se traduit directement en visibilite et ventes anticipees.",
          items: [
            "Les backlinks sont des recommandations de tiers qui signalent la confiance et la qualit\u00e9 du contenu a Google",
        ...
        },
        {
          ...
          content:
            "L'\u00e9valuation des liens par Google a considerablement evolue depuis les debuts de PageRank. L'algorithme considere desormais le contexte complet entourant un lien, pas seulement le nombre brut de domaines referents. Un seul lien d'une page hautement pertinente et autoritaire au sein d'un article bien structure peut l'emporter sur des dizaines de liens provenant de repertoires de faible qualit\u00e9 ou de sections de commentaires de blog.\n\nLe texte d'ancrage, le texte cliquable d'un lien, fournit a Google un signal fort sur le sujet de la page liee. Les profils de backlinks naturels montrent un texte d'ancrage diversifie : ancres de marque (le nom de votre boutique), ancres generiques (\"cliquez ici\", \"ce site\"), URLs brutes, et occasionnellement des ancres riches en mots-cl\u00e9s. Si un grand pourcentage de vos backlinks utilise des ancres de mots-cl\u00e9s a correspondance exacte, Google peut considerer cela comme manipulatif.\n\nGoogle \u00e9value egalement la velocite des liens, le rythme auquel un site acquiert de nouveaux backlinks au fil du temps. Un profil naturel montre une croissance reguliere et organique avec des pics occasionnels autour de lancements de produits, evenements de vente ou contenu viral.\n\nLes voisinages de liens comptent aussi. Si les sites qui vous lient pointent egalement vers des sites spammeurs ou de faible qualit\u00e9, la valeur de ces liens diminue. Inversement, si votre profil de backlinks partage des domaines referents avec des concurrents respectes dans votre niche, Google voit votre site plus favorablement.",
          tip: "Effectuez un audit mensuel des backlinks avec Ahrefs ou Google Search Console. Recherchez les pics soudains de liens de faible qualit\u00e9, le texte d'ancrage sur-optimise ou les liens de niches non pertinentes. Desavouer les liens toxiques avant qu'ils ne s'accumulent previent les penalites de classement potentielles.",
          image: {
        ...
        },
        {
          ...
          content:
            "Avant de poursuivre un link building actif, assurez-vous que votre boutique possede des pages qui meritent d'etre liees. La plupart des pages produit de la plupart des boutiques ne sont pas intrinsequement dignes d'etre liees, elles ressemblent au meme produit chez dix autres detaillants. Pour obtenir des liens, vous devez cr\u00e9er des actifs differencies.\n\nLa recherche originale est l'un des plus puissants aimants a liens. Sondez vos clients sur leurs pr\u00e9f\u00e9rences d'achat, analysez vos donn\u00e9es de vente pour identifier des tendances industrielles, ou compilez des donn\u00e9es de prix a travers votre cat\u00e9gorie. Une \u00e9tude de donn\u00e9es bien presentee, meme simple, peut obtenir des liens de blogs industriels, medias d'information et ressources academiques qui ne lieraient jamais une page produit standard.\n\nLes guides d'achat complets qui vont au-dela des conseils superficiels attirent egalement des liens. Un guide de 3 000 mots sur le choix de la bonne chaise de bureau couvrant les principes ergonomiques, les comparaisons de materiaux, les considerations de capacite de charge et les conseils d'entretien devient une r\u00e9f\u00e9rence que d'autres createurs de contenu veulent citer.\n\nLes outils interactifs, calculateurs de taille, configurateurs de produits, verificateurs de compatibilite, obtiennent des liens car ils offrent une utilite unique qui ne peut pas etre reproduite dans un simple article texte. Des strat\u00c3\u00a9gies comme les [RP num\u00c3\u00a9riques pour l'e-commerce](/academy/digital-pr-for-ecommerce) peuvent amplifier le contenu bas\u00c3\u00a9 sur les donn\u00c3\u00a9es en dizaines de liens \u00c3\u00a0 haute autorit\u00c3\u00a9.",
        },
        {
          title: "Eviter les penalites de link building",
          content:
            "L'algorithme Penguin de Google cible sp\u00e9cifiquement le link building manipulatif. Comprendre ce qui declenche les penalites vous aide a construire un profil de backlinks durable. Les liens payes sans divulgation appropriee violent les directives de Google. Si vous payez pour un lien, il doit porter un attribut sponsored ou nofollow. Les liens payes non divulgues risquent une action manuelle qui peut effondrer vos classements du jour au lendemain.\n\nLes reseaux de blogs prives (PBNs), des reseaux de sites crees uniquement pour manipuler les classements par des pages inter-liees, sont un declencheur de penalite bien connu. Google devient de plus en plus efficace pour detecter les empreintes de PBN, et le boost de classement temporaire qu'ils fournissent vaut rarement le risque d'une penalite a l'\u00e9chelle du domaine.\n\nLes echanges de liens excessifs (\"je te lie si tu me lies\") declenchent egalement des signaux d'alerte quand ils sont pratiques a grande \u00e9chelle. Bien que le lien reciproque naturel entre entreprises genuinement liees soit acceptable, les echanges systematiques avec des dizaines de sites non lies paraissent artificiels.\n\nL'approche la plus sure est de se concentrer sur l'obtention de liens par du contenu genuinement utile, de vraies relations commerciales et des activites dignes d'int\u00e9r\u00eat mediatique. Ces liens sont durables car ils refletent la vraie valeur que votre boutique apporte. Notre guide sur le [SEO off-page pour l'e-commerce](/blog/off-page-seo-for-ecommerce) explique comment construire un profil de backlinks r\u00c3\u00a9sistant aux p\u00c3\u00a9nalit\u00c3\u00a9s.",
          items: [
            ...
            "Les echanges de liens systematiques a grande \u00e9chelle semblent manipulatifs meme si les echanges individuels paraissent naturels",
    ...
    es: {
      ...
      intro: "Los backlinks siguen siendo una de las senales de posicionamiento m\u00e1s fuertes que Google utiliza para evaluar tiendas online. Cada enlace desde otro sitio web actua como un voto de confianza, indicando a los motores de busqueda que tu tienda ofrece algo digno de ser referenciado. Entender como funcionan los backlinks, y cuales realmente marcan la diferencia para el ecommerce, es la base de toda estrategia de [link building](/link-building) cubierta en este cluster.",
      readTime: "11 min de lectura",
      sections: [
        {
          title: "Por qué los backlinks importan para las tiendas online",
          content:
            "Google trata los backlinks como recomendaciones de terceros. Cuando un sitio web reputado enlaza a tu p\u00e1gina de producto, p\u00e1gina de categor\u00eda o art\u00edculo de blog, Google interpreta esto como una senal de que tu contenido es confiable y util. Para tiendas ecommerce compitiendo en mercados saturados, los backlinks a menudo determinan quien posiciona en la primera p\u00e1gina versus quien se queda en la tercera.\n\nLa conexi\u00f3n entre backlinks y posicionamiento esta bien documentada. Las p\u00e1ginas en las tres primeras posiciones organicas tienen, en promedio, de tres a cinco veces m\u00e1s dominios referentes que las p\u00e1ginas posicionadas entre las posiciones siete y diez. Para p\u00e1ginas de producto y categor\u00eda, que son intr\u00c3\u00adnsecamente m\u00e1s dificiles para conseguir enlaces, incluso un punado de backlinks de calidad puede crear una ventaja significativa sobre competidores sin enlaces externos.\n\nLos backlinks tambi\u00e9n aceleran el rastreo y la indexaci\u00f3n. Google descubre nuevas p\u00e1ginas siguiendo enlaces a traves de la web. Si tu nueva p\u00e1gina de producto obtiene un enlace de un blog o sitio de noticias bien rastreado, Googlebot encontrara e indexara esa p\u00e1gina m\u00e1s r\u00e1pido que si dependiera unicamente de tu sitemap XML. Para tiendas lanzando nuevos productos o colecciones de temporada, esta ventaja de velocidad se traduce directamente en visibilidad y ventas m\u00e1s tempranas.",
          items: [
            "Los backlinks son recomendaciones de terceros que senalan confianza y calidad de contenido a Google",
            "Las p\u00e1ginas mejor posicionadas tipicamente tienen de tres a cinco veces m\u00e1s dominios referentes que las p\u00e1ginas peor posicionadas",
            "Los enlaces de sitios bien rastreados ayudan a Google a descubrir e indexar nuevas p\u00e1ginas de producto m\u00e1s r\u00e1pido",
            "Las p\u00e1ginas ecommerce con incluso unos pocos backlinks de calidad obtienen ventajas significativas de posicionamiento en nichos competitivos",
          ],
        },
        {
          title: "Qué hace valioso a un backlink",
          content:
            "No todos los backlinks tienen el mismo peso. Google eval\u00faa los enlaces basandose en varios factores, y entender estos ayuda a priorizar que enlaces perseguir. El primer factor es la relevancia. Un enlace de un sitio de resenas de equipamiento fitness a tu p\u00e1gina de producto de esterilla de yoga es mucho m\u00e1s valioso que un enlace de un blog de cocina aleatorio. Google usa el contenido de la p\u00e1gina enlazante, el texto ancla y el contexto circundante para evaluar la relevancia tem\u00e1tica.\n\nEl segundo factor es la autoridad del dominio enlazante. Un enlace de una publicacion bien establecida como un periodico nacional o un blog industrial importante tiene m\u00e1s peso que un enlace de un sitio personal nuevo sin tr\u00e1fico. La autoridad de dominio, aunque no es una m\u00e9trica de Google en si, sirve como una aproximacion util.\n\nEl tercer factor es la ubicacion del enlace. Un enlace integrado naturalmente dentro del cuerpo de un art\u00edculo transmite m\u00e1s valor que un enlace enterrado en un footer, sidebar o biografia de autor. Los algoritmos de Google pueden distinguir entre enlaces editoriales que el autor incluyo deliberadamente y enlaces de plantilla que aparecen en cada p\u00e1gina de un sitio.\n\nFinalmente, el atributo dofollow versus nofollow importa. Los enlaces dofollow transmiten valor de posicionamiento completo por defecto. Los enlaces nofollow, y los atributos m\u00e1s recientes ugc y sponsored, le dicen a Google que el enlace no deberia transmitir autoridad.",
          tip: "Al evaluar un backlink potencial, verifica tres cosas en orden: relevancia tem\u00e1tica con tus productos, el score de autoridad del dominio enlazante, y si el enlace sera dofollow y estara ubicado dentro del contenido principal. Un enlace que puntua bien en los tres criterios vale por diez enlaces que solo cumplen uno.",
          image: {
        ...
        },
        {
          ...
          content:
            "La evaluaci\u00f3n de enlaces de Google ha evolucionado considerablemente desde los primeros dias de PageRank. El algoritmo ahora considera el contexto completo que rodea un enlace, no solo el conteo bruto de dominios enlazantes. Un unico enlace de una p\u00e1gina altamente relevante y autoritaria dentro de un art\u00edculo bien estructurado puede superar a docenas de enlaces de directorios de baja calidad o secciones de comentarios de blog.\n\nEl texto ancla, el texto clicable de un enlace, proporciona a Google una senal fuerte sobre el tema de la p\u00e1gina enlazada. Los perfiles de backlinks naturales muestran texto ancla diverso: anclas de marca (el nombre de tu tienda), anclas genericas (\"haz clic aqui\", \"este sitio\"), URLs desnudas, y ocasionalmente anclas ricas en palabras clave.\n\nGoogle tambi\u00e9n eval\u00faa la velocidad de enlaces, la tasa a la que un sitio adquiere nuevos backlinks con el tiempo. Un perfil natural muestra crecimiento constante y organico con picos ocasionales alrededor de lanzamientos de productos, eventos de venta o contenido viral.\n\nLos vecindarios de enlaces tambi\u00e9n importan. Si los sitios que te enlazan tambi\u00e9n enlazan a sitios web spam o de baja calidad, el valor de esos enlaces disminuye. Por el contrario, si tu perfil de backlinks comparte dominios referentes con competidores respetados en tu nicho, Google ve tu sitio m\u00e1s favorablemente.",
        ...
        },
        {
          ...
          content:
            "Antes de perseguir link building activo, asegura que tu tienda tenga p\u00e1ginas que merezcan ser enlazadas. La mayoria de p\u00e1ginas de producto en la mayoria de tiendas no son intr\u00c3\u00adnsecamente dignas de enlace, se ven identicas al mismo producto en otros diez minoristas. Para conseguir enlaces, necesitas crear activos diferenciados.\n\nLa investigaci\u00f3n original es uno de los imanes de enlaces m\u00e1s fuertes. Encuesta a tus clientes sobre preferencias de compra, analiza tus datos de ventas para tendencias de la industria, o compila datos de precios a traves de tu categor\u00eda. Un estudio de datos bien presentado, incluso uno simple, puede conseguir enlaces de blogs industriales, medios de noticias y recursos academicos que nunca enlazarian a una p\u00e1gina de producto est\u00e1ndar.\n\nLas guias de compra completas que van m\u00e1s alla del consejo superficial tambi\u00e9n atraen enlaces. Una guia de 3.000 palabras sobre como elegir la silla de oficina adecuada que cubra principios ergonomicos, comparaciones de materiales, consideraciones de capacidad de peso y consejos de mantenimiento se convierte en una referencia que otros creadores de contenido quieren citar.\n\nLas herramientas interactivas, calculadoras de tallas, buscadores de productos, verificadores de compatibilidad, consiguen enlaces porque proporcionan utilidad unica que no puede replicarse en un simple art\u00edculo de texto. Estrategias como el [PR digital para ecommerce](/academy/digital-pr-for-ecommerce) pueden amplificar el contenido basado en datos en docenas de enlaces de alta autoridad.",
        },
        {
          title: "Evitar penalizaciones de link building",
          content:
            "El algoritmo Penguin de Google apunta especificamente al link building manipulativo. Entender que desencadena penalizaciones te ayuda a construir un perfil de backlinks sostenible. Los enlaces pagados sin divulgacion adecuada violan las directrices de Google. Si pagas por un enlace, debe llevar un atributo sponsored o nofollow. Los enlaces pagados no divulgados arriesgan una acci\u00f3n manual que puede hundir tus posiciones de la noche a la manana.\n\nLas redes de blogs privados (PBNs), redes de sitios creados unicamente para manipular posicionamientos mediante p\u00e1ginas interenlazadas, son un conocido desencadenante de penalizaciones. Google se ha vuelto cada vez m\u00e1s efectivo detectando patrones de PBN, y el impulso temporal de posicionamiento que proporcionan raramente vale el riesgo de una penalizacion a nivel de dominio.\n\nLos intercambios excesivos de enlaces (\"yo te enlazo si tu me enlazas\") tambi\u00e9n levantan banderas cuando se hacen a gran escala. Mientras que el enlazado reciproco natural entre negocios genuinamente relacionados esta bien, los intercambios sistematicos con docenas de sitios no relacionados parecen artificiales.\n\nEl enfoque m\u00e1s seguro es centrarse en conseguir enlaces mediante contenido genuinamente util, relaciones comerciales reales y actividades de inter\u00e9s periodistico. Estos enlaces son sostenibles porque reflejan valor real que tu tienda proporciona. Nuestra guia de [SEO off-page para ecommerce](/blog/off-page-seo-for-ecommerce) cubre como construir un perfil de backlinks a prueba de penalizaciones.",
          items: [
            "Los enlaces pagados deben llevar atributos sponsored o nofollow para cumplir con las directrices de Google",
            "Las redes de blogs privados conllevan alto riesgo de penalizacion y son cada vez m\u00e1s faciles de detectar por Google",
        ...
        {
          title: "anchorMismatchDemotion y sourceType: Senales ocultas de calidad de enlace del leak",
          content:
            "El leak (catalogado para busqueda en sitios como seo-datawarehouse.com) confirmo que la evaluaci\u00f3n de enlaces de Google va mucho m\u00e1s alla del PageRank en bruto. Dos atributos importan para la estrategia de enlaces ecommerce.\n\nanchorMismatchDemotion: cuando el anchor text de un enlace entrante esta topicamente desalineado con la p\u00e1gina destino, el enlace puede ser devaluado o activamente degradado, no solo ignorado. Un enlace de un blog tech con anchor \"zapatillas de correr\" apuntando a tu p\u00e1gina de botas de senderismo es peor que ningun enlace. El consejo SEO historico de \"diversificar agresivamente el anchor text\" se vuelve en contra cuando los anchors desalineados se ven manipuladores.\n\nsourceType: los enlaces se categorizan por tipo de fuente. Los enlaces editoriales de sitios establecidos de alto tr\u00e1fico llevan materialmente m\u00e1s peso que los enlaces de directorio, enlaces de footer, o enlaces de p\u00e1ginas auto-generadas de bajo tr\u00e1fico. La clasificacion del leak sugiere que Google explicitamente distingue entre una mencion editorial en una publicacion relevante y un enlace de sidebar en un blogroll generico - y solo el primero cuenta para transferencia de autoridad seria.\n\nLa estrategia practica: persigue menos enlaces, m\u00e1s alineados topicamente de publicaciones editoriales genuinamente traficadas. Audita tu perfil de enlaces existente buscando anchors desalineados y disavow o solicita remocion donde el anchor mine la relevancia objetivo.",
          items: [
            "anchorMismatchDemotion puede devaluar o activamente degradar enlaces cuyos anchors no coinciden con el tema de la p\u00e1gina destino",
            "sourceType distingue enlaces editoriales en contenido de footer/directorio/sidebar - solo el editorial en contenido lleva peso serio",
            "La diversificacion agresiva de anchors con anchors desalineados se vuelve en contra bajo la senal filtrada",
            "Audita y poda anchors desalineados; persigue menos enlaces editoriales mejor alineados topicamente",
          ],
          callout: {
            title: "Los nombres de atributos filtrados estan publicamente indexados",
            text: "Los investigadores han catalogado las senales divulgadas (siteAuthority, NavBoost, anchorMismatchDemotion, sourceType, hostAge, contentEffort, etc.) en sitios como seo-datawarehouse.com. Usalos como vocabulario al explicar estrategia de enlaces a equipos o clientes - \"este enlace disparara anchorMismatchDemotion\" aterriza m\u00e1s duro que \"este enlace se ve poco natural\".",
          },
        },
      ],
      navLabels: {
    ...
    it: {
      ...
      sections: [
        ...
        {
          title: "anchorMismatchDemotion e sourceType: Segnali nascosti di qualita dei link dal leak",
          content:
            "Il leak (catalogato per la ricercabilita su siti come seo-datawarehouse.com) ha confermato che la valutazione dei link di Google va ben oltre il PageRank grezzo. Due attributi contano per la strategia di link ecommerce.\n\nanchorMismatchDemotion: quando l'anchor text di un link in entrata e tematicamente disallineato con la pagina target, il link puo essere svalutato o attivamente retrocesso, non solo ignorato. Un link da un blog tech con anchor \"scarpe da corsa\" che punta alla tua pagina di scarpe da trekking e peggio di nessun link. Il consiglio SEO storico di \"diversificare aggressivamente l'anchor text\" si ritorce quando gli anchor disallineati sembrano manipolativi.\n\nsourceType: i link sono categorizzati per tipo di fonte. I link editoriali da siti consolidati ad alto traffico portano materialmente piu peso dei link di directory, link di footer, o link da pagine auto-generate a basso traffico. La classificazione del leak suggerisce che Google distingue esplicitamente tra una menzione editoriale in una pubblicazione pertinente e un link di sidebar su un blogroll generico - e solo il primo conta per un trasferimento di autorita serio.\n\nLa strategia pratica: persegui meno link, meglio allineati tematicamente da pubblicazioni editoriali genuinamente trafficate. Audita il tuo profilo di link esistente per anchor disallineati e disavowa o richiedi rimozione dove l'anchor mina la pertinenza target.",
          items: [
            "anchorMismatchDemotion puo svalutare o attivamente retrocedere link i cui anchor non corrispondono al tema della pagina target",
            "sourceType distingue i link editoriali in-content da footer/directory/sidebar - solo l'editoriale in-content porta peso serio",
            "La diversificazione aggressiva di anchor con anchor disallineati si ritorce sotto il segnale trapelato",
            "Audita e pota anchor disallineati; persegui meno link editoriali meglio allineati tematicamente",
          ],
          callout: {
    ...
    nl: {
      ...
      sections: [
        ...
        {
          title: "anchorMismatchDemotion en sourceType: Verborgen link-kwaliteitssignalen uit het leak",
          content:
            "Het leak (gecatalogiseerd voor doorzoekbaarheid op sites zoals seo-datawarehouse.com) bevestigde dat Googles linkevaluatie veel verder gaat dan ruwe PageRank. Twee attributen tellen voor ecommerce link-strategie.\n\nanchorMismatchDemotion: wanneer de anker-tekst van een inkomende link topisch niet aansluit bij de doelpagina, kan de link gedevalueerd of actief gedegradeerd worden, niet alleen genegeerd. Een link van een tech blog met anker \"hardloopschoenen\" die naar je wandelschoenen-pagina wijst, is slechter dan helemaal geen link. Het historische SEO-advies om \"anker-tekst agressief te diversifieren\" mislukt wanneer de niet-passende ankers manipulatief lijken.\n\nsourceType: links worden gecategoriseerd op type bron. Redactionele links van gevestigde, hoog-verkeer sites dragen materieel meer gewicht dan directory-links, footer-links, of links van laag-verkeer auto-gegenereerde pagina's. De classificatie van het leak suggereert dat Google expliciet onderscheid maakt tussen een redactionele vermelding in een relevante publicatie en een sidebar-link op een generieke blogroll - en alleen de eerste telt voor serieuze autoriteits-overdracht.\n\nDe praktische strategie: streef minder, topisch beter uitgelijnde links na van echt verkeer-hebbende redactionele publicaties. Audit je bestaande link-profiel op niet-passende ankers en disavow of vraag verwijdering waar het anker de doelrelevantie ondermijnt.",
          items: [
            "anchorMismatchDemotion kan links devalueren of actief degraderen waarvan ankers niet matchen met het doelpagina-thema",
            "sourceType onderscheidt redactionele in-content links van footer/directory/sidebar - alleen redactionele in-content draagt serieus gewicht",
            "Agressieve anker-tekst diversificatie met niet-passende ankers werkt averechts onder het gelekte signaal",
            "Audit en snoei niet-passende ankers; streef minder, topisch beter uitgelijnde redactionele links na",
          ],
          callout: {
