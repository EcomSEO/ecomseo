      ...
      sections: [
        {
          ...
          content:
            "Le choix entre les domaines de premier niveau nationaux (ccTLDs comme .de, .fr), les sous-repertoires (/de/, /fr/) et les sous-domaines (de.example.com) a des consequences durables sur la distribution de l'autorite des liens, l'efficacite du crawl et la perception de la marque.\n\nLes ccTLDs fournissent le signal de geo-ciblage le plus fort et instaurent la confiance locale. Les acheteurs francais voyant un domaine .fr se sentent en confiance. Cependant, chaque ccTLD d\u00e9marre sans autorite de domaine et divise votre profil de backlinks.\n\nLes sous-repertoires (example.com/fr/) consolident toute l'autorite des liens sous un seul domaine, ce qui en fait le choix privilegie pour la plupart des op\u00e9rations e-commerce. Un seul domaine avec une forte autorite eleve tous les sous-repertoires regionaux.\n\nLes sous-domaines (fr.example.com) se situent dans un entre-deux inconfortable. Google les traite comme des entites semi-separees, donc l'autorite des liens ne circule pas librement entre les sous-domaines.",
          items: [
        ...
        },
        {
          ...
          content:
            "Les balises hreflang indiquent aux moteurs de recherche quelle version linguistique et regionale d'une page servir pour une requete donn\u00e9e. Sans elles, Google pourrait afficher votre page produit anglaise aux utilisateurs francais, ou pire, signaler vos variations regionales comme contenu duplique.\n\nL'attribut hreflang utilise les codes de langue ISO 639-1 et les codes de pays ISO 3166-1 Alpha-2 optionnels. Une page ciblant les francophones au Canada utiliserait hreflang=\"fr-CA\". Vous devez egalement inclure une balise x-default pointant vers votre page de repli.\n\nLe hreflang peut etre implemente via des \u00e9l\u00e9ments link HTML dans le <head>, des en-tetes HTTP ou des sitemaps XML. Pour les boutiques avec des milliers de produits dans plusieurs langues, l'impl\u00e9mentation via sitemap XML est l'approche la plus maintenable.\n\nL'erreur hreflang la plus courante est l'absence de balises retour. Si la page A r\u00e9f\u00e9rence la page B comme son alternative allemande, la page B doit referencer la page A en retour. Les annotations hreflang asymetriques sont compl\u00e8tement ignorees par Google. Une bonne [configuration des balises canoniques](/academy/canonical-tags-for-ecommerce) fonctionne main dans la main avec hreflang pour pr\u00c3\u00a9venir ces probl\u00c3\u00a8mes.",
        ...
        },
        {
          ...
          content:
            "Traduire automatiquement vos pages produit et appeler cela de la localisation est un raccourci qui coute des conversions et des classements. La vraie localisation signifie adapter les descriptions de produits, les guides de tailles, les r\u00e9f\u00e9rences de paiement et le contexte culturel pour chaque march\u00e9 cible.\n\nLa recherche de mots-cl\u00e9s doit etre repetee pour chaque march\u00e9. Ne supposez pas que les mots-cl\u00e9s traduits portent le meme volume de recherche ou la meme intention. Le march\u00e9 espagnol pourrait preferer des noms de cat\u00e9gories de produits diff\u00e9rents de ce qu'une traduction directe suggere.\n\nLes avis, le contenu genere par les utilisateurs et les signaux de confiance necessitent egalement une localisation. Afficher des avis en anglais sur une page de boutique allemande sape la confiance. Integrez les plateformes d'avis locales et affichez les avis dans la langue locale.",
        },
        {
          title: "Devise, tarification et données structurees",
          content:
            "Les boutiques internationales doivent gerer la tarification multi-devises avec precision, tant pour l'exp\u00e9rience utilisateur que pour l'exactitude des donn\u00e9es structurees. Votre balisage Product schema doit refleter la devise et le prix reels affiches a l'utilisateur sur cette page regionale sp\u00e9cifique.\n\nUtilisez le champ priceCurrency dans vos donn\u00e9es structurees Product avec le code devise ISO 4217 correct pour chaque page regionale. Si vous proposez une conversion dynamique des devises, les donn\u00e9es structurees doivent correspondre au prix affiche par defaut.\n\nLes donn\u00e9es structurees des frais de livraison doivent egalement etre regionalisees. Declarer la livraison gratuite aux US sur une page ciblant les clients allemands est trompeur et peut entrainer des penalites marchands dans Google Shopping.\n\nLe traitement fiscal varie considerablement selon les pays. Les prix americains sont generalement affiches hors taxes, tandis que les reglementations europeennes exigent des prix TTC.",
          items: [
            "Faire correspondre priceCurrency dans le schema Product a la devise reellement affichee par region",
            "D\u00e9finir des shippingDetails sp\u00e9cifiques a la region avec le bon shippingDestination",
            "Aligner les prix TTC vs. HT avec les reglementations locales",
            "Tester la validation des donn\u00e9es structurees pour chaque variante de page regionale separement",
          ],
          tip: "Creez un mod\u00e8le de donn\u00e9es structurees par region qui extrait automatiquement le code devise, le traitement fiscal et la destination d'expedition corrects.",
        },
        {
          title: "Considerations techniques internationales",
          content:
            "L'emplacement du serveur et la configuration CDN impactent directement la vitesse de chargement pour les visiteurs internationaux. Une boutique hebergee sur un seul serveur am\u00e9ricain delivrera des temps de chargement lents aux acheteurs europeens et asiatiques. Utilisez un CDN avec des noeuds edge dans vos march\u00e9s cibles.\n\nEvitez les redirections basees sur l'IP qui forcent les utilisateurs vers une version regionale sans consentement. Google crawle principalement depuis des adresses IP americaines, donc les redirections IP peuvent empecher Googlebot de decouvrir vos pages non-US.\n\nLes sitemaps XML doivent etre structures pour aider les moteurs de recherche a decouvrir efficacement toutes les variantes regionales. Creez un index de sitemap referencant des sous-sitemaps regionaux.\n\nSurveillez les performances de recherche internationales separement par march\u00e9. Configurez des proprietes Search Console pour chaque pays ou sous-repertoire cible.",
        },
        {
          title: "Gerer le link building international",
          content:
            "L'autorite des liens ne se transfere pas uniformement entre les variantes de pages internationales. Un backlink vers votre page produit am\u00e9ricaine n'ameliore pas les classements de votre version allemande sur google.de. Chaque march\u00e9 regional n\u00e9cessite sa propre strat\u00e9gie de link building.\n\nIdentifiez les opportunites de liens par march\u00e9 en analysant les profils de backlinks des concurrents dans chaque pays cible. Les sources de backlinks d'un concurrent allemand revelent quels blogs, magazines et repertoires locaux renvoient activement vers les boutiques e-commerce.\n\nLes campagnes de RP numerique doivent etre adaptees par march\u00e9, pas simplement traduites. Une histoire de lancement de produit qui resonne aupres des medias americains pourrait necesiter un angle compl\u00e8tement diff\u00e9rent pour les journalistes francais.\n\nLes liens internes entre les versions linguistiques doivent etre strategiques. Votre article de blog anglais doit renvoyer vers les pages produit anglaises, tandis que la traduction allemande renvoie vers les produits allemands. Nos services de [SEO international](/international-seo) peuvent vous aider \u00c3\u00a0 construire une autorit\u00c3\u00a9 sp\u00c3\u00a9cifique \u00c3\u00a0 chaque march\u00c3\u00a9 \u00c3\u00a0 grande \u00c3\u00a9chelle.",
        },
      ],
    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          tip: "Crea una plantilla de datos estructurados por region que extraiga autom\u00e1ticamente el codigo de divisa, tratamiento fiscal y destino de env\u00edo correctos.",
        },
        {
