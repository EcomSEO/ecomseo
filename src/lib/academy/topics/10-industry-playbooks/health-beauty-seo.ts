...
items: [
    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "Google soumet le contenu sante et beaute aux standards YMYL. Les pages qui font des affirmations de sante, recommandent des traitements ou discutent d'ingredients aux effets physiologiques font l'objet d'un examen accru. Des signaux E-E-A-T faibles peuvent empecher des pages par ailleurs bien optimisees d'atteindre la premi\u00e8re page.\n\nEtablissez la credibilite des auteurs pour tout le contenu educatif. Les articles de blog sur les routines de soins, les bienfaits des ingredients ou la s\u00e9lection de produits devraient lister les qualifications de l'auteur, dermatologue, estheticienne diplomee, chimiste cosmetique ou nutritionniste certifie.\n\nCitez des sources reputees lorsque vous faites des affirmations sur les ingredients ou les bienfaits. Liez vers des \u00e9tudes evaluees par des pairs, des directives de la FDA ou des associations dermatologiques reconnues.\n\nAjoutez un avertissement medical aux pages qui traitent de sujets lies a la sante. Cela ne ameliore pas directement les classements, mais signale des pratiques de contenu responsables aux evaluateurs de qualit\u00e9.",
        ...
        },
        {
          ...
          content:
            "Les pages produit sante et beaute necessitent un equilibre soigneux entre persuasion et conformite. Les allegaions exagerees declenchent des problemes reglementaires et des retrogradations de qualit\u00e9 Google. Les allegaions trop modestes echouent a convertir. La solution est la specificite soutenue par des preuves.\n\nStructurez les descriptions de produits autour de trois piliers : ce que fait le produit, quels ingredients produisent ces resultats, et quelles preuves soutiennent les allegaions.\n\nLes images avant/apr\u00e8s presentent a la fois une opportunite et un risque. Si vous utilisez des photos avant/apr\u00e8s, assurez-vous qu'elles sont authentiques, non retouchees, incluent des avertissements appropries sur la variation des resultats individuels.\n\n[Le contenu genere par les utilisateurs](/academy/user-generated-content-seo), avis, photos et temoignages video, fournit une preuve sociale authentique. Implementez le balisage schema des avis (AggregateRating) pour que les notes en etoiles apparaissent dans les resultats de recherche. Repondez aux avis negatifs de maniere professionnelle.",
        },
        {
          title: "Stratégie de contenu pour la beaute et le bien-etre",
          content:
            "Le contenu educatif genere une grande part du trafic organique en sante et beaute. Les acheteurs recherchent des routines, la compatibilite des ingredients, les techniques d'application et les comparatifs de produits avant d'acheter.\n\nConstruisez des guides de routine complets pour diff\u00e9rents types de peau, preoccupations et objectifs. \"Routine soin du matin pour peau grasse\" ou \"Guide du debutant pour le skincare coreen\" ciblent des requetes informationnelles a fort volume tout en liant naturellement a vos produits.\n\nLe contenu sur la compatibilite des ingredients performe exceptionnellement bien. Des articles comme \"Peut-on utiliser la vitamine C et le retinol ensemble ?\" repondent a des questions sp\u00e9cifiques que les acheteurs se posent avant de melanger des produits de diff\u00e9rentes marques.\n\nLe contenu video a une valeur SEO croissante en beaute. Les videos tutoriels integrees aux pages produit augmentent le temps passe sur la page et reduisent les taux de rebond. Transcrivez chaque video et incluez la transcription sur la page. Une [strat\u00c3\u00a9gie de contenu](/academy/content-strategy-for-stores) robuste capture ces chercheurs et les guide vers vos produits.\n\nLe contenu vid\u00c3\u00a9o a une valeur SEO croissante dans la beaut\u00c3\u00a9 et est un \u00c3\u00a9l\u00c3\u00a9ment cl\u00c3\u00a9 de la strat\u00c3\u00a9gie de [contenu SEO e-commerce](/blog/ecommerce-seo-content).",
          items: [
            "Construire des guides de routine organises par type de peau, preoccupation ou objectif",
            "Cr\u00e9er des articles de compatibilite d'ingredients repondant aux questions courantes de superposition",
        ...
        },
        {
          ...
          content:
            "Le marketing d'influence est central dans le e-commerce beaute, mais la plupart du contenu influenceur genere zero valeur SEO. Les publications Instagram et les videos TikTok construisent la notoriete de marque sans contribuer a l'autorite de recherche de votre domaine.\n\nNegociez du contenu base sur des blogs dans le cadre des partenariats influenceurs. Un blogueur beaute ecrivant un avis detaille sur son propre site avec un lien dofollow vers votre page produit delivre une valeur SEO durable.\n\nReutilisez le contenu influenceur sur votre propre site avec permission. Si un influenceur cree un tutoriel video presentant vos produits, integrez-le sur la page produit pertinente avec un resume \u00e9crit.\n\nCreez une page dediee influenceur ou ambassadeur sur votre site. Listez vos partenaires avec des photos, biographies et liens vers leur contenu. Cette page gagne des liens des influenceurs et fournit des signaux E-E-A-T supplementaires.",
        },
        {
          title: "SEO technique pour les grands catalogues beaute",
          content:
            "Les boutiques beaute proposent souvent des centaines ou des milliers de r\u00e9f\u00e9rences dans des cat\u00e9gories qui se chevauchent. Sans un SEO technique soigneux, cela cree un contenu duplique generalise et une inefficacite de crawl.\n\nUtilisez des balises canoniques pour consolider les listes de produits en double. Chaque produit devrait avoir une URL principale, et tous les emplacements de cat\u00e9gories secondaires devraient avoir une balise canonique pointant vers celle-ci.\n\nImplementez des contr\u00f4les de navigation a facettes robustes. Les acheteurs beaute filtrent par type de peau, preoccupation, ingredient, prix et marque. Autorisez Google a indexer les facettes a forte valeur tout en bloquant les permutations a faible valeur.\n\nLe schema produit est particulierement precieux pour les produits beaute. Incluez la marque, le SKU, le prix, la disponibilite, la note globale et les listes d'ingredients dans vos donn\u00e9es structurees.\n\nGerez les arrets de produits avec soin. Quand un produit est d\u00e9finitivement arrete, redirigez son URL en 301 vers le produit successeur le plus proche ou la page de cat\u00e9gorie parente.",
        },
      ],
      navLabels: {
        previous: "Precedent",
    ...
    es: {
      ...
      intro: "El ecommerce de salud y belleza se situa en la interseccion de ciencia, regulacion y confianza personal. Google clasifica muchas consultas de salud y belleza como YMYL, lo que significa que posicionarse requiere est\u00e1ndares m\u00e1s altos de experiencia y precision que la mayoria de las categor\u00c3\u00adas minoristas. Este playbook cubre las estrategias SEO especificas que impulsan el crecimiento organico para tiendas de cuidado de la piel, cosmeticos, suplementos y bienestar.",
      readTime: "11 min de lectura",
      sections: [
        {
          title: "Estrategia de palabras clave basada en ingredientes",
          content:
            "Los compradores de belleza buscan cada vez m\u00e1s por ingrediente en lugar de por marca o tipo de producto. Consultas como \"serum de niacinamida,\" \"crema hidratante con retinol\" y \"limpiador de acido salicilico\" tienen fuerte intenci\u00f3n comercial y a menudo convierten mejor que las busquedas genericas por categor\u00eda.\n\nCrea p\u00e1ginas de aterrizaje dedicadas para cada ingrediente estrella de tus productos. Una p\u00e1gina orientada a \"productos con acido hialuronico\" deberia explicar que hace el ingrediente, a quien beneficia, como usarlo, y luego mostrar tus productos relevantes.\n\nMapea las palabras clave de ingredientes a las p\u00e1ginas de producto tambi\u00e9n. Cada p\u00e1gina de producto deberia destacar prominentemente sus ingredientes activos clave en la etiqueta de t\u00edtulo, H1, meta descripcion y cuerpo del texto.\n\nRastrea las tendencias emergentes de ingredientes. Ingredientes como el bakuchiol, peptidos y acido tranexamico han visto un r\u00e1pido crecimiento de busqueda. Monitoriza publicaciones de belleza, comunidades de skincare en Reddit y Google Trends.",
          items: [
            "Crear p\u00e1ginas de aterrizaje dedicadas para cada ingrediente activo clave del cat\u00e1logo",
            "Incluir nombres de ingredientes en etiquetas de t\u00edtulo, H1s y meta descripciones de producto",
            "Rastrear tendencias emergentes de ingredientes a traves de publicaciones y comunidades de belleza",
            "Mapear consultas de ingredientes tanto a contenido educativo como a p\u00e1ginas de producto",
          ],
          image: {
        ...
        },
        {
          ...
          content:
            "Google aplica est\u00e1ndares YMYL al contenido de salud y belleza. Las p\u00e1ginas que hacen afirmaciones de salud, recomiendan tratamientos o discuten ingredientes con efectos fisiologicos enfrentan un escrutinio elevado. Senales E-E-A-T debiles pueden impedir que p\u00e1ginas bien optimizadas lleguen a la primera p\u00e1gina.\n\nEstablece la credibilidad del autor para todo el contenido educativo. Las publicaciones de blog sobre rutinas de cuidado de la piel, beneficios de ingredientes o selecci\u00f3n de productos deberian listar las cualificaciones del autor, dermatologo, esteticista licenciado, qu\u00edmico cosmetico o nutricionista certificado.\n\nCita fuentes reputadas al hacer afirmaciones sobre ingredientes o beneficios. Enlaza a estudios revisados por pares, directrices de la FDA o asociaciones dermatologicas reconocidas.\n\nAnade un aviso medico a las p\u00e1ginas que discuten temas relacionados con la salud. Esto no mejora directamente los rankings, pero senala practicas de contenido responsables a los evaluadores de calidad.",
          tip: "Crea una p\u00e1gina dedicada \"Nuestros Expertos\" listando a cada contribuidor de tu contenido educativo. Incluye fotos, credenciales y enlaces a perfiles externos. Esta p\u00e1gina centralizada de credibilidad refuerza el E-E-A-T en todo tu sitio.",
          image: {
        ...
        },
        {
          ...
          content:
            "Las p\u00e1ginas de producto de salud y belleza requieren un equilibrio cuidadoso entre persuasion y cumplimiento. Las afirmaciones exageradas desencadenan problemas regulatorios y degradaciones de calidad de Google. Las afirmaciones moderadas no convierten. La solucion es la especificidad respaldada por evidencia.\n\nEstructura las descripciones de producto en torno a tres pilares: que hace el producto, que ingredientes producen esos resultados y que evidencia respalda las afirmaciones.\n\nLas imagenes de antes/despues presentan tanto una oportunidad como un riesgo. Si usas fotos de antes/despues, asegurate de que sean genuinas, sin retocar, incluyan avisos apropiados sobre la variacion de resultados individuales.\n\nEl [contenido generado por usuarios](/academy/user-generated-content-seo), resenas, fotos y testimonios en video, proporciona prueba social autentica. Implementa el marcado schema de resenas (AggregateRating) para que las calificaciones con estrellas aparezcan en los resultados de busqueda. Responde profesionalmente a las resenas negativas.",
        },
        {
          title: "Estrategia de contenido para belleza y bienestar",
          content:
            "El contenido educativo genera una gran parte del tr\u00e1fico organico en salud y belleza. Los compradores investigan rutinas, compatibilidad de ingredientes, t\u00e9cnicas de aplicacion y comparaciones de productos antes de comprar.\n\nConstruye guias de rutina completas para diferentes tipos de piel, preocupaciones y objetivos. \"Rutina matutina de cuidado de la piel para piel grasa\" o \"Guia para principiantes del cuidado coreano de la piel\" apuntan a consultas informativas de alto volumen mientras enlazan naturalmente a tus productos.\n\nEl contenido sobre compatibilidad de ingredientes funciona excepcionalmente bien. Art\u00edculos como \"Se pueden usar vitamina C y retinol juntos?\" responden preguntas especificas que los compradores hacen antes de mezclar productos de diferentes marcas.\n\nEl contenido en video tiene un valor SEO creciente en belleza. Los videos tutoriales integrados en p\u00e1ginas de producto aumentan el tiempo en p\u00e1gina y reducen las tasas de rebote. Transcribe cada video e incluye la transcripcion en la p\u00e1gina. Una solida [estrategia de contenido](/academy/content-strategy-for-stores) captura a estos investigadores y los guia hacia tus productos. El contenido de video tiene un valor SEO creciente en belleza y es una parte clave de la estrategia de [contenido SEO para ecommerce](/blog/ecommerce-seo-content).",
          items: [
            "Construir guias de rutina organizadas por tipo de piel, preocupacion u objetivo",
            "Crear art\u00edculos de compatibilidad de ingredientes que respondan preguntas comunes de capas",
            "Integrar videos tutoriales en p\u00e1ginas de producto con transcripciones de texto completas",
            "Estructurar contenido practico con encabezados H2 claros para ganar featured snippets",
          ],
          tip: "P\u00fablica un \"Glosario de Ingredientes de Cuidado de la Piel\" cubriendo cada ingrediente activo de tu l\u00ednea de productos. Esta sola p\u00e1gina puede posicionarse para docenas de consultas informativas y sirve como hub de enlaces internos.",
        },
        {
          title: "Contenido de influencers e integracion SEO",
          content:
            "El marketing de influencers es central en el ecommerce de belleza, pero la mayoria del contenido de influencers genera cero valor SEO. Las publicaciones de Instagram y los videos de TikTok construyen conocimiento de marca sin contribuir a la autoridad de busqueda de tu dominio.\n\nNegocia contenido basado en blogs como parte de las asociaciones con influencers. Un blogger de belleza escribiendo una resena detallada en su propio sitio con un enlace dofollow a tu p\u00e1gina de producto entrega valor SEO duradero.\n\nReutiliza contenido de influencers en tu propio sitio con permiso. Si un influencer crea un video tutorial presentando tus productos, incrustalo en la p\u00e1gina de producto relevante con un resumen escrito.\n\nCrea una p\u00e1gina dedicada de influencers o embajadores en tu sitio. Lista tus socios con fotos, biografias y enlaces a su contenido.",
        },
        {
          title: "SEO técnico para grandes catálogos de belleza",
          content:
            "Las tiendas de belleza a menudo tienen cientos o miles de SKUs en categor\u00edas superpuestas. Sin un SEO t\u00e9cnico cuidadoso, esto crea contenido duplicado generalizado e ineficiencia de rastreo.\n\nUsa etiquetas canonical para consolidar listados de productos duplicados. Cada producto deberia tener una URL principal, y todas las ubicaciones de categor\u00edas secundarias deberian tener canonical hacia ella.\n\nImplementa controles robustos de navegaci\u00f3n facetada. Los compradores de belleza filtran por tipo de piel, preocupacion, ingrediente, precio y marca. Permite a Google indexar facetas de alto valor mientras bloqueas permutaciones de bajo valor.\n\nEl schema de producto es especialmente valioso para productos de belleza. Incluye marca, SKU, precio, disponibilidad, calificacion agregada y listas de ingredientes en tus datos estructurados.\n\nGestiona las discontinuaciones de productos cuidadosamente. Cuando un producto se discontinua permanentemente, redirige su URL con 301 al producto sucesor m\u00e1s cercano o a la p\u00e1gina de categor\u00eda principal.",
        },
      ],
      navLabels: {
        previous: "Anterior",
