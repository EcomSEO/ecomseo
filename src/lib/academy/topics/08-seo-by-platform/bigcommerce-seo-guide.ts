...
export const bigcommerceSeoGuide: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro:
        "BigCommerce dispose de fonctionnalites SEO natives qui rivalisent avec ou depassent celles de nombreuses plateformes e-commerce concurrentes. Ses structures d'URL propres, son CDN integre et ses options de personnalisation flexibles offrent aux marchands une base solide pour la recherche organique. Cependant, exploiter pleinement le potentiel SEO de BigCommerce necessite de comprendre son architecture unique, ses comportements par defaut et les domaines ou l'optimisation manuelle reste necessaire.",
      ...
      sections: [
        ...
        {
          title: "Personnalisation du theme et donnees structurees",
          content:
    ...
    it: {
      ...
      sections: [
        ...
        {
          title: "Personalizzazione del tema e dati strutturati",
          content:
