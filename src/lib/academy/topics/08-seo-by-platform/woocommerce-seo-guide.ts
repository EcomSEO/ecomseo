...
export const woocommerceSeoGuide: AcademyTopic = {
  ...
  content: {
    ...
    it: {
      ...
      intro:
        "WooCommerce funziona su WordPress, offrendo ai proprietari di negozi l'accesso al toolkit SEO piu flessibile disponibile per l'e-commerce. Con il pieno controllo su URL, configurazione del server e migliaia di plugin, WooCommerce consente un'ottimizzazione granulare che le piattaforme ospitate non possono offrire. Questa flessibilita significa anche piu decisioni e piu potenziale di configurazione errata.",
