...
items: [
      ...
      sections: [
        {
          ...
          content:
            "WordPress vous permet de d\u00e9finir des structures de permaliens personnalisees via R\u00e9glages > Permaliens. Pour les boutiques WooCommerce, le schema d'URL produit par defaut est /product/nom-produit/, mais vous pouvez modifier le slug de base /product/ ou le supprimer entierement avec des plugins ou des r\u00e8gles de reecriture personnalisees.\n\nL'approche la plus favorable au SEO consiste a garder des URLs courtes et descriptives. De nombreux proprietaires suppriment les slugs de base /product-category/ et /product/ pour obtenir des URLs plus propres. Cependant, la suppression de ces bases cree un risque de conflits d'URL entre produits, cat\u00e9gories, pages et articles partageant des slugs similaires.\n\nWooCommerce genere egalement des URLs a parametres de requete pour les listes de produits filtrees et triees. Ces URLs parametrees peuvent cr\u00e9er un contenu duplique massif si Google les indexe. Configurez votre plugin SEO pour ajouter des directives noindex aux URLs filtrees.\n\nPour les boutiques avec de grands catalogues, envisagez d'implementer une navigation a facettes avec filtrage AJAX qui ne genere pas de nouvelles URLs. Cela previent la cr\u00e9ation de milliers de pages de combinaisons de filtres indexables.",
          tip: "Apr\u00e8s avoir change votre structure de permaliens, utilisez un outil de recherche-remplacement en base de donn\u00e9es comme Better Search Replace pour mettre a jour les liens internes dans les descriptions de produits.",
        },
        {
          title: "Plugins SEO : Yoast vs RankMath vs SEOPress",
          content:
            "Chaque boutique WooCommerce a besoin d'un plugin SEO dedie pour gerer les balises title, les meta descriptions, les sitemaps XML, le balisage schema et les balises canoniques. Les trois options principales sont Yoast SEO, Rank Math et SEOPress.\n\nYoast SEO est le plugin le plus etabli avec une integration WooCommerce dediee via son addon premium WooCommerce SEO. Il fournit un balisage schema sp\u00e9cifique aux produits, la g\u00e9n\u00e9ration de fil d'Ariane et les meta tags pour les reseaux sociaux.\n\nRank Math offre plus de fonctionnalit\u00e9s dans sa version gratuite que Yoast, incluant des generateurs de schema integres pour les produits, une gestion avancee des redirections et l'integration de Google Search Console directement dans le tableau de bord WordPress.\n\nSEOPress est une alternative plus legere qui seduit les proprietaires soucieux de la performance. Il genere moins de requetes en base de donn\u00e9es que Yoast ou Rank Math, ce qui peut avoir son importance pour les boutiques avec plus de 10 000 produits.",
          items: [
            "Yoast SEO : meilleure notoriete, addon WooCommerce dedie, analyse de contenu approfondie",
            "Rank Math : plus de fonctionnalit\u00e9s gratuites, generateurs de schema integres, integration Search Console",
            "SEOPress : empreinte base de donn\u00e9es la plus legere, performance admin la plus rapide, bon pour les grands catalogues",
        ...
        },
        {
          ...
          content:
            "La performance de WooCommerce depend fortement de votre environnement d'hebergement et de l'optimisation de la base de donn\u00e9es. Contrairement aux plateformes hebergees comme Shopify, vous portez l'entiere responsabilite de la vitesse du serveur, qui impacte directement les Core Web Vitals et l'efficacite du crawl.\n\nChoisissez un hebergeur offrant un cache au niveau serveur (Varnish, LiteSpeed Cache ou NGINX FastCGI cache), PHP 8.1 ou plus recent, et MySQL ou MariaDB avec des caches de requetes correctement configures. L'hebergement mutualise produit fr\u00e9quemment des TTFB superieurs a 600 millisecondes.\n\nL'optimisation de la base de donn\u00e9es devient cruciale a mesure que votre catalogue grandit. WooCommerce stocke les meta-donnees dans la table wp_postmeta, qui peut atteindre des millions de lignes pour les boutiques avec des milliers de produits. WordPress 6.1 a introduit le High-Performance Order Storage (HPOS) qui deplace les donn\u00e9es de commandes dans des tables personnalisees.\n\nInstallez un plugin de cache de pages et une couche de cache d'objets (Redis ou Memcached). Le cache de pages sert du HTML pre-genere aux visiteurs et aux robots, reduisant drastiquement le temps de reponse du serveur. Les performances de WooCommerce d\u00c3\u00a9pendent fortement de votre environnement d'h\u00c3\u00a9bergement et de l'optimisation de la base de donn\u00c3\u00a9es, ce qui impacte directement l'[optimisation de la vitesse du site](/academy/site-speed-optimization).",
        },
        {
          ...
          tip: "Testez votre balisage schema sur une page produit, une page produit variable et une page cat\u00e9gorie. Les produits variables produisent souvent des erreurs de schema car chaque variation n\u00e9cessite son propre \u00e9l\u00e9ment Offre.",
        },
        {
          title: "Optimisation des images et medias WooCommerce",
          content:
            "Les images de produits sont generalement les fichiers les plus volumineux sur toute page e-commerce, rendant l'optimisation des images critique pour la performance des Core Web Vitals. WooCommerce genere plusieurs tailles d'images pour chaque photo de produit telechargee, ce qui signifie qu'un seul produit avec cinq images peut cr\u00e9er 20 fichiers image ou plus.\n\nConvertissez toutes les images de produits au format WebP avec un plugin comme ShortPixel, Imagify ou EWWW Image Optimizer. Les fichiers WebP sont 25 a 35 pour cent plus petits que les fichiers JPEG equivalents sans perte de qualit\u00e9 visible.\n\nImplementez le chargement paresseux pour les images de galerie produit, les carrousels de produits associes et toutes les images sous la ligne de flottaison. WordPress 5.5+ inclut le lazy loading natif, mais v\u00e9rifiez qu'il fonctionne sur vos templates WooCommerce. L'image produit principale au-dessus de la ligne de flottaison ne doit pas etre chargee en mode paresseux.\n\nDefinissez des attributs de largeur et hauteur explicites sur tous les \u00e9l\u00e9ments d'image pour prevenir le Cumulative Layout Shift.",
          items: [
            "Convertir les images produit en WebP (25-35% plus petit que JPEG sans perte visible de qualit\u00e9)",
            "Charger en mode paresseux les images de galerie mais pas l'image produit hero principale",
            "D\u00e9finir des attributs largeur et hauteur explicites sur toutes les images pour prevenir le CLS",
        ...
        },
        {
          ...
          content:
            "WordPress vous donne un contr\u00f4le complet sur l'architecture informationnelle de votre site. Planifiez votre taxonomie de cat\u00e9gories avant de construire la boutique, car restructurer les cat\u00e9gories apr\u00e8s l'indexation des produits signifie gerer des centaines de redirections.\n\nLimitez votre hierarchie de cat\u00e9gories a trois niveaux maximum : cat\u00e9gories principales, sous-categories et sous-sous-categories. Chaque niveau supplementaire dilue l'equite des liens internes et eloigne les produits de la page d'accueil.\n\nLes pages produit WooCommerce incluent automatiquement des produits associes et des sections de ventes croisees, fournissant des liens internes entre les produits. Personnalisez l'algorithme de produits associes via les hooks WooCommerce pour vous assurer qu'il met en avant des articles genuinement pertinents.\n\nLa navigation par fil d'Ariane est essentielle tant pour les utilisateurs que pour les moteurs de recherche. Activez le fil d'Ariane via votre plugin SEO et configurez-le pour suivre votre hierarchie de cat\u00e9gories. Creez une structure de maillage interne complete au-dela des widgets automatises.",
        },
      ],
    ...
    es: {
      ...
      intro: "WooCommerce funciona sobre WordPress, dando a los propietarios de tiendas acceso al conjunto de herramientas SEO m\u00e1s flexible disponible para comercio electr\u00c3\u00b3nico. Con control total sobre URLs, configuraci\u00c3\u00b3n del servidor y miles de plugins, WooCommerce permite una optimizaci\u00c3\u00b3n granular que las plataformas alojadas no pueden igualar. Esa flexibilidad tambi\u00e9n significa m\u00e1s decisiones y m\u00e1s potencial de errores de configuraci\u00c3\u00b3n. Para un contexto m\u00e1s amplio sobre optimizaci\u00c3\u00b3n de ecommerce, consulta nuestra vision general de [SEO t\u00c3\u00a9cnico para ecommerce](/blog/technical-seo-for-ecommerce).",
      readTime: "13 min de lectura",
      sections: [
        {
          title: "Estructura de enlaces permanentes y optimización de URLs",
          content:
            "WordPress permite definir estructuras de enlaces permanentes personalizadas a traves de Ajustes > Enlaces permanentes. Para tiendas WooCommerce, el patr\u00f3n de URL de producto por defecto es /product/nombre-producto/, pero puedes modificar el slug base /product/ o eliminarlo por completo usando plugins o reglas de reescritura personalizadas.\n\nEl enfoque m\u00e1s amigable para SEO es mantener URLs cortas y descriptivas. Muchos propietarios eliminan los slugs base /product-category/ y /product/ para conseguir URLs m\u00e1s limpias. Sin embargo, eliminar estas bases crea riesgo de conflictos de URL entre productos, categor\u00edas, p\u00e1ginas y entradas que comparten slugs similares.\n\nWooCommerce tambi\u00e9n genera URLs con parametros de consulta para listados de productos filtrados y ordenados. Estas URLs parametrizadas pueden crear contenido duplicado masivo si Google las indexa. Configura tu plugin SEO para agregar directivas noindex a URLs filtradas.\n\nPara tiendas con cat\u00e1logos grandes, considera implementar navegaci\u00f3n facetada con filtrado basado en AJAX que no genere nuevas URLs.",
        ...
        },
        {
          title: "Plugins SEO: Yoast vs RankMath vs SEOPress",
          content:
            "Toda tienda WooCommerce necesita un plugin SEO dedicado para gestionar etiquetas de t\u00edtulo, meta descripciones, sitemaps XML, marcado schema y etiquetas canonicas. Las tres opciones principales son Yoast SEO, Rank Math y SEOPress.\n\nYoast SEO es el plugin m\u00e1s establecido con integracion dedicada para WooCommerce a traves de su addon premium WooCommerce SEO. Proporciona marcado schema especifico para productos, generacion de migas de pan y meta tags para redes sociales.\n\nRank Math ofrece m\u00e1s funciones en su versi\u00f3n gratuita que Yoast, incluyendo generadores de schema integrados para productos, gestion avanzada de redirecciones e integracion con Google Search Console directamente en el panel de WordPress.\n\nSEOPress es una alternativa m\u00e1s ligera que atrae a propietarios conscientes del rendimiento. Genera menos consultas de base de datos que Yoast o Rank Math, lo cual puede importar en tiendas con m\u00e1s de 10.000 productos.",
          items: [
            "Yoast SEO: mayor reconocimiento de marca, addon dedicado para WooCommerce, an\u00e1lisis de contenido exhaustivo",
            "Rank Math: m\u00e1s funciones en versi\u00f3n gratuita, generadores de schema integrados, integracion con Search Console",
            "SEOPress: menor huella en base de datos, rendimiento de admin m\u00e1s r\u00e1pido, bueno para cat\u00e1logos grandes",
        ...
        },
        {
          ...
          content:
            "El rendimiento de WooCommerce depende en gran medida del entorno de hosting y la optimizaci\u00f3n de la base de datos. A diferencia de plataformas alojadas como Shopify, tu llevas la responsabilidad total de la velocidad del servidor, que impacta directamente en los Core Web Vitals y la eficiencia del rastreo.\n\nElige un proveedor de hosting que ofrezca cache a nivel de servidor (Varnish, LiteSpeed Cache o NGINX FastCGI cache), PHP 8.1 o m\u00e1s reciente, y MySQL o MariaDB con caches de consultas correctamente configurados. El hosting compartido frecuentemente produce valores de TTFB superiores a 600 milisegundos.\n\nLa optimizaci\u00f3n de la base de datos es cada vez m\u00e1s relevante conforme crece el cat\u00e1logo de productos. WooCommerce almacena meta-datos en la tabla wp_postmeta, que puede crecer a millones de filas. WordPress 6.1 introdujo el High-Performance Order Storage (HPOS) que mueve datos de pedidos a tablas personalizadas.\n\nInstala un plugin de cache de p\u00e1ginas y una capa de cache de objetos (Redis o Memcached). El cache de p\u00e1ginas sirve HTML pre-construido a visitantes y rastreadores, reduciendo drasticamente el tiempo de respuesta del servidor. El rendimiento de WooCommerce depende en gran medida de tu entorno de hosting y la optimizaci\u00f3n de la base de datos, lo que impacta directamente la [optimizaci\u00f3n de velocidad del sitio](/academy/site-speed-optimization).",
        },
        {
          title: "Marcado schema en WooCommerce y resultados enriquecidos",
          content:
            "El marcado schema correcto permite a Google mostrar resultados enriquecidos para tus productos, incluyendo precio, disponibilidad, calificaciones de resenas e informaci\u00f3n de env\u00edo directamente en los resultados de busqueda. WooCommerce no incluye marcado schema por defecto, as\u00ed que tu plugin SEO o un plugin dedicado debe generarlo.\n\nEl [schema de Producto](/academy/structured-data-for-products) debe incluir como minimo: nombre, descripcion, imagen, SKU, marca, precio, moneda, disponibilidad y resenas. Para productos variables, genera una Oferta para cada variacion para que Google pueda mostrar el rango de precios.\n\nEl schema de migas de pan ayuda a Google a entender la jerarquia de tu sitio y puede reemplazar la URL en los resultados de busqueda con un rastro de migas de pan legible.\n\nEl schema FAQ en p\u00e1ginas de producto puede ganar espacio adicional en las SERPs. Si tus p\u00e1ginas de producto incluyen una seccion FAQ o paneles desplegables de preguntas y respuestas, marcalos con el schema FAQPage.",
          tip: "Prueba tu marcado schema en una p\u00e1gina de producto, una p\u00e1gina de producto variable y una p\u00e1gina de categor\u00eda. Los productos variables a menudo producen errores de schema porque cada variacion necesita su propio elemento Oferta.",
        },
        {
          title: "Optimización de imagenes y medios en WooCommerce",
          content:
            "Las imagenes de productos son tipicamente los archivos m\u00e1s grandes en cualquier p\u00e1gina de comercio electr\u00f3nico, haciendo la optimizaci\u00f3n de imagenes critica para el rendimiento de Core Web Vitals. WooCommerce genera multiples tamanos de imagen para cada foto de producto subida, lo que significa que un solo producto con cinco imagenes puede crear 20 o m\u00e1s archivos.\n\nConvierte todas las imagenes de productos al formato WebP usando un plugin como ShortPixel, Imagify o EWWW Image Optimizer. Los archivos WebP son entre un 25 y un 35 por ciento m\u00e1s pequenos que los archivos JPEG equivalentes sin p\u00e9rdida visible de calidad.\n\nImplementa carga diferida para imagenes de galeria, carruseles de productos relacionados y cualquier imagen debajo del pliegue. WordPress 5.5+ incluye carga diferida nativa, pero verifica que funcione en tus plantillas WooCommerce. La imagen principal del producto sobre el pliegue no debe cargarse de manera diferida.\n\nEstablece atributos de ancho y alto explicitos en todos los elementos de imagen para prevenir el Cumulative Layout Shift.",
          items: [
            "Convertir imagenes de productos a WebP (25-35% m\u00e1s pequenos que JPEG sin p\u00e9rdida visible de calidad)",
        ...
        },
        {
          ...
          content:
            "WordPress te da control completo sobre la arquitectura de informaci\u00f3n de tu sitio. Planifica tu taxonomia de categor\u00edas antes de construir la tienda, porque reestructurar categor\u00edas despues de que los productos estan indexados significa gestionar cientos de redirecciones.\n\nManten tu jerarquia de categor\u00edas en un maximo de tres niveles: categor\u00edas principales, subcategorias y sub-subcategorias. Cada nivel adicional diluye la equidad de enlaces internos y aleja los productos de la p\u00e1gina de inicio.\n\nLas p\u00e1ginas de producto de WooCommerce incluyen autom\u00e1ticamente productos relacionados y secciones de venta cruzada, que proporcionan enlaces internos entre productos. Personaliza el algoritmo de productos relacionados usando hooks de WooCommerce para asegurar que muestre art\u00edculos genuinamente relevantes.\n\nLa navegaci\u00f3n por migas de pan es esencial tanto para usuarios como para motores de busqueda. Activa las migas de pan a traves de tu plugin SEO y configuralas para seguir tu jerarquia de categor\u00edas. Crea una estructura de enlazado interno integral m\u00e1s alla de los widgets automatizados.",
        },
      ],
