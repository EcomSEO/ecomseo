...
export const shopifySeoGuide: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro: "Shopify alimente plus de quatre millions de boutiques en ligne, mais son architecture imposee cree des contraintes SEO sp\u00e9cifiques que les proprietaires de boutiques doivent contourner. Comprendre comment Shopify gere les URLs, les templates et le rendu permet de maximiser la visibilite organique sans lutter contre la plateforme. Pour un guide complet, lisez \u00c3\u00a9galement notre guide sur le [SEO e-commerce Shopify](/blog/shopify-ecommerce-seo).",
      readTime: "12 min de lecture",
      sections: [
        {
          title: "Structure des URLs Shopify et implications SEO",
          content:
            "Shopify impose une structure d'URL rigide qui ajoute les prefixes /collections/, /products/ et /pages/ a chaque page. Contrairement aux plateformes open source, vous ne pouvez pas supprimer ces prefixes ni cr\u00e9er des schemas d'URL entierement personnalises. Une URL de produit ressemble toujours a /products/widget-bleu.\n\nCela concerne le SEO car le prefixe /products/ ajoute un niveau de repertoire supplementaire. Cependant, Google a confirme que la structure d'URL seule n'est pas un facteur de classement. Le veritable probleme est le contenu duplique : Shopify genere une URL secondaire pour chaque produit dans un contexte de collection, dupliquant la page canonique /products/.\n\nShopify gere cela en placant une balise canonique pointant vers la version /products/. V\u00e9rifiez que ces balises canoniques fonctionnent correctement avec l'outil d'inspection d'URL de Google Search Console. Si des URLs de produits basees sur des collections sont indexees, la balise canonique peut etre remplacee par une personnalisation du theme ou un conflit d'application.",
          tip: "Utilisez la fonctionnalit\u00e9 de redirection en masse de Shopify pour nettoyer les anciennes URLs de produits apr\u00e8s suppression ou renommage d'articles. Les liens produits brises renvoyant des erreurs 404 erosionnent l'efficacite du crawl.",
          image: {
        ...
        },
        {
          ...
          content:
            "Les themes Shopify utilisent le langage de template Liquid, qui vous donne un contr\u00f4le direct sur les balises title, les meta descriptions, la hierarchie des titres et la sortie des [donn\u00e9es structurees](/academy/structured-data-for-products). Chaque fichier de theme sous les repertoires /templates/ et /sections/ peut etre modifie pour injecter du balisage pertinent pour le SEO.\n\nPour les balises title, modifiez le fichier de mise en page theme.liquid ou utilisez l'objet title sp\u00e9cifique au SEO fourni par Shopify. La variable {{ page_title }} affiche ce que vous definissez dans le panneau d'administration, mais vous pouvez ajouter le nom de votre boutique ou des separateurs avec la logique Liquid.\n\nLes donn\u00e9es structurees necessitent plus d'efforts. Bien que Shopify injecte du JSON-LD basique pour les produits (prix, disponibilite, nom), il manque souvent les donn\u00e9es d'avis agreges, le balisage fil d'Ariane et le schema FAQ. Vous devez les ajouter manuellement dans le template product.liquid ou product.json.\n\nLa hierarchie des titres est un autre domaine ou les themes Shopify echouent fr\u00e9quemment. De nombreux themes utilisent des balises H1 pour le nom de la boutique dans l'en-tete. Auditez la section header.liquid de votre theme et assurez-vous que chaque type de page possede exactement un H1. Notre [g\u00c3\u00a9n\u00c3\u00a9rateur de sch\u00c3\u00a9ma](/tools/schema-generator) peut vous aider \u00c3\u00a0 cr\u00c3\u00a9er des [donn\u00c3\u00a9es structur\u00c3\u00a9es valides pour les produits](/academy/structured-data-for-products).",
          items: [
            "Modifier theme.liquid pour contr\u00f4ler le format de la balise title",
            "Ajouter des donn\u00e9es structurees JSON-LD dans product.liquid pour les avis et le fil d'Ariane",
            "V\u00e9rifier que chaque template de page utilise un seul H1 pour le titre principal",
            "Utiliser des conditionnels Liquid pour d\u00e9finir des meta descriptions uniques par type de page",
          ],
        },
        {
        ...
        },
        {
          ...
          content:
            "Les Core Web Vitals influencent directement les classements Google, et les boutiques Shopify peinent souvent avec le Largest Contentful Paint (LCP) et le Cumulative Layout Shift (CLS). Le goulot d'etranglement principal est generalement le theme lui-meme, combine a des images non optimisees et des scripts d'applications excessifs.\n\nShopify sert automatiquement les images via son CDN et supporte la conversion au format WebP. Utilisez le filtre Liquid image_url avec des parametres de largeur pour servir des images dimensionnees de maniere appropriee. Cela empeche le navigateur de t\u00e9l\u00e9charger des images produit haute resolution de 4000 pixels sur les appareils mobiles.\n\nLe choix du theme est primordial. Les themes Online Store 2.0 de Shopify construits sur l'architecture de templates JSON performent generalement mieux que les themes Liquid herites. Dawn, le theme de r\u00e9f\u00e9rence de Shopify, obtient de bons scores Core Web Vitals nativement.\n\nLe chargement paresseux des images sous la ligne de flottaison, le report du JavaScript non critique et la minimisation de la complexite des boucles Liquid dans les templates de collections contribuent tous a des chargements de pages plus rapides. R\u00c3\u00a9soudre ces probl\u00c3\u00a8mes est une partie essentielle de l'[optimisation de la vitesse du site](/academy/site-speed-optimization).",
    ...
    es: {
      ...
      intro: "Shopify alimenta m\u00e1s de cuatro millones de tiendas online, pero su arquitectura predefinida crea restricciones SEO especificas que los propietarios de tiendas deben sortear. Comprender como Shopify gestiona URLs, plantillas y renderizado permite maximizar la visibilidad organica sin luchar contra la plataforma. Para un recorrido completo, lee tambi\u00e9n nuestra guia de [SEO para ecommerce en Shopify](/blog/shopify-ecommerce-seo).",
      readTime: "12 min de lectura",
      sections: [
        {
          title: "Estructura de URLs en Shopify y sus implicaciones SEO",
          content:
            "Shopify impone una estructura de URL rigida que antepone los prefijos /collections/, /products/ y /pages/ a cada p\u00e1gina. A diferencia de las plataformas de codigo abierto, no puedes eliminar estos prefijos ni crear patrones de URL completamente personalizados. Una URL de producto siempre se ve como /products/widget-azul.\n\nEsto afecta al SEO porque el prefijo /products/ anade un nivel de directorio adicional. Sin embargo, Google ha confirmado que la estructura de URL por si sola no es un factor de clasificacion. La verdadera preocupacion es el contenido duplicado: Shopify genera una URL secundaria para cada producto dentro de un contexto de coleccion, duplicando la p\u00e1gina canonica /products/.\n\nShopify maneja esto colocando una etiqueta canonica que apunta a la versi\u00f3n /products/. Debes verificar que estas etiquetas canonicas funcionen correctamente usando la herramienta de inspeccion de URLs de Google Search Console.",
          tip: "Utiliza la funcion de redireccion masiva de Shopify para limpiar URLs de productos antiguas despues de eliminar o renombrar art\u00edculos. Los enlaces de productos rotos que devuelven errores 404 erosionan la eficiencia del rastreo.",
          image: {
        ...
        },
        {
          ...
          content:
            "Los temas de Shopify utilizan el lenguaje de plantillas Liquid, que te da control directo sobre las etiquetas de t\u00edtulo, meta descripciones, jerarquia de encabezados y salida de [datos estructurados](/academy/structured-data-for-products). Cada archivo de tema bajo los directorios /templates/ y /sections/ puede editarse para inyectar marcado relevante para SEO.\n\nPara las etiquetas de t\u00edtulo, edita el archivo de diseno theme.liquid o usa el objeto de t\u00edtulo especifico para SEO proporcionado por Shopify. La variable {{ page_title }} muestra lo que configures en el panel de administracion, pero puedes anadir el nombre de tu tienda o separadores con l\u00f3gica Liquid.\n\nLos datos estructurados requieren m\u00e1s esfuerzo. Aunque Shopify inyecta JSON-LD basico para productos (precio, disponibilidad, nombre), a menudo carece de datos agregados de resenas, marcado de migas de pan y esquema FAQ. Debes anadirlos manualmente en la plantilla product.liquid o product.json.\n\nLa jerarquia de encabezados es otra area donde los temas de Shopify frecuentemente fallan. Muchos temas usan etiquetas H1 para el nombre de la tienda en el encabezado. Audita la seccion header.liquid de tu tema y asegurate de que cada tipo de p\u00e1gina tenga exactamente un H1. Nuestro [generador de schema](/tools/schema-generator) puede ayudarte a crear datos estructurados validos para productos.",
          items: [
            "Editar theme.liquid para controlar el formato de la etiqueta de t\u00edtulo",
            "Agregar datos estructurados JSON-LD en product.liquid para resenas y migas de pan",
            "Verificar que cada plantilla de p\u00e1gina use un unico H1 para el encabezado principal",
            "Usar condicionales Liquid para establecer meta descripciones unicas por tipo de p\u00e1gina",
          ],
        },
        {
          title: "Ecosistema de aplicaciones Shopify y rendimiento SEO",
          content:
            "El ecosistema de aplicaciones de Shopify es tanto una fortaleza como una carga para el SEO. Apps como Yoast SEO para Shopify, Smart SEO y SEO Manager pueden automatizar meta tags, generar sitemaps y gestionar redirecciones. Sin embargo, cada app inyecta JavaScript en tu escaparate, aumentando los tiempos de carga.\n\nCada aplicacion instalada anade al menos una solicitud HTTP adicional, y muchas inyectan scripts que bloquean el renderizado. Hemos medido tiendas donde eliminar tres aplicaciones no utilizadas mejoro el Largest Contentful Paint en m\u00e1s de 800 milisegundos.\n\nEl sitemap integrado de Shopify (sitemap.xml) se genera autom\u00e1ticamente y no puede editarse directamente. Incluye todos los productos publicados, colecciones, p\u00e1ginas y entradas de blog. El sitemap nativo tambi\u00e9n carece de entradas de sitemap de imagenes para galerias de productos.\n\nPara la gestion de redirecciones, Shopify soporta redirecciones 301 a traves del panel de administracion. Esta interfaz funciona para pequenas cantidades de redirecciones pero se vuelve inmanejable por encima de unos pocos cientos de entradas.",
        },
        {
          title: "Optimización de velocidad en Shopify para SEO",
          content:
            "Los Core Web Vitals influyen directamente en los rankings de Google, y las tiendas Shopify a menudo luchan con el Largest Contentful Paint (LCP) y el Cumulative Layout Shift (CLS). El cuello de botella principal suele ser el tema en si, combinado con imagenes no optimizadas y scripts de aplicaciones excesivos.\n\nShopify sirve autom\u00e1ticamente las imagenes a traves de su CDN y soporta la conversion al formato WebP. Usa el filtro Liquid image_url con parametros de ancho para servir imagenes dimensionadas apropiadamente. Esto evita que el navegador descargue imagenes de productos de alta resoluci\u00f3n de 4000 pixeles en dispositivos moviles.\n\nLa selecci\u00f3n del tema es enormemente relevante. Los temas Online Store 2.0 de Shopify construidos sobre la arquitectura de plantillas JSON generalmente rinden mejor que los temas heredados basados solo en Liquid. Dawn, el tema de referencia de Shopify, obtiene buenas puntuaciones en Core Web Vitals de f\u00e1brica.\n\nLa carga diferida de imagenes debajo del pliegue, el aplazamiento de JavaScript no critico y la minimizacion de la complejidad de bucles Liquid en plantillas de coleccion contribuyen a cargas de p\u00e1gina m\u00e1s rapidas. Abordar estos problemas es una parte critica de la [optimizaci\u00f3n de velocidad del sitio](/academy/site-speed-optimization).",
          tip: "Ejecuta una auditoria de velocidad del tema Shopify con Lighthouse tanto en una p\u00e1gina de coleccion como en una p\u00e1gina de producto. Las p\u00e1ginas de coleccion con muchas tarjetas de producto a menudo obtienen puntuaciones significativamente peores.",
          image: {
        ...
        },
        {
          ...
          content:
            "Shopify incluye un motor de blog integrado, pero es limitado en comparacion con WordPress o plataformas CMS dedicadas. Las entradas de blog soportan formato basico, incrustacion de imagenes y etiquetas, pero carecen de soporte nativo para categor\u00edas, bloques de contenido avanzados y generacion de tablas de contenido.\n\nA pesar de estas limitaciones, los blogs de Shopify siguen siendo la mejor opcion para el SEO de contenido porque residen en tu dominio principal y transmiten autoridad directamente a tus p\u00e1ginas de producto y coleccion a traves de enlaces internos.\n\nOptimiza cada entrada de blog estableciendo un handle de URL personalizado, escribiendo una meta descripcion unica y estructurando el contenido con subtitulos H2 y H3 apropiados. Anade enlaces internos desde las entradas del blog hacia p\u00e1ginas de coleccion relevantes y desde p\u00e1ginas de producto hacia contenido de blog relacionado.\n\nPara tiendas que necesitan capacidades de contenido m\u00e1s avanzadas, considera usar Shopify como motor de comercio mientras ejecutas un blog en subdirectorio a traves de una configuraci\u00f3n de proxy inverso con WordPress.",
        },
        {
          title: "SEO internacional en Shopify",
          content:
            "Shopify Markets permite vender en multiples paises e idiomas desde una unica tienda. Correctamente configurado, Markets crea subcarpetas (por ejemplo, /en-ca/, /fr/) con etiquetas hreflang que indican a Google que versi\u00f3n de una p\u00e1gina mostrar en cada localidad.\n\nLa implementaci\u00f3n de hreflang a traves de Shopify Markets es generalmente confiable, pero debes verificar las etiquetas usando el verificador de hreflang en Google Search Console o una herramienta de rastreo de terceros. Los problemas comunes incluyen etiquetas hreflang autorreferenciales faltantes e inconsistencias.\n\nPara tiendas que usan la funcion de traduccion autom\u00e1tica de Shopify, revisa cuidadosamente la calidad del contenido traducido. Las descripciones de productos y meta tags traducidos autom\u00e1ticamente pueden sonar artificiales, lo que perjudica las tasas de clics desde los resultados de busqueda.\n\nLa visualizacion de moneda y precios debe usar el formato localizado para cada mercado. Simbolos de moneda inconsistentes en los datos estructurados pueden hacer que Google muestre precios incorrectos en los resultados enriquecidos.",
        },
      ],
    ...
    it: {
      ...
      intro:
        "Shopify alimenta oltre quattro milioni di negozi online, ma la sua architettura predefinita crea vincoli SEO specifici che i proprietari di negozi devono aggirare. Comprendere come Shopify gestisce URL, template e rendering permette di massimizzare la visibilita organica senza combattere la piattaforma. Per approfondire, consulta la nostra guida sulla [SEO ecommerce per Shopify](/blog/shopify-ecommerce-seo).",
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "I temi Shopify utilizzano il linguaggio di template Liquid, che offre controllo diretto su tag title, meta description, gerarchia dei titoli e output dei [dati strutturati](/academy/structured-data-for-products). Ogni file del tema nelle directory /templates/ e /sections/ puo essere modificato per iniettare markup rilevante per la SEO.\n\nPer i tag title, modifica il file di layout theme.liquid o utilizza l'oggetto title specifico per la SEO fornito da Shopify. La variabile {{ page_title }} mostra cio che imposti nel pannello di amministrazione, ma puoi aggiungere il nome del negozio o separatori con la logica Liquid.\n\nI dati strutturati richiedono maggiore impegno. Sebbene Shopify inietti JSON-LD basico per i prodotti (prezzo, disponibilita, nome), spesso mancano i dati aggregati delle recensioni, il markup breadcrumb e lo schema FAQ. Devi aggiungerli manualmente nel template product.liquid o product.json. Approfondisci con la nostra guida sul [generatore di schema](/tools/schema-generator).\n\nLa gerarchia dei titoli e un altro ambito in cui i temi Shopify mostrano frequenti carenze. Molti temi usano tag H1 per il nome del negozio nell'intestazione. Controlla la sezione header.liquid del tuo tema e assicurati che ogni tipo di pagina abbia esattamente un H1.",
          items: [
