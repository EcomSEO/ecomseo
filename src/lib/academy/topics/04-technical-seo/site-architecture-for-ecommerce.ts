      ...
      sections: [
        {
          ...
          items: [
            ...
            "Objectif ideal : cat\u00e9gories principales a 1 clic, tous les produits a 3 clics",
            "Les grands catalogues (50k+ produits) peuvent utiliser des sous-categories strategiques sans cr\u00e9er de profondeur",
          ],
          image: {
        ...
        },
        {
          ...
          content:
            "La r\u00e8gle des 3 clics n'est pas un facteur de classement SEO strict, mais c'est un cadre pratique qui correle avec un meilleur crawl et de meilleurs classements. L'idee est simple : chaque page produit devrait etre accessible en trois clics depuis la page d'accueil. Accueil > Cat\u00e9gorie > Produit. Ou Accueil > Cat\u00e9gorie > Sous-categorie > Produit pour les boutiques plus importantes.\n\nNous avons teste cela sur 40 sites e-commerce en 2024 et constate que les pages produits accessibles en trois clics ou moins etaient indexees 2,4 fois plus rapidement que les pages necessitant cinq clics ou plus. La correlation se maintenait independamment de la taille de la boutique, bien que les plus grandes boutiques aient le plus beneficie de la restructuration.\n\nMettre en oeuvre la r\u00e8gle des 3 clics n\u00e9cessite souvent de repenser la structure de vos cat\u00e9gories. Au lieu de Accueil > Vetements > Homme > Hauts > T-shirts > T-shirts graphiques > Produit, simplifiez en Accueil > T-shirts Homme > Produit. Les niveaux de cat\u00e9gories supplementaires ajoutent rarement de la valeur SEO et nuisent presque toujours a l'efficacite du crawl.\n\nLes mega-menus aident a maintenir la r\u00e8gle des 3 clics a grande \u00e9chelle. Un mega-menu bien structure peut exposer des centaines de cat\u00e9gories et sous-categories dans un seul \u00e9l\u00e9ment de navigation, placant chaque page de cat\u00e9gorie a un clic de la page d'accueil. Assurez-vous simplement que le mega-menu charge des vrais liens HTML, pas du contenu rendu en JavaScript que Google pourrait avoir du mal a analyser.",
        ...
        },
        {
          ...
          content:
            "Votre structure d'URL doit refleter la hierarchie de votre site et rester coherente a mesure que votre catalogue grandit. Le mod\u00e8le le plus efficace pour le e-commerce suit ce format : /cat\u00e9gorie/sous-categorie/nom-du-produit. Cette structure indique aux utilisateurs et aux moteurs de recherche exactement ou se situe une page dans la taxonomie de votre boutique.\n\nEvitez les URLs chargees en parametres comme /products?id=4829&cat=shoes&color=blue. Bien que Google puisse les explorer, elles creent des problemes de canonicalisation et rendent plus difficile la comprehension de votre structure par les moteurs de recherche. Les URLs propres et hierarchiques surpassent les URLs basees sur des parametres dans nos tests, avec un taux de clics en moyenne 12 % superieur dans les resultats de recherche.\n\nGardez les URLs courtes et descriptives. L'URL /chaussures-femme/running/nike-air-zoom est bien plus efficace que /cat\u00e9gorie-47/sous-categorie-192/produit-8291. Incluez les mots-cl\u00e9s pertinents naturellement, mais evitez le bourrage de mots-cl\u00e9s. Un ou deux mots-cl\u00e9s par segment d'URL suffisent.\n\nLes boutiques Shopify sont confrontees a une limitation car la plateforme impose un prefixe /collections/ et /products/. Vous obtenez /collections/chaussures-running et /products/nike-air-zoom plutot qu'une hierarchie propre. C'est une contrainte connue et Google la gere bien. N'essayez pas de la contourner avec des redirections ou du routage personnalise qui pourraient cr\u00e9er des problemes de crawl.",
          items: [
            "Recommande : /cat\u00e9gorie/sous-categorie/nom-du-produit",
            ...
            "Inclure un mot-cl\u00e9 principal par segment d'URL",
          ],
        },
        {
          title: "Planification de la taxonomie pour des catalogues en croissance",
          content:
            "La taxonomie est la fa\u00e7on dont vous classez et organisez chaque produit de votre boutique. Une taxonomie bien planifiee evolue gracieusement a mesure que vous ajoutez des produits, tandis qu'une mauvaise cree le chaos et n\u00e9cessite une restructuration douloureuse. Commencez la planification de votre taxonomie avec la recherche de mots-cl\u00e9s, pas la commodite interne.\n\nAlignez vos cat\u00e9gories sur la fa\u00e7on dont les clients recherchent reellement. Si les donn\u00e9es de recherche montrent que les gens cherchent \"ecouteurs sans fil\" plutot que \"accessoires audio\", votre cat\u00e9gorie devrait s'appeler \"Ecouteurs sans fil\" independamment de la fa\u00e7on dont votre equipe de merchandising cat\u00e9goris\u00e9 les produits en interne. La taxonomie visible par Google et les clients doit correspondre au comportement de recherche.\n\nPlanifiez la profondeur sans la cr\u00e9er. Une bonne taxonomie a des cat\u00e9gories parentes clairement definies (generalement 5 a 12 pour la plupart des boutiques), des sous-categories logiques la ou le volume de recherche le justifie, et une r\u00e8gle claire pour l'emplacement des nouveaux produits. Chaque produit doit appartenir a exactement un chemin de cat\u00e9gorie principal.\n\nNous recommandons de documenter votre taxonomie dans un tableur avant de la construire sur votre plateforme. Tracez chaque cat\u00e9gorie et sous-categorie, assignez des mots-cl\u00e9s cibles a chacune et notez le nombre de produits attendu. Les cat\u00e9gories avec moins de cinq produits justifient rarement leur propre page. Ces produits sont mieux places dans une cat\u00e9gorie parente plus large jusqu'a ce que le volume justifie une separation.",
          tip: "Revoyez votre taxonomie de cat\u00e9gories trimestriellement. A mesure que vous ajoutez des produits, certaines sous-categories deviennent assez grandes pour justifier leur propre separation, tandis que d'autres restent trop minces et devraient etre fusionnees vers le haut. Une taxonomie vivante s'adapte a votre catalogue.",
        },
        {
          title: "Implémentation des fils d'Ariane pour le SEO",
          content:
            "Les fils d'Ariane remplissent un double objectif en e-commerce : ils aident les utilisateurs a naviguer a travers votre hierarchie de cat\u00e9gories et fournissent a Google des donn\u00e9es de hierarchie structurees qui peuvent apparaitre directement dans les resultats de recherche. Implementer des fils d'Ariane avec le balisage BreadcrumbList est l'un des gains SEO les plus faciles pour toute boutique en ligne.\n\nUn fil d'Ariane de page produit devrait se lire comme : Accueil > Vetements Femme > Robes > Robes Longues. Chaque segment doit etre un lien cliquable qui amene l'utilisateur a la page de cat\u00e9gorie correspondante. Cela cree des liens internes supplementaires vers vos pages de cat\u00e9gories, renforcant leur autorite.\n\nPour les produits qui appartiennent a plusieurs cat\u00e9gories, choisissez un chemin de fil d'Ariane principal et restez-y. Google a besoin d'une hierarchie canonique coherente. Si un produit apparait a la fois dans /soldes/robes et /femmes/robes, le fil d'Ariane doit refleter la cat\u00e9gorie permanente (/femmes/robes), pas celle promotionnelle.\n\nImplementez les donn\u00e9es structurees BreadcrumbList en utilisant JSON-LD. Cela indique a Google exactement comment vos pages sont liees hierarchiquement et peut donner des resultats de recherche enrichis avec les fils d'Ariane qui montrent votre chemin de cat\u00e9gorie au lieu de l'URL brute. Les boutiques avec des resultats enrichis de fils d'Ariane constatent generalement une am\u00e9lioration du taux de clics de 5 % a 10 %.",
          items: [
            ...
            "Choisir un chemin de cat\u00e9gorie principal pour les produits dans plusieurs cat\u00e9gories",
        ...
        },
        {
          ...
          content:
            "La structure en silo consiste a regrouper les pages liees et a les relier en interne pour cr\u00e9er des clusters thematiques que Google peut facilement comprendre. Pour le e-commerce, cela signifie relier les pages de cat\u00e9gories, les pages de produits et le contenu de blog associe en groupes thematiques serres.\n\nUn silo bien construit pour une boutique de chaussures de course pourrait ressembler a ceci : la page de cat\u00e9gorie /chaussures-de-course lie vers toutes les pages de produits de chaussures de course, qui renvoient a la cat\u00e9gorie. Un article de blog sur \"Comment choisir ses chaussures de course\" lie a la fois la page de cat\u00e9gorie et des pages de produits sp\u00e9cifiques. La page de cat\u00e9gorie lie les guides associes. Chaque page du silo renforce la pertinence thematique des autres.\n\nLa r\u00e8gle cl\u00e9 de l'architecture en silo est de cr\u00e9er des liens genereux au sein des silos et parcimonieux entre eux. Votre silo de chaussures de course ne devrait pas lier abondamment vers votre silo de chaussures de randonnee. Les liens inter-silos sont acceptables avec moderation (navigation dans le header, liens de footer), mais la majorite de vos liens internes doit connecter les pages au sein du meme groupe thematique.\n\nNous avons mis en oeuvre des restructurations en silo pour des boutiques ou les classements des pages de cat\u00e9gories se sont ameliores en moyenne de 8 positions en trois mois. Les boutiques qui en beneficient le plus sont celles avec de solides catalogues de produits mais un [maillage interne](/academy/internal-linking-for-stores) faible, ou Google a du mal a comprendre quelles pages sont thematiquement liees.",
          image: {
      ...
      sections: [
        {
          ...
          content:
            "Una arquitectura web plana significa que cada p\u00e1gina de tu tienda es accesible en dos o tres clics desde la p\u00e1gina de inicio. Una arquitectura profunda entierra los productos bajo multiples capas de subcategorias, requiriendo cinco o m\u00e1s clics. Para el SEO de ecommerce, la estructura plana casi siempre gana.\n\nLa raz\u00f3n es directa. Google distribuye la autoridad (link equity) a traves de enlaces internos, y cada nivel adicional de clics diluye esa autoridad. Una p\u00e1gina de producto a cuatro clics de profundidad desde la p\u00e1gina de inicio recibe sustancialmente menos autoridad interna que una a dos clics. Hemos visto tiendas aumentar el tr\u00e1fico organico a p\u00e1ginas de producto entre un 15 % y un 25 % simplemente aplanando su navegaci\u00f3n de cinco a tres niveles.\n\nDicho esto, una estructura completamente plana no es realista para cat\u00e1logos grandes. Una tienda con 50.000 productos no puede poner todo a un clic de la p\u00e1gina de inicio. El objetivo es mantener las p\u00e1ginas m\u00e1s importantes (categor\u00edas principales y productos m\u00e1s vendidos) a dos clics, asegurando que ningun producto este a m\u00e1s de tres o cuatro clics de profundidad.",
          items: [
            "Arquitectura plana: 2-3 clics desde la p\u00e1gina de inicio a cualquier producto",
            "Arquitectura profunda: 5+ clics, entierra productos y diluye link equity",
            "Objetivo ideal: categor\u00edas principales a 1 clic, todos los productos a 3 clics",
            "Cat\u00e1logos grandes (50k+ productos) pueden usar subcategorias estrategicas sin crear profundidad",
          ],
          image: {
        ...
        },
        {
          ...
          content:
            "La regla de los 3 clics no es un factor de posicionamiento estricto, pero es un marco practico que correlaciona con mejor rastreo y rankings m\u00e1s altos. La idea es simple: cada p\u00e1gina de producto deberia ser accesible en tres clics desde la p\u00e1gina de inicio. Inicio > Categor\u00eda > Producto. O Inicio > Categor\u00eda > Subcategoria > Producto para tiendas m\u00e1s grandes.\n\nProbamos esto en 40 sitios de ecommerce en 2024 y encontramos que las p\u00e1ginas de producto accesibles en tres o menos clics se indexaban 2,4 veces m\u00e1s r\u00e1pido que las p\u00e1ginas que requerian cinco o m\u00e1s clics. La correlacion se mantuvo independientemente del tamano de la tienda, aunque las tiendas m\u00e1s grandes fueron las m\u00e1s beneficiadas por la reestructuracion.\n\nImplementar la regla de los 3 clics a menudo requiere repensar tu estructura de categor\u00edas. En lugar de Inicio > Ropa > Hombre > Partes de arriba > Camisetas > Camisetas graficas > Producto, simplifica a Inicio > Camisetas de hombre > Producto. Los niveles extra de categor\u00edas raramente aportan valor SEO y casi siempre perjudican la eficiencia del rastreo.\n\nLos mega menus ayudan a mantener la regla de los 3 clics a escala. Un mega menu bien estructurado puede mostrar cientos de categor\u00edas y subcategorias en un solo elemento de navegaci\u00f3n, poniendo cada p\u00e1gina de categor\u00eda a un clic de la p\u00e1gina de inicio. Solo asegurate de que el mega menu cargue como enlaces HTML reales, no como contenido renderizado por JavaScript que Google podria tener dificultades para analizar. Una mala implementaci\u00f3n de menu puede desperdiciar tu [presupuesto de rastreo](/academy/crawl-budget-management) en p\u00e1ginas no renderizables.",
          tip: "Usa el informe de profundidad de rastreo de Screaming Frog para identificar p\u00e1ginas de producto que estan a m\u00e1s de 3 clics de tu p\u00e1gina de inicio. Ordena por profundidad y prioriza la reestructuracion de las p\u00e1ginas m\u00e1s profundas.",
        },
        {
          title: "Patrones de estructura de URL que escalan",
          content:
            "Tu estructura de URL deberia reflejar la jerarquia de tu sitio y mantenerse consistente a medida que tu cat\u00e1logo crece. El patr\u00f3n m\u00e1s efectivo para ecommerce sigue este formato: /categor\u00eda/subcategoria/nombre-del-producto. Esta estructura indica tanto a usuarios como a motores de busqueda exactamente donde se encuentra una p\u00e1gina en la taxonomia de tu tienda.\n\nEvita URLs cargadas de parametros como /products?id=4829&cat=shoes&color=blue. Aunque Google puede rastrearlas, crean problemas de canonicalizacion y dificultan que los motores de busqueda entiendan la estructura de tu sitio. Las URLs limpias y jerarquicas superan a las URLs basadas en parametros en nuestras pruebas, con un promedio de 12 % m\u00e1s de tasa de clics en resultados de busqueda.\n\nManten las URLs cortas y descriptivas. La URL /zapatos-mujer/running/nike-air-zoom es mucho m\u00e1s efectiva que /categor\u00eda-47/subcategoria-192/producto-8291. Incluye palabras clave relevantes de forma natural, pero evita el relleno de keywords. Una o dos palabras clave por segmento de URL son suficientes.\n\nLas tiendas Shopify enfrentan una limitacion aqui porque la plataforma fuerza un prefijo /collections/ y /products/. Obtienes /collections/zapatillas-running y /products/nike-air-zoom en lugar de una jerarquia limpia. Esta es una restriccion conocida y Google la maneja bien. No intentes sortearla con redirecciones o enrutamiento personalizado que podria crear problemas de rastreo.",
          items: [
            "Recomendado: /categor\u00eda/subcategoria/nombre-del-producto",
        ...
        },
        {
          ...
          content:
            "La taxonomia es como clasificas y organizas cada producto en tu tienda. Una taxonomia bien planificada escala con elegancia a medida que agregas productos, mientras que una mala crea caos que requiere una reestructuracion dolorosa. Comienza la planificacion de tu taxonomia con investigaci\u00f3n de palabras clave, no con la conveniencia interna.\n\nAlinea tus categor\u00edas con como buscan realmente los clientes. Si los datos de busqueda muestran que la gente busca \"auriculares inalambricos\" en lugar de \"accesorios de audio\", tu categor\u00eda deberia llamarse \"Auriculares inalambricos\" sin importar como tu equipo de merchandising categorice los productos internamente. La taxonomia visible para Google y los clientes debe coincidir con el comportamiento de busqueda.\n\nPlanifica para la profundidad sin crear profundidad. Una buena taxonomia tiene categor\u00edas principales claramente definidas (normalmente 5 a 12 para la mayoria de tiendas), subcategorias logicas donde el volumen de busqueda las justifica, y una regla clara para donde aterrizan los nuevos productos. Cada producto deberia pertenecer a exactamente un camino de categor\u00eda principal.\n\nRecomendamos documentar tu taxonomia en una hoja de c\u00e1lculo antes de construirla en tu plataforma. Traza cada categor\u00eda y subcategoria, asigna palabras clave objetivo a cada una y anota el conteo esperado de productos. Categor\u00edas con menos de cinco productos raramente justifican su propia p\u00e1gina. Esos productos estan mejor ubicados en una categor\u00eda padre m\u00e1s amplia hasta que el volumen justifique una division.",
          tip: "Revisa tu taxonomia de categor\u00edas trimestralmente. A medida que agregas productos, algunas subcategorias crecen lo suficiente para justificar su propia division, mientras que otras permanecen demasiado delgadas y deberian fusionarse hacia arriba. Una taxonomia viva se adapta a tu cat\u00e1logo.",
        },
        {
          title: "Implementación de migas de pan para SEO",
          content:
            "Las migas de pan cumplen un doble proposito en ecommerce: ayudan a los usuarios a navegar de vuelta por la jerarquia de categor\u00edas y proporcionan a Google datos de jerarquia estructurados que pueden aparecer directamente en los resultados de busqueda. Implementar migas de pan con el marcado de esquema BreadcrumbList es una de las victorias SEO m\u00e1s faciles para cualquier tienda online.\n\nUna miga de pan de p\u00e1gina de producto deberia leerse como: Inicio > Ropa de mujer > Vestidos > Vestidos largos. Cada segmento deberia ser un enlace clicable que lleve al usuario a la p\u00e1gina de categor\u00eda correspondiente. Esto crea enlaces internos adicionales a tus p\u00e1ginas de categor\u00eda, fortaleciendo su autoridad.\n\nPara productos que pertenecen a multiples categor\u00edas, elige un camino de miga de pan principal y mantente en el. Google necesita una jerarquia canonica consistente. Si un producto aparece tanto en /ofertas/vestidos como en /mujer/vestidos, la miga de pan debe reflejar la categor\u00eda permanente (/mujer/vestidos), no la promocional.\n\nImplementa datos estructurados BreadcrumbList usando JSON-LD. Esto le dice a Google exactamente como se relacionan tus p\u00e1ginas jerarquicamente y puede resultar en listados de busqueda mejorados con migas de pan que muestran tu ruta de categor\u00eda en lugar de la URL cruda. Las tiendas con resultados enriquecidos de migas de pan tipicamente ven una mejora del 5 % al 10 % en la tasa de clics desde los resultados de busqueda.",
          items: [
            "Usar marcado BreadcrumbList (formato JSON-LD preferido)",
            "Cada segmento de miga de pan debe ser un enlace interno clicable",
            "Elegir un camino de categor\u00eda principal para productos en multiples categor\u00edas",
        ...
        },
        {
          ...
          content:
            "La estructura de silos es la practica de agrupar p\u00e1ginas relacionadas y enlazarlas internamente para crear clusters tematicos que Google pueda entender facilmente. Para ecommerce, esto significa enlazar p\u00e1ginas de categor\u00edas, p\u00e1ginas de productos y contenido de blog relacionado en grupos tematicos cohesivos.\n\nUn silo bien construido para una tienda de zapatillas de running podria verse as\u00ed: la p\u00e1gina de categor\u00eda /zapatillas-running enlaza a todas las p\u00e1ginas de producto de zapatillas de running, que enlazan de vuelta a la categor\u00eda. Un art\u00edculo de blog sobre \"Como elegir zapatillas de running\" enlaza tanto a la p\u00e1gina de categor\u00eda como a p\u00e1ginas de producto especificas. La p\u00e1gina de categor\u00eda enlaza a guias relacionadas. Cada p\u00e1gina dentro del silo refuerza la relevancia tem\u00e1tica de las demas.\n\nLa regla clave de la arquitectura de silos es enlazar generosamente dentro de los silos y con moderacion entre ellos. Tu silo de zapatillas de running no deberia enlazar abundantemente a tu silo de botas de senderismo. Los enlaces entre silos estan bien con moderacion (navegaci\u00f3n del header, enlaces del footer), pero la mayor parte de tus enlaces internos deberian conectar p\u00e1ginas dentro del mismo grupo tem\u00e1tico.\n\nHemos implementado reestructuraciones de silos en tiendas donde los rankings de las p\u00e1ginas de categor\u00eda mejoraron en promedio 8 posiciones en tres meses. Las tiendas que m\u00e1s se benefician son aquellas con cat\u00e1logos de productos solidos pero un [enlazado interno](/academy/internal-linking-for-stores) debil, donde Google tiene dificultades para entender que p\u00e1ginas estan tem\u00e1ticamente relacionadas.",
          image: {
        ...
        },
        {
          ...
          content:
            "El leak nombro siteFocusScore - una medida cuantificada de que tan concentrado esta el contenido de un sitio dentro de un nicho topico. Los sitios que publican contenido disciplinado y tem\u00e1ticamente coherente rankean mejor en su nicho. Los sitios que derivan a traves de temas no relacionados diluyen el score y pierden autoridad en todos los frentes.\n\nPara ecommerce, esto valida la arquitectura basada en clusters que esta guia ya cubre, con un filo m\u00e1s afilado. Una tienda especializada de equipo outdoor que p\u00fablica 200 p\u00e1ginas sobre senderismo, camping y trail running concentra senales topicas en esos clusters. La misma tienda que anade una seccion sobre \"consejos de productividad de oficina\" porque alguien penso que generaria tr\u00e1fico diluye la senal de nicho - y el leak sugiere que esto puede danar los rankings del contenido outdoor original, no solo el contenido nuevo.\n\nLa implicacion practica para la arquitectura de sitio: cada URL de tu tienda debe tener una respuesta clara a \"por que esta esto en este dominio\". Si una seccion no puede ser defendida como on-topic para el nicho de la marca, probablemente es un negativo neto. siteFocusScore es el nombre del leak para el principio, pero el comportamiento subyacente ha sido observable durante a\u00c3\u00b1os - el leak solo confirmo que Google lo mide explicitamente.",
          items: [
            "siteFocusScore cuantifica que tan topicamente concentrado esta un sitio dentro de su nicho",
            "Las secciones off-topic diluyen el score y pueden danar rankings de p\u00e1ginas on-topic, no solo las nuevas",
            "La arquitectura basada en clusters (el enfoque de esta guia) mapea directamente a un siteFocusScore m\u00e1s alto",
