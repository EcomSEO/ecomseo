...
export const siteArchitectureForEcommerce: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro:
        "La maniere dont vous organisez les pages de votre boutique determine la capacite de Google a les explorer, les comprendre et les classer. Une architecture de site plate et logique rend chaque produit accessible en quelques clics et distribue efficacement le link equity a travers votre catalogue.",
    ...
    es: {
      ...
      intro:
        "La forma en que organizas las paginas de tu tienda determina lo bien que Google puede rastrearlas, entenderlas y posicionarlas. Una arquitectura web plana y logica hace que cada producto sea accesible en pocos clics y distribuye la autoridad de enlaces de forma eficiente a traves de tu catalogo.",
