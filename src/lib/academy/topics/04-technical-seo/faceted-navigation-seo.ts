...
export const facetedNavigationSeo: AcademyTopic = {
  ...
  content: {
      ...
      sections: [
        {
          ...
          content:
            "La navigation a facettes fonctionne en ajoutant des parametres de filtre a l'URL de la cat\u00e9gorie. Quand un acheteur s\u00e9lectionn\u00e9 \"Marque: Nike\" sur une page de cat\u00e9gorie chaussures, l'URL devient /chaussures?marque=nike. Ajouter \"Couleur: Noir\" la change en /chaussures?marque=nike&couleur=noir. Ajouter \"Taille: 42\" cree /chaussures?marque=nike&couleur=noir&taille=42. Chaque combinaison est une URL unique et crawlable que les moteurs de recherche peuvent decouvrir.\n\nLes mathematiques de la g\u00e9n\u00e9ration combinatoire d'URLs sont stup\u00c3\u00a9fiantes. Une page de cat\u00e9gorie avec 5 groupes de filtres, chacun contenant 10 options, peut theoriquement generer plus de 100 000 combinaisons d'URLs. Un grand detaillant de mode avec 20 groupes de filtres sur des centaines de cat\u00e9gories peut facilement produire des dizaines de millions d'URLs de filtres crawlables.\n\nAu-dela du nombre brut d'URLs, la navigation a facettes cree plusieurs problemes SEO interrelies. Le budget de crawl est consomme par des pages de filtres de faible valeur au lieu de pages produits generant du revenu. L'equite des liens internes est distribuee sur des milliers d'URLs de filtres au lieu de se concentrer sur les pages de cat\u00e9gories et produits importantes. Des pages a contenu mince emergent quand des combinaisons de filtres sp\u00e9cifiques retournent tr\u00e8s peu ou zero produits. Et la cannibalisation de mots-cl\u00e9s se produit quand plusieurs pages de filtres ciblent les memes requetes.\n\nLe defi est que certaines combinaisons de filtres ont une demande de recherche reelle et une valeur SEO. Les gens cherchent \"chaussures de course Nike noires\" et \"grandes vestes d'hiver bleues.\" L'objectif SEO n'est pas de bloquer toute la navigation a facettes, mais de permettre selectivement aux moteurs de recherche d'acceder aux combinaisons de filtres precieuses tout en les empechant d'explorer les millions de combinaisons sans valeur. C'est un d\u00c3\u00a9fi fondamental du [SEO technique pour l'e-commerce](/blog/technical-seo-for-ecommerce).",
          items: [
            "Chaque s\u00e9lection de filtre cree une nouvelle URL crawlable avec des parametres ajoutes",
            "Explosion combinatoire : 5 groupes de filtres avec 10 options chacun peuvent cr\u00e9er plus de 100 000 URLs",
            ...
            "La cannibalisation de mots-cl\u00e9s se produit quand plusieurs pages filtres ciblent les memes requetes",
          ],
          tip: "Avant d'implementer une solution technique, identifiez quelles combinaisons de filtres correspondent a une demande de recherche reelle. Utilisez des outils de recherche de mots-cl\u00e9s pour identifier les requetes qui correspondent a des combinaisons sp\u00e9cifiques de facettes.",
          image: {
        ...
        },
        {
          ...
          content:
            "La d\u00e9cision fondamentale en SEO de navigation a facettes est de determiner quelles combinaisons de filtres doivent etre des pages indexables et lesquelles doivent etre bloquees. Cette d\u00e9cision doit etre guidee par les donn\u00e9es de demande de recherche, pas par la commodite technique.\n\nCommencez par exporter toutes vos cat\u00e9gories de filtres et leurs valeurs. Puis utilisez des outils de recherche de mots-cl\u00e9s pour trouver le volume de recherche pour les combinaisons de votre type de produit plus chaque valeur de filtre. Pour un magasin de chaussures, vous pourriez constater que les filtres de marque ont un volume significatif, les filtres de couleur un volume modere et les filtres de materiau une certaine demande. Les filtres de note, de disponibilite et les combinaisons multi-attributs ont generalement un volume negligeable.\n\nCreez un syst\u00e8me de classification a trois niveaux. Le niveau 1 inclut les filtres a attribut unique avec une demande de recherche prouvee qui devraient etre des pages entierement indexables avec une optimisation SEO dediee. Le niveau 2 inclut les filtres avec un potentiel de recherche modere qui peuvent etre indexables mais n'ont pas besoin d'optimisation dediee. Le niveau 3 inclut toutes les combinaisons restantes qui doivent etre compl\u00e8tement bloquees du crawl et de l'indexation.\n\nCette classification informe directement votre impl\u00e9mentation technique. Les filtres de niveau 1 obtiennent idealement des URLs propres et crawlables. Les filtres de niveau 2 utilisent des URLs parametrees avec des balises canonical auto-referencantes. Les filtres de niveau 3 sont bloques via robots.txt ou canonicalises vers la cat\u00e9gorie parente.",
          items: [
            "Baser les d\u00e9cisions d'indexation sur les donn\u00e9es reelles de demande de recherche",
            "Exporter toutes les cat\u00e9gories de filtres et v\u00e9rifier le volume de recherche par combinaison",
        ...
        },
        {
          ...
          content:
            "Pour les combinaisons de filtres de niveau 1 avec une demande de recherche prouvee, creez des pages d'atterrissage dediees qui vont au-dela du simple filtrage de votre catalogue. Ces pages doivent etre traitees comme des pages de cat\u00e9gorie de premi\u00e8re classe avec un contenu unique et precieux.\n\nCommencez par des balises titre et meta descriptions uniques ciblant la requete de recherche sp\u00e9cifique. Une page pour les chaussures de course Nike ne devrait pas utiliser le meme mod\u00e8le de titre que la cat\u00e9gorie parente chaussures avec \"Nike\" ajoute. Redigez plutot un titre comme \"Chaussures de Course Nike - Livraison Gratuite sur les Nouveautes.\"\n\nAjoutez du contenu d'introduction unique a chaque page filtre de niveau 1. Un ou deux paragraphes sur l'heritage de la marque, les caracteristiques de la cat\u00e9gorie de produits ou un guide d'achat sp\u00e9cifique a cette combinaison differencie la page d'une simple liste filtree de produits.\n\nImplementez une hierarchie de titres appropriee sur les pages d'atterrissage de filtres. Le H1 devrait correspondre a la cible de requete de recherche principale. Les titres subsequents peuvent organiser la page par sous-categorie, gamme de produits ou cas d'utilisation.\n\nAssurez-vous que ces pages sont bien integrees dans la structure de liens internes de votre site. Ajoutez-les a votre navigation principale, barres laterales de cat\u00e9gories et fils d'Ariane. Liez vers elles depuis le contenu de blog et les guides d'achat pertinents.",
          items: [
            "Cr\u00e9er des balises titre et meta descriptions uniques ciblant des requetes sp\u00e9cifiques",
            "Ajouter du contenu d'introduction unique : informations de marque, guides d'achat, descriptions de cat\u00e9gorie",
        ...
        },
        {
          ...
          content:
            "Les filtres multi-selection, ou les utilisateurs peuvent s\u00e9lectionner plusieurs valeurs au sein d'un seul groupe de filtres, creent la pire inflation d'URLs. Un seul filtre multi-selection avec 10 options genere 1 023 combinaisons possibles. Deux filtres multi-selection avec 10 options chacun creent plus d'un million de combinaisons.\n\nL'approche la plus sure pour les filtres multi-selection est d'empecher compl\u00e8tement les moteurs de recherche d'y acceder. Utilisez un filtrage base sur AJAX qui met a jour la grille de produits dynamiquement sans changer l'URL quand plusieurs valeurs sont selectionnees au sein d'un groupe de filtres.\n\nSi votre plateforme requiert des changements d'URL pour les filtres multi-selection, implementez des balises canonical qui pointent toutes les URLs multi-selection vers la page de filtre unique la plus pertinente ou la cat\u00e9gorie parente. De plus, utilisez des r\u00e8gles robots.txt pour bloquer les patterns d'URL contenant des valeurs multi-selection separees par des virgules.\n\nLes combinaisons inter-filtres ne devraient presque jamais etre indexables. Une URL comme /chaussures?marque=nike&couleur=noir&taille=42&materiau=cuir represente une s\u00e9lection de produits si etroite qu'elle n'a certainement pas de volume de recherche significatif.\n\nLes filtres appliques doivent maintenir un ordre de parametres URL coherent independamment de l'ordre de s\u00e9lection par les utilisateurs. Sans ordre de parametres coherent, vous doublez votre nombre d'URLs crawlables pour chaque combinaison de deux filtres.",
          items: [
            ...
            "Canonicaliser les URLs multi-selection vers la cat\u00e9gorie parente ou la meilleure page de filtre unique",
            "Bloquer les URLs inter-filtres avec plus de deux groupes de filtres actifs du crawl",
            "Imposer un ordre de parametres URL coherent independamment de la sequence de s\u00e9lection",
          ],
          tip: "Configurez les parametres d'URL Google Search Console en complement de votre strat\u00e9gie robots.txt et balises canonical pour donner un signal supplementaire a Google.",
        },
        {
          title: "Surveiller et mesurer l'impact SEO de la navigation a facettes",
          content:
            "Apr\u00e8s avoir implemente votre strat\u00e9gie SEO de navigation a facettes, une surveillance continue est essentielle pour v\u00e9rifier que la solution fonctionne et pour detecter les regressions introduites par les mises a jour de plateforme ou les ajouts de nouveaux filtres.\n\nUtilisez le rapport de couverture de Google Search Console pour suivre le nombre total de pages indexees de votre site. Apr\u00e8s l'impl\u00e9mentation des contr\u00f4les de navigation a facettes, vous devriez voir le nombre de pages indexees diminuer a mesure que Google retire les pages filtres bloquees ou canonicalisees de son index. Cette diminution est positive. Suivez ce nombre mensuellement et enquetez sur toute augmentation soudaine.\n\nSurveillez vos statistiques de crawl dans GSC pour v\u00e9rifier que Googlebot passe moins de temps sur les URLs de filtres et plus de temps sur les pages produits et cat\u00e9gories. Apr\u00e8s l'impl\u00e9mentation des blocages robots.txt et des balises canonical, les URLs de filtres devraient diminuer en pourcentage des pages crawlees totales.\n\nAnalysez les logs serveur directement pour la vue la plus precise de l'interaction des bots avec votre navigation a facettes. Filtrez vos donn\u00e9es de log pour les requetes Googlebot et categorisez-les par pattern d'URL. Calculez le pourcentage de budget de crawl alloue a chaque cat\u00e9gorie avant et apr\u00e8s vos changements. Une impl\u00e9mentation reussie devrait deplacer au moins 15 % a 25 % du budget de crawl des URLs de filtres vers les pages produits.\n\nSuivez la performance organique des pages d'atterrissage de filtres de niveau 1 sp\u00e9cifiquement. Ces pages devraient gagner en impressions, clics et classements. Configurez un suivi de positionnement pour les mots-cl\u00e9s cibles de chaque page de niveau 1.\n\nCreez enfin un tableau de bord combinant couverture d'index, allocation de crawl et metriques de trafic organique. Incluez des alertes pour les changements soudains.",
          items: [
            "Suivre le nombre de pages indexees dans le rapport de couverture GSC ; s'attendre a une diminution",
            "Surveiller les statistiques de crawl pour v\u00e9rifier le deplacement du crawl des filtres vers les produits",
            ...
            "Cr\u00e9er un tableau de bord combine avec couverture d'index, allocation de crawl et metriques de trafic",
            "Configurer des alertes pour les changements soudains du nombre de pages indexees ou du trafic de niveau 1",
          ],
          tip: "Effectuez une comparaison avant-apres de la fr\u00e9quence de crawl de vos 100 pages produits principales. Une impl\u00e9mentation reussie devrait augmenter la fr\u00e9quence de crawl moyenne des pages produits de 20 % a 40 % en deux mois.",
        },
      ],
      navLabels: {
    ...
    es: {
      ...
      intro: "La navegaci\u00f3n facetada permite a los compradores filtrar productos por atributos como talla, color, marca, rango de precio y valoraci\u00f3n. Aunque es esencial para la experiencia del usuario, la navegaci\u00f3n facetada es una de las funcionalidades m\u00e1s peligrosas para el SEO de ecommerce. Una sola categor\u00c3\u00ada con diez opciones de filtro puede generar millones de combinaciones de URLs rastreables, creando contenido duplicado masivo, desperdiciando presupuesto de rastreo y diluyendo la autoridad de posicionamiento entre miles de p\u00c3\u00a1ginas casi identicas.",
      readTime: "13 min de lectura",
      sections: [
        {
          title: "Cómo la navegación facetada crea problemas de SEO",
          content:
            "La navegaci\u00f3n facetada funciona agregando parametros de filtro a la URL de la categor\u00eda. Cuando un comprador selecciona \"Marca: Nike\" en una p\u00e1gina de categor\u00eda de zapatos, la URL se convierte en /zapatos?marca=nike. Agregar \"Color: Negro\" la cambia a /zapatos?marca=nike&color=negro. Agregar \"Talla: 42\" crea /zapatos?marca=nike&color=negro&talla=42. Cada combinacion es una URL unica y rastreable que los motores de busqueda pueden descubrir.\n\nLas matematicas de la generacion combinatoria de URLs son asombrosas. Una p\u00e1gina de categor\u00eda con 5 grupos de filtros, cada uno con 10 opciones, puede teoricamente generar m\u00e1s de 100,000 combinaciones de URLs. Un gran minorista de moda con 20 grupos de filtros en cientos de categor\u00edas puede producir facilmente decenas de millones de URLs de filtros rastreables. La gran mayoria de estas p\u00e1ginas muestran listados de productos casi identicos en disposiciones ligeramente diferentes.\n\nM\u00e1s alla del recuento de URLs, la navegaci\u00f3n facetada crea varios problemas de SEO interrelacionados. El [presupuesto de rastreo](/academy/crawl-budget-management) se consume en p\u00e1ginas de filtros de bajo valor en lugar de p\u00e1ginas de productos que generan ingresos. La equidad de enlaces internos se distribuye entre miles de URLs de filtros en lugar de concentrarse en p\u00e1ginas importantes de categor\u00edas y productos. Surgen p\u00e1ginas de contenido delgado cuando combinaciones especificas de filtros devuelven muy pocos o cero productos. Y la canibalizaci\u00f3n de palabras clave ocurre cuando multiples p\u00e1ginas de filtros apuntan a las mismas consultas de busqueda.\n\nEl desafio es que algunas combinaciones de filtros tienen demanda de busqueda genuina y valor SEO. La gente busca \"zapatillas running Nike negras\" y \"chaquetas de invierno azules grandes.\" El objetivo SEO no es bloquear toda la navegaci\u00f3n facetada, sino permitir selectivamente que los motores de busqueda accedan a combinaciones valiosas mientras se bloquean los millones de combinaciones sin valor. Este es un desafio central del [SEO t\u00e9cnico para ecommerce](/blog/technical-seo-for-ecommerce).",
          items: [
            "Cada selecci\u00f3n de filtro crea una nueva URL rastreable con parametros agregados",
            "Explosion combinatoria: 5 grupos de filtros con 10 opciones cada uno pueden crear 100,000+ URLs",
            "El presupuesto de rastreo se desperdicia en p\u00e1ginas de filtros en lugar de p\u00e1ginas de productos",
            "La equidad de enlaces internos se diluye entre miles de URLs de filtros casi duplicadas",
            "La canibalizaci\u00f3n de palabras clave ocurre cuando multiples p\u00e1ginas de filtros apuntan a las mismas consultas",
          ],
          tip: "Antes de implementar cualquier solucion t\u00e9cnica, identifica que combinaciones de filtros corresponden a demanda de busqueda real. Usa herramientas de investigaci\u00f3n de palabras clave para identificar consultas que coincidan con combinaciones especificas de facetas.",
          image: {
        ...
        },
        {
          ...
          content:
            "La decisi\u00f3n fundamental en SEO de navegaci\u00f3n facetada es determinar que combinaciones de filtros deben ser p\u00e1ginas indexables y cuales deben bloquearse. Esta decisi\u00f3n debe basarse en datos de demanda de busqueda, no en conveniencia t\u00e9cnica.\n\nComienza exportando todas tus categor\u00edas de filtros y sus valores. Luego usa herramientas de investigaci\u00f3n de palabras clave para encontrar el volumen de busqueda para combinaciones de tu tipo de producto m\u00e1s cada valor de filtro. Para una tienda de zapatos, podrias encontrar que los filtros de marca tienen volumen significativo, los filtros de color volumen moderado y los filtros de material algo de demanda. Los filtros de valoraci\u00f3n, disponibilidad y combinaciones multi-atributo tipicamente tienen volumen negligible.\n\nCrea un sistema de clasificacion de tres niveles. El nivel 1 incluye filtros de atributo unico con demanda de busqueda comprobada que deben ser p\u00e1ginas completamente indexables con optimizaci\u00f3n SEO dedicada. El nivel 2 incluye filtros con algun potencial de busqueda que pueden ser indexables pero no necesitan optimizaci\u00f3n dedicada. El nivel 3 incluye todas las combinaciones restantes que deben bloquearse completamente del rastreo e indexaci\u00f3n.\n\nEsta clasificacion informa directamente tu implementaci\u00f3n t\u00e9cnica. Los filtros de nivel 1 idealmente obtienen URLs limpias y rastreables. Los filtros de nivel 2 usan URLs con parametros y etiquetas canonical autorreferenciales. Los filtros de nivel 3 se bloquean via robots.txt o se canonizan hacia la categor\u00eda padre.",
          items: [
            "Basar decisiones de indexaci\u00f3n en datos reales de demanda de busqueda, no en conveniencia t\u00e9cnica",
            "Exportar todas las categor\u00edas de filtros y verificar volumen de busqueda por combinacion",
          ...
          tip: "Revisa tus datos de rendimiento en Google Search Console para ver que URLs de filtros existentes ya reciben impresiones y clics. Si una p\u00e1gina de filtro ya posiciona para consultas relevantes, pertenece al nivel 1 o 2.",
        },
        {
          title: "Enfoques técnicos para controlar URLs facetadas",
          content:
            "Existen cinco enfoques t\u00e9cnicos principales para gestionar la navegaci\u00f3n facetada para SEO, y la mayoria de las tiendas necesitan una combinacion en lugar de una solucion unica.\n\nLas [etiquetas canonical](/academy/canonical-tags-for-ecommerce) son el enfoque m\u00e1s comun. Para p\u00e1ginas de filtros de nivel 3, agrega una etiqueta canonical apuntando a la p\u00e1gina de categor\u00eda padre. Esto le dice a Google que /zapatos?marca=nike&color=negro&talla=42&sort=precio es un duplicado de /zapatos. Sin embargo, las etiquetas canonical son sugerencias, no directivas, y Google puede elegir ignorarlas.\n\nEl bloqueo con robots.txt impide que los motores de busqueda rastreen URLs de filtros completamente. Esto es efectivo para conservar presupuesto de rastreo pero tiene un inconveniente significativo: si sitios externos enlazan a una URL de filtro bloqueada, la equidad de enlace se pierde completamente.\n\nLas meta etiquetas noindex le dicen a Google que rastree la p\u00e1gina pero no la incluya en el indice. Esto permite que Google descubra y siga enlaces en la p\u00e1gina pero previene que la p\u00e1gina de filtro aparezca en resultados de busqueda.\n\nEl filtrado basado en JavaScript renderiza cambios de filtro del lado del cliente sin modificar la URL. Esto previene que los motores de busqueda descubran URLs de filtros pero elimina la capacidad de crear p\u00e1ginas de filtros indexables.\n\nEl enrutamiento de URLs limpias crea URLs estaticas y SEO-friendly para tus combinaciones de filtros de nivel 1. En lugar de /zapatos?marca=nike, crea una p\u00e1gina dedicada /zapatos/nike/ con etiquetas de t\u00edtulo unicas y contenido potencialmente unico.",
          items: [
            "Etiquetas canonical: apuntar p\u00e1ginas de filtro a la categor\u00eda padre; sugerencias, no directivas",
            "Bloqueo robots.txt: previene rastreo completamente pero pierde equidad de enlaces externos",
            "Etiquetas noindex: permiten rastreo y seguimiento de enlaces pero previenen indexaci\u00f3n",
            "Filtrado JavaScript: previene cambios de URL pero elimina todas las p\u00e1ginas de filtro indexables",
            "Enrutamiento de URLs limpias: URLs estaticas dedicadas para filtros de alto valor; el est\u00e1ndar de oro",
          ],
        ...
        },
        {
          ...
          content:
            "Para combinaciones de filtros de nivel 1 con demanda de busqueda comprobada, crea p\u00e1ginas de aterrizaje dedicadas que vayan m\u00e1s alla del simple filtrado de tu cat\u00e1logo. Estas p\u00e1ginas deben tratarse como p\u00e1ginas de categor\u00eda de primera clase con contenido unico y valioso.\n\nComienza con etiquetas de t\u00edtulo y meta descripciones unicas que apunten a la consulta de busqueda especifica. Una p\u00e1gina para zapatillas running Nike no deberia usar la misma plantilla de t\u00edtulo que la categor\u00eda padre zapatos con \"Nike\" agregado. En su lugar, crea un t\u00edtulo como \"Zapatillas Running Nike - Env\u00edo Gratis en Novedades.\"\n\nAgrega contenido introductorio unico a cada p\u00e1gina de filtro de nivel 1. Uno o dos parrafos sobre la herencia de la marca, las caracteristicas de la categor\u00eda de producto o una guia de compra especifica diferencian la p\u00e1gina de un simple listado filtrado de productos.\n\nImplementa una jerarquia de encabezados apropiada en las p\u00e1ginas de aterrizaje de filtros. El H1 debe coincidir con el objetivo de consulta de busqueda principal. Los encabezados subsiguientes pueden organizar la p\u00e1gina por subcategoria, l\u00ednea de producto o caso de uso.\n\nAsegura que estas p\u00e1ginas esten bien integradas en la estructura de enlaces internos de tu sitio. Agregalas a tu navegaci\u00f3n principal, barras laterales de categor\u00edas y rutas de migas de pan. Enlaza hacia ellas desde contenido de blog y guias de compra relacionados.",
          items: [
            "Crear etiquetas de t\u00edtulo y meta descripciones unicas apuntando a consultas de busqueda especificas",
            "Agregar contenido introductorio unico: informaci\u00f3n de marca, guias de compra, descripciones de categor\u00eda",
            "Implementar jerarquia H1 y de encabezados apropiada que coincida con la consulta de busqueda objetivo",
            "Integrar p\u00e1ginas de filtros en navegaci\u00f3n principal, migas de pan y enlazado interno",
            "Enlazar a p\u00e1ginas de filtros desde contenido de blog y guias de compra para autoridad",
          ],
          tip: "Analiza las p\u00e1ginas de filtros de tus principales competidores para ver que contenido incluyen. Muchos sitios de ecommerce lideres agregan historias de marca, guias de tallas y preguntas frecuentes a sus p\u00e1ginas de aterrizaje de filtros.",
          image: {
        ...
        },
        {
          ...
          content:
            "Los filtros multi-seleccion, donde los usuarios pueden seleccionar multiples valores dentro de un solo grupo de filtros, crean la peor inflaci\u00f3n de URLs. Un solo filtro multi-seleccion con 10 opciones genera 1,023 combinaciones posibles. Dos filtros multi-seleccion con 10 opciones cada uno crean m\u00e1s de un mill\u00f3n de combinaciones.\n\nEl enfoque m\u00e1s seguro para filtros multi-seleccion es impedir que los motores de busqueda accedan completamente. Usa filtrado basado en AJAX que actualice la cuadricula de productos dinamicamente sin cambiar la URL cuando se seleccionan multiples valores dentro de un grupo de filtros.\n\nSi tu plataforma requiere cambios de URL para filtros multi-seleccion, implementa etiquetas canonical que apunten todas las URLs multi-seleccion hacia la p\u00e1gina de filtro unico m\u00e1s relevante o la categor\u00eda padre. Adicionalmente, usa reglas robots.txt para bloquear patrones de URL con valores multi-seleccion separados por comas.\n\nLas combinaciones de filtros cruzados casi nunca deben ser indexables. Una URL como /zapatos?marca=nike&color=negro&talla=42&material=cuero representa una selecci\u00f3n de productos tan estrecha que casi seguro no tiene volumen de busqueda significativo.\n\nLos filtros aplicados deben mantener un orden de parametros URL consistente independientemente del orden de selecci\u00f3n del usuario. Sin un orden de parametros consistente, duplicas tu conteo de URLs rastreables para cada combinacion de dos filtros.",
          items: [
            ...
            "Canonicalizar URLs multi-seleccion a la categor\u00eda padre o mejor p\u00e1gina de filtro unico",
            "Bloquear URLs de filtros cruzados con m\u00e1s de dos grupos de filtros activos del rastreo",
            "Imponer orden de parametros URL consistente independientemente de la secuencia de selecci\u00f3n",
          ],
        ...
        },
        {
          ...
          content:
            "Despues de implementar tu estrategia SEO de navegaci\u00f3n facetada, el monitoreo continuo es esencial para verificar que la solucion funciona y para detectar regresiones introducidas por actualizaciones de plataforma o nuevos filtros.\n\nUsa el informe de Cobertura de Google Search Console para rastrear el n\u00famero total de p\u00e1ginas indexadas de tu sitio. Despues de implementar controles de navegaci\u00f3n facetada, deberias ver disminuir el conteo de p\u00e1ginas indexadas a medida que Google elimina p\u00e1ginas de filtros bloqueadas o canonicalizadas de su indice. Esta disminucion es positiva. Rastrea este n\u00famero mensualmente e investiga cualquier aumento repentino.\n\nMonitorea tus estadisticas de rastreo en GSC para verificar que Googlebot pasa menos tiempo en URLs de filtros y m\u00e1s tiempo en p\u00e1ginas de productos y categor\u00edas. Despues de implementar bloqueos robots.txt y etiquetas canonical, las URLs de filtros deberian disminuir como porcentaje de las p\u00e1ginas rastreadas totales.\n\nAnaliza logs del servidor directamente para la vista m\u00e1s precisa de como los bots interactuan con tu navegaci\u00f3n facetada. Filtra tus datos de log para solicitudes de Googlebot y categoriza por patr\u00f3n de URL. Calcula el porcentaje de presupuesto de rastreo asignado a cada categor\u00eda antes y despues de tus cambios. Una implementaci\u00f3n exitosa deberia mover al menos 15% a 25% del presupuesto de rastreo de URLs de filtros hacia p\u00e1ginas de productos.\n\nRastrea el rendimiento de p\u00e1gina de aterrizaje organica para tus p\u00e1ginas de filtros de nivel 1 especificamente. Estas p\u00e1ginas deberian ganar impresiones, clics y posicionamientos. Configura seguimiento de rankings para las palabras clave especificas que cada p\u00e1gina de nivel 1 apunta.\n\nFinalmente, crea un panel que combine cobertura de indice, asignacion de rastreo y m\u00e9tricas de tr\u00e1fico organico. Incluye alertas para cambios repentinos.",
          items: [
            "Rastrear conteo de p\u00e1ginas indexadas en informe de Cobertura GSC; esperar disminucion tras implementar controles",
            "Monitorear estadisticas de rastreo para verificar que Googlebot cambia de URLs de filtros a p\u00e1ginas de productos",
            "Analizar logs del servidor para calcular asignacion exacta del presupuesto de rastreo por patr\u00f3n de URL",
            "Rastrear rankings y tr\u00e1fico organico para p\u00e1ginas de aterrizaje de filtros de nivel 1 mensualmente",
            "Crear panel combinado con cobertura de indice, asignacion de rastreo y m\u00e9tricas de tr\u00e1fico organico",
            "Configurar alertas para cambios repentinos en conteo de p\u00e1ginas indexadas o tr\u00e1fico de p\u00e1ginas nivel 1",
          ],
          tip: "Ejecuta una comparacion antes-despues de la frecuencia de rastreo de tus 100 p\u00e1ginas de productos principales. Una implementaci\u00f3n exitosa deberia aumentar la frecuencia de rastreo promedio de p\u00e1ginas de productos entre 20% y 40% en dos meses.",
        },
      ],
      navLabels: {
        previous: "Robots.txt y sitemaps XML",
        next: "Optimizaci\u00f3n de velocidad del sitio",
      },
    },
    it: {
      badge: "SEO Tecnica",
