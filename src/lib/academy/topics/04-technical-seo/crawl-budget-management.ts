...
export const crawlBudgetManagement: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          callout: {
            title: "Budget-Umverteilung",
            text: "Le blocage des param\u00c3\u00a8tr\u00e8s de filtrage et de tri via robots.txt transf\u00c3\u00a8re g\u00c3\u00a9n\u00c3\u00a9ralement 15 \u00c3\u00a0 25 % du budget d'exploration vers les pages de produits dans un d\u00c3\u00a9lai de 2 \u00c3\u00a0 4 semaines, augmentant ainsi la fr\u00c3\u00a9quence d'exploration des produits de 40 % ou plus.",
          },
        },
        {
        ...
        },
        {
          ...
          tip: "Creez une liste de vos 100 pages produits et cat\u00e9gories les plus generatrices de revenus. Assurez-vous que ces pages ont le plus de liens internes, apparaissent dans votre sitemap et recoivent des dates lastmod mises a jour a chaque changement de contenu.",
        },
        {
    ...
    es: {
      ...
      intro: "Google asigna un n\u00famero limitado de p\u00c3\u00a1ginas que rastreara en tu sitio dentro de un periodo de tiempo determinado. Para tiendas con miles de productos, p\u00c3\u00a1ginas de filtros y URLs con parametros, una mala gestion de este presupuesto de rastreo significa que Google pierde tiempo en p\u00c3\u00a1ginas sin valor mientras ignora las que realmente generan ingresos. Este es uno de los temas clave del [SEO t\u00c3\u00a9cnico para ecommerce](/blog/technical-seo-for-ecommerce).",
      ...
      sections: [
        ...
        },
        {
          ...
          tip: "Descarga tus logs del servidor de los \u00faltimos 30 dias y analiza que URLs visito Googlebot con mayor frecuencia. Probablemente encontraras que las p\u00e1ginas de parametros y las URLs de filtros dominan el rastreo, mientras que las p\u00e1ginas de productos reciben muchas menos visitas de las que deberian.",
        },
        {
          ...
          tip: "Despues de actualizar tu robots.txt, monitorea el informe de Estadisticas de rastreo en Google Search Console durante dos a cuatro semanas. Deberias ver que el total de p\u00e1ginas rastreadas disminuye mientras la frecuencia de rastreo de tus p\u00e1ginas importantes aumenta.",
        },
        {
        ...
        },
        {
          ...
          tip: "Crea una lista de tus 100 p\u00e1ginas de productos y categor\u00edas que m\u00e1s ingresos generan. Asegurate de que estas p\u00e1ginas tengan la mayor cantidad de enlaces internos, aparezcan en tu sitemap y reciban fechas lastmod actualizadas cuando el contenido cambie.",
        },
        {
