    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "Las im\u00c3\u00a1genes representan del 50 % al 70 % del peso total de p\u00c3\u00a1gina en la mayor\u00c3\u00ada de sitios ecommerce. Una p\u00c3\u00a1gina de categor\u00c3\u00ada mostrando 40 productos con im\u00c3\u00a1genes sin optimizar puede superar f\u00c3\u00a1cilmente los 15 MB. La optimizaci\u00c3\u00b3n adecuada de im\u00c3\u00a1genes por s\u00c3\u00ad sola puede reducir el tiempo de carga a la mitad.\n\nConvierte todas las im\u00c3\u00a1genes de producto al formato WebP o AVIF. WebP ofrece archivos entre un 25 % y un 35 % m\u00c3\u00a1s peque\u00c3\u00b1os que JPEG con calidad equivalente, y AVIF lleva el ahorro al 50 %. Todos los navegadores principales ahora soportan WebP, y el soporte de AVIF cubre m\u00c3\u00a1s del 90 % de los usuarios. Sirve AVIF con fallback WebP usando el elemento HTML picture.\n\nRedimensiona las im\u00c3\u00a1genes para que coincidan con sus dimensiones de visualizaci\u00c3\u00b3n. Una miniatura de producto mostrada a 300x300 p\u00c3\u00adxeles no necesita un archivo fuente de 2000x2000. Genera m\u00c3\u00baltiples tama\u00c3\u00b1os en tiempo de compilaci\u00c3\u00b3n o a trav\u00c3\u00a9s de la API de transformaci\u00c3\u00b3n de im\u00c3\u00a1genes de tu CDN. Sirve im\u00c3\u00a1genes 1x a pantallas est\u00c3\u00a1ndar y 2x a pantallas Retina usando atributos srcset.\n\nImplementa carga diferida para im\u00c3\u00a1genes debajo del pliegue. La primera fila de productos en una p\u00c3\u00a1gina de categor\u00c3\u00ada debe cargar inmediatamente (carga eager), mientras que todo lo dem\u00c3\u00a1s debe usar loading=\"lazy\". Esto reduce el peso inicial de la p\u00c3\u00a1gina dr\u00c3\u00a1sticamente. Una tienda de muebles que optimizamos pas\u00c3\u00b3 de cargar 80 im\u00c3\u00a1genes en la carga inicial a 12, reduciendo el LCP de 4,8 segundos a 1,9 segundos. Una correcta [optimizaci\u00f3n de imagenes](/academy/image-optimization-for-products) por si sola puede reducir el tiempo de carga de p\u00e1gina a la mitad.",
        ...
        },
        {
          ...
          content:
            "La ruta de renderizado cr\u00c3\u00adtico es la secuencia de pasos que el navegador sigue para convertir HTML, CSS y JavaScript en p\u00c3\u00adxeles renderizados. Optimizar esta ruta significa asegurar que el navegador pueda mostrar contenido significativo lo m\u00c3\u00a1s r\u00c3\u00a1pidamente posible, incluso mientras recursos adicionales a\u00c3\u00ban se est\u00c3\u00a1n cargando.\n\nIncrusta tu CSS cr\u00c3\u00adtico directamente en el head HTML. El CSS cr\u00c3\u00adtico es el conjunto m\u00c3\u00adnimo de estilos necesarios para renderizar el contenido visible sobre el pliegue. Herramientas como Critical o Penthouse pueden extraerlo autom\u00c3\u00a1ticamente. Al incrustar de 10 a 15 KB de CSS cr\u00c3\u00adtico, el navegador puede pintar la vista inicial sin esperar descargas de hojas de estilo externas.\n\nPrecarga recursos clave que el navegador descubre tarde en el proceso de an\u00c3\u00a1lisis. Las fuentes web, im\u00c3\u00a1genes hero y bundles de JavaScript cr\u00c3\u00adticos deben usar etiquetas link rel=\"preload\" en el head HTML. Sin precarga, el navegador solo descubre estos recursos despu\u00c3\u00a9s de analizar archivos CSS o JavaScript, a\u00c3\u00b1adiendo cientos de milisegundos de retraso.\n\nElimina recursos que bloquean el renderizado difiriendo CSS y JavaScript no cr\u00c3\u00adticos. Carga tu hoja de estilos completa de forma as\u00c3\u00adncrona usando el truco de media=\"print\" con un controlador onload que la cambia a media=\"all\". Esto permite al navegador renderizar la p\u00c3\u00a1gina usando CSS cr\u00c3\u00adtico incrustado mientras la hoja de estilos completa se descarga en segundo plano.\n\nPara tiendas Shopify, las plantillas Liquid del tema y los bloques de aplicaciones a menudo inyectan scripts y estilos que bloquean el renderizado. Audita tu archivo theme.liquid y mueve los scripts de aplicaciones no esenciales a carga diferida. Cada recurso que bloquea el renderizado a\u00c3\u00b1ade de 100 a 300 milisegundos al renderizado inicial. Asegurar que tu tienda funcione bien en tel\u00e9fonos es igualmente critico: consulta nuestra guia de [SEO mobile-first](/academy/mobile-first-for-ecommerce).",
        },
      ],
      navLabels: {
