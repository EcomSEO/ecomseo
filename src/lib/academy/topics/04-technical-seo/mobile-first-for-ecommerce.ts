...
export const mobileFirstForEcommerce: AcademyTopic = {
  ...
  content: {
    ...
    es: {
      ...
      intro:
        "Google utiliza la versión móvil de tu tienda para todas las decisiones de indexación y ranking. Si tus páginas de producto se ven diferentes, cargan más lento o contienen menos contenido en móvil que en escritorio, esa versión móvil es lo que determina tu visibilidad en búsquedas. Más del 70 % del tráfico de ecommerce proviene ahora de dispositivos móviles.",
