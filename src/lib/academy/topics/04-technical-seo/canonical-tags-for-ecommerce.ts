...
export const canonicalTagsForEcommerce: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "La source la plus repandue de contenu duplique en e-commerce est celle des variantes de produits accessibles via differentes URLs. Si votre boutique cree des URLs separees pour chaque selection de couleur ou taille (/product/t-shirt?couleur=rouge vs. /product/t-shirt?couleur=bleu) et que les deux pages affichent un contenu quasi identique avec seulement un echantillon de couleur modifie, ce sont des doublons necessitant un traitement canonical.\n\nLa navigation a facettes genere de la duplication a une echelle massive. Les pages de categorie avec des filtres pour la marque, la gamme de prix, la taille, le materiau et la note produisent des explosions combinatoires d'URLs. Une page comme /vestes?marque=northface&taille=large&couleur=noir et /vestes?couleur=noir&marque=northface&taille=large montrent des resultats identiques mais ont des URLs differentes. Chaque combinaison de filtres necessite un canonical pointant vers la page de categorie la plus pertinente.\n\nLes pages de categorie paginees creent une autre couche de duplication. Bien que la page 2 d'une categorie ne soit pas vraiment un doublon de la page 1, les parametres de tri sur les pages paginees creent de veritables doublons. Le canonical devrait pointer vers la page paginee sans parametres de tri.\n\nLa duplication inter-domaines affecte les boutiques vendant sur plusieurs places de marche. Si vous syndiquez vos descriptions de produits sur Amazon, eBay ou des sites de comparaison, ces plateformes peuvent surclasser votre propre boutique pour vos propres descriptions.",
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            "Verifiez les balises canonical injectees par la plateforme avant d'ajouter les votres",
        ...
        },
        {
          ...
          tip: "Executez un audit mensuel avec Screaming Frog ou Sitebulb pour verifier les erreurs canonical. Filtrez les pages ou l'URL canonical differe de l'URL de la page et verifiez que chaque cas est intentionnel.",
        },
        {
          title: "Auditer et surveiller les balises canonical a grande echelle",
          content:
            "Pour les boutiques avec des milliers de produits, l'audit canonical manuel est impraticable. Utilisez des outils de crawl comme Screaming Frog, Sitebulb ou Ahrefs Site Audit pour explorer votre site entier et extraire les donnees des balises canonical. Exportez les resultats et filtrez les problemes specifiques : pages sans balises canonical, pages avec canonicals pointant vers des URLs non-200, pages avec plusieurs balises canonical, et pages ou l'URL canonical differe de l'URL de la page de maniere inattendue.\n\nL'outil d'inspection d'URL de Google Search Console revele comment Google interprete vos balises canonical pour des pages specifiques. Entrez n'importe quelle URL et verifiez le champ \"Canonical selectionnee par Google\". Si le canonical choisi par Google differe de votre canonical declare, Google a decide d'ignorer votre suggestion. Les raisons courantes incluent des signaux contradictoires, un contenu trop mince sur la cible canonical, ou la cible bloquee par robots.txt.\n\nMettez en place une surveillance continue plutot que des audits ponctuels. Configurez votre outil de crawl SEO pour s'executer chaque semaine et vous alerter quand de nouveaux problemes canonical apparaissent. Les lancements de produits, mises a jour de plateforme, changements de theme et installations d'apps cassent frequemment les implementations canonical sans que personne ne s'en apercoive. Une boutique que nous avons auditee a eu une mise a jour de theme qui a silencieusement supprime tous les canonicals auto-referencants, entrainant une baisse de 23 % du trafic organique sur six semaines.\n\nPour les boutiques a grande echelle, envisagez d'implementer la validation des balises canonical dans votre pipeline de deploiement. Ajoutez des tests automatises qui verifient la presence et le format correct des balises canonical sur les modeles de pages cles avant la mise en production.",
          items: [
            ...
            "Utilisez l'inspection d'URL de Google Search Console pour verifier si Google respecte vos canonicals declares",
            ...
            "Surveillez le canonical selectionne par Google vs. declare pour les pages produits et categories importantes",
          ],
          tip: "Exportez vos donnees d'audit canonical dans un tableur et creez un tableau croise dynamique groupant les pages par leur relation canonical. Cela revele rapidement des schemas comme tous les produits d'une categorie canonicalisant accidentellement vers la page categorie.",
        },
      ],
      navLabels: {
    ...
    es: {
      ...
      intro:
        "Las tiendas de ecommerce generan rutinariamente multiples URLs para el mismo producto a traves de variantes de color, parametros de seguimiento, IDs de sesion y combinaciones de filtros. Sin etiquetas canonical, los motores de busqueda ven cada URL como una pagina separada, dividiendo tus senales de posicionamiento entre docenas de duplicados. Dominar las etiquetas canonical es esencial para consolidar la autoridad y asegurar que la version correcta de cada pagina aparezca en los resultados de busqueda.",
      readTime: "11 min de lectura",
      sections: [
        {
          title: "Que hacen las etiquetas canonical y por que el ecommerce las necesita",
          content:
            "Una etiqueta canonical (rel=\"canonical\") es un elemento HTML colocado en la seccion head de una pagina que indica a los motores de busqueda cual URL representa la version principal de ese contenido. Cuando Google encuentra una pagina con una etiqueta canonical apuntando a una URL diferente, trata la URL referenciada como la version autoritativa y consolida senales de posicionamiento como backlinks, metricas de engagement y equidad de enlaces internos hacia esa unica URL.\n\nLas tiendas de ecommerce enfrentan un desafio de duplicacion unico que los sitios de contenido rara vez encuentran. Un solo producto puede ser accesible a traves de su URL directa (/products/zapatillas-azules), una URL filtrada por categoria (/zapatos?color=azul&tipo=running), una URL de resultado de busqueda (/search?q=zapatillas+azules), una URL con parametros de seguimiento (/products/zapatillas-azules?utm_source=email) y una URL con ID de sesion (/products/zapatillas-azules?sid=abc123). Las cinco URLs muestran el mismo producto, pero para Google cada una es una pagina separada compitiendo por los mismos rankings.\n\nSin etiquetas canonical, Google debe adivinar cual URL indexar. Podria elegir la URL cargada de parametros, dejando tu URL limpia de producto fuera de los resultados de busqueda. O podria dividir tu autoridad de backlinks entre las cinco versiones, debilitando cada una. Las etiquetas canonical eliminan esta incertidumbre declarando explicitamente cual URL debe recibir todo el credito.",
          items: [
            "Las etiquetas canonical consolidan senales de posicionamiento de URLs duplicadas a una unica URL principal",
            "Los duplicados de ecommerce surgen de parametros, filtros, IDs de sesion y codigos de seguimiento",
        ...
        },
        {
          ...
          content:
            "La fuente mas extendida de contenido duplicado en ecommerce son las variantes de producto accesibles a traves de diferentes URLs. Si tu tienda crea URLs separadas para cada seleccion de color o talla (/product/camiseta?color=rojo vs. /product/camiseta?color=azul) y ambas paginas muestran contenido casi identico con solo un muestrario de color cambiado, son duplicados que necesitan tratamiento canonical.\n\nLa navegacion facetada genera duplicacion a escala masiva. Las paginas de categoria con filtros para marca, rango de precio, talla, material y valoracion producen explosiones combinatorias de URLs. Una pagina como /chaquetas?marca=northface&talla=grande&color=negro y /chaquetas?color=negro&marca=northface&talla=grande muestran resultados identicos pero tienen URLs diferentes. Cada combinacion de filtros necesita un canonical apuntando a la pagina de categoria mas relevante.\n\nLas paginas de categoria paginadas crean otra capa de duplicacion. Aunque la pagina 2 de una categoria no es realmente un duplicado de la pagina 1, los parametros de ordenacion en paginas paginadas crean duplicados genuinos. El canonical deberia apuntar a la pagina paginada sin parametros de ordenacion.\n\nLa duplicacion entre dominios afecta a tiendas que venden en multiples marketplaces. Si distribuyes descripciones de productos a Amazon, eBay o sitios de comparacion, esas plataformas pueden posicionarse por encima de tu propia tienda para tus propias descripciones de productos.",
          items: [
            "Las variantes de color y talla con diferencias minimas de contenido necesitan canonicalizacion",
            "Las combinaciones de filtros de navegacion facetada crean miles de URLs casi duplicadas",
            "Las paginas paginadas con parametros de ordenacion producen duplicados de cada vista paginada",
          ...
          tip: "Audita tu tienda para contenido duplicado buscando en Google site:tudominio.es seguido de una frase unica de una de tus descripciones de producto. Si aparecen multiples URLs de tu tienda, esas paginas necesitan etiquetas canonical.",
        },
        {
          title: "Implementar etiquetas canonical correctamente",
          content:
            "La etiqueta canonical debe colocarse dentro de la seccion <head> del HTML de cada pagina. La sintaxis es directa: <link rel=\"canonical\" href=\"https://www.example.com/products/zapatillas-azules\" />. El valor href debe ser una URL absoluta incluyendo el protocolo (https://) y tu formato de dominio preferido (www o sin www). Usar URLs relativas u omitir el protocolo causara errores de implementacion.\n\nLos canonicals autorreferenciales son una buena practica que muchas tiendas pasan por alto. Cada pagina debe incluir una etiqueta canonical apuntando a su propia URL limpia. Esto asegura que cuando parametros de consulta o codigos de seguimiento se agregan por herramientas de marketing o campanas de email, la URL limpia permanece como el canonical declarado.\n\nPara paginas de variantes de producto, decide una estrategia de canonicalizacion basada en la unicidad del contenido. Si cada variante de color tiene una imagen unica, texto de descripcion unico y apunta a una consulta de busqueda distinta, cada variante debe auto-canonicalizarse como pagina unica. Si las variantes comparten la misma descripcion y solo difieren por un muestrario de color, todas deben canonicalizar hacia la variante principal.\n\nAl implementar etiquetas canonical en tu plataforma de ecommerce, verifica que tu CMS o tema no inyecte ya etiquetas canonical automaticamente. Shopify, WooCommerce y Magento agregan etiquetas canonical por defecto, pero su implementacion automatica puede no coincidir con tus necesidades especificas. Etiquetas canonical duplicadas o en conflicto confunden a los motores de busqueda y anulan completamente el beneficio.",
          items: [
            "Siempre usa URLs absolutas con protocolo (https://) en etiquetas canonical",
            "Agrega canonicals autorreferenciales a cada pagina, incluso sin duplicados conocidos",
            ...
            "Nunca uses mas de una etiqueta canonical por pagina",
          ],
        },
        {
          title: "Etiquetas canonical vs. otras soluciones de contenido duplicado",
          content:
            "Las etiquetas canonical no son la unica herramienta para manejar contenido duplicado, y elegir la herramienta incorrecta lleva a esfuerzo desperdiciado o peores resultados. Entender cuando usar canonicals versus redirecciones 301, etiquetas noindex o bloqueo robots.txt es critico para SEO de ecommerce.\n\nLas redirecciones 301 son la senal mas fuerte y deben usarse cuando la URL duplicada nunca deberia ser accesible para los usuarios. Si migraste de /antigua-url-producto a /nueva-url-producto, una redireccion 301 es correcta porque los usuarios nunca deben aterrizar en la URL antigua. Las etiquetas canonical, en cambio, son apropiadas cuando ambas URLs necesitan permanecer accesibles.\n\nLas etiquetas noindex dicen a Google que elimine una pagina completamente del indice. Usa noindex para paginas como resultados de busqueda interna, paginas del carrito o paginas de cuenta que no tienen razon para aparecer en resultados de busqueda.\n\nEl bloqueo con robots.txt impide que Google rastree una URL. Esto es util para conservar presupuesto de rastreo pero peligroso para la canonicalizacion porque Google no puede ver una etiqueta canonical en una pagina que no puede rastrear. Si bloqueas una pagina via robots.txt y esa pagina tiene backlinks externos, Google perdera esas senales completamente.",
          items: [
            ...
            "Noindex: usar para paginas que nunca deben aparecer en resultados de busqueda",
        ...
        },
        {
          ...
          content:
            "El error canonical mas danino en ecommerce es apuntar todas las paginas de categoria paginadas a la pagina 1. Si /categoria/zapatos?page=2, /categoria/zapatos?page=3 y /categoria/zapatos?page=4 todas tienen etiquetas canonical apuntando a /categoria/zapatos (pagina 1), Google ignorara los productos listados en las paginas 2 a 4 porque le dijiste que esas paginas son duplicados de la pagina 1. Cada pagina paginada debe tener un canonical autorreferencial.\n\nOtro error frecuente es canonicalizar hacia URLs inexistentes o rotas. Esto sucede cuando se eliminan productos pero las etiquetas canonical en las paginas de variantes siguen apuntando a la URL padre eliminada. Google recibe un 404 para el objetivo canonical y puede eliminar todas las paginas de variantes del indice.\n\nLas etiquetas canonical dinamicas que incluyen parametros de sesion anulan completamente el proposito. Hemos visto tiendas donde el CMS genera etiquetas canonical que incluyen el ID de sesion del usuario, creando una URL canonical unica para cada visitante.\n\nEl encadenamiento de canonicals es otro problema comun. La pagina A canonicaliza a la pagina B, que canonicaliza a la pagina C. Google intenta seguir la cadena, pero cadenas de mas de un salto no son confiables. Siempre apunta los canonicals directamente a la URL objetivo final.",
          items: [
            "Nunca canonicalices paginas paginadas a la pagina 1; cada pagina paginada tiene contenido unico",
            "Verifica que las URLs objetivo canonical devuelvan estado 200",
            "Asegura que el CMS no inyecte IDs de sesion en las etiquetas canonical",
            "Evita cadenas canonical: siempre apunta directamente al objetivo final",
            "Vigila los bucles canonical donde dos paginas apuntan una a la otra",
          ],
          tip: "Ejecuta una auditoria mensual con Screaming Frog o Sitebulb para verificar errores canonical. Filtra paginas donde la URL canonical difiere de la URL de la pagina y verifica que cada caso sea intencional.",
        },
        {
          title: "Auditar y monitorear etiquetas canonical a escala",
          content:
            "Para tiendas con miles de productos, la auditoria canonical manual es impracticable. Usa herramientas de rastreo como Screaming Frog, Sitebulb o Ahrefs Site Audit para rastrear tu sitio completo y extraer datos de etiquetas canonical. Exporta los resultados y filtra problemas especificos: paginas sin etiquetas canonical, paginas con canonicals apuntando a URLs que no devuelven 200, paginas con multiples etiquetas canonical y paginas donde la URL canonical difiere inesperadamente de la URL de la pagina.\n\nLa herramienta de inspeccion de URLs de Google Search Console revela como Google interpreta tus etiquetas canonical para paginas especificas. Ingresa cualquier URL y verifica el campo \"Canonical seleccionado por Google\". Si el canonical seleccionado por Google difiere de tu canonical declarado, significa que Google decidio anular tu sugerencia.\n\nConfigura monitoreo continuo en lugar de auditorias puntuales. Configura tu herramienta de rastreo SEO para ejecutarse semanalmente y alertarte cuando aparezcan nuevos problemas canonical. Los lanzamientos de productos, actualizaciones de plataforma, cambios de tema e instalaciones de apps rompen frecuentemente las implementaciones canonical sin que nadie lo note. Una tienda que auditamos tuvo una actualizacion de tema que silenciosamente elimino todos los canonicals autorreferenciales, resultando en una caida del 23 % del trafico organico en seis semanas.\n\nPara tiendas empresariales, considera implementar validacion de etiquetas canonical en tu pipeline de despliegue. Agrega pruebas automatizadas que verifiquen la presencia y formato correcto de etiquetas canonical en plantillas de paginas clave antes de que el codigo llegue a produccion.",
          items: [
            ...
            "Monitorea el canonical seleccionado por Google vs. el declarado para paginas importantes",
          ],
          tip: "Exporta tus datos de auditoria canonical a una hoja de calculo y crea una tabla dinamica agrupando paginas por su relacion canonical. Esto revela rapidamente patrones como todos los productos de una categoria canonicalizando accidentalmente a la pagina de categoria.",
        },
      ],
      navLabels: {
