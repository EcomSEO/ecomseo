  ...
  content: {
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          tip: "Submit your sitemap through Google Search Console and check the Coverage report regularly. GSC will tell you exactly how many URLs from your sitemap were indexed, excluded, or had errors. A healthy sitemap should have a high ratio of indexed to submitted URLs.",
        },
        {
    ...
    de: {
      ...
      sections: [
        ...
        },
        {
          ...
          tip: "Reichen Sie Ihre Sitemap ueber die Google Search Console ein und pruefen Sie den Abdeckungsbericht regelmaessig. GSC zeigt Ihnen genau, wie viele URLs aus Ihrer Sitemap indexiert, ausgeschlossen oder fehlerhaft waren.",
        },
        {
    ...
    fr: {
      ...
      sections: [
        ...
        {
          title: "Regles robots.txt essentielles pour les boutiques en ligne",
          content:
        ...
        },
        {
          ...
          tip: "Soumettez votre sitemap via Google Search Console et verifiez le rapport de couverture regulierement. GSC vous indiquera exactement combien d'URLs de votre sitemap ont ete indexees, exclues ou ont eu des erreurs.",
        },
        {
    ...
    nl: {
      ...
      sections: [
        ...
        },
        {
          ...
          tip: "Dien je sitemap in via Google Search Console en controleer het dekkingsrapport regelmatig. GSC vertelt je precies hoeveel URL's uit je sitemap zijn geindexeerd, uitgesloten of fouten hadden.",
        },
        {
