    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          tip: "Utilisez les caracteres joker avec prudence. Disallow: /*? bloquerait toutes les URLs avec n'importe quel parametre de requete, y compris les potentiellement precieux. Bloquez plutot les noms de parametres sp\u00e9cifiques individuellement.",
          image: {
        ...
        },
        {
          ...
          tip: "Soumettez votre sitemap via Google Search Console et v\u00e9rifiez le rapport de couverture r\u00e9guli\u00e8rement. GSC vous indiquera exactement combien d'URLs de votre sitemap ont ete indexees, exclues ou ont eu des erreurs. Soumettez votre sitemap via la [Google Search Console](/academy/google-search-console-for-stores) et v\u00c3\u00a9rifiez le rapport de couverture r\u00c3\u00a9guli\u00c3\u00a8rement.",
        },
        {
          ...
          tip: "Apr\u00e8s avoir corrige votre impl\u00e9mentation lastmod, surveillez le rapport de statistiques de crawl dans Google Search Console. Vous devriez voir Google reorienter son crawl vers les pages recemment mises a jour dans les deux a quatre semaines.",
        },
        {
          ...
          tip: "Creez un processus automatis\u00e9 qui retire les URLs produits de votre sitemap quand elles retournent des codes de statut non-200 pendant plus de sept jours consecutifs.",
          image: {
        ...
        },
        {
          ...
          tip: "Apr\u00e8s chaque mise a jour de plateforme ou changement de theme, v\u00e9rifiez immediatement votre robots.txt et regenerez votre sitemap. Croisez les deux fichiers pour vous assurer qu'aucune URL du sitemap n'est bloquee et qu'aucune page critique ne manque dans le sitemap.",
        },
      ],
      navLabels: {
      ...
      sections: [
        {
          ...
          tip: "Mantiene una copia de seguridad de tu robots.txt antes de hacer cambios. Un archivo robots.txt roto que accidentalmente bloquea todo (Disallow: /) puede causar p\u00e9rdida catastrofica de tr\u00e1fico organico en dias.",
        },
        {
        ...
        },
        {
          ...
          tip: "Despues de corregir tu implementaci\u00f3n de lastmod, monitorea el informe de estadisticas de rastreo en Google Search Console. Deberias ver a Google redirigir su foco de rastreo hacia p\u00e1ginas recientemente actualizadas en dos a cuatro semanas.",
        },
        {
          ...
          tip: "Crea un proceso automatizado que retire URLs de productos de tu sitemap cuando devuelvan codigos de estado no-200 durante m\u00e1s de siete dias consecutivos.",
          image: {
        ...
        },
        {
          ...
          tip: "Despues de cada actualizacion de plataforma o cambio de tema, verifica inmediatamente tu robots.txt y regenera tu sitemap. Cruza ambos archivos para asegurar que ninguna URL del sitemap este bloqueada y que ninguna p\u00e1gina critica falte en el sitemap.",
        },
      ],
      navLabels: {
        previous: "Etiquetas canonical para ecommerce",
        next: "SEO de navegaci\u00f3n facetada",
      },
    },
    it: {
      badge: "SEO Tecnica",
