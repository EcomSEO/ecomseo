    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "M\u00c3\u00a1s all\u00c3\u00a1 del schema Product, dos tipos adicionales de datos estructurados benefician significativamente a las tiendas de ecommerce: BreadcrumbList y FAQPage. Ambos obtienen mejoras visuales en los resultados de b\u00c3\u00basqueda y ayudan a Google a entender la estructura de tu sitio.\n\nEl schema BreadcrumbList refleja tus migas de pan de navegaci\u00c3\u00b3n y muestra rutas de categor\u00c3\u00ada en los resultados de b\u00c3\u00basqueda en lugar de URLs sin formato. Un resultado de b\u00c3\u00basqueda que muestra \"Inicio > Zapatos de Mujer > Zapatillas de Running\" proporciona m\u00c3\u00a1s contexto que \"example.com/products/nike-air-zoom\" y obtiene tasas de clics m\u00c3\u00a1s altas. Implementa BreadcrumbList en cada p\u00c3\u00a1gina de producto y categor\u00c3\u00ada.\n\nEl schema FAQPage en p\u00c3\u00a1ginas de producto puede mostrar pares de pregunta-respuesta expandibles directamente en los resultados de b\u00c3\u00basqueda, ocupando m\u00c3\u00a1s espacio en la p\u00c3\u00a1gina de resultados. \u00c3\u009asalo para FAQs genuinas de producto como \"De qu\u00c3\u00a9 materiales est\u00c3\u00a1 hecho?\" o \"Este producto tiene garant\u00c3\u00ada?\". No uses FAQPage para preguntas gen\u00c3\u00a9ricas de atenci\u00c3\u00b3n al cliente que pertenecen a una p\u00c3\u00a1gina de ayuda.\n\nGoogle restringi\u00c3\u00b3 la elegibilidad para resultados enriquecidos FAQPage en 2023. Ahora aparecen principalmente para sitios conocidos y con autoridad. Para tiendas m\u00c3\u00a1s peque\u00c3\u00b1as, el schema FAQPage todav\u00c3\u00ada ayuda a Google a entender tu contenido, incluso si no activa resultados enriquecidos visuales. Los datos estructurados en s\u00c3\u00ad proporcionan valor a trav\u00c3\u00a9s de una mejor comprensi\u00c3\u00b3n del contenido.\n\nNo apiles tipos de schema excesivos en una sola p\u00c3\u00a1gina. Las p\u00c3\u00a1ginas de producto deber\u00c3\u00adan tener schema Product, BreadcrumbList y opcionalmente FAQPage. A\u00c3\u00b1adir Organization, WebSite, LocalBusiness y otros tipos a cada p\u00c3\u00a1gina a\u00c3\u00b1ade peso sin beneficio proporcional. Ambos contribuyen a un [SEO on-page](/blog/on-page-seo-for-ecommerce) m\u00e1s fuerte en todo tu cat\u00e1logo.",
        },
        {
        ...
        },
        {
          ...
          content:
            "El leak confirmo que los datos estructurados alimentan la comprensi\u00f3n de entidades de Google mucho m\u00e1s alla de la elegibilidad para rich results. Atributos alrededor de la confianza de entidad y asociacion topica dependen de senales consistentes y legibles por maquina a traves de la p\u00e1gina (Product schema, Brand schema, Organization schema) y a traves del sitio (enlaces sameAs, consistencia NAP, markup de autor).\n\nPara ecommerce, el movimiento practico es tratar los datos estructurados como la capa de datos que Google usa para entender lo que es tu tienda, no como un truco de rich snippet. Brand schema en cada p\u00e1gina con legalName consistente, enlaces sameAs a perfiles sociales verificados, y Organization schema en la homepage con foundingDate, direccion y contactPoint - estos tipicamente no producen cambios visibles en SERP el primer dia, pero elevan las senales de confianza de entidad que influyen siteAuthority en el tiempo.\n\nHacer Product schema correctamente es table stakes. M\u00e1s alla de eso, sameAs es la senal de autoridad m\u00e1s barata que puedes enviar - enlaza tu entidad Brand a cada perfil social verificado, p\u00e1gina de Wikipedia si aplica, y perfil Google Business. El leak sugiere que estas referencias cruzadas influyen materialmente como Google modela tu entidad Brand.",
          items: [
            "Los datos estructurados alimentan la comprensi\u00f3n de entidad, no solo los rich results - el schema es una capa de datos para Google",
