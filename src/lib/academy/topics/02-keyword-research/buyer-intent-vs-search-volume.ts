...
export const buyerIntentVsSearchVolume: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro: "Un mot-cl\u00e9 avec 50 recherches mensuelles et un taux de conversion de 6% genere plus de revenus qu'un mot-cl\u00e9 avec 10 000 recherches et un taux de conversion de 0,1%. Pour les boutiques e-commerce, comprendre l'intention d'achat est la competence la plus rentable en recherche de mots-cl\u00c3\u00a9s.",
      readTime: "8 min de lecture",
      sections: [
        {
          title: "Pourquoi le volume seul est trompeur",
          content:
            "Le volume de recherche vous dit combien de personnes saisissent une requete dans Google chaque mois. Il ne dit rien sur le fait que ces personnes veulent acheter, comparer, apprendre ou simplement naviguer. Une requete comme \"veste en cuir\" obtient environ 135 000 recherches mensuelles, mais l'intention derriere va de l'inspiration mode a la recherche d'achat en passant par les conseils d'entretien.\n\nComparez avec \"acheter veste cuir Schott NYC Perfecto taille 42\" a peut-etre 30 recherches par mois. Chaque personne qui tape cette requete est prete a sortir sa carte bancaire. L'ecart de taux de conversion entre ces deux requetes peut etre de 20x ou plus.\n\nLa plupart des outils de mots-cl\u00e9s trient par volume par defaut. Cela conditionne les proprietaires de boutiques a courir apr\u00e8s les plus gros chiffres, ce qui signifie souvent les termes les plus vagues, les plus competitifs et les moins convertissants. Inverser ce defaut, trier par revenus estimes a la place, change compl\u00e8tement quels mots-cl\u00e9s vous priorisez. Notre sujet sur l'[intention de recherche pour l'e-commerce](/academy/search-intent-for-ecommerce) couvre le cadre fondamental derri\u00c3\u00a8re ces cat\u00c3\u00a9gories d'intention.",
          items: [
            "Les mots-cl\u00e9s a fort volume ont souvent une intention mixte, repartissant le trafic entre acheteurs et simples visiteurs",
            "Les taux de conversion pour les mots-cl\u00e9s produits sp\u00e9cifiques oscillent entre 3-8%, contre 0,1-0,5% pour les termes generiques",
            "Le potentiel de revenus d'un mot-cl\u00e9 est volume multiplie par CTR multiplie par taux de conversion multiplie par panier moyen",
          ],
        },
        {
          title: "Le calcul du revenu par mot-clé",
          content:
            "Voici la formule que nous utilisons pour chaque d\u00e9cision de mot-cl\u00e9 : Revenu = Volume de recherche mensuel x CTR attendu x Taux de conversion x Panier moyen.\n\nPrenons deux exemples reels. Mot-cl\u00e9 A : \"chaussures de course\" avec 201 000 recherches mensuelles. En position 5 (environ 4% de CTR), avec un taux de conversion de 0,3% et un panier moyen de 120 EUR, cela donne : 201 000 x 0,04 x 0,003 x 120 = 2 894 EUR/mois.\n\nMot-cl\u00e9 B : \"Brooks Ghost 15 femme pointure 39\" avec 320 recherches mensuelles. En position 2 (environ 12% de CTR), avec un taux de conversion de 7% et le meme panier moyen de 120 EUR, cela donne : 320 x 0,12 x 0,07 x 120 = 322 EUR/mois pour un seul mot-cl\u00e9 longue traine.\n\nConsiderez maintenant ceci : votre boutique a probablement plus de 500 pages produits. Si chacune capture seulement deux ou trois mots-cl\u00e9s longue traine comme le mot-cl\u00e9 B, le revenu total des termes longue traine depasse largement ce que vous obtiendriez du seul terme generique, avec beaucoup moins de concurrence et des delais de positionnement bien plus rapides.",
          tip: "Construisez un tableur qui calcule automatiquement le revenu par mot-cl\u00e9. Integrez vos taux de conversion reels depuis Google Analytics par type de page, les pages produits convertissent generalement 3-5x plus que les pages cat\u00e9gories pour le trafic organique.",
        },
        {
          title: "Comment évaluer les mots-clés par intention d'achat",
          content:
            "Nous classifions les mots-cl\u00e9s e-commerce en quatre niveaux d'intention. Niveau 1 (intention la plus forte) : requetes contenant des noms de produits sp\u00e9cifiques, r\u00e9f\u00e9rences, numeros de mod\u00e8le ou attributs exacts du produit plus \"acheter\", \"commander\" ou \"prix\". Ceux-ci convertissent a 5-10%.\n\nNiveau 2 (intention de comparaison) : requetes avec des modificateurs comme \"meilleur\", \"vs\", \"avis\", \"top 10\" ou \"compare a\". Ces acheteurs ont une intention d'achat mais n'ont pas encore decide d'un produit sp\u00e9cifique. Les taux de conversion oscillent entre 2-4%, et la strat\u00e9gie gagnante est d'utiliser des pages cat\u00e9gories ou des guides d'achat qui orientent le trafic vers les produits.\n\nNiveau 3 (intention de solution) : requetes decrivant un probleme ou un cas d'usage, comme \"veste impermeable pour randonnee sous la pluie\" ou \"chaise de bureau confortable pour mal de dos\". Le chercheur veut un produit mais ne sait pas dans quelle cat\u00e9gorie regarder. Les taux de conversion oscillent entre 1-3%, et les pages cat\u00e9gories filtrees fonctionnent bien ici.\n\nNiveau 4 (informationnel) : requetes commencant par \"comment\", \"qu'est-ce que\", \"pourquoi\" ou termes thematiques generaux. Les taux de conversion sont inferieurs a 0,5%. Ceux-ci ont une valeur SEO pour construire l'autorite thematique, mais ne devraient jamais etre priorises par rapport aux mots-cl\u00e9s de niveaux 1 a 3, sauf si vous avez d\u00e9j\u00e0 capture les termes commerciaux.",
          items: [
            "Niveau 1 (achat immediat) : nom du produit + acheter/prix/commander, cibler avec des pages produits",
            "Niveau 2 (comparaison) : meilleur/vs/avis/top, cibler avec des pages cat\u00e9gories ou du contenu comparatif",
            "Niveau 3 (recherche de solution) : descriptions de problemes ou cas d'usage, cibler avec des pages cat\u00e9gories filtrees",
        ...
        },
        {
          ...
          content:
            "Certains mots ajoutes a un mot-cl\u00e9 de base augmentent considerablement la probabilite d'achat. Nous suivons ces modificateurs dans chaque projet de recherche de mots-cl\u00e9s car ils sont le moyen le plus rapide d'identifier des termes a forte conversion que les concurrents negligent.\n\nLes modificateurs transactionnels incluent : acheter, commander, boutique, offre, reduction, coupon, soldes, livraison gratuite, prix, cout, pas cher, abordable et ou acheter. Quand quelqu'un ajoute \"acheter\" ou \"prix\" a une requete produit, son intention est claire.\n\nLes modificateurs de comparaison incluent : meilleur, top, vs, versus, compare, avis, test, note, recommande et alternative a. Ceux-ci signalent un acheteur proche de l'achat mais qui \u00e9value ses options. Les pages cat\u00e9gories et le contenu comparatif captent efficacement ce trafic.\n\nLes modificateurs de specification incluent : taille, couleur, materiau, numero de mod\u00e8le, ann\u00e9e, dimensions, poids et termes de compatibilite. Ceux-ci resserrent la recherche vers une variante tr\u00e8s sp\u00e9cifique et convertissent exceptionnellement bien lorsqu'ils sont apparies a des pages produits correctement optimisees.\n\nLes modificateurs de cas d'usage comme \"pour la randonnee\", \"pour le bureau\", \"pour enfants\", \"pour debutants\" revelent la situation de l'acheteur et vous permettent de le diriger vers le bon sous-ensemble de produits. Ceux-ci fonctionnent bien avec des pages cat\u00e9gories filtrees.",
          tip: "Creez une bibliotheque de modificateurs pour votre niche. Listez chaque modificateur transactionnel, comparatif, de specification et de cas d'usage pertinent pour vos produits. Croisez-les avec vos mots-cl\u00e9s de base pour generer des centaines de variations longue traine a forte intention.",
        },
        {
          title: "Exemples reels : le faible volume qui bat le fort volume",
          content:
            "Un client dans l'ameublement se positionnait en premi\u00e8re page pour \"table a manger\" (74 000 recherches mensuelles). La page recevait 2 800 visites organiques par mois mais ne generait que 4 200 EUR de revenus attribuables, un revenu par visite de 1,50 EUR.\n\nParallelement, leur page produit pour une table a manger extensible sp\u00e9cifique en chene se positionnait sur 23 variations longue traine avec une moyenne de 40 a 150 recherches chacune. Trafic mensuel combine : 380 visites. Revenu mensuel combine : 8 900 EUR, un revenu par visite de 23,42 EUR.\n\nNous observons ce schema r\u00e9guli\u00e8rement. Un magasin d'equipement outdoor genere 60% de son chiffre d'affaires organique a partir de mots-cl\u00e9s avec moins de 500 recherches mensuelles chacun. Une marque de complements alimentaires obtient son meilleur ROI a partir de requetes sur des ingredients de marque que la plupart des outils signalent comme \"faible volume\".\n\nLa lecon n'est pas que les mots-cl\u00e9s a fort volume sont inutiles, ils construisent la visibilite de marque et captent le trafic haut de funnel. Mais pour la g\u00e9n\u00e9ration de revenus, la longue traine avec une intention d'achat claire surpasse les termes generiques presque a chaque fois. Le mouvement strategique est d'allouer vos efforts proportionnellement : 70% de votre travail SEO devrait cibler les termes qui generent 70% de votre chiffre d'affaires.",
          items: [
            "Suivez le revenu par visite organique au niveau de la page, pas seulement le trafic total",
            "Les mots-cl\u00e9s a faible volume sp\u00e9cifiques aux produits delivrent souvent 10-20x plus de revenu par visite",
        ...
        },
        {
          ...
          content:
            "Commencez par extraire vos 100 meilleures landing pages organiques par revenu depuis vos analytics. Pour chaque page, identifiez le mot-cl\u00e9 principal qui genere le trafic (la GSC rend cela simple). Taguez chaque mot-cl\u00e9 avec son niveau d'intention.\n\nVous constaterez probablement que vos pages a plus fort revenu sont portees par des mots-cl\u00e9s de niveaux 1 et 2, meme si ces pages ne recoivent pas le plus de trafic. Cela confirme ou concentrer vos efforts d'optimisation.\n\nEnsuite, examinez votre pipeline de recherche de mots-cl\u00e9s. Chaque nouvelle cible de mot-cl\u00e9 devrait passer par le processus d'\u00e9valuation d'intention avant d'etre priorisee. Un mot-cl\u00e9 de niveau 1 avec 200 recherches mensuelles devrait etre travaille avant un mot-cl\u00e9 de niveau 4 avec 5 000 recherches mensuelles.\n\nEnfin, utilisez l'analyse d'intention pour am\u00e9liorer les pages existantes. Si une page cat\u00e9gorie se positionne sur un mot-cl\u00e9 de niveau 2 mais convertit mal, v\u00e9rifiez si le contenu de la page correspond a l'intention de comparaison, aide-t-il les acheteurs a decider entre les options, ou se contente-t-il de lister des produits ? Aligner le contenu de la page avec l'intention du mot-cl\u00e9 est l'un des moyens les plus rapides d'augmenter les taux de conversion sans trafic supplementaire. Une fois vos mots-cl\u00c3\u00a9s \u00c3\u00a9valu\u00c3\u00a9s, le [mapping de mots-cl\u00c3\u00a9s pour les boutiques](/academy/keyword-mapping-for-stores) vous aide \u00c3\u00a0 attribuer chaque terme \u00c3\u00a0 la bonne page. Pour une vue d'ensemble compl\u00c3\u00a8te de ces strat\u00c3\u00a9gies, consultez notre guide sur la [strat\u00c3\u00a9gie SEO e-commerce](/blog/ecommerce-seo-strategy).",
        },
      ],
      navLabels: {
        previous: "Recherche de mots-cl\u00e9s pour le e-commerce",
        next: "Mots-cl\u00e9s produit vs. cat\u00e9gorie",
      },
    },
    es: {
      badge: "Investigaci\u00f3n de palabras clave",
      heading: "Intención de compra vs. volumen de busqueda",
      intro: "Una palabra clave con 50 busquedas mensuales y una tasa de conversion del 6% genera m\u00e1s ingresos que una con 10.000 busquedas y una tasa de conversion del 0,1%. Para tiendas ecommerce, entender la intenci\u00c3\u00b3n de compra es la habilidad m\u00e1s rentable en la investigaci\u00f3n de palabras clave.",
      readTime: "8 min de lectura",
      sections: [
        {
          title: "Por qué el volumen por si solo es enganoso",
          content:
            "El volumen de busqueda te dice cuantas personas escriben una consulta en Google cada mes. No dice nada sobre si esas personas quieren comprar, comparar, aprender o simplemente navegar. Una consulta como \"chaqueta de cuero\" obtiene unas 135.000 busquedas mensuales, pero la intenci\u00f3n detras va desde inspiracion de moda hasta investigaci\u00f3n de compra y busqueda de instrucciones de cuidado.\n\nCompara eso con \"comprar chaqueta cuero Schott NYC Perfecto talla 42\" con quizas 30 busquedas al mes. Cada persona que escribe esa consulta esta lista para sacar su tarjeta de credito. La diferencia en tasa de conversion entre estas dos consultas puede ser de 20x o m\u00e1s.\n\nLa mayoria de herramientas de palabras clave ordenan por volumen por defecto. Esto entrena a los duenos de tiendas a perseguir los n\u00fameros m\u00e1s grandes, lo que a menudo significa los terminos m\u00e1s vagos, m\u00e1s competitivos y que menos convierten. Invertir este orden por defecto, ordenar por ingresos estimados en su lugar, cambia completamente que palabras clave priorizas. Nuestro tema sobre [intenci\u00f3n de busqueda para ecommerce](/academy/search-intent-for-ecommerce) cubre el marco fundamental detras de estas categor\u00edas de intenci\u00f3n.",
          items: [
            "Las palabras clave de alto volumen a menudo tienen intenci\u00f3n mixta, dividiendo el tr\u00e1fico entre compradores y curiosos",
        ...
        },
        {
          ...
          content:
            "Esta es la formula que usamos para cada decisi\u00f3n de palabras clave: Ingresos = Volumen de busqueda mensual x CTR esperado x Tasa de conversion x Valor medio de pedido.\n\nVeamos dos ejemplos reales. Palabra clave A: \"zapatillas de correr\" con 201.000 busquedas mensuales. En posicion 5 (aproximadamente 4% CTR), con una tasa de conversion del 0,3% y un AOV de 120 EUR, eso da: 201.000 x 0,04 x 0,003 x 120 = 2.894 EUR/mes.\n\nPalabra clave B: \"Brooks Ghost 15 mujer talla 39\" con 320 busquedas mensuales. En posicion 2 (aproximadamente 12% CTR), con una tasa de conversion del 7% y el mismo AOV de 120 EUR, eso da: 320 x 0,12 x 0,07 x 120 = 322 EUR/mes de una sola palabra clave de cola larga.\n\nAhora considera esto: tu tienda probablemente tiene m\u00e1s de 500 p\u00e1ginas de producto. Si cada una captura solo dos o tres palabras clave de cola larga como la palabra clave B, los ingresos totales de terminos de cola larga superan con creces lo que obtendrias del unico termino generico, con mucha menos competencia y plazos de posicionamiento mucho m\u00e1s rapidos.",
          tip: "Construye una hoja de c\u00e1lculo que calcule autom\u00e1ticamente los ingresos por palabra clave. Introduce tus tasas de conversion reales de Google Analytics por tipo de p\u00e1gina, las p\u00e1ginas de producto tipicamente convierten 3-5x m\u00e1s que las p\u00e1ginas de categor\u00eda para tr\u00e1fico organico.",
        },
        {
          title: "Cómo puntuar palabras clave por intención de compra",
          content:
            "Clasificamos las palabras clave de ecommerce en cuatro niveles de intenci\u00f3n. Nivel 1 (intenci\u00f3n m\u00e1s alta): consultas que contienen nombres de productos especificos, SKUs, n\u00fameros de modelo o atributos exactos del producto m\u00e1s \"comprar\", \"pedir\" o \"precio\". Estas convierten al 5-10%.\n\nNivel 2 (intenci\u00f3n de comparacion): consultas con modificadores como \"mejor\", \"vs\", \"opinion\", \"top 10\" o \"comparado con\". Estos compradores tienen intenci\u00f3n de compra pero no han decidido un producto especifico. Las tasas de conversion van del 2-4%, y la estrategia ganadora son p\u00e1ginas de categor\u00eda o guias de compra que canalicen el tr\u00e1fico hacia productos.\n\nNivel 3 (intenci\u00f3n de solucion): consultas que describen un problema o caso de uso, como \"chaqueta impermeable para senderismo bajo lluvia\" o \"silla de oficina comoda para dolor de espalda\". El buscador quiere un producto pero no sabe en que categor\u00eda mirar. Las tasas de conversion van del 1-3%, y las p\u00e1ginas de categor\u00eda filtradas funcionan bien aqui.\n\nNivel 4 (informacional): consultas que empiezan con \"como\", \"que es\", \"por que\" o terminos tematicos generales. Las tasas de conversion estan por debajo del 0,5%. Tienen valor SEO para construir autoridad tem\u00e1tica, pero nunca deberian priorizarse sobre palabras clave de niveles 1-3 a menos que ya hayas capturado los terminos comerciales.",
          items: [
            "Nivel 1 (compra inmediata): nombre del producto + comprar/precio/pedir, apuntar con p\u00e1ginas de producto",
            "Nivel 2 (comparando): mejor/vs/opinion/top, apuntar con p\u00e1ginas de categor\u00eda o contenido comparativo",
            "Nivel 3 (buscando solucion): descripciones de problemas o casos de uso, apuntar con p\u00e1ginas de categor\u00eda filtradas",
        ...
        },
        {
          ...
          content:
            "Ciertas palabras anadidas a una palabra clave base aumentan dramaticamente la probabilidad de compra. Rastreamos estos modificadores en cada proyecto de investigaci\u00f3n de palabras clave porque son la forma m\u00e1s r\u00e1pida de identificar terminos de alta conversion que los competidores pasan por alto.\n\nLos modificadores transaccionales incluyen: comprar, pedir, tienda, oferta, descuento, cupon, rebajas, env\u00edo gratis, precio, coste, barato, economico y donde comprar. Cuando alguien anade \"comprar\" o \"precio\" a una consulta de producto, su intenci\u00f3n es inconfundible.\n\nLos modificadores de comparacion incluyen: mejor, top, vs, versus, comparado, opinion, resena, valorado, recomendado y alternativa a. Estos senalan un comprador que esta cerca de comprar pero evaluando opciones. Las p\u00e1ginas de categor\u00eda y el contenido comparativo capturan este tr\u00e1fico efectivamente.\n\nLos modificadores de especificacion incluyen: talla, color, material, n\u00famero de modelo, a\u00c3\u00b1o, dimensiones, peso y terminos de compatibilidad. Estos acotan al buscador a una variante muy especifica del producto y convierten excepcionalmente bien cuando se emparejan con p\u00e1ginas de producto correctamente optimizadas.\n\nLos modificadores de caso de uso como \"para senderismo\", \"para oficina\", \"para ninos\", \"para principiantes\" revelan la situacion del comprador y te permiten dirigirlo al subconjunto de productos adecuado. Estos funcionan bien con p\u00e1ginas de categor\u00eda filtradas.",
          tip: "Crea una biblioteca de modificadores para tu nicho. Lista cada modificador transaccional, comparativo, de especificacion y de caso de uso relevante para tus productos. Cruzalos con tus palabras clave semilla para generar cientos de variaciones de cola larga con alta intenci\u00f3n.",
        },
        {
          title: "Ejemplos reales: bajo volumen superando a alto volumen",
          content:
            "Un cliente de muebles para el hogar se posicionaba en primera p\u00e1gina para \"mesa de comedor\" (74.000 busquedas mensuales). La p\u00e1gina recibia 2.800 visitas organicas al mes pero generaba solo 4.200 EUR en ingresos atribuibles, un ingreso por visita de 1,50 EUR.\n\nMientras tanto, su p\u00e1gina de producto para una mesa de comedor extensible de roble especifica se posicionaba para 23 variaciones de cola larga con un promedio de 40-150 busquedas cada una. Tr\u00e1fico mensual combinado: 380 visitas. Ingresos mensuales combinados: 8.900 EUR, un ingreso por visita de 23,42 EUR.\n\nVemos este patr\u00f3n consistentemente. Una tienda de equipamiento outdoor genera el 60% de sus ingresos organicos de palabras clave con menos de 500 busquedas mensuales cada una. Una marca de suplementos obtiene su mayor ROI de consultas sobre ingredientes de marca que la mayoria de herramientas senalan como \"bajo volumen\".\n\nLa leccion no es que las palabras clave de alto volumen sean inutiles, construyen visibilidad de marca y capturan tr\u00e1fico de la parte alta del embudo. Pero para generar ingresos, la cola larga con clara intenci\u00f3n de compra supera a los terminos genericos casi siempre. El movimiento estrategico es asignar tu esfuerzo proporcionalmente: el 70% de tu trabajo SEO deberia apuntar a los terminos que generan el 70% de tus ingresos.",
          items: [
            "Rastrea los ingresos por visita organica a nivel de p\u00e1gina, no solo el tr\u00e1fico total",
            "Las palabras clave de bajo volumen especificas de producto a menudo entregan 10-20x m\u00e1s ingresos por visita",
        ...
        },
        {
          ...
          content:
            "Empieza extrayendo tus 100 mejores landing pages organicas por ingresos desde analytics. Para cada p\u00e1gina, identifica la palabra clave principal que genera el tr\u00e1fico (GSC lo hace sencillo). Etiqueta cada palabra clave con su nivel de intenci\u00f3n.\n\nProbablemente encontraras que tus p\u00e1ginas de mayor ingreso estan impulsadas por palabras clave de niveles 1 y 2, aunque esas p\u00e1ginas no reciban el mayor tr\u00e1fico. Esto confirma donde concentrar tus esfuerzos de optimizaci\u00f3n.\n\nA continuacion, revisa tu pipeline de investigaci\u00f3n de palabras clave. Cada nuevo objetivo de palabra clave deberia pasar por el proceso de evaluaci\u00f3n de intenci\u00f3n antes de ser priorizado. Una palabra clave de nivel 1 con 200 busquedas mensuales deberia trabajarse antes que una de nivel 4 con 5.000 busquedas mensuales.\n\nFinalmente, usa el an\u00e1lisis de intenci\u00f3n para mejorar p\u00e1ginas existentes. Si una p\u00e1gina de categor\u00eda se posiciona para una palabra clave de nivel 2 pero convierte mal, verifica si el contenido de la p\u00e1gina coincide con la intenci\u00f3n de comparacion, ayuda a los compradores a decidir entre opciones, o simplemente lista productos? Alinear el contenido de la p\u00e1gina con la intenci\u00f3n de la palabra clave es una de las formas m\u00e1s rapidas de aumentar las tasas de conversion sin tr\u00e1fico adicional. Una vez que hayas puntuado tus palabras clave, el [mapeo de palabras clave para tiendas](/academy/keyword-mapping-for-stores) te ayuda a asignar cada termino a la p\u00e1gina correcta. Para una vision completa de estas estrategias, consulta nuestra guia de [estrategia SEO para ecommerce](/blog/ecommerce-seo-strategy).",
        },
      ],
      navLabels: {
        previous: "Investigaci\u00f3n de palabras clave para ecommerce",
        next: "Palabras clave de producto vs. categor\u00eda",
      },
    },
    it: {
