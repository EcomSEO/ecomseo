...
export const competitorKeywordAnalysis: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro:
        "Vos concurrents ont deja fait la recherche de mots-cles pour vous, ils ne le savent pas. En analysant quels mots-cles generent du trafic vers les boutiques concurrentes, vous pouvez identifier les lacunes de votre propre strategie et trouver des opportunites eprouvees qui generent deja des revenus dans votre marche.",
      readTime: "8 min de lecture",
      sections: [
        {
          title: "Identifier vos vrais concurrents SEO",
          content:
            "Vos concurrents SEO ne sont pas necessairement vos concurrents commerciaux. Un magasin de chaussures local peut rivaliser avec Nike pour les clients, mais dans les resultats de recherche, ses vrais concurrents sont d'autres detaillants en ligne de taille moyenne positionnes sur les memes mots-cles produits.\n\nPour trouver vos concurrents SEO reels, cherchez vos 10 principaux mots-cles de categorie et notez quels domaines apparaissent regulierement en premiere page. Ce sont les sites avec lesquels vous vous battez pour les clics. Certains seront des concurrents commerciaux directs ; d'autres pourraient etre des places de marche, des sites d'avis ou des detaillants de niche que vous n'aviez pas consideres.\n\nAhrefs et Semrush disposent tous deux de fonctionnalites de decouverte de concurrents qui automatisent ce processus. Entrez votre domaine et ils vous montreront quels sites partagent le plus de chevauchement de mots-cles avec le votre. Le rapport \"domaines concurrents\" revele typiquement 5 a 10 sites que vous devriez suivre regulierement.\n\nConcentrez-vous sur les concurrents qui sont un cran devant vous, pas les leaders du marche avec une autorite de domaine massive. Si vous etes une boutique de 2 ans avec 500 produits, analyser Amazon ou Cdiscount ne vous apprend rien d'actionnable. Analysez plutot la boutique avec 1 000 produits et des classements legerement meilleurs, leur strategie est a votre portee.",
          items: [
            "Cherchez vos 10 principaux mots-cles de categorie et notez quels domaines apparaissent de facon repetee en premiere page",
            "Utilisez les rapports de domaines concurrents Ahrefs/Semrush pour trouver les sites avec le plus de chevauchement de mots-cles",
            "Concentrez-vous sur les concurrents legerement en avance sur vous, pas les leaders inaccessibles du marche",
        ...
        },
        {
          ...
          items: [
            "Categorie 1 : avez des pages mais ne vous positionnez pas, optimiser le contenu existant pour ces termes",
            "Categorie 2 : pas encore de pages, creer de nouvelles pages categorie ou produit pour capturer ces mots-cles",
        ...
        },
        {
          ...
          content:
            "L'analyse des mots-cles concurrents n'est pas un projet ponctuel. Les marches evoluent, de nouveaux concurrents apparaissent, et le paysage des mots-cles change chaque trimestre. Nous executons ce workflow tous les 90 jours pour nos clients e-commerce.\n\nSemaine 1 : mettez a jour votre liste de concurrents. Verifiez si de nouveaux domaines sont entres dans le top 10 pour vos mots-cles principaux. Retirez ceux qui en sont sortis. Tirez des donnees de gap de mots-cles fraiches pour chaque concurrent.\n\nSemaine 2 : categorisez les nouveaux mots-cles de gap dans les quatre categories. Priorisez les opportunites de categorie 1 (optimisation) et categorie 2 (creation de nouvelles pages). Estimez le potentiel de trafic pour chacun en utilisant les donnees de volume et des hypotheses de CTR realistes.\n\nSemaine 3 : creez des tickets d'implementation. Pour les mots-cles de categorie 1, assignez des taches d'optimisation de page avec des changements on-page specifiques. Pour les mots-cles de categorie 2, cadrez la creation de nouvelles pages categorie ou contenu. Ajoutez des delais et des responsables a chaque ticket.\n\nSemaine 4 : examinez les resultats de l'analyse de gap du dernier trimestre. Quelles pages ont ete optimisees ? Les classements se sont-ils ameliores ? Quelles nouvelles pages ont ete creees ? Sont-elles indexees et gagnent-elles des impressions ? Cette retrospective garantit que l'analyse de gap mene a l'action, pas seulement a l'analyse.\n\nLa cadence trimestrielle vous garde reactif aux changements du marche sans surcharger votre equipe avec une surveillance constante des concurrents. Entre les revues trimestrielles, votre outil de suivi de mots-cles gere les fluctuations de classement quotidiennes.",
          items: [
            "Mettez a jour votre liste de concurrents chaque trimestre, de nouveaux acteurs entrent et les anciens s'estompent",
            "Categorisez les mots-cles de gap en quatre categories : optimiser, creer, approvisionner et ignorer",
            "Creez des tickets d'implementation specifiques avec des delais et des responsables",
            "Examinez les resultats d'implementation du dernier trimestre pour mesurer les progres",
          ],
          tip: "Tenez un document evoluant avec les insights concurrentiels, pas seulement les mots-cles, mais aussi les modeles de contenu, les choix structurels et les strategies saisonnieres. Sur quatre trimestres, cela se construit en un actif d'intelligence concurrentielle qui informe les decisions strategiques bien au-dela du SEO.",
        },
      ],
      navLabels: {
        previous: "Mots-cles longue traine pour les produits",
        next: "Mapping de mots-cles pour les boutiques",
      },
    },
    es: {
      ...
      intro:
        "Tus competidores ya han hecho la investigacion de palabras clave por ti, simplemente no lo saben. Al analizar que palabras clave generan trafico a las tiendas competidoras, puedes identificar brechas en tu propia estrategia y encontrar oportunidades probadas que ya generan ingresos en tu mercado.",
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "El analisis de brecha te da la lista cruda, pero convertirla en accion requiere categorizacion. Clasificamos las palabras clave de competidores en cuatro cubetas.\n\nCubeta uno: palabras clave para las que tienes paginas pero no posicionas. Ya tienes una pagina de producto o categoria que deberia apuntar a esta palabra clave pero no aparece en el top 100. Son oportunidades de optimizacion, actualiza el titulo, H1 y contenido de la pagina existente para apuntar mejor al termino.\n\nCubeta dos: palabras clave para las que no tienes paginas pero podrias crear. Tu competidor tiene una pagina de categoria para \"auriculares inalambricos para correr\" y tu vendes auriculares deportivos pero no tienes una pagina de categoria dedicada. Crea la pagina.\n\nCubeta tres: palabras clave que requieren nuevos productos o lineas de producto. Tu competidor posiciona para productos que no tienes en tu catalogo. Esto es inteligencia de negocio, no solo datos SEO, te dice que productos incorporar o desarrollar.\n\nCubeta cuatro: palabras clave que no vale la pena perseguir. Algunas palabras clave de competidores no se alinean con tu modelo de negocio, mercado objetivo o gama de productos. Un competidor puede posicionar para modificadores \"barato\" mientras tu marca se posiciona como premium. Omitelas.\n\nLas dos primeras cubetas contienen el 80% de tus oportunidades accionables. La cubeta uno es la mas rapida de implementar (optimizar paginas existentes), mientras la cubeta dos requiere creacion de nuevas paginas pero tipicamente produce resultados en 3-6 meses.",
          items: [
            "Cubeta 1: tienes paginas pero no posicionas, optimiza el contenido existente para estos terminos",
            "Cubeta 2: aun sin paginas, crea nuevas paginas de categoria o producto para capturar estas palabras clave",
        ...
        },
        {
          ...
          items: [
            ...
            "Crea tickets de implementacion especificos con plazos y responsables",
            "Revisa los resultados de implementacion del trimestre anterior para medir el progreso",
          ],
          tip: "Mantien un documento continuo de insights competitivos, no solo palabras clave, sino tambien patrones de contenido, decisiones estructurales y estrategias estacionales. En cuatro trimestres, esto se construye en un activo de inteligencia competitiva que informa decisiones estrategicas mucho mas alla del SEO.",
        },
      ],
      navLabels: {
