...
export const keywordResearchForEcommerce: AcademyTopic = {
  ...
  content: {
      ...
      sections: [
        {
          ...
          content:
            "Les sites de contenu monetisent l'attention. Ils ont besoin de visiteurs, donc le volume est roi. Une boutique en ligne monetise les transactions. Un mot-cl\u00e9 qui amene 50 visiteurs qui achetent vaut plus qu'un qui en amene 5 000 qui rebondissent. Cette distinction change tout dans la priorisation.\n\nLa plupart des guides de recherche de mots-cl\u00e9s recommandent de commencer par une liste de base, de l'enrichir avec un outil, puis de filtrer par volume et difficulte. Ce workflow a du sens pour un blog. Pour une boutique, il mene directement vers des termes informationnels qui remplissent vos analytics de trafic qui ne convertit jamais.\n\nLe workflow de recherche de mots-cl\u00e9s e-commerce commence par vos propres donn\u00e9es de transactions. Quels produits se vendent ? Que tapent les clients dans votre recherche interne ? Quelles landing pages convertissent d\u00e9j\u00e0 ? A partir de la, on s'etend vers des termes adjacents et des opportunites inexploitees. Pour un aper\u00c3\u00a7u plus large de ce sujet, consultez notre guide sur les [mots-cl\u00c3\u00a9s SEO e-commerce](/blog/ecommerce-seo-keywords).",
          items: [
            "Extrayez vos pages les plus generatrices de revenus depuis vos analytics avant de toucher un outil de mots-cl\u00e9s",
            "Exportez vos requetes de recherche interne, ce sont des signaux de demande spontanes de vrais acheteurs",
            "Consultez Google Search Console pour les requetes generant d\u00e9j\u00e0 des impressions sur vos pages produits et cat\u00e9gories",
          ],
          callout: {
            title: "Die 15/70-Regel",
        ...
        },
        {
          ...
          content:
            "Ouvrez votre plateforme d'analytics et triez les landing pages par revenu. Les pages qui generent le plus de ventes vous indiquent d\u00e9j\u00e0 quels mots-cl\u00e9s comptent. Croisez ces pages avec Google Search Console pour voir quelles requetes amenent des visiteurs.\n\nPour une boutique typique avec plus de 200 produits, vous constaterez que 15-20% des pages generent 70-80% du chiffre d'affaires organique. Ce sont vos mots-cl\u00e9s prioritaires. Toute recherche supplementaire doit s'etendre a partir de ce noyau, pas d'une page blanche.\n\nSi vous lancez une nouvelle boutique sans donn\u00e9es historiques, utilisez l'analyse concurrentielle comme point de depart. Identifiez 3 a 5 concurrents directs et extrayez leurs mots-cl\u00e9s positionnees depuis Ahrefs ou Semrush. Filtrez pour les pages qui ressemblent a des pages produits ou cat\u00e9gories, ignorez leur contenu blog pour l'instant.",
          tip: "Creez un tableur simple avec des colonnes pour l'URL, le mot-cl\u00e9 principal, les recherches mensuelles, le classement actuel et le revenu mensuel. Cela devient votre centre de commande de mots-cl\u00e9s et vous empeche de vous perdre dans les donn\u00e9es des outils.",
        },
        {
          title: "Le workflow de recherche de mots-clés e-commerce",
          content:
            "\u00c9tape une : auditez votre performance organique existante. Tirez toutes les pages avec du trafic organique de la GSC et taguez chacune comme produit, cat\u00e9gorie, blog ou autre. Calculez le revenu par session organique pour chaque type de page.\n\n\u00c9tape deux : construisez votre liste de base a partir de trois sources, vos donn\u00e9es de recherche interne, votre rapport de requetes GSC et les exports de mots-cl\u00e9s concurrents. Dedupliquez et taguez chaque mot-cl\u00e9 avec son type de page probable (page produit, page cat\u00e9gorie ou page de contenu).\n\n\u00c9tape trois : elargissez votre liste de base avec des outils de mots-cl\u00e9s. Pour chaque terme de base, tirez les termes associes, les questions et les variantes longue traine. Mais filtrez sans pitie, ne gardez que les termes avec une intention commerciale ou transactionnelle claire.\n\n\u00c9tape quatre : priorisez. Evaluez chaque mot-cl\u00e9 sur trois axes : potentiel de revenus (volume de recherche multiplie par le taux de conversion estime multiplie par le panier moyen), position actuelle et lacune de contenu (avez-vous une page pour ce terme ou non). Les mots-cl\u00e9s avec les meilleurs scores sur les trois axes sont traites en premier. D\u00c3\u00a9dupliquez et taguez chaque mot-cl\u00c3\u00a9 avec son type de page probable (les [mots-cl\u00c3\u00a9s produit vs cat\u00c3\u00a9gorie](/academy/product-vs-category-keywords) sont couverts dans notre prochain sujet).",
          items: [
            "Taguez chaque mot-cl\u00e9 avec son type de page cible : produit, cat\u00e9gorie ou contenu",
            "Filtrez les mots-cl\u00e9s purement informationnels sauf s'ils s'inscrivent clairement dans un tunnel d'achat",
            "Evaluez les mots-cl\u00e9s par potentiel de revenus, pas seulement par volume ou difficulte",
            "Identifiez les lacunes de contenu ou aucune page ne cible un mot-cl\u00e9 a fort potentiel",
          ],
          image: {
        ...
        },
        {
          ...
          content:
            "Google Search Console est votre outil de mots-cl\u00e9s le plus sous-estime. Il vous montre exactement quelles requetes Google associe a vos pages, vos taux de clics et votre position dans les classements. Aucun outil tiers n'offre ce niveau de precision pour votre propre site.\n\nAhrefs et Semrush fournissent tous deux des bases de donn\u00e9es de mots-cl\u00e9s avec des estimations de volume, des scores de difficulte et des donn\u00e9es concurrentielles. Pour le e-commerce, leurs fonctionnalit\u00e9s de keyword gap sont particulierement utiles, elles vous montrent exactement quels termes vos concurrents couvrent et que vous manquez compl\u00e8tement.\n\nGoogle Keyword Planner reste utile pour les estimations de volume, surtout pour les termes sp\u00e9cifiques aux produits que les outils tiers ratent parfois. Ses donn\u00e9es proviennent directement de Google Ads, donc les mots-cl\u00e9s commerciaux tendent a avoir des chiffres de volume plus precis.\n\nN'oubliez pas Amazon Autocomplete et les donn\u00e9es de recherche Amazon si vous vendez aussi sur les places de march\u00e9. Les termes de recherche Amazon sont de l'[intention d'achat](/academy/buyer-intent-vs-search-volume) pure, les gens qui cherchent sur Amazon sont prets a acheter. Des outils comme Helium 10 ou Jungle Scout peuvent extraire ces donn\u00e9es.",
          tip: "Passez vos 50 principaux noms de produits dans Amazon Autocomplete. Les suggestions revelent des modificateurs d'achat sp\u00e9cifiques (tailles, couleurs, cas d'usage) que les outils de mots-cl\u00e9s Google ratent souvent.",
        },
        {
          title: "Erreurs courantes des boutiques",
          content:
            "La plus grosse erreur est de cibler des termes generiques avec un volume massif en ignorant la longue traine. Une boutique vendant des chaussures de course pourrait se focaliser sur \"chaussures de course\" (201 000 recherches mensuelles) tout en ignorant \"chaussures de trail femme pied large\" (480 recherches mensuelles, taux de conversion 4x superieur).\n\nUne autre erreur frequente est de traiter la recherche de mots-cl\u00e9s comme un projet ponctuel. Votre catalogue produit evolue, la demande saisonni\u00e8re fluctue, et les concurrents entrent et quittent le march\u00e9. La recherche de mots-cl\u00e9s devrait etre revisitee au minimum chaque trimestre, avec des verifications mensuelles sur vos termes prioritaires.\n\nBeaucoup de boutiques font aussi l'erreur d'utiliser des strat\u00e9gies de mots-cl\u00e9s orientees blog. Elles publient des dizaines d'articles informationnels qui se positionnent bien mais ne menent jamais a un achat. Un article sur \"comment choisir des chaussures de randonnee\" n'aide que s'il renvoie efficacement vers votre page cat\u00e9gorie de chaussures de randonnee.\n\nEnfin, mefiance envers les outils qui gonflent les scores de difficulte. Un mot-cl\u00e9 avec une difficulte de 70 dans Ahrefs pourrait etre parfaitement accessible pour votre boutique si les premiers resultats sont des pages produits maigres de concurrents avec des profils de backlinks faibles. V\u00e9rifiez toujours manuellement la SERP avant d'ecarter un mot-cl\u00e9 comme trop competitif.",
          items: [
            "Evitez de cibler uniquement les termes generiques, la longue traine convertit 2 a 3x mieux pour la plupart des boutiques",
            "Revisitez votre strat\u00e9gie de mots-cl\u00e9s chaque trimestre, pas chaque ann\u00e9e",
            "Assurez-vous que le contenu informationnel est connecte aux pages transactionnelles via des liens internes",
            "V\u00e9rifiez manuellement les SERP avant de faire confiance aux scores de difficulte d'un outil",
          ],
        },
        {
          title: "Construire votre premier sprint de recherche de mots-clés",
          content:
            "Nous recommandons un sprint concentre de deux semaines pour construire votre carte de mots-cl\u00e9s initiale. La premi\u00e8re semaine couvre la collecte de donn\u00e9es : tirer les donn\u00e9es GSC, exporter les mots-cl\u00e9s concurrents, rassembler les requetes de recherche interne et passer vos termes de base dans Ahrefs ou Semrush.\n\nLa deuxieme semaine se concentre sur l'analyse et le mapping. Clusterisez vos mots-cl\u00e9s par theme, assignez chaque cluster a un type de page, identifiez les lacunes dans votre structure de site actuelle et priorisez les 20-30 cibles de mots-cl\u00e9s qui genereront le plus de revenus.\n\nA la fin de ce sprint, vous devriez avoir une carte de mots-cl\u00e9s fonctionnelle couvrant vos principales cat\u00e9gories et produits, une liste priorisee de lacunes de contenu a combler et un calendrier de revue trimestriel pour maintenir la carte a jour. Ce document devient la base de chaque d\u00e9cision SEO que vous prendrez par la suite.",
        },
      ],
      navLabels: {
    ...
    es: {
      ...
      intro: "La investigaci\u00f3n de palabras clave para tiendas online sigue una l\u00c3\u00b3gica fundamentalmente diferente a la de blogs o sitios de contenido. En lugar de perseguir volumen de busqueda, comenzamos con datos de ingresos y trabajamos hacia atr\u00c3\u00a1s para identificar los terminos que realmente generan ventas.",
      readTime: "9 min de lectura",
      sections: [
        {
          title: "Por qué la investigación de palabras clave para ecommerce es diferente",
          content:
            "Los sitios de contenido monetizan la atenci\u00f3n. Necesitan visitantes, as\u00ed que el volumen es lo primordial. Una tienda online monetiza transacciones. Una palabra clave que trae 50 visitantes que compran vale m\u00e1s que una que trae 5.000 que rebotan. Esta distincion cambia todo sobre como priorizas.\n\nLa mayoria de guias de investigaci\u00f3n de palabras clave te dicen que empieces con una lista semilla, la expandas con una herramienta y luego filtres por volumen y dificultad. Ese flujo de trabajo tiene sentido para un blog. Para una tienda, te lleva directamente a terminos informativos que llenan tus analytics con tr\u00e1fico que nunca convierte.\n\nEl flujo de trabajo de investigaci\u00f3n de [palabras clave para ecommerce](/blog/ecommerce-seo-keywords) comienza con tus propios datos de transacciones. Que productos se venden? Que escriben los clientes en la busqueda interna? Que landing pages ya convierten? Desde ahi, expandimos hacia terminos adyacentes y oportunidades sin explotar.",
          items: [
            "Extrae tus p\u00e1ginas con mayor generacion de ingresos de analytics antes de tocar cualquier herramienta de palabras clave",
            "Exporta las consultas de busqueda interna de tu sitio, son senales de demanda espontaneas de compradores reales",
            "Revisa Google Search Console para consultas que ya generan impresiones en p\u00e1ginas de productos y categor\u00edas",
          ],
          callout: {
            title: "Die 15/70-Regel",
        ...
        },
        {
          ...
          content:
            "Abre tu plataforma de analytics y ordena las landing pages por ingresos. Las p\u00e1ginas que generan m\u00e1s ventas ya te dicen que palabras clave importan. Cruza estas p\u00e1ginas con Google Search Console para ver que consultas traen visitantes.\n\nPara una tienda tipica con m\u00e1s de 200 productos, encontraras que el 15-20% de las p\u00e1ginas genera el 70-80% de los ingresos organicos. Estas son tus palabras clave prioritarias. Cualquier investigaci\u00f3n adicional debe expandirse desde este nucleo, no desde una hoja en blanco.\n\nSi estas lanzando una tienda nueva sin datos historicos, usa el an\u00e1lisis de competencia como punto de partida. Identifica 3 a 5 competidores directos y extrae sus palabras clave posicionadas desde Ahrefs o Semrush. Filtra por p\u00e1ginas que parezcan p\u00e1ginas de producto o categor\u00eda, ignora su contenido de blog por ahora.",
          tip: "Crea una hoja de c\u00e1lculo simple con columnas para URL, palabra clave principal, busquedas mensuales, posicion actual e ingresos mensuales. Esto se convierte en tu centro de mando de palabras clave y evita que te pierdas en datos de herramientas.",
        },
        {
          title: "El flujo de trabajo de investigación de palabras clave para ecommerce",
          content:
            "Paso uno: audita tu rendimiento organico existente. Extrae todas las p\u00e1ginas con tr\u00e1fico organico de GSC y etiqueta cada una como producto, categor\u00eda, blog u otro. Calcula los ingresos por sesi\u00f3n organica para cada tipo de p\u00e1gina.\n\nPaso dos: construye tu lista semilla desde tres fuentes, tus datos de busqueda interna, tu informe de consultas GSC y exportaciones de palabras clave de competidores. Deduplica y etiqueta cada palabra clave con su tipo de p\u00e1gina probable (p\u00e1gina de producto, p\u00e1gina de categor\u00eda o p\u00e1gina de contenido).\n\nPaso tres: expande tu lista semilla usando herramientas de palabras clave. Para cada semilla, extrae terminos relacionados, preguntas y variantes de cola larga. Pero filtra sin piedad, conserva solo terminos con intenci\u00f3n comercial o transaccional clara.\n\nPaso cuatro: prioriza. Puntua cada palabra clave en tres ejes: potencial de ingresos (volumen de busqueda multiplicado por tasa de conversion estimada multiplicado por valor promedio de pedido), posicion actual de ranking y brecha de contenido (tienes una p\u00e1gina para este termino o no). Las palabras clave con las puntuaciones m\u00e1s altas en los tres ejes se trabajan primero. Deduplica y etiqueta cada palabra clave con su tipo de p\u00e1gina probable ([palabras clave de producto vs categor\u00eda](/academy/product-vs-category-keywords) se cubre en nuestro siguiente tema). Comprender la [intenci\u00f3n de compra vs volumen de busqueda](/academy/buyer-intent-vs-search-volume) te ayudara a hacer esta distincion.",
          items: [
            "Etiqueta cada palabra clave con su tipo de p\u00e1gina objetivo: producto, categor\u00eda o contenido",
            ...
            "Identifica brechas de contenido donde no tienes p\u00e1gina apuntando a una palabra clave de alto potencial",
          ],
          image: {
        ...
        },
        {
          ...
          content:
            "Google Search Console es tu herramienta de palabras clave m\u00e1s infravalorada. Te muestra exactamente que consultas asocia Google con tus p\u00e1ginas, tus tasas de clics y donde te situas en los rankings. Ninguna herramienta de terceros ofrece este nivel de precision para tu propio sitio.\n\nAhrefs y Semrush proporcionan bases de datos de palabras clave con estimaciones de volumen, puntuaciones de dificultad y datos de competencia. Para ecommerce, sus funciones de keyword gap son particularmente utiles, te muestran exactamente que terminos cubren tus competidores y que tu pierdes por completo.\n\nGoogle Keyword Planner sigue siendo util para estimaciones de volumen, especialmente para terminos especificos de productos que las herramientas de terceros a veces pasan por alto. Sus datos provienen directamente de Google Ads, as\u00ed que las palabras clave comerciales tienden a tener n\u00fameros de volumen m\u00e1s precisos.\n\nNo pases por alto Amazon Autocomplete y los datos de busqueda de Amazon si tambi\u00e9n vendes en marketplaces. Los terminos de busqueda de Amazon son intenci\u00f3n de compra pura, las personas que buscan en Amazon estan listas para comprar. Herramientas como Helium 10 o Jungle Scout pueden extraer estos datos.",
        ...
        },
        {
          ...
          items: [
            ...
            "Asegura que el contenido informativo se conecte con p\u00e1ginas transaccionales mediante enlaces internos",
        ...
        },
        {
          ...
          content:
            "Recomendamos un sprint enfocado de dos semanas para construir tu mapa de palabras clave inicial. La primera semana cubre la recopilacion de datos: extraer datos de GSC, exportar palabras clave de competidores, reunir consultas de busqueda interna y pasar tus terminos semilla por Ahrefs o Semrush.\n\nLa segunda semana se enfoca en an\u00e1lisis y mapeo. Agrupa tus palabras clave por tema, asigna cada grupo a un tipo de p\u00e1gina, identifica brechas en la estructura actual de tu sitio y prioriza los 20-30 objetivos de palabras clave que generaran m\u00e1s ingresos.\n\nAl final de este sprint, deberias tener un mapa de palabras clave funcional que cubra tus principales categor\u00edas y productos, una lista priorizada de brechas de contenido a llenar y un calendario de revision trimestral para mantener el mapa actualizado. Este documento se convierte en la base de cada decisi\u00f3n SEO que tomes en adelante. Si necesitas ayuda profesional con este proceso, explora nuestro servicio de [investigaci\u00f3n de palabras clave](/keyword-research).",
        },
      ],
      navLabels: {
        previous: "Google Search Console para tiendas",
        next: "Intenci\u00f3n de compra vs. volumen de busqueda",
      },
    },
    it: {
