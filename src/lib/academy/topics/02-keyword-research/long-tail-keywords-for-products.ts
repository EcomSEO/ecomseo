      ...
      sections: [
        {
          ...
          content:
            "La plupart des proprietaires de boutiques se focalisent sur une poignee de mots-cl\u00e9s a fort volume. Pendant ce temps, la veritable opportunite de revenus reside dans le trafic longue traine agrege. Regardons des chiffres realistes.\n\nUne boutique avec 500 pages produits peut raisonnablement cibler 2 a 5 mots-cl\u00e9s longue traine par page. Ca fait 1 000 a 2 500 cibles de mots-cl\u00e9s. Chaque mot-cl\u00e9 longue traine n'obtient peut-etre que 20 a 200 recherches par mois, mais avec un classement en position 1-3, vous pouvez capter 15-30% de ce trafic. Et parce que les recherches longue traine sont tr\u00e8s sp\u00e9cifiques, les taux de conversion atteignent 4-8% contre 0,5-1% pour les termes generiques.\n\nFaites le calcul : 1 500 mots-cl\u00e9s longue traine avec une moyenne de 80 recherches par mois, avec un taux de clic de 20% en positions 1-3, donnent 24 000 visites mensuelles. A un taux de conversion de 5% et un panier moyen de 75 EUR, ca fait 90 000 EUR de revenus mensuels, a partir de termes que la plupart des concurrents ignorent totalement.\n\nL'effet compose est ce qui rend cette strat\u00e9gie puissante. Chaque nouvelle page produit que vous ajoutez capture davantage de termes longue traine. A mesure que votre autorite de domaine augmente, ces pages se positionnent plus vite et pour plus de variations. Une boutique qui optimise systematiquement ses pages produits pour les mots-cl\u00e9s longue traine construit un actif de trafic organique que les concurrents ne peuvent pas facilement repliquer. Notre guide plus large sur la [recherche de mots-cl\u00c3\u00a9s pour l'e-commerce](/academy/keyword-research-for-ecommerce) explique comment construire cette fondation.",
          items: [
            "Ciblez 2-5 mots-cl\u00e9s longue traine par page produit sur l'ensemble de votre catalogue",
        ...
        },
        {
          ...
          content:
            "Vos donn\u00e9es produits sont une mine d'or de mots-cl\u00e9s longue traine en evidence. Chaque attribut, taille, couleur, materiau, poids, compatibilite, cas d'usage, se combine avec le type de produit pour cr\u00e9er une requete recherchable.\n\nPrenez un produit comme un sac de couchage de camping. Le mot-cl\u00e9 de base est \"sac de couchage camping\" (fort volume, competition feroce). Mais les attributs generent des dizaines de termes longue traine : \"sac de couchage 3 saisons temperature confort 0 degre\", \"sac de couchage momie ultralight moins de 1 kg\", \"sac de couchage large pour dormeur lateral\", \"sac de couchage duvet compressible pour randonnee\". Chacun de ces termes a un volume moindre mais une intention d'achat considerablement plus elevee.\n\nL'approche systematique : exportez vos donn\u00e9es produits avec tous les attributs dans un tableur. Creez des formules de mots-cl\u00e9s qui combinent type de produit + attribut 1, type de produit + attribut 1 + attribut 2, et ainsi de suite. Puis validez-les contre le volume de recherche reel avec Ahrefs, Semrush ou Google Keyword Planner.\n\nN'oubliez pas les requetes de compatibilite et d'accessoires. \"Protection ecran iPhone 15 Pro Max verre trempe\" est un mot-cl\u00e9 longue traine construit entierement a partir d'attributs de compatibilite produit. Pour les boutiques vendant des accessoires, pieces ou produits compatibles, ces requetes representent parmi le trafic le plus convertissant disponible.",
          tip: "Exportez votre flux produit et creez une matrice de mots-cl\u00e9s : type de produit en lignes, attributs en colonnes. Les intersections generent vos cibles de mots-cl\u00e9s longue traine. Une boutique avec 10 types de produits et 8 attributs par type peut generer plus de 80 variations de mots-cl\u00e9s par produit.",
        },
        {
          title: "Optimiser les pages produits sans créer du contenu mince",
          content:
            "Le defi de l'optimisation longue traine est d'eviter le contenu mince, des pages qui ciblent des mots-cl\u00e9s sp\u00e9cifiques mais manquent de substance pour se positionner. Les standards de qualit\u00e9 de Google exigent que chaque page apporte une valeur reelle, pas seulement des correspondances de mots-cl\u00e9s.\n\nLa solution est le contenu en couches. Commencez par une description produit unique (150-300 mots) qui incorpore naturellement vos mots-cl\u00e9s longue traine principaux et secondaires. Cela remplace le texte standard du fabricant que tous les autres revendeurs utilisent.\n\nAjoutez une section de specifications qui liste chaque attribut produit dans un format structure. Cela sert a la fois le SEO (chaque spec est un signal de mot-cl\u00e9) et l'exp\u00e9rience utilisateur (les acheteurs comparent les specs avant d'acheter). Utilisez un format de liste de definitions ou de tableau que les moteurs de recherche peuvent facilement analyser.\n\nIncluez une section cas d'usage (100-200 mots) qui repond a \"a qui s'adresse ce produit ?\" et \"quand devriez-vous l'utiliser ?\". Cela incorpore naturellement les modificateurs de cas d'usage (\"pour la randonnee\", \"pour les debutants\", \"pour usage professionnel\") qui generent du trafic longue traine.\n\nEnfin, le contenu genere par les utilisateurs, avis, sections Q&R et photos clients, ajoute du texte unique et riche en mots-cl\u00e9s a chaque page produit sans aucun effort de cr\u00e9ation de contenu de votre part. Une page produit avec plus de 20 avis a plus de texte indexable qu'une avec juste une description, et ce texte contient exactement le langage que les vrais acheteurs utilisent en cherchant. Pour en savoir plus sur l'optimisation de ces pages, consultez notre sujet sur le [SEO des pages produits](/academy/product-page-seo).",
          items: [
            ...
            "Activez les avis et Q&R pour generer automatiquement du contenu riche en mots-cl\u00e9s cree par les utilisateurs",
          ],
        },
        {
          title: "La stratégie d'empilement des revenus",
          content:
            "L'empilement des revenus signifie construire le trafic organique incrementalement, page produit par page produit, jusqu'a ce que le trafic longue traine cumulatif devienne votre plus grand canal de revenus. Plutot que de tout miser sur le positionnement pour un ou deux termes generiques competitifs, vous repartissez votre investissement SEO sur l'ensemble de votre catalogue.\n\nLe processus fonctionne par vagues. Premi\u00e8re vague : optimisez vos 50 meilleurs produits par chiffre d'affaires, ceux qui se vendent d\u00e9j\u00e0 bien. Redigez des descriptions uniques, ajoutez des specifications structurees, optimisez les titres et meta descriptions pour leurs mots-cl\u00e9s longue traine principaux. Cela prend generalement 2 a 4 semaines et produit des augmentations de trafic mesurables dans les 60-90 jours.\n\nDeuxieme vague : etendez a vos 100 produits suivants, en appliquant le meme mod\u00e8le. A ce stade, vous avez un format de contenu eprouve que vous pouvez industrialiser avec un r\u00e9dacteur ou une equipe de r\u00e9daction. Le cout par page diminue car le template est etabli.\n\nTroisieme vague et au-dela : parcourez votre catalogue restant par lots de 50-100 produits. A ce stade, l'effet cumulatif est visible, votre courbe de trafic organique global grimpe r\u00e9guli\u00e8rement, et l'attribution des revenus rend le cas ROI \u00e9vident.\n\nUne boutique d'ameublement avec laquelle nous avons travaille a suivi exactement ce processus sur 800 produits en six mois. La croissance mensuelle du chiffre d'affaires organique a atteint en moyenne 12%, et au huitieme mois, la recherche organique etait devenue leur deuxieme plus grand canal de revenus apr\u00e8s la publicite payante.",
        },
        {
          title: "Outils pour trouver des longues traines au niveau produit",
          content:
            "Google Search Console est le point de depart. Filtrez par pages contenant \"/product/\" ou votre mod\u00e8le d'URL produit. Le rapport des requetes montre exactement quels termes longue traine generent d\u00e9j\u00e0 des impressions sur vos pages produits. Beaucoup seront des termes auxquels vous n'aviez pas pense, du langage reel de vrais acheteurs.\n\nAhrefs et Semrush permettent tous deux d'analyser des URLs de pages produits individuelles. Entrez une URL de page produit et voyez pour quels mots-cl\u00e9s elle se positionne, pour lesquels elle pourrait se positionner avec optimisation, et quels mots-cl\u00e9s associes la page ne cible pas du tout. Leurs fonctions de suggestions de mots-cl\u00e9s generent egalement des idees longue traine a partir de vos termes de base.\n\nLes suggestions de recherche Amazon sont de l'or pur pour les longues traines au niveau produit. Tapez le nom de votre produit dans la barre de recherche Amazon et notez les suggestions d'autocompletion, elles proviennent de recherches reelles avec intention d'achat. Des outils comme Helium 10 et Jungle Scout aggregent ces donn\u00e9es a grande \u00e9chelle.\n\nLes termes de recherche Google Shopping (si vous utilisez Google Ads) fournissent une autre source riche. Ce sont les requetes exactes qui ont declenche vos annonces shopping, filtrees par intention d'achat par defaut. Exportez votre rapport de termes de recherche et exploitez-le pour des cibles de mots-cl\u00e9s organiques.\n\nVos propres donn\u00e9es de recherche interne completent le tableau. Les termes que les acheteurs tapent dans votre barre de recherche interne revelent la demande pour des attributs, variations et cas d'usage sp\u00e9cifiques que vous pouvez cibler avec l'optimisation de pages produits. Pour plus de techniques de recherche de mots-cl\u00c3\u00a9s, consultez notre guide sur les [mots-cl\u00c3\u00a9s SEO e-commerce](/blog/ecommerce-seo-keywords).",
          tip: "Mettez en place un workflow mensuel : extraire les donn\u00e9es de requetes GSC pour les pages produits, extraire les suggestions Amazon pour vos meilleures ventes, et examiner les journaux de recherche interne. Alimentez les resultats dans votre file d'optimisation. La regularite bat toujours les efforts ponctuels.",
          items: [
            "Rapport de requetes GSC filtre par URLs de pages produits, votre source de donn\u00e9es la plus precise",
            "Analyse d'URL individuelle Ahrefs/Semrush, trouver des mots-cl\u00e9s inexploites par page produit",
            "Suggestions d'autocompletion Amazon, donn\u00e9es de mots-cl\u00e9s a pure intention d'achat",
        ...
        },
        {
          ...
          content:
            "Les boutiques avec plus de 1 000 produits ne peuvent pas rediger du contenu personnalise pour chaque page du jour au lendemain. La cl\u00e9 est une approche par mod\u00e8les qui equilibre qualit\u00e9 et rapidite.\n\nCreez un mod\u00e8le de contenu de page produit pour chaque cat\u00e9gorie principale. Le mod\u00e8le definit quelles sections apparaissent sur la page, quels attributs sont mis en evidence et ou les mots-cl\u00e9s longue traine doivent etre incorpores. Un mod\u00e8le pour l'electronique pourrait mettre l'accent sur la compatibilite et les specs techniques, tandis qu'un pour l'habillement se concentre sur les tailles, materiaux et instructions d'entretien.\n\nUtilisez votre flux de donn\u00e9es produits pour auto-generer des portions du contenu. Les tableaux de specifications, les puces de caracteristiques principales et les avis de compatibilite peuvent tous etre construits a partir de donn\u00e9es produits structurees. Cela donne a chaque page une base de contenu riche en mots-cl\u00e9s sans r\u00e9daction manuelle.\n\nReservez la cr\u00e9ation de contenu manuel pour les pages les plus precieuses, vos 100-200 meilleurs produits par chiffre d'affaires. Ceux-ci recoivent des descriptions personnalisees, des sections de cas d'usage detaillees et un guide d'achat redige a la main. Le reste de votre catalogue recoit le traitement par mod\u00e8le, ce qui reste une am\u00e9lioration massive par rapport aux descriptions generiques du fabricant.\n\nSuivez les resultats au niveau du mod\u00e8le. Si un mod\u00e8le particulier produit systematiquement des pages qui se positionnent et convertissent, deployez-le plus agressivement. Si un mod\u00e8le sous-performe, affinez-le avant de l'appliquer a d'autres produits.",
        },
      ],
      navLabels: {
        previous: "Mots-cl\u00e9s produit vs. cat\u00e9gorie",
        next: "Analyse des mots-cl\u00e9s concurrents",
      },
    },
    es: {
      ...
      sections: [
        {
          ...
          content:
            "La mayoria de duenos de tiendas se fijan en un punado de palabras clave de alto volumen. Mientras tanto, la verdadera oportunidad de ingresos esta en el tr\u00e1fico agregado de cola larga. Veamos n\u00fameros realistas.\n\nUna tienda con 500 p\u00e1ginas de producto puede razonablemente apuntar a 2-5 palabras clave de cola larga por p\u00e1gina. Eso son 1.000-2.500 objetivos de palabras clave. Cada palabra clave de cola larga puede obtener solo 20-200 busquedas al mes, pero con un ranking en posiciones 1-3, puedes capturar el 15-30% de ese tr\u00e1fico. Y porque las busquedas de cola larga son altamente especificas, las tasas de conversion alcanzan el 4-8% comparado con 0,5-1% para terminos genericos.\n\nHaz los c\u00e1lculos: 1.500 palabras clave de cola larga promediando 80 busquedas al mes, con una tasa de clic del 20% en posiciones 1-3, produce 24.000 visitas mensuales. Con una tasa de conversion del 5% y un valor medio de pedido de 75 EUR, son 90.000 EUR en ingresos mensuales, de terminos que la mayoria de competidores ignoran completamente.\n\nEl efecto compuesto es lo que hace poderosa esta estrategia. Cada nueva p\u00e1gina de producto que anades captura m\u00e1s terminos de cola larga. A medida que crece tu autoridad de dominio, esas p\u00e1ginas posicionan m\u00e1s r\u00e1pido y para m\u00e1s variaciones. Una tienda que sistematicamente optimiza p\u00e1ginas de producto para palabras clave de cola larga construye un activo de tr\u00e1fico organico que los competidores no pueden replicar facilmente. Nuestra guia m\u00e1s amplia de [investigaci\u00f3n de palabras clave para ecommerce](/academy/keyword-research-for-ecommerce) explica como construir esta base.",
          items: [
            "Apunta a 2-5 palabras clave de cola larga por p\u00e1gina de producto en todo tu cat\u00e1logo",
            "Las tasas de conversion de cola larga tipicamente alcanzan 4-8%, versus 0,5-1% para terminos genericos",
            "500 p\u00e1ginas de producto bien optimizadas pueden generar 20.000-30.000 visitas organicas mensuales",
            "Cada nueva p\u00e1gina de producto compone el efecto de cola larga, construyendo un activo de tr\u00e1fico duradero",
          ],
          image: {
        ...
        },
        {
          ...
          content:
            "Tus datos de producto son una mina de oro de palabras clave de cola larga a la vista. Cada atributo, talla, color, material, peso, compatibilidad, caso de uso, se combina con el tipo de producto para crear una consulta buscable.\n\nToma un producto como un saco de dormir para camping. La palabra clave base es \"saco de dormir camping\" (alto volumen, competencia feroz). Pero los atributos generan docenas de terminos de cola larga: \"saco de dormir 3 estaciones temperatura confort 0 grados\", \"saco de dormir momia ultraligero menos de 1 kg\", \"saco de dormir ancho para personas que duermen de lado\", \"saco de dormir de plumon comprimible para trekking\". Cada uno de estos terminos tiene menor volumen pero intenci\u00f3n de compra drasticamente mayor.\n\nEl enfoque sistematico: exporta tus datos de producto con todos los atributos a una hoja de c\u00e1lculo. Crea formulas de palabras clave que combinen tipo de producto + atributo 1, tipo de producto + atributo 1 + atributo 2, y as\u00ed sucesivamente. Luego valida contra el volumen de busqueda real usando Ahrefs, Semrush o Google Keyword Planner.\n\nNo pases por alto las consultas de compatibilidad y accesorios. \"Protector de pantalla iPhone 15 Pro Max cristal templado\" es una palabra clave de cola larga construida completamente a partir de atributos de compatibilidad del producto. Para tiendas que venden accesorios, repuestos o productos compatibles, estas consultas representan parte del tr\u00e1fico con mayor conversion disponible.",
          tip: "Exporta tu feed de productos y crea una matriz de palabras clave: tipo de producto en filas, atributos en columnas. Las intersecciones generan tus objetivos de palabras clave de cola larga. Una tienda con 10 tipos de producto y 8 atributos por tipo puede generar m\u00e1s de 80 variaciones de palabras clave por producto.",
        },
        {
          title: "Optimizar páginas de producto sin crear contenido delgado",
          content:
            "El desafio con la optimizaci\u00f3n de cola larga es evitar contenido delgado, p\u00e1ginas que apuntan a palabras clave especificas pero carecen de suficiente sustancia para posicionar. Los est\u00e1ndares de calidad de Google exigen que cada p\u00e1gina proporcione valor genuino, no solo coincidencias de palabras clave.\n\nLa solucion es contenido por capas. Empieza con una descripcion de producto unica (150-300 palabras) que incorpore naturalmente tus palabras clave de cola larga primarias y secundarias. Esto reemplaza el texto est\u00e1ndar del fabricante que todos los demas minoristas usan.\n\nAnade una seccion de especificaciones que liste cada atributo del producto en formato estructurado. Esto sirve tanto al SEO (cada especificacion es una senal de palabra clave) como a la experiencia de usuario (los compradores comparan especificaciones antes de comprar). Usa un formato de lista de definiciones o tabla que los motores de busqueda puedan analizar facilmente.\n\nIncluye una seccion de caso de uso (100-200 palabras) que responda \"para quien es este producto?\" y \"cuando deberia usarse?\". Esto incorpora naturalmente modificadores de caso de uso (\"para senderismo\", \"para principiantes\", \"para uso profesional\") que generan tr\u00e1fico de cola larga.\n\nFinalmente, el contenido generado por usuarios, resenas, secciones de preguntas y respuestas, y fotos de clientes, anade texto unico y rico en palabras clave a cada [p\u00e1gina de producto](/academy/product-page-seo) sin ningun esfuerzo de creaci\u00f3n de contenido de tu parte. Una p\u00e1gina de producto con m\u00e1s de 20 resenas tiene m\u00e1s texto indexable que una con solo descripcion, y ese texto incluye exactamente el lenguaje que los compradores reales usan al buscar.",
          items: [
            ...
            "Habilita resenas y preguntas y respuestas para generar autom\u00e1ticamente contenido rico en palabras clave creado por usuarios",
          ],
        },
        {
          title: "La estrategia de apilamiento de ingresos",
          content:
            "El apilamiento de ingresos significa construir tr\u00e1fico organico incrementalmente, p\u00e1gina de producto por p\u00e1gina de producto, hasta que el tr\u00e1fico acumulado de cola larga se convierta en tu mayor canal de ingresos. En lugar de apostar todo a posicionar uno o dos terminos genericos competitivos, distribuyes tu inversion SEO en todo tu cat\u00e1logo.\n\nEl proceso funciona en oleadas. Primera oleada: optimiza tus 50 mejores productos por ingresos, los que ya se venden bien. Escribe descripciones unicas, anade especificaciones estructuradas, optimiza t\u00edtulos y meta descripciones para sus palabras clave de cola larga principales. Esto suele llevar 2-4 semanas y produce incrementos de tr\u00e1fico medibles dentro de 60-90 dias.\n\nSegunda oleada: expande a tus siguientes 100 productos, aplicando la misma plantilla. A este punto, tendras un formato de contenido probado que puedes escalar con un redactor o equipo de redaccion. El coste por p\u00e1gina baja porque la plantilla esta establecida.\n\nTercera oleada y m\u00e1s alla: trabaja tu cat\u00e1logo restante en lotes de 50-100 productos. Para este momento, el efecto acumulativo es visible, tu curva de tr\u00e1fico organico general esta subiendo constantemente, y la atribucion de ingresos hace evidente el caso de ROI.\n\nUna tienda de art\u00edculos para el hogar con la que trabajamos siguio exactamente este proceso en 800 productos durante seis meses. El crecimiento mensual de ingresos organicos promedio el 12%, y para el octavo mes, la busqueda organica se habia convertido en su segundo mayor canal de ingresos detras de la publicidad de pago.",
        },
        {
          title: "Herramientas para encontrar colas largas a nivel de producto",
          content:
            "Google Search Console es el punto de partida. Filtra por p\u00e1ginas que contengan \"/product/\" o tu patr\u00f3n de URL de producto. El informe de consultas muestra exactamente que terminos de cola larga ya generan impresiones en tus p\u00e1ginas de producto. Muchos seran terminos que no habias considerado, lenguaje real de compradores reales.\n\nAhrefs y Semrush permiten analizar URLs de p\u00e1ginas de producto individuales. Introduce una URL de p\u00e1gina de producto y ve para que palabras clave posiciona, para cuales podria posicionar con optimizaci\u00f3n, y que palabras clave relacionadas la p\u00e1gina no cubre en absoluto. Sus funciones de sugerencia de palabras clave tambi\u00e9n generan ideas de cola larga a partir de tus terminos semilla.\n\nLas sugerencias de busqueda de Amazon son oro puro para colas largas a nivel de producto. Escribe el nombre de tu producto en la barra de busqueda de Amazon y anota las sugerencias de autocompletado, provienen de busquedas reales con intenci\u00f3n de compra. Herramientas como Helium 10 y Jungle Scout agregan estos datos a escala.\n\nLos terminos de busqueda de Google Shopping (si ejecutas Google Ads) proporcionan otra fuente rica. Son las consultas exactas que activaron tus anuncios de shopping, filtradas por intenci\u00f3n de compra por defecto. Exporta tu informe de terminos de busqueda y aprovechalo para objetivos de palabras clave organicas.\n\nTus propios datos de busqueda interna completan el panorama. Los terminos que los compradores escriben en tu barra de busqueda interna revelan demanda de atributos, variaciones y casos de uso especificos que puedes cubrir con la optimizaci\u00f3n de p\u00e1ginas de producto. Para m\u00e1s t\u00e9cnicas de busqueda de palabras clave, consulta nuestra guia de [palabras clave SEO para ecommerce](/blog/ecommerce-seo-keywords).",
          tip: "Establece un flujo de trabajo mensual: extraer datos de consultas GSC para p\u00e1ginas de producto, extraer sugerencias de Amazon para tus productos m\u00e1s vendidos y revisar los registros de busqueda interna. Alimenta los resultados en tu cola de optimizaci\u00f3n. La consistencia supera a los esfuerzos puntuales siempre.",
          items: [
            "Informe de consultas GSC filtrado por URLs de p\u00e1ginas de producto, tu fuente de datos m\u00e1s precisa",
            "An\u00e1lisis de URL individual Ahrefs/Semrush, encontrar palabras clave sin explotar por p\u00e1gina de producto",
            "Sugerencias de autocompletado de Amazon, datos de palabras clave con pura intenci\u00f3n de compra",
            "Terminos de busqueda de Google Shopping, consultas filtradas por intenci\u00f3n de compra",
        ...
        },
        {
          ...
          content:
            "Tiendas con m\u00e1s de 1.000 productos no pueden escribir contenido personalizado para cada p\u00e1gina de la noche a la manana. La clave es un enfoque basado en plantillas que equilibre calidad con velocidad.\n\nCrea una plantilla de contenido de p\u00e1gina de producto para cada categor\u00eda principal. La plantilla define que secciones aparecen en la p\u00e1gina, que atributos se destacan prominentemente y donde deben incorporarse las palabras clave de cola larga. Una plantilla para electr\u00f3nica podria enfatizar compatibilidad y especificaciones t\u00e9cnicas, mientras que una para ropa se centra en tallas, materiales e instrucciones de cuidado.\n\nUsa tu feed de datos de producto para auto-generar porciones del contenido. Tablas de especificaciones, puntos de caracteristicas clave y avisos de compatibilidad pueden construirse a partir de datos de producto estructurados. Esto da a cada p\u00e1gina una base de contenido rico en palabras clave sin escritura manual.\n\nReserva la creaci\u00f3n de contenido manual para las p\u00e1ginas de mayor valor, tus 100-200 mejores productos por ingresos. Estos reciben descripciones personalizadas, secciones detalladas de casos de uso y guias de compra escritas a mano. El resto de tu cat\u00e1logo recibe el tratamiento de plantilla, que sigue siendo una mejora masiva respecto a las descripciones genericas del fabricante.\n\nHaz seguimiento de resultados a nivel de plantilla. Si una plantilla particular produce consistentemente p\u00e1ginas que posicionan y convierten, desplegala m\u00e1s agresivamente. Si una plantilla rinde por debajo, refinala antes de aplicarla a m\u00e1s productos.",
        },
      ],
      navLabels: {
        previous: "Palabras clave de producto vs. categor\u00eda",
        next: "An\u00e1lisis de palabras clave de competidores",
      },
    },
    it: {
