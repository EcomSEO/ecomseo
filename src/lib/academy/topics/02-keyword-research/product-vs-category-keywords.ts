...
export const productVsCategoryKeywords: AcademyTopic = {
  ...
  content: {
    ...
    fr: {
      ...
      intro: "Decider si un mot-cl\u00e9 doit \u00c3\u00aatre cible par une page produit ou une page cat\u00c3\u00a9gorie est l'un des choix SEO les plus determinants pour toute boutique en ligne. Une erreur, et vos pages se font concurrence entre elles au lieu de concurrencer vos rivaux.",
      ...
      navLabels: {
        ...
        next: "Mots-cl\u00e9s longue traine pour les produits",
      },
    },
    es: {
      badge: "Investigaci\u00f3n de palabras clave",
      heading: "Palabras clave de producto vs. categoría",
      intro: "Decidir si apuntar a una palabra clave con una p\u00c3\u00a1gina de producto o una p\u00c3\u00a1gina de categor\u00c3\u00ada es una de las decisiones SEO m\u00e1s trascendentales para cualquier tienda online. Si te equivocas, tus p\u00c3\u00a1ginas compiten entre si en lugar de contra los competidores.",
      ...
      navLabels: {
        previous: "Intenci\u00f3n de compra vs. volumen de busqueda",
