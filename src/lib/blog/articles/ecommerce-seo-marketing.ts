...
export const ecommerceSeoMarketing: BlogArticle = {
  ...
  primaryKeyword: "ecommerce seo marketing",
  secondaryKeywords: [
    "seo marketing for ecommerce",
    "ecommerce marketing seo",
    "seo and marketing for online stores",
  ],
  sections: [
    {
      heading: "SEO does not work in a silo",
      body: [
    ...
    {
      heading: "SEO and PPC synergies that save money",
      body: [
    ...
    {
      heading: "Using paid data to inform SEO strategy",
      body: [
    ...
    {
      heading: "Building a cross-channel marketing strategy",
      body: [
    ...
    },
    {
      ...
      body: [
        ...
        "Start small. You do not need to overhaul your entire marketing operation overnight. Pick one integration point and execute it well. Use PPC keyword data to inform your next quarter's SEO content plan. Or create one piece of content that gets promoted across email, social, and organic. Measure the results. Then add another integration point. After 6 months of this incremental approach, you will have a genuinely integrated marketing operation without the disruption of a top-down restructuring. Our [ecommerce SEO strategy guide](/blog/ecommerce-seo-strategy) provides the overarching framework that ties all these integration points together.",
      ],
    },
  ],
};
