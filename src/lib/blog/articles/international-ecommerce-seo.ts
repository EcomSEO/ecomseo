  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "We build separate keyword maps for each market, even when the products are identical. The investment in market-specific keyword research pays for itself many times over compared to the alternative of ranking for translated terms that nobody actually searches for.",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        "International ecommerce SEO takes patience, investment in local content, and consistent technical maintenance. But for stores that execute it properly, each new market becomes an additional source of organic revenue that compounds as your international authority grows.",
      ],
    },
  ],
};
