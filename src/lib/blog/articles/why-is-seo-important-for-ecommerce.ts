    ...
    fr: {
      ...
      sections: [
        ...
        },
        {
          ...
          image: { src: "/images/blog/fr/seo-when-not-priority.svg", alt: "Decision framework showing when to prioritize other channels versus when SEO should be a top priority for ecommerce stores", caption: "Use paid ads for immediate revenue while investing in SEO simultaneously for long-term compounding." },
        },
      ],
    },
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          image: { src: "/images/blog/es/seo-when-not-priority.svg", alt: "Decision framework showing when to prioritize other channels versus when SEO should be a top priority for ecommerce stores", caption: "Use paid ads for immediate revenue while investing in SEO simultaneously for long-term compounding." },
        },
      ],
    },
  },
