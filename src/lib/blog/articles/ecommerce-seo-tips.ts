  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "The most important ecommerce SEO advice we can give is this: start. Imperfect action beats perfect planning. Pick three tips from this list, implement them this week, and measure the results. That first step matters more than having the perfect strategy on paper. When you are ready to go deeper, our [ecommerce SEO strategy guide](/blog/ecommerce-seo-strategy) lays out a full roadmap."
      ],
    },
  ],
};
