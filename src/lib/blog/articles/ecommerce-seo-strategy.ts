...
export const ecommerceSeoStrategy: BlogArticle = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "[Keyword research for ecommerce](/blog/ecommerce-seo-keywords) is not just about finding high-volume terms. It is about understanding where each keyword sits in the buyer journey and matching it to the right page type.",
