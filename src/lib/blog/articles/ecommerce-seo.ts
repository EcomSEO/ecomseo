  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "[Off-page SEO](/blog/off-page-seo-for-ecommerce) for ecommerce is primarily about building domain authority through backlinks and digital PR. Product pages rarely attract natural links. You need linkable assets, supplier relationships, and sometimes creative PR campaigns to build the authority that lifts your entire store in the rankings."
      ],
    },
    {
