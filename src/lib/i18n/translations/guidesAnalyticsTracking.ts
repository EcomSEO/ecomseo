...
> = {
  ...
  fr: {
    ...
    heading: "Analytics & Tracking",
    intro:
      "Chaque d\u00e9cision SEO ne vaut que par les donn\u00e9es qui la soutiennent. Avant de faire de la recherche de mots-cl\u00e9s, d\u2019optimiser des balises title ou de faire du netlinking, il vous faut une base de donn\u00e9es fiable. Ce guide couvre les deux outils indispensables pour toute boutique en ligne (GA4 et Google Search Console) et comment les connecter pour que vos d\u00e9cisions SEO reposent sur des chiffres r\u00e9els.",
  ...
  nl: {
    ...
    heading: "Analytics & Tracking",
    intro:
      "Elke SEO-beslissing is maar zo goed als de data erachter. Voordat je zoekwoordenonderzoek doet, title-tags aanpast of links bouwt, heb je een betrouwbare databasis nodig. Deze gids behandelt de twee tools die elke webshop nodig heeft (GA4 en Google Search Console) en hoe je ze verbindt zodat je SEO-beslissingen gebaseerd zijn op echte cijfers.",
      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: "Eenmaal gekoppeld zie je organische zoekopdrachten direct in GA4 onder Rapporten > Acquisitie > Search Console. Nog belangrijker: je kunt aangepaste rapporten maken die zoekopdrachten koppelen aan omzet. Zo weet je welke zoekwoorden je echt geld opleveren, niet alleen verkeer.",
          },
        ],
      },
      {
