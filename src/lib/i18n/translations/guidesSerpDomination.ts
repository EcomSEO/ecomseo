    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Google Shopping results appear at the top of the page for product queries and drive significant purchase-intent traffic. There are two routes in: paid Shopping campaigns (Performance Max) and free organic product listings in the Shopping tab. Both require a product feed submitted via Google Merchant Center.",
          },
          {
            type: "p",
            text: "For organic Shopping results, the quality of your product feed is everything. Google pulls Product schema from your pages as a secondary signal, but the Merchant Center feed takes priority. Make sure every product has: a clear, descriptive title (include brand, product name, key attribute, and size/color if relevant), accurate price and availability, GTIN or MPN if available, and high-resolution images. Feeds with errors get suppressed — run your Merchant Center diagnostics monthly.",
          },
          {
            type: "checklist",
            items: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "tip",
            text: "Use Google Search Console to find queries where you rank in positions 5-15 and the SERP shows a featured snippet. These are your best opportunities — you're close enough to rank, and the snippet is already available. Reformat those pages to match snippet structure.",
          },
          {
            type: "callout",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Alt text: include the product name and one key attribute — 'Solid oak dining table 180cm, natural finish'. Don't keyword-stuff",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Google Shopping-Ergebnisse erscheinen ganz oben auf der Seite bei Produktanfragen und generieren erheblichen Traffic mit Kaufabsicht. Es gibt zwei Wege hinein: bezahlte Shopping-Kampagnen (Performance Max) und kostenlose organische Produktlistings im Shopping-Tab. Beide erfordern einen Produktfeed, der über Google Merchant Center eingereicht wird.",
          },
          {
            type: "p",
            text: "Für organische Shopping-Ergebnisse ist die Qualität deines Produktfeeds entscheidend. Google zieht Product-Schema von deinen Seiten als sekundäres Signal heran, aber der Merchant Center-Feed hat Priorität. Stelle sicher, dass jedes Produkt folgendes hat: einen klaren, beschreibenden Titel (Marke, Produktname, Hauptattribut und Größe/Farbe wenn relevant), genauen Preis und Verfügbarkeit, GTIN oder MPN wenn verfügbar, und hochauflösende Bilder. Feeds mit Fehlern werden unterdrückt — führe monatlich Merchant Center-Diagnosen durch.",
          },
          {
            type: "checklist",
            items: [
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Alt-Text: Füge den Produktnamen und ein Hauptattribut ein — 'Massiver Eichen-Esstisch 180cm, Naturfinish'. Kein Keyword-Stuffing",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Les résultats Google Shopping apparaissent en haut de page pour les requêtes produits et génèrent un trafic significatif à forte intention d'achat. Deux voies d'accès existent : les campagnes Shopping payantes (Performance Max) et les listes de produits organiques gratuites dans l'onglet Shopping. Les deux nécessitent un flux produit soumis via Google Merchant Center.",
          },
          {
            type: "p",
            text: "Pour les résultats Shopping organiques, la qualité de votre flux produit est primordiale. Google tire le schema Product de vos pages comme signal secondaire, mais le flux Merchant Center est prioritaire. Assurez-vous que chaque produit dispose de : un titre clair et descriptif (marque, nom du produit, attribut clé, et taille/couleur si pertinent), un prix et une disponibilité exacts, un GTIN ou MPN si disponible, et des images haute résolution. Les flux avec des erreurs sont supprimés — effectuez des diagnostics Merchant Center mensuellement.",
          },
          {
            type: "checklist",
            items: [
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Texte alternatif : incluez le nom du produit et un attribut clé — 'Table à manger en chêne massif 180cm, finition naturelle'. Pas de bourrage de mots-clés",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Los resultados de Google Shopping aparecen en la parte superior de la página para consultas de productos y generan un tráfico significativo con intención de compra. Hay dos vías de entrada: campañas de Shopping de pago (Performance Max) y listados de productos orgánicos gratuitos en la pestaña de Shopping. Ambas requieren un feed de productos enviado a través de Google Merchant Center.",
          },
          {
            type: "p",
            text: "Para los resultados de Shopping orgánico, la calidad de tu feed de productos lo es todo. Google extrae el schema de Product de tus páginas como señal secundaria, pero el feed de Merchant Center tiene prioridad. Asegúrate de que cada producto tenga: un título claro y descriptivo (incluye marca, nombre del producto, atributo clave y talla/color si es relevante), precio y disponibilidad precisos, GTIN o MPN si está disponible, e imágenes de alta resolución. Los feeds con errores quedan suprimidos — ejecuta los diagnósticos de Merchant Center mensualmente.",
          },
          {
            type: "checklist",
            items: [
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Texto alternativo: incluye el nombre del producto y un atributo clave — 'Mesa de comedor de roble macizo 180cm, acabado natural'. Sin keyword stuffing",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Testo alternativo: includi il nome del prodotto e un attributo chiave — 'Tavolo da pranzo in quercia massiccia 180cm, finitura naturale'. No keyword stuffing",
