  ...
  en: {
    ...
    articles: [
      ...
      },
      {
        ...
        description: "A comprehensive look at our SEO solutions for ecommerce brands.",
      },
    ],
  },
  de: {
    ...
    articles: [
      ...
      {
        title: "EcomSEO Lösungen im Überblick",
        description: "Ein umfassender Blick auf unsere SEO-Lösungen für E-Commerce-Marken.",
      },
    ],
  },
  fr: {
    ...
    articles: [
      ...
      {
        title: "Apercu des solutions EcomSEO",
        description: "Un regard complet sur nos solutions SEO pour les marques e-commerce.",
      },
    ],
  },
  es: {
    ...
    articles: [
      ...
      {
        title: "Resumen de las soluciones de EcomSEO",
        description: "Una vision completa de nuestras soluciones SEO para marcas e-commerce.",
      },
    ],
  },
  it: {
    ...
    articles: [
      ...
      {
        title: "Panoramica delle soluzioni EcomSEO",
        description: "Uno sguardo completo alle nostre soluzioni SEO per i brand e-commerce.",
      },
    ],
  },
  nl: {
    ...
    articles: [
      ...
      {
        title: "Overzicht van EcomSEO-oplossingen",
        description: "Een uitgebreid overzicht van onze SEO-oplossingen voor e-commercemerken.",
      },
    ],
  },
};
