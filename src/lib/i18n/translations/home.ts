...
export const processT: Record<Locale, {
  ...
  en: {
    ...
    steps: [
      ...
      { number: "02", title: "Proven Process", description: "SEO sensei\u2019s like us know exactly what we\u2019re doing. Because we\u2019ve done it before. For many brands." },
      { number: "03", title: "Profit-Focused", description: "Revenue is nice. Profit is nicer. We focus on high ROI tasks. No time for bs." },
    ],
  },
  de: {
    badge: "Prozess",
    ...
    steps: [
      ...
      { number: "02", title: "Bewährter Prozess", description: "SEO-Experten wie wir wissen genau, was wir tun. Weil wir es schon gemacht haben. Für viele Marken." },
      { number: "03", title: "Gewinnorientiert", description: "Umsatz ist schön. Gewinn ist schöner. Wir fokussieren uns auf Aufgaben mit hohem ROI. Keine Zeit für Unsinn." },
    ],
  },
  fr: {
    badge: "Processus",
    ...
    steps: [
      ...
      { number: "02", title: "Processus éprouvé", description: "Des experts SEO comme nous savent exactement ce que nous faisons. Parce que nous l\u2019avons déjà fait. Pour de nombreuses marques." },
      { number: "03", title: "Axé sur le profit", description: "Le chiffre d\u2019affaires c\u2019est bien. Le profit c\u2019est mieux. Nous nous concentrons sur les tâches à fort ROI. Pas de temps pour le superflu." },
    ],
  },
  es: {
    badge: "Proceso",
    ...
    steps: [
      ...
      { number: "02", title: "Proceso probado", description: "Expertos en SEO como nosotros sabemos exactamente lo que hacemos. Porque ya lo hemos hecho antes. Para muchas marcas." },
      { number: "03", title: "Enfocados en el beneficio", description: "Los ingresos están bien. El beneficio está mejor. Nos enfocamos en tareas de alto ROI. Sin tiempo para tonterías." },
    ],
  },
  it: {
    badge: "Processo",
    ...
    steps: [
      ...
      { number: "02", title: "Processo collaudato", description: "Esperti SEO come noi sanno esattamente cosa stanno facendo. Perché lo abbiamo già fatto prima. Per molti brand." },
      { number: "03", title: "Orientato al profitto", description: "Il fatturato è buono. Il profitto è meglio. Ci concentriamo su attività ad alto ROI. Niente tempo per sciocchezze." },
    ],
  },
  nl: {
    badge: "Proces",
    ...
    steps: [
      ...
      { number: "02", title: "Bewezen proces", description: "SEO-experts zoals wij weten precies wat we doen. Omdat we het eerder hebben gedaan. Voor veel merken." },
      { number: "03", title: "Winstgericht", description: "Omzet is fijn. Winst is fijner. We focussen op taken met hoge ROI. Geen tijd voor onzin." },
    ],
  },
};
