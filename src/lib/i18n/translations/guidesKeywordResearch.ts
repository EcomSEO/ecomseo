  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Every page on your site needs a primary keyword and two to four secondary keywords. We build a spreadsheet that maps each URL to its assigned keywords, search volume, current ranking position, and target position. This prevents keyword cannibalization, which is when two or more pages on your site compete for the same term and end up splitting authority so neither ranks well.\n\nCheck for existing cannibalization in Google Search Console by filtering for a keyword and looking at which URLs appear. If you see two or more URLs swapping in and out of results for the same query, that's cannibalization. The fix is usually consolidating content into one page, adding a canonical tag, or adjusting the keyword targeting so each page has a distinct focus. Your keyword map is a living document. Update it monthly as rankings change and new opportunities appear.",
      },
    ],
    navLabels: {
      previous: "Previous",
  ...
  it: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Le pagine categoria sono dove si genera il vero fatturato nella SEO e-commerce. Le pagine prodotto puntano su query long-tail specifiche, ma le pagine categoria possono posizionarsi per termini mid-funnel come \"stivali in pelle uomo,\" \"cibo biologico per cani\" o \"cuffie wireless con cancellazione del rumore.\" Sono keyword ad alto volume e alta intenzione d'acquisto che generano fatturato costante mese dopo mese. Abbiamo visto singole pagine categoria generare oltre 30.000 euro al mese di fatturato organico quando sono ottimizzate correttamente con contenuti di supporto, link interni e dati strutturati.\n\nL'errore che fa la maggior parte dei negozi e trattare le pagine categoria come pagine sottili con nient'altro che una griglia di prodotti. Google vuole contenuto su queste pagine. Un'introduzione di 200 parole che includa naturalmente keyword correlate, una sezione FAQ in fondo, opzioni di filtro che generano URL indicizzabili per le sottocategorie. Tutto questo aiuta una singola pagina categoria a posizionarsi per centinaia di termini di ricerca correlati invece di uno solo.",
      },
      {
  ...
  nl: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Categoriepagina's zijn waar het echte geld zit in e-commerce SEO. Productpagina's richten zich op specifieke long-tail zoekopdrachten, maar categoriepagina's kunnen ranken op mid-funnel termen zoals \"leren herenlaarzen,\" \"biologisch hondenvoer\" of \"draadloze noise-cancelling koptelefoons.\" Dit zijn zoekwoorden met hoog volume en hoge koopintentie die maand na maand consistent omzet opleveren. We hebben gezien dat individuele categoriepagina's meer dan 30.000 euro per maand aan organische omzet genereren wanneer ze goed geoptimaliseerd zijn met ondersteunende content, interne links en gestructureerde data.\n\nDe fout die de meeste shops maken is categoriepagina's behandelen als dunne overzichtspagina's met niets anders dan een productraster. Google wil content op deze pagina's. Een introductie van 200 woorden die op een natuurlijke manier gerelateerde zoekwoorden bevat, een FAQ-sectie onderaan, filteropties die indexeerbare URL's genereren voor subcategorieen. Dit alles helpt een enkele categoriepagina om te ranken voor honderden gerelateerde zoektermen in plaats van slechts een.",
      },
      {
