  ...
  en: {
    ...
    faqs: {
      items: [
        ...
        {
          question: "Can you help with international consumables SEO?",
          answer:
    ...
    sections: [
      {
        ...
        benefits: [
          ...
          },
          {
            ...
            description:
              "Les consommables ont des fen\u00eatres de r\u00e9achat naturelles. Nous alignons contenu et strat\u00e9gie SEO sur les cycles de rachat pour maximiser la fid\u00e9lisation.",
          },
        ],
      },
      {
