...
export const fashionSeoData: Record<Locale, ServicePageProps> = {
      ...
      items: [
        {
          ...
          answer:
            "Ja. Wir arbeiten ausschlie\u00dflich mit E-Commerce-Marken, und Mode ist eine unserer Kernbranchen. Wir verstehen saisonale Sortimentszyklen, Variantenmanagement und die visuelle Natur der Modesuche.",
        },
        {
          question: "Wie handhaben Sie saisonalen Content f\u00fcr Modemarken?",
          answer:
            "Wir planen Content 3\u20136 Monate vor jeder Saison. Kollektionsseiten, Trend-Guides und Style-Content werden vorbereitet und optimiert, bevor die Suchnachfrage ihren H\u00f6hepunkt erreicht \u2014 so ranken Sie bereits, wenn K\u00e4ufer mit der Suche beginnen.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Wir implementieren korrekte Kanonisierung f\u00fcr Gr\u00f6\u00dfen- und Farbvarianten, verwalten URL-Parameter und stellen sicher, dass Google sich auf Ihre Hauptproduktseiten konzentriert, anstatt Crawl-Budget f\u00fcr Varianten-URLs zu verschwenden.",
        },
        {
  ...
  fr: {
    ...
    faqs: {
      items: [
        { question: "\u00cates-vous sp\u00e9cialis\u00e9 dans le e-commerce mode ?", answer: "Oui. Nous travaillons exclusivement avec des marques e-commerce, et la mode est l\u2019une de nos verticales principales. Nous comprenons les cycles de stock saisonniers, la gestion des variantes et la nature visuelle de la recherche mode." },
        { question: "Comment g\u00e9rez-vous le contenu saisonnier pour les marques de mode ?", answer: "Nous planifions le contenu 3 \u00e0 6 mois avant chaque saison. Les pages de collection, les guides de tendances et le contenu de style sont pr\u00e9par\u00e9s et optimis\u00e9s avant que la demande de recherche n\u2019atteigne son pic \u2014 vous \u00eates d\u00e9j\u00e0 positionn\u00e9 quand les acheteurs commencent \u00e0 chercher." },
  ...
  es: {
    ...
    faqs: {
      items: [
        { question: "\u00bfSe especializan en e-commerce de moda?", answer: "S\u00ed. Trabajamos exclusivamente con marcas de e-commerce, y la moda es una de nuestras verticales principales. Entendemos los ciclos de inventario estacionales, la gesti\u00f3n de variantes y la naturaleza visual de la b\u00fasqueda de moda." },
        { question: "\u00bfC\u00f3mo gestionan el contenido estacional para marcas de moda?", answer: "Planificamos el contenido con 3 a 6 meses de antelaci\u00f3n a cada temporada. Las p\u00e1ginas de colecci\u00f3n, gu\u00edas de tendencias y contenido de estilo est\u00e1n preparados y optimizados antes de que la demanda alcance su pico \u2014 ya est\u00e1s posicionado cuando los compradores empiezan a buscar." },
  ...
  it: {
    ...
    faqs: {
      items: [
        { question: "Siete specializzati nell\u2019e-commerce di moda?", answer: "S\u00ec. Lavoriamo esclusivamente con brand e-commerce, e la moda \u00e8 una delle nostre verticali principali. Comprendiamo i cicli di inventario stagionali, la gestione delle varianti e la natura visiva della ricerca moda." },
        { question: "Come gestite i contenuti stagionali per i brand di moda?", answer: "Pianifichiamo i contenuti da 3 a 6 mesi prima di ogni stagione. Le pagine di collezione, le guide sulle tendenze e i contenuti di stile sono preparati e ottimizzati prima che la domanda di ricerca raggiunga il picco \u2014 cos\u00ec siete gi\u00e0 posizionati quando gli acquirenti iniziano a cercare." },
  ...
  nl: {
    ...
    faqs: {
      items: [
        { question: "Zijn jullie gespecialiseerd in mode-e-commerce?", answer: "Ja. Wij werken uitsluitend met e-commercemerken, en mode is een van onze kernverticalen. Wij begrijpen seizoensgebonden voorraadcycli, variantbeheer en het visuele karakter van modezoekgedrag." },
        { question: "Hoe gaan jullie om met seizoenscontent voor modemerken?", answer: "Wij plannen content 3 tot 6 maanden voor elk seizoen. Collectiepagina\u2019s, trendgidsen en stijlcontent worden voorbereid en geoptimaliseerd v\u00f3\u00f3r de zoekvraag piekt \u2014 zodat je al rankt wanneer shoppers beginnen te zoeken." },
        ...
        { question: "Hoe gaan jullie om met productvarianten in SEO?", answer: "Wij implementeren correcte canonicalisatie voor maat- en kleurvarianten, beheren URL-parameters en zorgen ervoor dat Google zich richt op je hoofdproductpagina\u2019s in plaats van crawlbudget te verspillen aan variant-URL\u2019s." },
