...
export const amazonSeoData: Record<Locale, ServicePageProps> = {
  ...
  de: {
    ...
    sections: [
      {
        ...
        heading: "Alles, was Sie brauchen, um die Amazon-Suche zu dominieren",
        benefits: [
          {
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Listing-Audits",
            description: "Vollst\u00e4ndige Katalogpr\u00fcfung mit Optimierungspriorit\u00e4ten",
          },
          {
            title: "Keyword-Reports",
            description: "Suchbegriff-Recherche und Ranking-Tracking",
          },
          {
            title: "Content-Updates",
            description: "Listing-\u00dcberarbeitungen und A+-Content-Beratung",
          },
          {
            title: "Performance-Berichte",
            description: "Monatliche Impressionen, Klicks und Umsatzdaten",
          },
        ],
      },
    ],
    faqs: {
      ...
      miniCta: {
        heading: "Bereit, die Amazon-Suche zu dominieren?",
        subtitle:
  ...
  fr: {
    ...
    sections: [
      {
        ...
        heading: "Tout ce dont vous avez besoin pour dominer la recherche Amazon",
        benefits: [
          {
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Audits de fiches",
            description: "Revue compl\u00e8te du catalogue avec priorit\u00e9s d\u2019optimisation",
          },
          {
            title: "Rapports de mots-cl\u00e9s",
            description: "Recherche de termes de recherche et suivi des classements",
          },
          {
            title: "Mises \u00e0 jour de contenu",
            description: "R\u00e9\u00e9criture des fiches et accompagnement contenu A+",
          },
          {
            title: "Rapports de performance",
            description: "Impressions, clics et donn\u00e9es de revenus mensuels",
          },
        ],
      },
    ],
    faqs: {
      ...
      miniCta: {
        heading: "Pr\u00eat \u00e0 dominer la recherche Amazon ?",
        subtitle:
  ...
  es: {
    ...
    sections: [
      {
        ...
        heading: "Todo lo que necesitas para dominar la b\u00fasqueda en Amazon",
        benefits: [
          {
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Auditor\u00edas de listings",
            description: "Revisi\u00f3n completa del cat\u00e1logo con prioridades de optimizaci\u00f3n",
          },
          {
            title: "Informes de keywords",
            description: "Investigaci\u00f3n de t\u00e9rminos de b\u00fasqueda y seguimiento de rankings",
          },
          {
            title: "Actualizaciones de contenido",
            description: "Reescritura de listings y asesor\u00eda de contenido A+",
          },
          {
            title: "Informes de rendimiento",
            description: "Datos mensuales de impresiones, clics e ingresos",
          },
        ],
      },
    ],
    faqs: {
      ...
      miniCta: {
        heading: "\u00bfListo para dominar la b\u00fasqueda en Amazon?",
        subtitle:
  ...
  it: {
    ...
    sections: [
      {
        ...
        heading: "Tutto ci\u00f2 che serve per dominare la ricerca Amazon",
        benefits: [
          {
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Audit delle inserzioni",
            description: "Revisione completa del catalogo con priorit\u00e0 di ottimizzazione",
          },
          {
            title: "Report keyword",
            description: "Ricerca dei termini di ricerca e monitoraggio dei posizionamenti",
          },
          {
            title: "Aggiornamenti contenuti",
            description: "Riscrittura delle inserzioni e consulenza contenuti A+",
          },
          {
            title: "Report di performance",
            description: "Dati mensili su impressioni, clic e ricavi",
          },
        ],
      },
    ],
    faqs: {
      ...
      miniCta: {
        heading: "Pronti a dominare la ricerca Amazon?",
        subtitle:
  ...
  nl: {
    ...
    sections: [
      {
        ...
        heading: "Alles wat je nodig hebt om Amazon-zoekresultaten te domineren",
        benefits: [
          {
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Listingaudits",
            description: "Volledige catalogusbeoordeling met optimalisatieprioriteiten",
          },
          {
            title: "Zoekwoordrapporten",
            description: "Zoekwoordonderzoek en rankingtracking",
          },
          {
            title: "Contentupdates",
            description: "Herschrijving van listings en A+-contentbegeleiding",
          },
          {
            title: "Prestatierapporten",
            description: "Maandelijkse impressie-, klik- en omzetdata",
          },
        ],
      },
    ],
    faqs: {
      ...
      miniCta: {
        heading: "Klaar om Amazon-zoekresultaten te domineren?",
        subtitle:
