  ...
  de: {
    ...
    faqs: {
      items: [
        ...
        { question: "K\u00fcmmern Sie sich um Plattformmigrationen?", answer: "Ja. Plattformmigration ist eines der risikoreichsten SEO-Ereignisse, die ein Shop durchmachen kann. Wir planen und f\u00fchren Migrationen mit Redirect-Mapping, Crawl-\u00dcberwachung und einem 90-t\u00e4gigen Post-Migration-Tracking-Protokoll durch, um Ranking-Drops zu erkennen und zu beheben, bevor sie sich verschlimmern." },
  ...
  fr: {
    ...
    faqs: {
      items: [
        ...
        { question: "G\u00e9rez-vous les migrations de plateformes\u00a0?", answer: "Oui. La migration de plateforme est l\u2019un des \u00e9v\u00e9nements SEO les plus risqu\u00e9s qu\u2019une boutique peut traverser. Nous planifions et ex\u00e9cutons les migrations avec cartographie des redirections, surveillance du crawl et un protocole de suivi post-migration de 90 jours pour d\u00e9tecter et corriger les baisses de classement avant qu\u2019elles s\u2019aggravent." },
