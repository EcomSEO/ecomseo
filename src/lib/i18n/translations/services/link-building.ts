      ...
      },
      {
        ...
        benefits: [
          ...
          },
          {
            ...
            description:
              "AI Overviews und Answer Boxes dominieren die SERPs. Wir bauen Links von Quellen auf, die LLMs zitieren, damit Ihre Marke in KI-gest\u00FCtzter Suche erscheint.",
          },
        ],
      },
      {
        ...
        deliverables: [
          {
            ...
            description: "Vollst\u00E4ndiges Wettbewerber-Backlink-Audit",
          },
          {
            title: "Outreach-Kampagnen",
            description: "Gezielte Platzierungen in Ihrer Nische",
          },
          {
            title: "Content-Assets",
            description: "Verlinkbare Leitf\u00E4den, Daten und Tools",
          },
          {
            title: "Monatliche Berichte",
            description: "Jeder Link, jede Metrik, jeden Monat",
          },
        ],
      },
    ],
  ...
  fr: {
    ...
    sections: [
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Analyse du gap de liens",
            description: "Audit complet des backlinks concurrents",
          },
          {
            title: "Campagnes d\u2019outreach",
            description: "Placements cibl\u00E9s dans votre niche",
          },
          {
            title: "Assets de contenu",
            description: "Guides, donn\u00E9es et outils linkables",
          },
          {
            title: "Rapports mensuels",
            description: "Chaque lien, chaque m\u00E9trique, chaque mois",
          },
        ],
      },
    ],
  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "An\u00E1lisis de gap de enlaces",
            description: "Auditor\u00EDa completa de backlinks de competidores",
          },
          {
            title: "Campa\u00F1as de outreach",
            description: "Colocaciones dirigidas en tu nicho",
          },
          {
            title: "Activos de contenido",
            description: "Gu\u00EDas, datos y herramientas enlazables",
          },
          {
            title: "Informes mensuales",
            description: "Cada enlace, cada m\u00E9trica, cada mes",
          },
        ],
      },
    ],
    ...
    sections: [
      {
        type: "stats",
        badge: "Risultati",
        heading: "Risultati che parlano da soli",
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Analisi del gap di link",
            description: "Audit completo dei backlink dei competitor",
          },
          {
            title: "Campagne di outreach",
            description: "Posizionamenti mirati nella tua nicchia",
          },
          {
            title: "Asset di contenuto",
            description: "Guide, dati e tool linkabili",
          },
          {
            title: "Report mensili",
            description: "Ogni link, ogni metrica, ogni mese",
          },
        ],
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        benefits: [
          ...
          },
          {
            ...
            description:
              "AI Overviews en answer boxes domineren de SERP\u2019s. We bouwen links van bronnen die LLM\u2019s citeren, zodat jouw merk verschijnt in AI-aangedreven zoekresultaten.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        deliverables: [
          {
            title: "Link gap-analyse",
            description: "Volledige concurrerende backlink-audit",
          },
          {
            title: "Outreach-campagnes",
            description: "Gerichte plaatsingen in jouw niche",
          },
          {
            title: "Content-assets",
            description: "Linkwaardige gidsen, data en tools",
          },
          {
            title: "Maandelijkse rapporten",
            description: "Elke link, elke metriek, elke maand",
          },
        ],
      },
    ],
